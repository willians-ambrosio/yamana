...
*******************************************************************************/
{include/i-prgvrs.i YMRE0101B 11.5.11.001}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i YMRE0101B MRE}
&ENDIF
...
DEFINE VARIABLE h_ymre0101b-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_ymre0101b-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 15.67 COL 2.57 HELP
          "Salva e sai"
     bt-save AT ROW 15.67 COL 13 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 15.67 COL 23.57 HELP
          "Cancela"
     bt-ajuda AT ROW 15.67 COL 70.72
     rt-button AT ROW 15.42 COL 1.57
...
DO:
{include/okfil.i h_ymre0101b-v01}
END.
...
DO:
{include/salvafil.i h_ymre0101b-v01}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymre0101b-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ymre0101b-v01 ).
       RUN set-position IN h_ymre0101b-v01 ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 13.25 , 80.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymre0101b-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_ymre0101b-q01 ).
       RUN set-position IN h_ymre0101b-q01 ( 15.17 , 44.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_ymre0101b-v01. */
       RUN add-link IN adm-broker-hdl ( h_ymre0101b-q01 , 'Record':U , h_ymre0101b-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_ymre0101b-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymre0101b-v01 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "YMRE0101B" "11.5.11.001"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_ymre0101b-v01 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_ymre0101b-q01 (input v-row-table).
