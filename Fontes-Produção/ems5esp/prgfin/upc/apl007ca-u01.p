 ...
 then do: 
    ...
    create fill-in wh-fill
        assign frame              = p-wgh-frame
               ...
               visible            = yes
               sensitive          = no
               TOOLTIP            = "Mouse duplo click para Zoom"
               triggers:
                   ON F5 PERSISTENT RUN prgfin/upc/apl007ca-u03.p.
                   ON "mouse-select-dblclick" PERSISTENT RUN prgfin/upc/apl007ca-u03.p.
                   ON "leave" PERSISTENT RUN prgfin/upc/apl007ca-u05.p.
               end triggers.
    ...
    &endif  
     ...
     create text tx-label-3
         assign frame        = p-wgh-frame
                format       = "x(23)"
                width        = 20
                screen-value = "Cotaá∆o Contrato m∆e:"
                row          = 7.99
                col          = 60
                fgcolor      = 1
                visible      = yes.   
...
and p-ind-object = "VIEWER"
 then do:
   ...
   IF AVAIL b_operac_financ AND (b_operac_financ.dat_liquidac_operac_financ < TODAY OR b_operac_financ.ind_sit_operac_financ_apl = "encerrada")
