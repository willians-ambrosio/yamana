...
*******************************************************************************/
{include/i-prgvrs.i YG0002 12.1.13.002}
...
define temp-table tt-param no-undo
    ...
    fields numero-ordem-ini    like ordem-compra.numero-ordem
    fields numero-ordem-fim    like ordem-compra.numero-ordem
    fields num-pedido-ini      like ordem-compra.num-pedido  
    fields num-pedido-fim      like ordem-compra.num-pedido  
    fields it-codigo-ini       like ordem-compra.it-codigo   
    fields it-codigo-fim       like ordem-compra.it-codigo   
    fields data-emissao-ini    like ordem-compra.data-emissao  
    fields data-emissao-fim    like ordem-compra.data-emissao  
    fields nr-contrato-ini     like ordem-compra.nr-contrato 
    fields nr-contrato-fim     like ordem-compra.nr-contrato 
    FIELDS cod-emitente-ini    LIKE pedido-compr.cod-emitente
    FIELDS cod-emitente-fim    LIKE pedido-compr.cod-emitente
    FIELDS cod-comprado-ini    LIKE ordem-compra.cod-comprado
    FIELDS cod-comprado-fim    LIKE ordem-compra.cod-comprado
...
DEFINE VARIABLE text-tipo AS CHARACTER FORMAT "X(256)":U INITIAL " Tipo de arquivo" 
      VIEW-AS TEXT 
     SIZE 8.57 BY .63 NO-UNDO.
...
DEFINE VARIABLE data-emissao-fim AS DATE FORMAT "99/99/9999" INITIAL 12/31/2999 
     VIEW-AS FILL-IN 
     SIZE 12.57 BY .88.

DEFINE VARIABLE data-emissao-ini AS DATE FORMAT "99/99/9999" INITIAL 01/01/1900 
     LABEL "Data Emiss∆o" 
     VIEW-AS FILL-IN 
     SIZE 12.57 BY .88.
...
DEFINE FRAME f-pg-sel
     cod-emitente-ini AT ROW 1.17 COL 30 RIGHT-ALIGNED WIDGET-ID 2
     cod-emitente-fim AT ROW 1.17 COL 49.29 COLON-ALIGNED NO-LABEL WIDGET-ID 34
     cod-comprado-ini AT ROW 2.17 COL 30 RIGHT-ALIGNED WIDGET-ID 4
     cod-comprado-fim AT ROW 2.17 COL 49.29 COLON-ALIGNED NO-LABEL WIDGET-ID 32
     it-codigo-ini AT ROW 3.17 COL 30 RIGHT-ALIGNED WIDGET-ID 8
     it-codigo-fim AT ROW 3.17 COL 49.29 COLON-ALIGNED NO-LABEL WIDGET-ID 38
     nr-contrato-ini AT ROW 4.17 COL 30 RIGHT-ALIGNED HELP
          "N£mero do Contrato da Ordem de Compra" WIDGET-ID 10
     nr-contrato-fim AT ROW 4.17 COL 49.29 COLON-ALIGNED HELP
          "N£mero do Contrato da Ordem de Compra" NO-LABEL WIDGET-ID 40
     data-emissao-ini AT ROW 5.17 COL 30 RIGHT-ALIGNED WIDGET-ID 6
     data-emissao-fim AT ROW 5.17 COL 49.29 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     IMAGE-1 AT ROW 1.17 COL 31.86
     IMAGE-2 AT ROW 1.17 COL 47.29
     IMAGE-3 AT ROW 2.17 COL 31.86 WIDGET-ID 12
     IMAGE-4 AT ROW 2.17 COL 47.29 WIDGET-ID 14
     IMAGE-5 AT ROW 3.17 COL 31.86 WIDGET-ID 16
     IMAGE-6 AT ROW 3.17 COL 47.29 WIDGET-ID 18
     IMAGE-7 AT ROW 4.17 COL 31.86 WIDGET-ID 20
     IMAGE-8 AT ROW 4.17 COL 47.29 WIDGET-ID 22
     IMAGE-9 AT ROW 5.17 COL 31.86 WIDGET-ID 24
     IMAGE-10 AT ROW 5.17 COL 47.29 WIDGET-ID 26
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
DEFINE FRAME f-pg-par
     rs-tipo AT ROW 1.63 COL 3.29 HELP
          "Destino de Impress∆o do Relat¢rio" NO-LABEL WIDGET-ID 16
     text-tipo AT ROW 1.04 COL 3.86 NO-LABEL WIDGET-ID 20
     RECT-10 AT ROW 1.33 COL 2.14 WIDGET-ID 14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Relat¢rio de Suprimentos"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
/* SETTINGS FOR FRAME f-pg-sel
                                                                        */
/* SETTINGS FOR FILL-IN cod-comprado-ini IN FRAME f-pg-sel
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN cod-emitente-ini IN FRAME f-pg-sel
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN data-emissao-ini IN FRAME f-pg-sel
   ALIGN-R                                                              */
...
ON END-ERROR OF w-relat /* Relat¢rio de Suprimentos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Relat¢rio de Suprimentos */
DO:
...
{utp/ut9000.i "YG0002" "12.1.13.002"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY cod-emitente-ini cod-emitente-fim cod-comprado-ini cod-comprado-fim 
          it-codigo-ini it-codigo-fim nr-contrato-ini nr-contrato-fim 
          data-emissao-ini data-emissao-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         IMAGE-9 IMAGE-10 cod-emitente-ini cod-emitente-fim cod-comprado-ini 
         cod-comprado-fim it-codigo-ini it-codigo-fim nr-contrato-ini 
         nr-contrato-fim data-emissao-ini data-emissao-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    IF INPUT FRAME f-pg-sel cod-emitente-ini > INPUT FRAME f-pg-sel cod-emitente-fim THEN DO:
       APPLY "MOUSE-SELECT-CLICK":U TO im-pg-sel IN FRAME f-relat.
       RUN utp/ut-msgs.p (INPUT "show":U, INPUT 142, INPUT "Emitente~~Emitente").
       APPLY "ENTRY":U TO cod-emitente-ini IN FRAME f-pg-sel.
       RETURN ERROR.
    END.

    IF INPUT FRAME f-pg-sel cod-comprado-ini > INPUT FRAME f-pg-sel cod-comprado-fim THEN DO:
       APPLY "MOUSE-SELECT-CLICK":U TO im-pg-sel IN FRAME f-relat.
       RUN utp/ut-msgs.p (INPUT "show":U, INPUT 142, INPUT "Comprador~~Comprador").
       APPLY "ENTRY":U TO cod-comprado-ini IN FRAME f-pg-sel.
       RETURN ERROR.
    END.
    
    IF INPUT FRAME f-pg-sel it-codigo-ini > INPUT FRAME f-pg-sel it-codigo-fim THEN DO:
       APPLY "MOUSE-SELECT-CLICK":U TO im-pg-sel IN FRAME f-relat.
       RUN utp/ut-msgs.p (INPUT "show":U, INPUT 142, INPUT "Item~~Item").
    ...
    IF INPUT FRAME f-pg-sel nr-contrato-ini > INPUT FRAME f-pg-sel nr-contrato-fim THEN DO:
       APPLY "MOUSE-SELECT-CLICK":U TO im-pg-sel IN FRAME f-relat.
       RUN utp/ut-msgs.p (INPUT "show":U, INPUT 142, INPUT "Contrato~~Contrato").
       APPLY "ENTRY":U TO nr-contrato-ini IN FRAME f-pg-sel.
       RETURN ERROR.
    END.


    IF INPUT FRAME f-pg-sel data-emissao-ini > INPUT FRAME f-pg-sel data-emissao-fim THEN DO:
       APPLY "MOUSE-SELECT-CLICK":U TO im-pg-sel IN FRAME f-relat.
       RUN utp/ut-msgs.p (INPUT "show":U, INPUT 142, INPUT "Data Emiss∆o~~Data Emiss∆o").
       APPLY "ENTRY":U TO data-emissao-ini IN FRAME f-pg-sel.
       RETURN ERROR.
    END.
    ...
    ASSIGN tt-param.numero-ordem-ini   = 0         /*INPUT FRAME f-pg-sel numero-ordem-ini */
           tt-param.numero-ordem-fim   = 999999999 /*INPUT FRAME f-pg-sel numero-ordem-fim */
           tt-param.num-pedido-ini     = 0         /*INPUT FRAME f-pg-sel num-pedido-ini   */
           tt-param.num-pedido-fim     = 999999999 /*INPUT FRAME f-pg-sel num-pedido-fim   */
           tt-param.it-codigo-ini      = INPUT FRAME f-pg-sel it-codigo-ini   
           tt-param.it-codigo-fim      = INPUT FRAME f-pg-sel it-codigo-fim   
           tt-param.data-emissao-ini   = INPUT FRAME f-pg-sel data-emissao-ini
           tt-param.data-emissao-fim   = INPUT FRAME f-pg-sel data-emissao-fim
           ...
           tt-param.cod-comprado-ini   = INPUT FRAME f-pg-sel cod-comprado-ini
           tt-param.cod-comprado-fim   = INPUT FRAME f-pg-sel cod-comprado-fim
    ...
    {include/i-rprun.i esp/yg0002rp.p}
