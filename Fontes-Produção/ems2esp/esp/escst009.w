...
fi-dt-fim fi-cst btn-executar btn-close 
&Scoped-Define DISPLAYED-OBJECTS fi-arquivo fi-dt-ini fi-dt-fim fi-cst 
...
DEFINE VARIABLE fi-arquivo AS CHARACTER FORMAT "X(256)":U INITIAL "C:~\temp~\alt-cst-item.txt" 
     LABEL "Arquivo" 
     VIEW-AS FILL-IN 
     SIZE 38 BY .88
...
DEFINE FRAME DEFAULT-FRAME
     ...
     fi-cst AT ROW 5.25 COL 25 COLON-ALIGNED WIDGET-ID 12
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Altera CST item fixo (97120035)"
         HEIGHT             = 8
         WIDTH              = 80
         MAX-HEIGHT         = 30.04
         MAX-WIDTH          = 194.86
...
ON END-ERROR OF C-Win /* Altera CST item fixo (97120035) */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Altera CST item fixo (97120035) */
DO:
...
DO:
    ...
    ASSIGN FRAME {&FRAME-NAME} fi-arquivo fi-dt-ini fi-dt-fim fi-cst .
    ...
    FOR EACH nota-fiscal NO-LOCK
        ...
        FOR EACH it-nota-fisc OF nota-fiscal EXCLUSIVE-LOCK
            WHERE it-nota-fisc.it-codigo = '97120035':
...
------------------------------------------------------------------------------*/
  DISPLAY fi-arquivo fi-dt-ini fi-dt-fim fi-cst 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE RECT-12 RECT-13 fi-arquivo fi-dt-ini fi-dt-fim fi-cst btn-executar 
         btn-close 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
