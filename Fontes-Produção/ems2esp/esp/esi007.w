...
/*------------------------------------------------------------------------
File.............: esi007.w
Description......: Exporta Cota‡Æo de Moeda
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 17/01/11 - 17:57 - adm

------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "esi007".
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Exporta Cota‡Æo de Moeda - esi007"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "esi007".
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "esi007" + "." + v-cod-extens-arq.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "esp/esi00727.p".
