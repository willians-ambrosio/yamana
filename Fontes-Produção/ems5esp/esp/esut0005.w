...
/*------------------------------------------------------------------------
    ...
    Objetivo: Importa‡Æo da Tabela es_item_distrib_ccusto_dia (Interface)
...
{include/i-prgvrs.i ESUT0005 5.06.00.000}
...
DEFINE FRAME f-pg-log
     rs-destino AT ROW 2 COL 3.29 HELP
          "Destino de ImpressÆo do Relat¢rio" NO-LABEL
     bt-config-impr-destino AT ROW 3.21 COL 43.29 HELP
          "Configura‡Æo da impressora"
     bt-arquivo-destino AT ROW 3.21 COL 43.29 HELP
          "Escolha do nome do arquivo"
     c-arquivo-destino AT ROW 3.25 COL 3.29 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     rs-execucao AT ROW 5.38 COL 3.14 HELP
          "Modo de Execu‡Æo" NO-LABEL
     text-destino AT ROW 1.25 COL 3.86 NO-LABEL
...
DEFINE FRAME f-pg-par
     bt-arq-entrada AT ROW 2.08 COL 71.86 HELP
          "Escolha do nome do arquivo"
     c-arquivo-entrada AT ROW 2.13 COL 15.86 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     "Arquivo Entrada:" VIEW-AS TEXT
          SIZE 11.14 BY .67 AT ROW 2.21 COL 3.86 WIDGET-ID 18
          FONT 1
     RECT-8 AT ROW 1.58 COL 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 76.14 BY 10.38 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Importa‡Æo de Crit‚rios Distrib CCusto por Dia"
         HEIGHT             = 14.96
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.96
         MAX-WIDTH          = 182.86
...
ON END-ERROR OF C-Win /* Importa‡Æo de Crit‚rios Distrib CCusto por Dia */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Importa‡Æo de Crit‚rios Distrib CCusto por Dia */
DO:
...
&Scoped-define SELF-NAME bt-arq-entrada
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-arq-entrada C-Win
ON CHOOSE OF bt-arq-entrada IN FRAME f-pg-par
DO:
    
    Def Var c-arq      As Char No-undo.
    Def Var l-escolheu As Log  No-undo.

    SYSTEM-DIALOG GET-FILE c-arq
        TITLE       "Escolha o arquivo com os dados..."   
        FILTERS     "CSV (*.csv)" "*.csv"
    ...
    If l-escolheu Then 
        Assign c-arquivo-entrada:Screen-value = c-arq.
...
/* {utp/ut9000.i "ESUT0005" "5.05.00.000"} */
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    /*
    {include/i-fndparamdir.i &programa=ESUT0005 &parametro=1 &objeto=c-arquivo-entrada}
    {include/i-fndparamdir.i &programa=ESUT0005 &parametro=2 &objeto=c-dir-log}
    {include/i-fndparamdir.i &programa=ESUT0005 &parametro=3 &objeto=c-dir-erro}
    */
    ...
    {include/i-imvrf.i &programa=ESUT0005 &versao-layout=001}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-8 bt-arq-entrada c-arquivo-entrada 
      WITH FRAME f-pg-par IN WINDOW C-Win.
...
do  on error undo, return error
    ...
    Assign tt-param.arq-entrada = Input Frame f-pg-par c-arquivo-entrada.

    {include/i-imexb.i}

    if  session:set-wait-state("general":U) then.

    {include/i-imrun.i esp/esut0005rp.p}
