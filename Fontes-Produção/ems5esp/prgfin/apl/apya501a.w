...
*******************************************************************************/
{include/i-prgvrs.i APYA501A 12.1.17.000}
...
DEFINE FRAME f-cad
     bt-ok AT ROW 14.92 COL 2.86 HELP
          "Salva e sai"
     bt-save AT ROW 14.92 COL 13.86 HELP
          "Salva e cria novo registro"
     bt-cancela AT ROW 15 COL 24.86 HELP
          "Cancela"
     bt-ajuda AT ROW 15 COL 79.14
     rt-button AT ROW 14.75 COL 1.72
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 93.86 BY 16.5 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-incmdp ASSIGN
         HIDDEN             = YES
         TITLE              = "Inclui/Modifica Contrato Intercompany"
         HEIGHT             = 15.38
         WIDTH              = 90.57
         MAX-HEIGHT         = 28
         MAX-WIDTH          = 169
...
ON END-ERROR OF w-incmdp /* Inclui/Modifica Contrato Intercompany */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-incmdp w-incmdp
ON WINDOW-CLOSE OF w-incmdp /* Inclui/Modifica Contrato Intercompany */
DO:
...
DO:
{include/salvapai.i h_apya501-v01}
 END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_apya501-v01 ( 1.21 , 1.72 ) NO-ERROR.
       ...
       RUN set-position IN h_apya501-q01 ( 14.67 , 62.72 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'tableio':U , h_apya501-v01 ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "APYA501A" "12.1.17.000"}
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_apya501-q01 (INPUT v-row-table). 
