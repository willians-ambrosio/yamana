...
/*------------------------------------------------------------------------
File.............: esbtb008.w
Description......: Exporta Cadastro de Fornecedor
Author...........: Daniel P. de Lima
Created..........: 22/02/11 - 14:05
------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "ESBTB008".
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Exporta Cadastro de Fornecedor - ESBTB008"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "ESBTB008".
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "ESBTB008" + "." + v-cod-extens-arq.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "esp/esbtb008rp.p".
