...
*****************************************************************************/
{include/i-prgvrs.i esfnd001-g01 5.06.00.000}
...
&Scoped-Define ENABLED-OBJECTS rt-button c_cod_prog_dtsul bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod_prog_dtsul 
...
DEFINE FRAME d-vapara
     c_cod_prog_dtsul AT ROW 1.75 COL 23 COLON-ALIGNED WIDGET-ID 2
...
DO:
FIND es-param-prog-pai NO-LOCK
    WHERE es-param-prog-pai.cod_prog_dtsul EQ INPUT FRAME {&FRAME-NAME} c_cod_prog_dtsul NO-ERROR.

IF NOT AVAILABLE es-param-prog-pai THEN DO:
    {utp/ut-table.i emp es-param-prog-pai 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-param-prog-pai).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod_prog_dtsul 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cod_prog_dtsul bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esfnd001-g01" "5.06.00.000"}
