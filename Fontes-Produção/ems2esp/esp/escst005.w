...
DEFINE VARIABLE fi-arquivo AS CHARACTER FORMAT "X(256)":U INITIAL "C:~\temp~\cd0303.txt" 
     LABEL "Arquivo" 
     VIEW-AS FILL-IN 
     SIZE 38 BY .88
...
DEFINE FRAME DEFAULT-FRAME
     fi-arquivo AT ROW 3.75 COL 25 COLON-ALIGNED WIDGET-ID 2
...
ON END-ERROR OF C-Win /* cd0303 - excel */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* cd0303 - excel */
DO:
...
OUTPUT TO VALUE (fi-arquivo). /*"C:\bruno\cd0303.txt"*/
...
FOR EACH sit-tribut-relacto NO-LOCK:
    ...
    EXPORT DELIMITER ";" 
        ...
        sit-tribut-relacto.cod-livre-1 
        sit-tribut-relacto.cod-livre-2 
        sit-tribut-relacto.cod-natur-operac 
        sit-tribut-relacto.cod-ncm 
        sit-tribut-relacto.dat-livre-1 
        sit-tribut-relacto.dat-livre-2 
        sit-tribut-relacto.dat-valid-inic 
        sit-tribut-relacto.idi-tip-docto 
        sit-tribut-relacto.log-livre-1 
        sit-tribut-relacto.log-livre-2 
        sit-tribut-relacto.num-livre-1 
        sit-tribut-relacto.num-livre-2 
        sit-tribut-relacto.val-livre-1 
        sit-tribut-relacto.val-livre-2
        .
END.
