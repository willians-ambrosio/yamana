...
**       Objetivo: Exporta para Ilha a Condi‡Æo de Pagamento
**       VersÆo..: 1.00.000
*******************************************************************************/
...
form cond-pagto.cod-cond-pag column-label "Cond" format ">>9" at 001
     cond-pagto.descricao column-label "Descri‡Æo" format "x(30)" at 006
...
assign c-programa     = "ESBTB004RP"
       c-versao       = "2.06"
       c-revisao      = ".00.000"
       c-titulo-relat = "Exporta para Ilha a Condi‡Æo de Pagamento"
       c-sistema      = "".
...
if  tt-param.parametro then do:
   ...
   disp stream str-rp "   Exporta para Ilha a Condi‡Æo de Pagamento"
