...
*******************************************************************************/
{include/i-prgvrs.i ESFT0003-G01 2.06.00.000}
...
&Scoped-Define ENABLED-OBJECTS rt-button c_cod-estabel c_nat-operacao bt-ok ~
bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod-estabel c_nat-operacao 
...
DEFINE VARIABLE c_cod-estabel AS CHARACTER FORMAT "x(5)" 
...
DEFINE FRAME d-vapara
     c_cod-estabel AT ROW 1.67 COL 30 COLON-ALIGNED WIDGET-ID 4
     c_nat-operacao AT ROW 2.67 COL 30 COLON-ALIGNED WIDGET-ID 2
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "V  Para Natureza de Opera‡Æo"
...
ON GO OF FRAME d-vapara /* V  Para Natureza de Opera‡Æo */
DO:
FIND es-conta-cfop NO-LOCK
    WHERE es-conta-cfop.cod-estabel  EQ INPUT FRAME {&FRAME-NAME} c_cod-estabel AND
          es-conta-cfop.nat-operacao EQ INPUT FRAME {&FRAME-NAME} c_nat-operacao NO-ERROR.

IF NOT AVAILABLE es-conta-cfop THEN DO:
    {utp/ut-table.i mgesp es-conta-cfop 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-conta-cfop).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Natureza de Opera‡Æo */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod-estabel c_nat-operacao 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cod-estabel c_nat-operacao bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESFT0003-G01" "2.06.00.000"}
