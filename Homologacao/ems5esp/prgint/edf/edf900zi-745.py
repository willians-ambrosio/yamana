...
PROCEDURE pi_extracao_banco_brasil_detalhe:
    ...
    */
    ...
    then do: /* --- DETALHE ---*/
        ...
        assign v_dec_aux           = dec(substring(tt_param_program_formul.ttv_des_contdo, 1,17))
               v_tot_vl_corr_monet = v_dec_aux
               v_val_juros         = int(substring(tt_param_program_formul.ttv_des_contdo, 1,17)). /* Juros */
        ...
        assign v_dec_aux           = dec(substring(tt_param_program_formul.ttv_des_contdo, 1,17))
               ...
               v_val_multa         = int(substring(tt_param_program_formul.ttv_des_contdo, 1,17)). /* Juros */
        ...
        if v_cod_segto = '' then do:
            ...
            then do:
                ...
                IF int(v_val_pagto) > 250000 THEN DO:
