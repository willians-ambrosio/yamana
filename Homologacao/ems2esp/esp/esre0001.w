...
**
******************************************************************************/
{include/i-prgvrs.i ESRE0001 2.12.00.000}
...
bt-arquivo c-arquivo rs-execucao l-pdf 
&Scoped-Define DISPLAYED-OBJECTS rs-destino c-arquivo rs-execucao l-pdf 
...
DEFINE VARIABLE l-pdf AS LOGICAL INITIAL yes 
     LABEL "Gera PDF?" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME f-pg-sel
     serie-docto-ini AT ROW 2.25 COL 17 COLON-ALIGNED WIDGET-ID 24
     serie-docto-fim AT ROW 2.25 COL 43 COLON-ALIGNED NO-LABEL WIDGET-ID 64
     nro-docto-ini AT ROW 3.25 COL 17 COLON-ALIGNED WIDGET-ID 68
     nro-docto-fim AT ROW 3.25 COL 43 COLON-ALIGNED NO-LABEL WIDGET-ID 62
     ...
     dt-trans-ini AT ROW 6.25 COL 17 COLON-ALIGNED WIDGET-ID 76
     dt-trans-fim AT ROW 6.25 COL 43 COLON-ALIGNED NO-LABEL WIDGET-ID 74
     ...
     IMAGE-11 AT ROW 6.25 COL 36.57 WIDGET-ID 80
     IMAGE-12 AT ROW 6.25 COL 41.57 WIDGET-ID 78
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.83
         SIZE 73.29 BY 10.63
...
DEFINE FRAME f-pg-imp
     ...
     l-pdf AT ROW 7.75 COL 5 WIDGET-ID 2
...
ON LEAVE OF dt-trans-fim IN FRAME f-pg-sel
DO:
/*   {cdp\cd9998.i}  */
END.
...
{utp/ut9000.i "ESRE0001" "12.6.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY serie-docto-ini serie-docto-fim nro-docto-ini nro-docto-fim 
  ...
  ENABLE IMAGE-9 IMAGE-10 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         IMAGE-11 IMAGE-12 serie-docto-ini serie-docto-fim nro-docto-ini 
         nro-docto-fim cod-emitente-ini cod-emitente-fim dt-emissao-ini 
         dt-emissao-fim dt-trans-ini dt-trans-fim 
      WITH FRAME f-pg-sel IN WINDOW C-Win.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-sel}
  DISPLAY rs-destino c-arquivo rs-execucao l-pdf 
...
do on error undo, return error
   ...
   ASSIGN tt-param.serie-docto-ini   = input frame f-pg-sel serie-docto-ini
          tt-param.serie-docto-fim   = input frame f-pg-sel serie-docto-fim
          ...
          tt-param.pdf               = INPUT FRAME f-pg-imp l-pdf. 
                                           
   {include/i-rpexb.i}

   if  session:set-wait-state("general") then.

   {include/i-rprun.i esp/ESRE0001rp.p}
