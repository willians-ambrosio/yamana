...
{include/i-prgvrs.i IM0100-UPC 2.00.00.001 } /*** 010001 ***/
{utp/ut-glob.i}
...
DEFINE NEW GLOBAL SHARED VARIABLE g-cod-embarque				AS CHAR NO-UNDO.
DEFINE NEW GLOBAL SHARED VARIABLE g-cod-estabel 				AS CHAR NO-UNDO.
...
IF p-ind-event = "CHANGE-PAGE" THEN DO:
    IF VALID-HANDLE(wgh-embarque-IM0100) THEN DO:
       /*MESSAGE p-ind-event SKIP
        g-cod-estabel  skip
        g-cod-embarque skip
        wgh-cod-estabel-IM0100:SCREEN-VALUE skip
        wgh-embarque-IM0100:SCREEN-VALUE   
        VIEW-AS ALERT-BOX INFO BUTTONS OK.
*/

		IF wgh-cod-estabel-IM0100:SCREEN-VALUE <> g-cod-estabel
		OR wgh-embarque-IM0100:SCREEN-VALUE	   <> g-cod-embarque THEN DO:
		
			ASSIGN g-cod-estabel  = wgh-cod-estabel-IM0100:SCREEN-VALUE
				   g-cod-embarque = wgh-embarque-IM0100:SCREEN-VALUE.
