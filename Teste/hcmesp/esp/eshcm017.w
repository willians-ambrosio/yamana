...
DEFINE VARIABLE fi-est-ini AS CHARACTER FORMAT "x(5)":U 
...
------------------------------------------------------------------------------*/
  ...
  ENABLE IMAGE-15 IMAGE-17 IMAGE-21 IMAGE-22 IMAGE-23 IMAGE-24 fi-empresa-ini 
         fi-empresa-fim fi-est-ini fi-est-fim fi-func-ini fi-func-fim 
      WITH FRAME f-pg-sel IN WINDOW C-Win.
