            ...
            for each tt-item-batch:
                ...
                if  tt-item-batch.cod-erro <> 0 then do:
                    ...
                    DO:
                       ...
                       BUFFER-COPY tt-item-batch        TO es-klassmatt-integr
                                                    ASSIGN es-klassmatt-integr.idklassmatt = 999999999                               
                                                           ...
                                                           es-klassmatt-integr.log-retorno   = "ESCD0209RP - TIPO DE CONTROLE ATUALIZADO Tipo-Contr = "  + STRING(tt-item-batch.tipo-contr)      
