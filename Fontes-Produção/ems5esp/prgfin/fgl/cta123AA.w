...
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 14/04/09 - 08:51 - adm
OBS..............: Este fonte foi gerado pelo Data Viewer
------------------------------------------------------------------------*/
def buffer empresa         for ems2cadme.empresa.

define variable c-prog-gerado as character no-undo initial "CTA123AA".
...
define temp-table tt-param
    ...
    field i-ep-codigo-ini like empresa.ep-codigo
    field i-ep-codigo-fim like empresa.ep-codigo
    field c-ct-codigo-ini like movto-estoq.ct-codigo
    field c-ct-codigo-fim like movto-estoq.ct-codigo
    field c-sc-codigo-ini like movto-estoq.sc-codigo
    field c-sc-codigo-fim like movto-estoq.sc-codigo
.
...
def new shared var i-ep-codigo-ini like empresa.ep-codigo     format "x(3)" initial "" no-undo.
def new shared var i-ep-codigo-fim like empresa.ep-codigo     format "x(3)" initial "ZZZ" no-undo.
def new shared var c-ct-codigo-ini like movto-estoq.ct-codigo format "X(8)" initial "" no-undo.
def new shared var c-ct-codigo-fim like movto-estoq.ct-codigo format "X(8)" initial "ZZZZZZZZ" no-undo.
def new shared var c-sc-codigo-ini like movto-estoq.sc-codigo format "x(8)" initial "" no-undo.
def new shared var c-sc-codigo-fim like movto-estoq.sc-codigo format "x(8)" initial "ZZZZZZZZ" no-undo.
...
DEFINE FRAME f-pg-sel
   i-ep-codigo-ini label "Empresa"
     at row 1 col 12 colon-aligned
     view-as fill-in 
     size 4 by .88
     font 1

   i-ep-codigo-fim no-label
     at row 1 col 31 colon-aligned
     view-as fill-in 
     size 4 by .88
     font 1

   c-ct-codigo-ini label "Cta"
     at row 2 col 12 colon-aligned
     view-as fill-in 
     size 9 by .88
     font 1

   c-ct-codigo-fim no-label
     at row 2 col 31 colon-aligned
     view-as fill-in 
     size 9 by .88
     font 1

   c-sc-codigo-ini label "Ccusto"
     at row 3 col 12 colon-aligned
     view-as fill-in 
     size 9 by .88
     font 1

   c-sc-codigo-fim no-label
     at row 3 col 31 colon-aligned
     view-as fill-in 
     size 9 by .88
     font 1

   IMAGE-1 AT ROW 01.00 COL 24
   IMAGE-2 AT ROW 01.00 COL 29
   WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY
   SIDE-LABELS NO-UNDERLINE THREE-D
   AT COL 3 ROW 2.85
   SIZE 76.86 BY 10.62.
...
assign v-cod-prog-gerado = "cta123AA".
...
PROCEDURE enable_UI :
   ...
   c-ct-codigo-ini c-ct-codigo-fim
   c-sc-codigo-ini c-sc-codigo-fim
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "cta123AA" + "." + v-cod-extens-arq.

    assign tt-param.i-ep-codigo-ini = input frame f-pg-sel i-ep-codigo-ini
           ...
           tt-param.c-sc-codigo-ini = input frame f-pg-sel c-sc-codigo-ini
           tt-param.c-sc-codigo-fim = input frame f-pg-sel c-sc-codigo-fim
.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "prgfin\fgl\cta12327.p".
