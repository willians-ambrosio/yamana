...
*******************************************************************************/
{include/i-prgvrs.i ESUT0011 2.06.00.000}
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Atualizaá∆o da SÇrie da Carteira Trabalho Funcionario"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Atualizaá∆o da SÇrie da Carteira Trabalho Funcionario */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Atualizaá∆o da SÇrie da Carteira Trabalho Funcionario */
DO:
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/esut0011rp.p}
