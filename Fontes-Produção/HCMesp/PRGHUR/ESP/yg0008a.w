...
*******************************************************************************/
{include/i-prgvrs.i YG0008A 12.1.17.000}
...
DEFINE FRAME f-cad
     bt-ok AT ROW 11.83 COL 3.14 HELP
          "Salva e sai"
     bt-save AT ROW 11.83 COL 14.14 HELP
          "Salva e cria novo registro"
     bt-cancela AT ROW 11.83 COL 25.14 HELP
          "Cancela"
     bt-ajuda AT ROW 11.83 COL 79.57
     rt-button AT ROW 11.67 COL 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 90 BY 19.63 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-incmdp ASSIGN
         HIDDEN             = YES
         TITLE              = "Inclui/Modifica Parametros In Intineres"
         HEIGHT             = 12.29
         WIDTH              = 90.72
         MAX-HEIGHT         = 22
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-incmdp /* Inclui/Modifica Parametros In Intineres */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-incmdp w-incmdp
ON WINDOW-CLOSE OF w-incmdp /* Inclui/Modifica Parametros In Intineres */
DO:
...
DO:
{include/salvapai.i h_yg0008-v01}
 END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_yg0008-v01 ).
       RUN set-position IN h_yg0008-v01 ( 1.25 , 2.14 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_yg0008-q01 ).
       RUN set-position IN h_yg0008-q01 ( 11.71 , 53.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_yg0008-v01. */
       RUN add-link IN adm-broker-hdl ( h_yg0008-q01 , 'Record':U , h_yg0008-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_yg0008-v01 ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "YG0008A" "12.1.17.000"}
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_yg0008-q01 (INPUT v-row-table). 
