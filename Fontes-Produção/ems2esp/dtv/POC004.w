...
define variable c-prog-gerado as character no-undo initial "POC004".
...
def var c-titulo           as char init "Notas Fiscais Recebidas - Laurence _ colocar em pr" no-undo.        
def var v-cod-prog-gerado  as char init "POC004" no-undo.           
...
assign v-cod-prog-gerado = "POC004".
