...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-fornec-ap NO-LOCK, ~
      EACH emitente OF es-fornec-ap NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-fornec-ap NO-LOCK, ~
      EACH emitente OF es-fornec-ap NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-fornec-ap emitente
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-fornec-ap
&Scoped-define SECOND-TABLE-IN-QUERY-Query-Main emitente
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.es-fornec-ap,emitente OF mgesp.es-fornec-ap"
     _Options          = "NO-LOCK"
