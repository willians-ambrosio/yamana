...
DEFINE FRAME f-cad
     bt-ok AT ROW 8 COL 3.14 HELP
          "Salva e sai"
     bt-save AT ROW 8 COL 15 HELP
          "Salva e cria novo registro"
     bt-cancela AT ROW 8 COL 25.14 HELP
          "Cancela"
     bt-ajuda AT ROW 8 COL 78.14
     rt-button AT ROW 7.83 COL 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 91.43 BY 17 WIDGET-ID 100.
...
DO:
{include/okpai.i h_ymof0100-v01}
END.
...
DO:
{include/salvapai.i h_ymof0100-v01}
 END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_folder ( 6.50 , 91.00 ) NO-ERROR.
       ...
       RUN set-position IN h_ymof0100-v01 ( 3.25 , 1.00 ) NO-ERROR.
       ...
       RUN set-position IN h_ymof0100-q01 ( 1.25 , 48.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.00 , 7.72 ) */

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Empresa':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_ymof0100-v01. */
       RUN add-link IN adm-broker-hdl ( h_ymof0100-q01 , 'Record':U , h_ymof0100-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'tableio':U , h_ymof0100-v01 ).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_ymof0100-q01 (INPUT v-row-table). 
