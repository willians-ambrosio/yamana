...
DEFINE FRAME f-pg-sel
     i-dias-extrat AT ROW 4.5 COL 27 COLON-ALIGNED WIDGET-ID 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
ON LEAVE OF i-dias-extrat IN FRAME f-pg-sel /* Numero dias */
DO:
...
{utp/ut9000.i "ESCC0009" "1.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY i-dias-extrat 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE i-dias-extrat 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
/*     {include/i-rprun.i esp\escc009rp.p } */

      RUN esp\escc0009rp.p(INPUT  i-dias-extrat,                  
                          INPUT YES) NO-ERROR.    
