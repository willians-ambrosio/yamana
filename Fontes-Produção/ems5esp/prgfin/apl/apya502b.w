...
*******************************************************************************/
{include/i-prgvrs.i APYA501B 12.1.17.000}
...
DEFINE FRAME f-cad
     bt-ok AT ROW 5.42 COL 2.57 HELP
          "Salva e sai"
     bt-save AT ROW 5.42 COL 13 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 5.42 COL 23.57 HELP
          "Cancela"
     bt-ajuda AT ROW 5.42 COL 79.72
     rt-button AT ROW 5.25 COL 1.57
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Inclui/Modifica Aditivo Contrato Intercompany"
         HEIGHT             = 5.79
         WIDTH              = 91
         MAX-HEIGHT         = 26.75
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-cadsim /* Inclui/Modifica Aditivo Contrato Intercompany */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Inclui/Modifica Aditivo Contrato Intercompany */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_apya501b-v01 ( 1.21 , 1.72 ) NO-ERROR.
       ...
       RUN set-position IN h_apya501b-q01 ( 5.33 , 50.00 ) NO-ERROR.
