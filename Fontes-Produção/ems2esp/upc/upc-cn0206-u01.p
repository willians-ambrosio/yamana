...
**   Descri‡Æo: Cria BotÆo Excel, fill-in para buscar arquivo importa‡Æo e gera‡Æo arquivo layout 
**              importa‡Æo
***************************************************************************************************/
...
DO:   
   ...
   DO:
      ...
      assign frame        = wh-cn0206-c-arquivo-entrada:frame
             format       = "x(22)"
             width        = 18
             screen-value = "Arquivo de Importa‡Æo"
    ...
    DO:
       ...
       DO:              
          run utp/ut-msgs.p (input "show",
                             input 17006,
                             input "Arquivo Excel Inv lido~~Informe um arquivo " + wh-cn0206-fill-import:SCREEN-VALUE + "inv lido e/ou nÆo informado corretamente. Informe um arquivo v lido").        
       ...
       /* ASSIGN d-vl-base    = 0
        ...
        DO:
            ...
            ASSIGN tt-import.nr-contrato     = i-nr-contrato                                                              /* | Ordem |                         Descricao                       | Tamanho | Inicio | Termino | Conteudo | Decimais | Obrigatorio | */                                          
                   ...
                   tt-import.campos[12]      = FILL(" ",008)                                                              /* |   12  | Codigo da Referˆncia                                    |     8   |   104  |   111   | Caracter |          |     Sim     | */  
...
PROCEDURE pi-export-arquivo:                                                /* |----------------------------------------------------------------------------------------------------------------------------------| */  
    ...
    FOR EACH tt-import:                                                     /* |-------+---------------------------------------------------------+---------+--------+---------+----------+----------+-------------| */              
        PUT UNFORMATTED tt-import.campos[01]      AT 001                    /* |    1  | Codigo do Registro (IC00)                               |     4   |     1  |     4   | Caracter |          |     Sim     | */
                        ...
                        tt-import.campos[12]      AT 104                    /* |   12  | Codigo da Referˆncia                                    |     8   |   104  |   111   | Caracter |          |     Sim     | */                    
