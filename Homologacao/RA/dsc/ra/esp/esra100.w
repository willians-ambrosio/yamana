...
/*------------------------------------------------------------------------
  ...
  V07_R00_01 04/09/2014 = Foi colocado tratamento Pi-inicializar para controlar trazer default 
                          o recebimento Fisico ou fiscal dependendo da parametriza»’o
...
bt-limpa fi-cod-estabel-ini bt-implantar fi-cod-estabel-fim bt-chave ~
tg-sefaz-pendente tg-erp-pendente tg-nfe fi-serie-ini fi-serie-fim ~
tg-sefaz-nao-aut tg-erp-implantada bt-filtrar tg-cte fi-nr-docto-ini ~
...
/* Menu Definitions                                                     */
DEFINE MENU POPUP-MENU-br-doctos TITLE "Op»„es"
...
DEFINE BUTTON bt-chave 
     LABEL "Chave" 
     SIZE 13 BY 1.13 TOOLTIP "Abre a tela para inser»’o da Chave Acesso a ser procurada".
...
DEFINE BUTTON bt-Danfe 
     LABEL "Gerar Danfe" 
     SIZE 15 BY 1.13 TOOLTIP "Salva a Danfe selecionada num diret½rio escolhido pelo usuÿrio".
...
DEFINE BUTTON bt-limpa 
     LABEL "Limpar" 
     SIZE 13 BY 1.13 TOOLTIP "Retorna para default todos os campos da Sele»’o, Sefaz, ERP e tipo".
...
DEFINE BUTTON bt-salva-xml 
     LABEL "Salvar XML" 
     SIZE 15 BY 1.13 TOOLTIP "Salva XML selecionada num diret½rio escolhido pelo usuÿrio".
...
DO:
    ...
    IF AVAIL nfe-dfe THEN DO:
        IF nfe-dfe.tipo = "CTE" THEN
            MESSAGE "N’o ² Possivel Emissao de Danfe de CTE!"
                VIEW-AS ALERT-BOX ERROR BUTTONS OK.
...
IF AVAIL grp_usuar THEN DO:
    IF LOOKUP ("RA", v_cod_grp_usuar_lst) = 0 THEN DO: /*n’o encontrei o grupo RA ou n’o perten»o a ele*/
...
------------------------------------------------------------------------------*/
  ...
  ENABLE bt-sair RECT-2 RECT-3 IMAGE-18 IMAGE-25 IMAGE-26 IMAGE-27 IMAGE-29 
         ...
         fi-cod-estabel-ini bt-implantar fi-cod-estabel-fim bt-chave 
         tg-sefaz-pendente tg-erp-pendente tg-nfe fi-serie-ini fi-serie-fim 
         tg-sefaz-nao-aut tg-erp-implantada bt-filtrar tg-cte fi-nr-docto-ini 
         fi-nr-docto-fim tg-sefaz-cancelado tg-erp-imp-manual fi-nome-abrev-ini 
         fi-nome-abrev-fim tg-sefaz-autorizado fi-dt-emissao-ini 
        ...
        IF  AVAIL nfe-nota-fiscal-rec THEN DO:
            ...
            IF nfe-dfe.sit-erp = 2 OR nfe-dfe.sit-erp = 3 THEN DO: /* --- Implantada ou implntada manual--- */
                ASSIGN c-mensagem-erro = "2,"                                       +
                                         ...
                                         "O documento fiscal selecionado jÿ foi efetivado no Sistema e nao pode ser eliminado.".
                RUN dsc\ra\esp\bonfe001.p PERSISTENT SET h_bonfe001.
                RUN pi_mensagem_erro IN h_bonfe001 (INPUT c-mensagem-erro,
                                                    OUTPUT i-acao) /* --- 1 - Erro / 2 - Alerta --- */.
                DELETE PROCEDURE h_bonfe001.
