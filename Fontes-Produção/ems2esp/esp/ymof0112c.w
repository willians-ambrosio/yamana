...
DO:
{include/okpai.i  h_ymof0112-v01}
END.
...
DO:
{include/salvapai.i h_ymof0112-v01}
 END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_folder ( 8.79 , 88.43 ) NO-ERROR.
       ...
       RUN set-position IN h_ymof0112-v01 ( 2.50 , 2.00 ) NO-ERROR.
       ...
       RUN set-position IN h_ymof0112-q01 ( 1.00 , 44.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'tableIo':U , h_ymof0112-v01 ).
...
------------------------------------------------------------------------------*/
  ...
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .
   run pi-atualiza-parent IN h_ymof0112-v01 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_ymof0112-q01 (INPUT v-row-table). 
