...
define variable c-prog-gerado as character no-undo initial "POC009A".
...
DEFINE FRAME f-pg-sel
   ...
   da-dt-pagamento-ini label "Dt Pagamento"
     at row 4 col 18 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

   da-dt-pagamento-fim no-label
     at row 4 col 45 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

   da-dt-vencimen-ini label "Dt Vencimento"
     at row 5 col 18 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

   da-dt-vencimen-fim no-label
...
assign v-cod-prog-gerado = "POC009A".
...
PROCEDURE enable_UI :
   ...
   da-dt-pagamento-ini da-dt-pagamento-fim
   da-dt-vencimen-ini da-dt-vencimen-fim
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "POC009A" + "." + v-cod-extens-arq.
    ...
    assign tt-param.c-cod-estabel-ini = input frame f-pg-sel c-cod-estabel-ini
           ...
           tt-param.da-dt-pagamento-ini = input frame f-pg-sel da-dt-pagamento-ini
           tt-param.da-dt-pagamento-fim = input frame f-pg-sel da-dt-pagamento-fim
           tt-param.da-dt-vencimen-ini = input frame f-pg-sel da-dt-vencimen-ini
           tt-param.da-dt-vencimen-fim = input frame f-pg-sel da-dt-vencimen-fim
.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "dtv/POC0091.p".
