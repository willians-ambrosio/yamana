...
ON F5 OF es-cfop-excecao.nat-operacao IN FRAME f-main /* Nat Opera‡Æo */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-cfop-excecao.nat-operacao V-table-Win
ON LEAVE OF es-cfop-excecao.nat-operacao IN FRAME f-main /* Nat Opera‡Æo */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-cfop-excecao.nat-operacao V-table-Win
ON MOUSE-SELECT-DBLCLICK OF es-cfop-excecao.nat-operacao IN FRAME f-main /* Nat Opera‡Æo */
DO:
  APPLY "f5" TO SELF.
END.
