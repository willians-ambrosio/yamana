...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-cfa-ge ~
      WHERE es-cfa-ge.ep-codigo = i-ep-codigo-usuario NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-cfa-ge ~
      WHERE es-cfa-ge.ep-codigo = i-ep-codigo-usuario NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-cfa-ge
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-cfa-ge
