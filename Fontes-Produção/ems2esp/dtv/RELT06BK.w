...
/*------------------------------------------------------------------------
File.............: RELT06BK.w
Description......: SEGURADORA COM IPI - COM ESTAB
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
...
define variable c-prog-gerado as character no-undo initial "RELT06BK".
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "SEGURADORA COM IPI - COM ESTAB - RELT06BK"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "RELT06BK".
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "RELT06BK" + "." + v-cod-extens-arq.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "DTV/RELT0663.p".
