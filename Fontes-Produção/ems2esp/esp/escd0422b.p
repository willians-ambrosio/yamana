...
*******************************************************************************/
{include/i-prgvrs.i CD0422B 2.00.00.001}  /*** 010001 ***/

&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i cd0422b MCD}
&ENDIF
...
form emitente.nome-abrev    format "X(12)"      colon 025
     emitente.cod-emitente  format ">>>>>>>>9"  colon 075
     c-nome-emit          label "Nome" format "X(20)" colon 109 skip
     emitente.cgc           format "x(19)"      colon 025
     emitente.nome-matriz   format "x(10)"      colon 075
     emitente.ins-estadual  format "X(19)"      colon 109 skip
     emitente.endereco      format "X(40)"      colon 025 skip
     emitente.bairro        format "X(30)"      colon 025
     emitente.cidade        format "X(25)"      colon 075 skip
     emitente.estado        format "x(4)"       colon 025
     emitente.cep           format "x(12)"      colon 075 skip
     emitente.caixa-postal  format "X(10)"      colon 025
     emitente.cod-gr-forn   format ">9"         colon 075
     emitente.telefone[1]   format "x(15)"      colon 109 skip
     emitente.telefax       format "x(15)"      colon 025
     emitente.telef-fac     format "x(15)"      colon 075
     emitente.telefone[2]   format "x(15)"      colon 109 skip
     emitente.telef-modem   format "x(15)"      colon 025
     emitente.ramal-fax     format "x(05)"      colon 075
     emitente.telex         format "x(15)"      colon 109 skip
     emitente.atividade     format "X(12)"      colon 025
     emitente.linha-produt  format "X(08)"      colon 075
     emitente.cod-transp    format ">>,>>9"     colon 109 skip
     emitente.cod-cond-pag  format ">>9"        colon 025
     emitente.nat-operacao  format "9.99-xxx"   colon 075 skip
     emitente.data-taxa     format "99/99/9999" colon 025
     emitente.bonificacao label "Bonifica‡Æo" format ">>9.99" colon 075
     emitente.taxa-financ   format ">>9.99"     colon 109 skip
     emitente.agencia       format "x(8)"       colon 025
     emitente.emissao-ped   format ">9"         colon 075
     emitente.cod-banco     format "999"        colon 109 skip
     emitente.pais          format "X(20)"      colon 025
     emitente.conta-corren  format "x(20)"      colon 075 skip
     c-desc-situacao        format "x(30)"      colon 025
     dt-vig-ini             format "99/99/9999" colon 075
     dt-vig-fim             format "99/99/9999" colon 109 skip
     ...
     &endif
     c-branco no-label      format "x(10)"      at 004
...
for each emitente no-lock
    ...
    display stream str-rp emitente.nome-abrev
