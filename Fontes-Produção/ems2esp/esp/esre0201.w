...
*******************************************************************************/
{include/i-prgvrs.i ESRE0201 2.06.00.001}  /*** 010003 ***/
...
DEFINE VARIABLE c-usu-fim AS CHARACTER FORMAT "X(15)":U INITIAL "zzzzzzzzzzzzzzzzzzzzz" 
     VIEW-AS FILL-IN 
     SIZE 18 BY .88 NO-UNDO.

DEFINE VARIABLE c-usu-ini AS CHARACTER FORMAT "X(15)":U 
     LABEL "Usu rio" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-imp
     rs-destino AT ROW 3.5 COL 18.14 HELP
...
DEFINE FRAME f-pg-sel
     c-usu-ini AT ROW 3.75 COL 11 COLON-ALIGNED
     c-usu-fim AT ROW 3.75 COL 49 COLON-ALIGNED NO-LABEL
     IMAGE-1 AT ROW 3.75 COL 33
     IMAGE-2 AT ROW 3.75 COL 47.29
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62.
...
{utp/ut9000.i "ESRE0201" "2.06.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-usu-ini c-usu-fim 
      WITH FRAME f-pg-sel IN WINDOW C-Win.
  ENABLE IMAGE-1 IMAGE-2 c-usu-ini c-usu-fim 
      WITH FRAME f-pg-sel IN WINDOW C-Win.
...
do  on error undo, return error
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.c-usu-ini       = input frame f-pg-sel c-usu-ini
           tt-param.c-usu-fim       = input frame f-pg-sel c-usu-fim.
    ...
    {include/i-rprun.i esp/esre0201rp.p}
