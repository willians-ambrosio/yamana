...
*******************************************************************************/
{include/i-prgvrs.i APYA501E-G01 12.1.17.000}
...
&Scoped-Define ENABLED-OBJECTS rt-button c_cod_banco c_cod_produt_financ ~
c_cod_operac_financ c_cod_contrat_apf bt-ok bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod_banco c_cod_produt_financ ~
c_cod_operac_financ c_cod_contrat_apf 
...
DEFINE VARIABLE c_cod_banco AS CHARACTER FORMAT "x(8)":U 
     LABEL "Banco" 
     VIEW-AS FILL-IN 
     SIZE 8 BY .88 NO-UNDO.

DEFINE VARIABLE c_cod_contrat_apf AS CHARACTER FORMAT "x(10)":U 
     LABEL "Contrato" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE c_cod_operac_financ AS CHARACTER FORMAT "x(10)":U 
     LABEL "Opera‡Æo Financeira" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE c_cod_produt_financ AS CHARACTER FORMAT "x(8)":U 
...
DEFINE FRAME d-vapara
     c_cod_banco AT ROW 1.17 COL 30 COLON-ALIGNED WIDGET-ID 2
     c_cod_produt_financ AT ROW 2.17 COL 30 COLON-ALIGNED WIDGET-ID 4
     c_cod_operac_financ AT ROW 3.17 COL 30 COLON-ALIGNED WIDGET-ID 6
     c_cod_contrat_apf AT ROW 4.17 COL 30 COLON-ALIGNED WIDGET-ID 8
     bt-ok AT ROW 5.83 COL 2.14
     bt-cancela AT ROW 5.83 COL 13
     bt-ajuda AT ROW 5.83 COL 58
     rt-button AT ROW 5.58 COL 1
     SPACE(0.13) SKIP(0.28)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "V  Para Opera‡Æo"
...
ON GO OF FRAME d-vapara /* V  Para Opera‡Æo */
DO:
FIND es_operac_financ NO-LOCK
    WHERE es_operac_financ.cod_banco EQ INPUT FRAME {&FRAME-NAME} c_cod_banco
      AND es_operac_financ.cod_produt_financ EQ INPUT FRAME {&FRAME-NAME} c_cod_produt_financ
      AND es_operac_financ.cod_operac_financ EQ INPUT FRAME {&FRAME-NAME} c_cod_operac_financ
      AND es_operac_financ.cod_contrat_apf EQ INPUT FRAME {&FRAME-NAME} c_cod_contrat_apf NO-ERROR.

IF NOT AVAILABLE es_operac_financ THEN DO:
    ...
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es_operac_financ).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Opera‡Æo */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod_banco c_cod_produt_financ c_cod_operac_financ c_cod_contrat_apf 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cod_banco c_cod_produt_financ c_cod_operac_financ 
         c_cod_contrat_apf bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "APYA501E-G01" "12.1.17.000"}
