...
*******************************************************************************/
{include/i-prgvrs.i escd0007 2.12.00.000}
...
DEFINE VARIABLE h_escd0007-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escd0007-v01 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Manuten‡Æo de Parƒmetros Espec¡ficos"
         HEIGHT             = 8.88
         WIDTH              = 89.14
         MAX-HEIGHT         = 28.21
         MAX-WIDTH          = 195.14
...
ON END-ERROR OF w-cadsim /* Manuten‡Æo de Parƒmetros Espec¡ficos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manuten‡Æo de Parƒmetros Espec¡ficos */
DO:
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Layout = ,
                     Create-On-Add = ?':U ,
             OUTPUT h_escd0007-v01 ).
       RUN set-position IN h_escd0007-v01 ( 2.75 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 7.00 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'cdp/escd0007-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = cdp/escd0007-z01.w,
                     ProgVaPara = cdp/escd0007-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_escd0007-q01 ).
       RUN set-position IN h_escd0007-q01 ( 1.00 , 61.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.75 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_escd0007-v01. */
       RUN add-link IN adm-broker-hdl ( h_escd0007-q01 , 'Record':U , h_escd0007-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_escd0007-v01 ).

       /* Links to SmartQuery h_escd0007-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_escd0007-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_escd0007-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_escd0007-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_escd0007-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "escd0007" "2.12.00.000"}
