...
*******************************************************************************/
{include/i-prgvrs.i esmv0401 2.00.00.000}  /*** 010005 ***/
/********************************************************************************
...
&GLOBAL-DEFINE Program       esmv0401
...
&GLOBAL-DEFINE page2Widgets  fi-ordem-ini ~ fi-ordem-fim ~ fi-empresa-ini ~ fi-empresa-fim ~ fi-equipamento-ini ~ fi-equipamento-fim ~ fi-abertura-ini ~ fi-abertura-fim ~ fi-entrada-ini ~ fi-entrada-fim ~ fi-tipo-manut-ini ~ fi-tipo-manut-fim ~ fi-planejador-ini ~ fi-planejador-fim ~ fi-oficina-ini ~ fi-oficina-fim ~ fi-prev-termino-ini ~ fi-prev-termino-fim ~ fi-termino-ini ~ fi-termino-fim  


&GLOBAL-DEFINE page3Widgets   rsClassif
&GLOBAL-DEFINE page4Widgets   rsEstado ~ rsTipo
...
&GLOBAL-DEFINE page2Fields  fi-ordem-ini ~ fi-ordem-fim ~ fi-empresa-ini ~ fi-empresa-fim ~ fi-equipamento-ini ~ fi-equipamento-fim ~ fi-abertura-ini ~ fi-abertura-fim ~ fi-entrada-ini ~ fi-entrada-fim ~ fi-tipo-manut-ini ~ fi-tipo-manut-fim ~ fi-planejador-ini ~ fi-planejador-fim ~ fi-oficina-ini ~ fi-oficina-fim ~ fi-prev-termino-ini ~ fi-prev-termino-fim ~ fi-termino-ini ~ fi-termino-fim  
...
DEFINE VARIABLE fi-abertura-fim AS DATE FORMAT "99/99/9999" INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 12.43 BY .88.

DEFINE VARIABLE fi-abertura-ini AS DATE FORMAT "99/99/9999" INITIAL 01/01/1900 
     LABEL "Abertura":R8 
     VIEW-AS FILL-IN 
     SIZE 12.43 BY .88.
...
DEFINE VARIABLE fi-Entrada-fim AS DATE FORMAT "99/99/9999" INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 12.43 BY .88.

DEFINE VARIABLE fi-entrada-ini AS DATE FORMAT "99/99/9999" INITIAL 01/01/001 
     LABEL "Entrada":R18 
     VIEW-AS FILL-IN 
     SIZE 12.43 BY .88.
...
DEFINE VARIABLE rsTipo AS INTEGER INITIAL 4 
     VIEW-AS RADIO-SET VERTICAL
     RADIO-BUTTONS 
          "Equipamento", 1,
"Componente", 2,
...
DEFINE FRAME fPage2
     ...
     fi-abertura-ini AT ROW 4.83 COL 18.57 COLON-ALIGNED HELP
          "C¢digo do Modelo"
     fi-abertura-fim AT ROW 4.83 COL 43 COLON-ALIGNED HELP
          "C¢digo do Modelo" NO-LABEL
     fi-entrada-ini AT ROW 5.83 COL 18.57 COLON-ALIGNED HELP
          "C¢digo do estabelecimento."
     fi-Entrada-fim AT ROW 5.83 COL 43 COLON-ALIGNED HELP
          "C¢digo do estabelecimento." NO-LABEL
     fi-tipo-manut-fim AT ROW 6.83 COL 43 COLON-ALIGNED HELP
          "Localiza‡Æo funcional (TAG)" NO-LABEL
     fi-planejador-ini AT ROW 7.83 COL 18.57 COLON-ALIGNED HELP
          "C½digo do proprietÿrio do equipamento"
     fi-planejador-fim AT ROW 7.83 COL 43 COLON-ALIGNED HELP
          "C½digo do proprietÿrio do equipamento" NO-LABEL
     fi-oficina-ini AT ROW 8.83 COL 18.57 COLON-ALIGNED HELP
          "C¢digo Estrutura Mecƒnica"
     fi-oficina-fim AT ROW 8.83 COL 43 COLON-ALIGNED HELP
     ...
     fi-tipo-manut-ini AT ROW 6.88 COL 18.57 COLON-ALIGNED HELP
          "C½digo do proprietÿrio do equipamento"
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario               = c-seg-usuario
           ...
           tt-param.dt-abertura-ini       = input frame fpage2  fi-abertura-ini      
           tt-param.dt-abertura-fim       = input frame fpage2  fi-abertura-fim       
           tt-param.dt-entrada-ini        = input frame fpage2  fi-entrada-ini     
           tt-param.dt-entrada-fim        = input frame fpage2  fi-entrada-fim     
    ...
    {report/rprun.i mvp/esmv0401rp.p}
