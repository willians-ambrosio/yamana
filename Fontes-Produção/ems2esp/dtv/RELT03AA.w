...
/*------------------------------------------------------------------------
File.............: RELT03AA.w
Description......: TOTAL CONSUMIDO POR FAMILIA
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 11/04/12 - 10:57 - adm
OBS..............: Este fonte foi gerado pelo Data Viewer
------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "RELT03AA".
...
DEFINE FRAME f-pg-sel
   ...
   c-fm-codigo-fim no-label
    ...
    IMAGE-3 AT ROW 02.00 COL 33
    IMAGE-4 AT ROW 02.00 COL 38
   WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY
   SIDE-LABELS NO-UNDERLINE THREE-D
   AT COL 3 ROW 2.85
   SIZE 76.86 BY 10.62.
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "TOTAL CONSUMIDO POR FAMILIA - RELT03AA"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "RELT03AA".
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "RELT03AA" + "." + v-cod-extens-arq.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "dtv/RELT0327.p".
