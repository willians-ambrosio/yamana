...
*******************************************************************************/
{include/i-prgvrs.i APYA502-G01 12.1.17.000}
...
&Scoped-Define ENABLED-OBJECTS rt-button c_cod_admdra_apf bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod_admdra_apf 
...
DEFINE VARIABLE c_cod_admdra_apf AS CHARACTER FORMAT "x(5)":U 
...
DEFINE FRAME d-vapara
     c_cod_admdra_apf AT ROW 1.75 COL 30 COLON-ALIGNED WIDGET-ID 2
...
ON GO OF FRAME d-vapara /* V  Para Administradora */
DO:
FIND admdra_apf NO-LOCK
    WHERE admdra_apf.cod_admdra_apf EQ INPUT FRAME {&FRAME-NAME} c_cod_admdra_apf NO-ERROR.

IF NOT AVAILABLE admdra_apf THEN DO:
    {utp/ut-table.i ems5_esp admdra_apf 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(admdra_apf).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Administradora */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod_admdra_apf 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cod_admdra_apf bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "APYA502-G01" "12.1.17.000"}
