...
*******************************************************************************/
{include/i-prgvrs.i YMSA0001-z01 1.00.00.000}
...
DEFINE VARIABLE h_YMSA0001-z01-b01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     ...
     bt-ok AT ROW 14.79 COL 3
     bt-cancela AT ROW 14.79 COL 14
     bt-ajuda AT ROW 14.79 COL 72.57
     rt-button AT ROW 14.54 COL 2
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Tipo Refei‡Æo' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prghur/esp/YMSA0001-z01-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_YMSA0001-z01-b01 ).
       RUN set-position IN h_YMSA0001-z01-b01 ( 2.54 , 2.72 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_YMSA0001-z01-b01. */
       RUN add-link IN adm-broker-hdl ( h_YMSA0001-z01-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_YMSA0001-z01-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "YMSA0001-z01" "1.00.00.000"}
