...
/****************************************************************************************** 
** 	   Programa: rep001-G01.w
**   	      Autor: Felipe Vieira
**   	 Fornecedor: DKP
**    	 Data: 25/09/2018
** Change/Chamado: 
**    Objetivo: Cadastro de aprovadores (va para)
**
...
******************************************************************************************/
{include/i-prgvrs.i REP001-G01 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i REP001-G01 REP}
&ENDIF
...
&Scoped-Define ENABLED-OBJECTS rt-button i_cod_usuario bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS i_cod_usuario 
...
DEFINE VARIABLE i_cod_usuario AS CHARACTER FORMAT "X(12)":U 
     LABEL "C¢digo Usuario" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     i_cod_usuario AT ROW 2.13 COL 18.43 COLON-ALIGNED WIDGET-ID 2
...
FIND esp_aprovador NO-LOCK
    WHERE esp_aprovador.cod_usuario EQ INPUT FRAME {&FRAME-NAME} i_cod_usuario NO-ERROR.

IF NOT AVAILABLE esp_aprovador THEN DO:
    {utp/ut-table.i mgesp esp_aprovador 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(esp_aprovador).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY i_cod_usuario 
      WITH FRAME d-vapara.
  ENABLE rt-button i_cod_usuario bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "REP001-G01" "1.00.00.000"}
