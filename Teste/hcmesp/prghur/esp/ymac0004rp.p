...
{include/i-prgvrs.i YMAC0004RP 1.02.00.003 } /*** 010003 ***/
/*******************************************************************************
**
...
/****************************************************************************************** 
** 	   Programa: ymac0004rp.p - copia do programa ymfr0003rp.p
**   	  Autor: Daniela Campos
** 	 Fornecedor: DKP
**         Data: 05/12/2018
** Change/Chamado: 
**      Objetivo: Gerar o arquivo de remessa de pagamento de folha no padr∆o Febraban 240 posiá‰es para Accesstage
...
{utp/ut-liter.i Liquido_Rescis∆o_Bradesco_VAN MFP C}
...
if tt-param.classifica = 1 or
   ...
   if avail rh_agenc_bcia and 
      ...
      put stream ger-liq 
          ...
          "089"                                                                         /* 164 a 166 - versao do layout - verificar se n∆o Ç 103 */   
                ...
                if d-valor-lanc > 0 then do:
                   if v_num_seq_lot = 0 then do:
                      ...
                      put stream ger-liq                                                                        
                          ...
                          v_tipo_pagto                                             format "99"                  /* Tipo do Serviáo - 30  */                                       
                          v_cdn_forma_pagto                                        format "99"                  /* Forma de Lanáamento - 12 a 13 */                               
                          ...
                          caps(fn-free-accent(rh_pessoa_jurid.nom_ender_rh))       format "x(30)"               /* 147 a 172 - endereáo */                                         
                          ...
                          "01"                                                     FORMAT "99"                                /* 223 a 224 - Indificativo da forma de pagto = numÇrico 01 */
                   ...
                   put stream ger-liq 
                       ...
                       "00".                                                            /* Instruá∆o de movimento 16 a 17 */    
                   ...
                   PUT STREAM ger-liq
                       ...
                       v_cod_dv                                             format "x"                   /* Dig CC 42 */                                                                                    
                       v_cod_dv_agconta                                     format "x"                   /* Dig ag conta 43 */                                                                                                      
                       ...
                       FILL('0',15)                                         FORMAT "X(15)"               /* 115 a 119 - 15 posiáoes qtd moeda */                                                            
                       c-valor-lanc                                         format "xxxxxxxxxxxxxxx"     /* 120 a 134 - 15 posiá‰es valor pagto */                                                          
                       FILL(' ',20)                                         format "x(20)"               /* NR documento atrib banco - 135 a 154 */                                                         
                       v_dat_lancto                                         format "99999999"            /* Dt. Real efetivaá∆o do pagto - 155 a 162 */                                                     
                       c-valor-lanc                                         format "xxxxxxxxxxxxxxx"     /* 163 a 177 - valor real efetivaá∆o pagto - 15 pos */                                             
                    ...
                    IF tt-param.LOG_gera_seg_b or
                       ...
                       put stream ger-liq
                           ...
                           caps(fn-free-accent(rh_pessoa_fisic.nom_ender_rh))  format "x(30)"                   /* endereáo 33 a 62 */                             
                           "00000"                                                                              /* nr endereáo */                                  
                           ...
                           c-valor-lanc                                             format "xxxxxxxxxxxxxxx"    /* 136 a 150 - 15 posi‰es valor pagto */           
