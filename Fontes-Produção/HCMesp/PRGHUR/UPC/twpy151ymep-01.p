...
{include/i-prgvrs.i TWPY267YMEP 12.1.13.001}
/*****************************************************************************************
***
**       Programa: prghur/upc/TWPY151YMEP-01.p
**
**       Data....: Maio 2017
**
**       Cliente.: YAMANA
...
FIND FIRST es_parametros 
     WHERE es_parametros.cod_prog_dtsul = "FR5040" AND 
           es_parametros.cod_referencia = "FUNCIONARIO-DESLIGADO"
     NO-LOCK NO-ERROR.
