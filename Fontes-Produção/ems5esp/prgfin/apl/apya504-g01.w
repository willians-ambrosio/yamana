...
*******************************************************************************/
{include/i-prgvrs.i APYA504-G01 12.1.17.000}
...
&Scoped-Define ENABLED-OBJECTS rt-button c_cod_produt_financ bt-ok ~
bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod_produt_financ 
...
DEFINE FRAME d-vapara
     c_cod_produt_financ AT ROW 1.67 COL 30 COLON-ALIGNED WIDGET-ID 2
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "V† Para Extens∆o Produto Financeiro"
...
ON GO OF FRAME d-vapara /* V† Para Extens∆o Produto Financeiro */
DO:
FIND es_produt_financ NO-LOCK
    WHERE es_produt_financ.cod_produt_financ EQ INPUT FRAME {&FRAME-NAME} c_cod_produt_financ NO-ERROR.

IF NOT AVAILABLE es_produt_financ THEN DO:
    {utp/ut-table.i ems5_esp es_produt_financ 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es_produt_financ).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V† Para Extens∆o Produto Financeiro */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod_produt_financ 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cod_produt_financ bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "APYA504-G01" "12.1.17.000"}
