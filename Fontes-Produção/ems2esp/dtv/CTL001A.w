...
/*------------------------------------------------------------------------
File.............: CTL001A.w
Description......: Implantacao de titulos por usuario
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 20/07/10 - 09:40 - 20100079
OBS..............: Este fonte foi gerado pelo Data Viewer
------------------------------------------------------------------------*/

def var c-prog-gerado as character no-undo initial "CTL001A".
...
define temp-table tt-param
    ...
    field c-origem-ini         like movto_tit_ap.ind_origin_tit_ap
    field c-origem-fim         like movto_tit_ap.ind_origin_tit_ap
...
DEFINE FRAME f-pg-sel
   ...
   da-dt-transacao-ini label "Dt Transa‡Æo"
     at row 2 col 17 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

   da-dt-transacao-fim no-label
     at row 2 col 40 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

   da-dt-emissao-ini label "Dt EmissÆo"
   ...
   c-origem-ini label "Origem"
     at row 4 col 17 colon-aligned
     view-as fill-in 
     size 3 by .88
     font 1

   c-origem-fim no-label
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Implantacao de titulos por usuario - CTL001A"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "CTL001A".
...
PROCEDURE enable_UI :
   ...
   da-dt-transacao-ini da-dt-transacao-fim
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "CTL001A" + "." + v-cod-extens-arq.
    ...
    assign tt-param.c-cod-estabel-ini = input frame f-pg-sel c-cod-estabel-ini
           ...
           tt-param.c-cod-estabel-fim = input frame f-pg-sel c-cod-estabel-fim
           tt-param.da-dt-transacao-ini = input frame f-pg-sel da-dt-transacao-ini
           tt-param.da-dt-transacao-fim = input frame f-pg-sel da-dt-transacao-fim
           ...
           tt-param.c-origem-ini = input frame f-pg-sel c-origem-ini
           tt-param.c-origem-fim = input frame f-pg-sel c-origem-fim
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "dtv/CTL0011.p".
