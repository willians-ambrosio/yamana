...
*******************************************************************************/
{include/i-prgvrs.i  2.00.00.003}
/*------------------------------------------------------------------------
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-conta-cosmos WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-conta-cosmos WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main es-conta-cosmos
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-conta-cosmos
...
<FOREIGN-KEYS>
ge-codigo||y|mgind.grup-estoque.ge-codigo
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "ge-codigo" "grup-estoque" "ge-codigo"}
