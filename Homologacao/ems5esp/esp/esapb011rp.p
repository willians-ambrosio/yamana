...
*                             ALTERAÄ«O
*******************************************************************************
* DATA ALTERAÄ«O: 03/07/2018
* AUTOR.........: WILLIANS M AMBROSIO - GRUPO DKP
* DESCRIÄ«O.....:  Regra para busca da conta contabil antecipada para atender a 
*...............   busca dos registros do esapb010 corretamente E INCLUS«O DA
...
/*                                movto_tit_ap.ind_trans_ap = "Estorno de Baixa" NO-LOCK NO-ERROR. */
                ...
                /* Quando n∆o localizar o lanáamento dever† ser verificado o cadastro esapb013 */
                IF AVAIL aprop_ctbl_ap                             AND 
                  (movto_tit_ap.ind_trans_ap = "Baixa"             OR 
                   movto_tit_ap.ind_trans_ap = "Estorno de Baixa") THEN
                DO:
                ...
                IF tt-param.tipo-clas = 2 THEN DO:
                    ...
                    FIND FIRST es-cat-code-conta NO-LOCK
                        /* Begins 03/07/2018 - Aplicada a regra de busca da conta localizada no recebimento e/ou apropriaá∆o contabil */
...
/*                             END.                                                                                         */
                ...
                /* Begins 03/07/2018 -  Ponto foi retirado desta linha e subiu antes da validaá∆o do cadastro esapb010 */
                /* busca conta do recebimento para transit¢ria */
/*                 RUN pi-verifica-conta-trans.                              */
/*                                                                           */
/*                 IF c-conta-contabil = "" THEN                             */
...
/*                 END.                                                                                                      */
                ...
                FOR EACH b-movto_tit_ap OF tit_ap WHERE
                         ...
                         b-movto_tit_ap.log_bxa_contra_antecip = NO
                    NO-LOCK. 
...
/*                                     VIEW-AS ALERT-BOX INFO BUTTONS OK.          */
                        ...
                        ASSIGN tt-titulos.cod-fornecedor        =   string(fornecedor.cdn_fornecedor) + "-" + fornecedor.nom_pessoa                         
                               ...
                               tt-titulos.val_pagto_tit_ap      =   IF ems5.espec_docto.ind_tip_espec_docto = "Antecipaá∆o" THEN tit_ap.val_origin_tit_ap ELSE tit_ap.val_pagto_tit_ap                                       
