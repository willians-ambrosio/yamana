...
&Scoped-define INTERNAL-TABLES es-param-tax

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-param-tax NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-param-tax NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-param-tax
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-param-tax
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems5_esp.es-param-tax"
     _Options          = "NO-LOCK"
