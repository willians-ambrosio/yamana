...
**         Objetivo: Selecionar um registro da tabela es_param_webserver (Parametro webserver)
**
...
******************************************************************************************/
{include/i-prgvrs.i VAN001-Z01 1.00.00.000}
...
DEFINE VARIABLE h_VAN001-B01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     ...
     bt-ajuda AT ROW 16.54 COL 52.29
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa de Parametro webserver"
         HEIGHT             = 17
         WIDTH              = 64
         MAX-HEIGHT         = 24.75
         MAX-WIDTH          = 195.14
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Parametro webserver */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Parametro webserver */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Identificador' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.17 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 13.67 , 62.43 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'VAN/VAN001-B01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_VAN001-B01 ).
       RUN set-position IN h_VAN001-B01 ( 3.75 , 3.72 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 58.00 ) */

       /* Links to SmartBrowser h_VAN001-B01. */
       RUN add-link IN adm-broker-hdl ( h_VAN001-B01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_VAN001-B01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
