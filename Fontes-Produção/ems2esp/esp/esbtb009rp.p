/*****************************************************************************
**       Programa: esbtb009rp.p
**       Data....: 22/02/11
**       Autor...: Daniel Pereira de Lima
**       Objetivo: Exporta Cad. Grupo Fornec
**       Vers∆o..: 1.00.000
*******************************************************************************/

define variable c-prog-gerado as character no-undo initial "ESBTB009RP".
...
assign c-programa     = "ESBTB009RP"
       c-versao       = "2.06"
       c-revisao      = ".00.000"
       c-titulo-relat = "Exporta Cad. Grupo Fornec"
       c-sistema      = "".
...
/* gr9020a.p */
    ...
    FIND FIRST es_grupofornec NO-LOCK NO-ERROR. 
    IF AVAIL es_grupofornec  THEN  DO:  
            
        RUN esp/esidelete.i 'es_grupofornec'.
        RUN pi-executa.
...
PROCEDURE pi-executa.
    ...
    FOR EACH grupo-fornec USE-INDEX codigo NO-LOCK:
        CREATE es_grupofornec NO-ERROR.
        ASSIGN  es_grupofornec.cod_gr_forn                            = grupo-fornec.cod-gr-forn                         
                es_grupofornec.descricao                              = grupo-fornec.descricao.
...
if  tt-param.parametro then do:
   ...
   disp stream str-rp "   Exporta Cad. Grupo Fornec"
