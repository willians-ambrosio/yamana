...
*******************************************************************************/
{include/i-prgvrs.i APYA501D 12.1.17.000}  /*** 010007 ***/


&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i APYA501d APL}
&ENDIF
...
DEFINE VARIABLE h_apya501d-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_apya501d-v01 AS HANDLE NO-UNDO.
...
DO:
{include/okfil.i h_apya501d-v01}
END.
...
DO:
{include/salvafil.i h_apya501d-v01}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apl/apya501d-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_apya501d-v01 ).
       RUN set-position IN h_apya501d-v01 ( 1.21 , 1.86 ) NO-ERROR.
       /* Size in UIB:  ( 4.00 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apl/apya501d-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_apya501d-q01 ).
       RUN set-position IN h_apya501d-q01 ( 5.00 , 47.86 ) NO-ERROR.
       /* Size in UIB:  ( 1.79 , 8.29 ) */

       /* Links to SmartViewer h_apya501d-v01. */
       RUN add-link IN adm-broker-hdl ( h_apya501d-q01 , 'Record':U , h_apya501d-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_apya501d-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_apya501d-v01 ,
...
{utp/ut9000.i "APYA501d" "12.1.17.000"}
  
  run pi-atualiza-parent in h_apya501d-v01 (input v-row-parent). 
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_apya501d-q01 (input v-row-table).
...
-------------------------------------------------------------*/
  RUN prgfin/apl/apya501d-q01.w.
  RUN prgfin/apl/apya501d-v01.w.
