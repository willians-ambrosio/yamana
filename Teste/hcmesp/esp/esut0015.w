...
*******************************************************************************/
{include/i-prgvrs.i ESUT0015 2.06.00.000}  /*** 010011 ***/
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Atualizaá∆o de Niveis Hierarquicos"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF C-Win /* Atualizaá∆o de Niveis Hierarquicos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Atualizaá∆o de Niveis Hierarquicos */
DO:
...
{utp/ut9000.i "ESUT0015" "2.06.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {include/i-imvrf.i &programa=ESUT0015 &versao-layout=001}
    ...
    if  c-nom-prog-appc-mg97 <> "" then do:
        ...
        IF l-TMS-401 THEN DO:
            {include/i-imvrf.i &programa=ESUT0015 &versao-layout=002}
        END.
        ELSE IF l-TMS-402 THEN DO:
            {include/i-imvrf.i &programa=ESUT0015 &versao-layout=003}
        END.
...
do  on error undo, return error
    ...
    {include/i-imrun.i esp/esut0015rp.p}
