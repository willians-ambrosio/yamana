...
{include/i-prgvrs.i YMCA0001 1.02.00.000}
...
DEFINE VARIABLE v_dat_liber_sal AS DATE FORMAT "99/99/9999" INITIAL 08/12/08 
     LABEL "Data Libera Salarial":R24 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE v_cdn_estab_ini AS CHARACTER FORMAT "x(5)" INITIAL "" 
     LABEL "Estabelecimento":R18 
     VIEW-AS FILL-IN 
     SIZE 4.57 BY .88 NO-UNDO.

DEFINE VARIABLE v_cod_rh_ccusto_fim AS CHARACTER FORMAT "x(08)" INITIAL "ZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 12.14 BY .88 NO-UNDO.

DEFINE VARIABLE v_cod_rh_ccusto_ini AS CHARACTER FORMAT "x(08)" 
...
DEFINE FRAME f-pg-log
     rs-todos AT ROW 2.79 COL 19.29 NO-LABEL
     rs-destino AT ROW 5.04 COL 19.29 HELP
          "Destino de Impress∆o do Relat¢rio" NO-LABEL
     bt-arquivo-destino AT ROW 6.25 COL 59.29 HELP
          "Escolha do nome do arquivo"
     bt-config-impr-destino AT ROW 6.25 COL 59.29 HELP
          "Configuraá∆o da impressora"
     c-arquivo-destino AT ROW 6.29 COL 19.29 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     rs-execucao AT ROW 8.42 COL 19.14 HELP
          "Modo de Execuá∆o" NO-LABEL
     text-destino-2 AT ROW 2 COL 20 NO-LABEL
     text-destino AT ROW 4.29 COL 19.86 NO-LABEL
     text-modo AT ROW 7.67 COL 17.14 COLON-ALIGNED NO-LABEL
     RECT-9 AT ROW 7.96 COL 18
     RECT-11 AT ROW 2.29 COL 18
     RECT-7 AT ROW 4.58 COL 18
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 76.29 BY 10.46.
...
DEFINE FRAME f-pg-par
     c-arquivo-entrada AT ROW 4.79 COL 21.29 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     bt-arquivo-entrada AT ROW 4.79 COL 61.14 HELP
          "Escolha do nome do arquivo"
     v_dat_liber_sal AT ROW 7.04 COL 41.72 COLON-ALIGNED HELP
          "Data Liber Salarial"
     text-entrada AT ROW 3.75 COL 22.14 NO-LABEL
     RECT-8 AT ROW 4.08 COL 20
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.88
         SIZE 77.43 BY 10.83.
...
DEFINE FRAME f-pg-sel
     v_cdn_empresa_ini AT ROW 3.75 COL 23 COLON-ALIGNED HELP
          "C¢digo Empresa"
     v_cdn_empresa_fim AT ROW 3.75 COL 45.72 COLON-ALIGNED HELP
          "C¢digo Empresa" NO-LABEL
     v_cdn_estab_ini AT ROW 4.75 COL 23 COLON-ALIGNED HELP
          "C¢digo N£mero Estabelecimento"
     v_cdn_estab_fim AT ROW 4.75 COL 46 COLON-ALIGNED HELP
          "C¢digo N£mero Estabelecimento" NO-LABEL
     v_cod_rh_ccusto_ini AT ROW 5.75 COL 23 COLON-ALIGNED HELP
          "C¢digo do centro de custo"
     v_cod_rh_ccusto_fim AT ROW 5.75 COL 46 COLON-ALIGNED HELP
          "C¢digo do centro de custo" NO-LABEL
     IMAGE-1 AT ROW 3.75 COL 38
     IMAGE-2 AT ROW 3.75 COL 44.14
     IMAGE-3 AT ROW 4.75 COL 38
     IMAGE-4 AT ROW 4.75 COL 44.14
     IMAGE-5 AT ROW 5.75 COL 38
     IMAGE-6 AT ROW 5.75 COL 44.14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62.
...
{utp/ut9000.i "YMCA0001" "1.02.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {include/i-imvrf.i &programa=YMCA0001 &versao-layout=001}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY v_cdn_empresa_ini v_cdn_empresa_fim v_cdn_estab_ini v_cdn_estab_fim 
          v_cod_rh_ccusto_ini v_cod_rh_ccusto_fim 
      WITH FRAME f-pg-sel IN WINDOW C-Win.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 v_cdn_empresa_ini 
         v_cdn_empresa_fim v_cdn_estab_ini v_cdn_estab_fim v_cod_rh_ccusto_ini 
         v_cod_rh_ccusto_fim 
      WITH FRAME f-pg-sel IN WINDOW C-Win.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-sel}
  DISPLAY c-arquivo-entrada v_dat_liber_sal 
      WITH FRAME f-pg-par IN WINDOW C-Win.
  ENABLE RECT-8 c-arquivo-entrada bt-arquivo-entrada v_dat_liber_sal 
      WITH FRAME f-pg-par IN WINDOW C-Win.
...
do  on error undo, return error
    ...
    assign tt-param.usuario           = c-seg-usuario
           ...
           tt-param.dat_liber_sal     = input frame f-pg-par v_dat_liber_sal.

    if  tt-param.destino = 1 then
        assign tt-param.arquivo = "".
    else
    if  tt-param.destino = 2 then 
        assign tt-param.arquivo = input frame f-pg-log c-arquivo-destino.
    else
        assign tt-param.arquivo = session:temp-directory + c-programa-mg97 + ".tmp":U.

    assign tt-param.arq-destino = tt-param.arquivo.
    ...
    {include/i-imrun.i prghur/esp/ymca0001rp.p}

    {include/i-imexc.i}

    if  session:set-wait-state("") then.
    
    {include/i-imtrm.i tt-param.arquivo tt-param.destino}
