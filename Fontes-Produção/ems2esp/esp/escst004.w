...
ON END-ERROR OF C-Win /* Altera CST item fixo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Altera CST item fixo */
DO:
...
DO:
    ...
    /*ASSIGN c-arq = "C:\temp\cst-dif.txt".
    UPDATE c-arq.*/
    ...
    FOR EACH nota-fiscal NO-LOCK
        ...
        FOR EACH it-nota-fisc OF nota-fiscal EXCLUSIVE-LOCK:
            IF it-nota-fisc.it-codigo = '97120035' THEN NEXT.
