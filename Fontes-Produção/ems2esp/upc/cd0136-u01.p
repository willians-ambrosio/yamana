...
/*************************************************************************************
                                      INCLUDES   
*************************************************************************************/
{include/i-prgvrs.i  cd0136-u01.P 2.06.00.000}
...
DEFINE NEW GLOBAL SHARED VARIABLE wh-cd0136-res-for-comp     AS WIDGET-HANDLE NO-UNDO.
DEFINE NEW GLOBAL SHARED VARIABLE i-res-for-comp-ant         AS INTEGER       NO-UNDO.
DEFINE NEW GLOBAL SHARED VARIABLE wh-cd0136-deposito-pad     AS WIDGET-HANDLE NO-UNDO.
DEFINE NEW GLOBAL SHARED VARIABLE i-deposito-pad-ant         AS CHARACTER     NO-UNDO.
DEFINE NEW GLOBAL SHARED VARIABLE wh-cd0136-cod-localiz      AS WIDGET-HANDLE NO-UNDO.
DEFINE NEW GLOBAL SHARED VARIABLE i-cod-localiz-ant          AS CHARACTER     NO-UNDO.
DEFINE NEW GLOBAL SHARED VARIABLE wh-cd0136-res-int-comp     AS WIDGET-HANDLE NO-UNDO.
DEFINE NEW GLOBAL SHARED VARIABLE i-res-int-comp-ant         AS INTEGER       NO-UNDO.
DEFINE NEW GLOBAL SHARED VARIABLE wh-cd0136-cod-unid-negoc   AS WIDGET-HANDLE NO-UNDO.
DEFINE NEW GLOBAL SHARED VARIABLE i-cod-unid-negoc-ant       AS CHARACTER     NO-UNDO.
DEFINE NEW GLOBAL SHARED VARIABLE wh-cd0136-prioridade-aprov AS WIDGET-HANDLE NO-UNDO.
...
DEFINE BUFFER b-fam-uni-estab FOR fam-uni-estab.
...
IF NOT VALID-HANDLE(wh-cd0136-res-for-comp)  THEN 
DO:
   ASSIGN c-handle-obj = fc-handle-obj("res-for-comp",p-wgh-frame).
   ASSIGN wh-cd0136-res-for-comp = WIDGET-HANDLE(ENTRY(1,c-handle-obj))
          i-res-for-comp-ant     = 0.
END.

IF NOT VALID-HANDLE(wh-cd0136-deposito-pad)  THEN 
DO:
   ASSIGN c-handle-obj = fc-handle-obj("deposito-pad",p-wgh-frame).
   ASSIGN wh-cd0136-deposito-pad = WIDGET-HANDLE(ENTRY(1,c-handle-obj))
          i-deposito-pad-ant     = ''.
END.

IF NOT VALID-HANDLE(wh-cd0136-cod-localiz)  THEN 
DO:
   ASSIGN c-handle-obj = fc-handle-obj("cod-localiz",p-wgh-frame).
   ASSIGN wh-cd0136-cod-localiz = WIDGET-HANDLE(ENTRY(1,c-handle-obj))
          i-cod-localiz-ant     = ''.
END.

IF NOT VALID-HANDLE(wh-cd0136-res-int-comp)  THEN 
DO:
   ASSIGN c-handle-obj = fc-handle-obj("res-int-comp",p-wgh-frame).
   ASSIGN wh-cd0136-res-int-comp = WIDGET-HANDLE(ENTRY(1,c-handle-obj))
          i-res-int-comp-ant     = 0.
END.

IF NOT VALID-HANDLE(wh-cd0136-cod-unid-negoc)  THEN 
DO:
   ASSIGN c-handle-obj = fc-handle-obj("c-cod-unid-negoc",p-wgh-frame).
   ASSIGN wh-cd0136-cod-unid-negoc = WIDGET-HANDLE(ENTRY(1,c-handle-obj))
          i-cod-unid-negoc-ant     = ''.
END.

IF NOT VALID-HANDLE(wh-cd0136-prioridade-aprov)  THEN 
DO:
   ASSIGN c-handle-obj = fc-handle-obj("cb-prioridade-aprova",p-wgh-frame).
   ASSIGN wh-cd0136-prioridade-aprov = WIDGET-HANDLE(ENTRY(1,c-handle-obj))
...
DO:
    FIND b-fam-uni-estab NO-LOCK WHERE
         ROWID(b-fam-uni-estab) = p-row-table NO-ERROR.
    IF AVAIL b-fam-uni-estab THEN
       ASSIGN i-res-for-comp-ant = b-fam-uni-estab.res-for-comp
              i-deposito-pad-ant   = b-fam-uni-estab.deposito-pad
              i-cod-localiz-ant    = b-fam-uni-estab.cod-localiz
              i-res-int-comp-ant   = b-fam-uni-estab.res-int-comp
              i-cod-unid-negoc-ant   = b-fam-uni-estab.cod-unid-negoc
              i-prioridade-aprov-ant = b-fam-uni-estab.prioridade-aprov.
...
DO:
    FIND b-fam-uni-estab NO-LOCK WHERE
         ROWID(b-fam-uni-estab) = p-row-table NO-ERROR.
    IF AVAIL b-fam-uni-estab THEN DO:
        
        IF b-fam-uni-estab.res-for-comp <> i-res-for-comp-ant THEN DO:
            ...
            ASSIGN ext-audit-item-fam.it-codigo = ""
                   ...
                   ext-audit-item-fam.fm-codigo = b-fam-uni-estab.fm-codigo
                   ext-audit-item-fam.programa  = "cd0136"
                   ext-audit-item-fam.usuario   = c-seg-usuario
                   ext-audit-item-fam.valor-ant = STRING(i-res-for-comp-ant)
                   ext-audit-item-fam.valor-atu = STRING(b-fam-uni-estab.res-for-comp).

        END.

        IF b-fam-uni-estab.deposito-pad <> i-deposito-pad-ant THEN DO:
            ...
            ASSIGN ext-audit-item-fam.it-codigo = ""
                   ...
                   ext-audit-item-fam.valor-atu = STRING(b-fam-uni-estab.deposito-pad).

        END.

        IF b-fam-uni-estab.cod-localiz <> i-cod-localiz-ant THEN DO:
            ...
            ASSIGN ext-audit-item-fam.it-codigo = ""
                   ...
                   ext-audit-item-fam.valor-atu = STRING(b-fam-uni-estab.cod-localiz).

        END.

        IF b-fam-uni-estab.res-int-comp <> i-res-int-comp-ant THEN DO:
            ...
            ASSIGN ext-audit-item-fam.it-codigo = ""
                   ...
                   ext-audit-item-fam.valor-atu = STRING(b-fam-uni-estab.res-int-comp).

        END.

        IF b-fam-uni-estab.cod-unid-negoc <> i-cod-unid-negoc-ant THEN DO:
            ...
            ASSIGN ext-audit-item-fam.it-codigo = ""
                   ...
                   ext-audit-item-fam.valor-atu = STRING(b-fam-uni-estab.cod-unid-negoc).

        END.

        IF b-fam-uni-estab.prioridade-aprov <> i-prioridade-aprov-ant THEN DO:
            ...
            CASE b-fam-uni-estab.prioridade-aprov:
