...
*******************************************************************************/
{include/i-prgvrs.i ESUT0009 12.1.13.000}  /*** 010009 ***/

&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
{include/i-license-manager.i ESUT0009 HCM}
&ENDIF
...
DEFINE VARIABLE text-entrada-2 AS CHARACTER FORMAT "X(256)":U INITIAL "Registros exixtentes" 
      VIEW-AS TEXT 
...
DEFINE VARIABLE tg-sobrepoe AS LOGICAL INITIAL no 
     LABEL "Regravar Unidade" 
     VIEW-AS TOGGLE-BOX
     SIZE 33 BY .83 TOOLTIP "Em caso de Unidade j† existente o registro ser† regravado" NO-UNDO.
...
DEFINE FRAME f-pg-par
     ...
     bt-arquivo-entrada AT ROW 3.25 COL 43.86 HELP
          "Escolha do nome do arquivo"
     tg-sobrepoe AT ROW 5.75 COL 4 WIDGET-ID 6
...
{utp/ut9000.i "ESUT0009" "12.1.13.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {include/i-imvrf.i &programa=ESUT0009 &versao-layout=001}
    ...
    if  c-nom-prog-appc-mg97 <> "" then do:
        ...
        IF l-TMS-401 THEN DO:
            {include/i-imvrf.i &programa=ESUT0009 &versao-layout=002}
        END.
        ELSE IF l-TMS-402 THEN DO:
            {include/i-imvrf.i &programa=ESUT0009 &versao-layout=003}
        END.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-arquivo-entrada tg-sobrepoe 
      WITH FRAME f-pg-par IN WINDOW C-Win.
  ENABLE RECT-8 RECT-10 c-arquivo-entrada bt-arquivo-entrada tg-sobrepoe 
      WITH FRAME f-pg-par IN WINDOW C-Win.
...
do  on error undo, return error
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.l-sobrepoe      = INPUT FRAME f-pg-par tg-sobrepoe.
    ...
    {include/i-imrun.i esp/esut0009rp.p}
