...
define variable c-prog-gerado as character no-undo initial "RELT06".
...
def var c-titulo           as char init "SEGURADORA - ENVIOS NO MÒS - COM ESTABEL" no-undo.        
def var v-cod-prog-gerado  as char init "RELT06" no-undo.           
...
assign v-cod-prog-gerado = "RELT06".
