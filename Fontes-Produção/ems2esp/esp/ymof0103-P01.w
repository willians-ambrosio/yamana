...
DEFINE VARIABLE h_ymof0103-bz01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-ajuda AT ROW 13.63 COL 63
     bt-ok AT ROW 13.67 COL 3
     bt-cancela AT ROW 13.67 COL 14
     rt-button AT ROW 13.42 COL 2
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Codigo' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.17 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 12.08 , 73.43 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             bt-ajuda:HANDLE IN FRAME f-zoom , 'BEFORE':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymof0103-bz01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ymof0103-bz01 ).
       RUN set-position IN h_ymof0103-bz01 ( 2.50 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 71.00 ) */

       /* Links to SmartBrowser h_ymof0103-bz01. */
       RUN add-link IN adm-broker-hdl ( h_ymof0103-bz01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymof0103-bz01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
