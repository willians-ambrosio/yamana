...
{include/i-prgvrs.i YMRE0101-Q01 11.5.11.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i YMRE0101-Q01 MUT}
&ENDIF
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH empresa ~
      WHERE empresa.ep-codigo = i-ep-codigo-usuario NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH empresa ~
      WHERE empresa.ep-codigo = i-ep-codigo-usuario NO-LOCK INDEXED-REPOSITION.
...
<FOREIGN-KEYS>
ep-codigo||y|ems2cadme.empresa.ep-codigo
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems2cadme.empresa"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _Where[1]         = "ems2cadme.empresa.ep-codigo = i-ep-codigo-usuario"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "ep-codigo" "empresa" "ep-codigo"}
