...
**       Data....: 17/01/12
**       Autor...: DATASUL S.A.
**       Objetivo: Modifica IP
**       Vers∆o..: 1.00.000 - adm
**       OBS.....: Este fonte foi gerado pelo Data Viewer 3.00
*******************************************************************************/

define variable c-prog-gerado as character no-undo initial "MOD01I16".
...
def new shared var ip_new as character format "x(15)" label "Novo-IP".
...
form param-global.grupo column-label "Grupo Empresarial" format "x(40)" at 001
     param-global.serv-mail column-label "Servidor de E-Mail" format "x(40)" at 042
...
assign c-programa     = "MOD01I16"
       c-versao       = "2.00"
       c-revisao      = ".00.000"
       c-titulo-relat = "Modifica IP"
       c-sistema      = "".
...
for each param-global:

    ASSIGN param-global.serv-mail = ip_new. /* Modifica endereáo IP */
    ...
    if  tt-param.formato = 2 then do:
        ...
        display stream str-rp param-global.grupo
            param-global.serv-mail
...
if  tt-param.parametro then do:
   ...
   form
     ip_new colon 9 label "Novo-IP" format "x(15)"
   ...
   disp stream str-rp "   Modifica IP"
