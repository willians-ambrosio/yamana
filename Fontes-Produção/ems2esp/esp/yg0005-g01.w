...
*******************************************************************************/
{include/i-prgvrs.i YG0005-G01 12.1.13.000}
...
&Scoped-Define ENABLED-OBJECTS rt-button i_cod-emitente c_cod-estabel ~
i_qt-garantia bt-ok bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS i_cod-emitente c_cod-estabel i_qt-garantia 
...
DEFINE VARIABLE i_qt-garantia AS INTEGER FORMAT ">>>>>>9":U 
     LABEL "Garantia" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     ...
     c_cod-estabel AT ROW 2 COL 30 COLON-ALIGNED WIDGET-ID 4
     i_qt-garantia AT ROW 3 COL 30 COLON-ALIGNED WIDGET-ID 6
...
ON GO OF FRAME d-vapara /* V  Para Garantia */
DO:
FIND es-garantia NO-LOCK
    WHERE es-garantia.cod-emitente EQ INPUT FRAME {&FRAME-NAME} i_cod-emitente
      AND es-garantia.cod-estabel EQ INPUT FRAME {&FRAME-NAME} c_cod-estabel
      AND es-garantia.qt-garantia EQ INPUT FRAME {&FRAME-NAME} i_qt-garantia NO-ERROR.

IF NOT AVAILABLE es-garantia THEN DO:
    ...
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-garantia).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Garantia */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY i_cod-emitente c_cod-estabel i_qt-garantia 
      WITH FRAME d-vapara.
  ENABLE rt-button i_cod-emitente c_cod-estabel i_qt-garantia bt-ok bt-cancela 
         bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "YG0005-G01" "12.1.13.000"}
