...
&Scoped-define INTERNAL-TABLES es_categ_ptoelet_sit sit_afast
...
es_categ_ptoelet_sit.cdn_sit_afast_func sit_afast.des_sit_afast_func 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table 
&Scoped-define QUERY-STRING-br-table FOR EACH es_categ_ptoelet_sit OF es_categ_ptoelet WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH sit_afast OF es_categ_ptoelet_sit NO-LOCK
&Scoped-define OPEN-QUERY-br-table OPEN QUERY br-table FOR EACH es_categ_ptoelet_sit OF es_categ_ptoelet WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH sit_afast OF es_categ_ptoelet_sit NO-LOCK.
&Scoped-define TABLES-IN-QUERY-br-table es_categ_ptoelet_sit sit_afast
&Scoped-define FIRST-TABLE-IN-QUERY-br-table es_categ_ptoelet_sit
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      es_categ_ptoelet_sit.cdn_sit_afast_func FORMAT "zzzz9":U
...
DEFINE FRAME F-Main
     ...
     bt-modificar2 AT ROW 7.5 COL 11
...
/* SETTINGS FOR BUTTON bt-modificar2 IN FRAME F-Main
   NO-ENABLE                                                            */
...
/* Query rebuild information for BROWSE br-table
     _TblList          = "hresp.es_categ_ptoelet_sit OF hresp.es_categ_ptoelet,hcm.sit_afast OF hresp.es_categ_ptoelet_sit"
     _Options          = "NO-LOCK KEY-PHRASE"
     _FldNameList[1]   = hresp.es_categ_ptoelet_sit.cdn_sit_afast_func
