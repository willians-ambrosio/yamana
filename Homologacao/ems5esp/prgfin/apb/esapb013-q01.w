...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-cat-code-cta-ex NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-cat-code-cta-ex NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-cat-code-cta-ex
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-cat-code-cta-ex
