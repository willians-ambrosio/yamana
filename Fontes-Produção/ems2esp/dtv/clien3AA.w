...
define variable c-prog-gerado as character no-undo initial "CLIEN3AA".
...
DEFINE FRAME f-pg-sel
   ...
   i-cod-gr-cli-ini label "Grupo"
     at row 2 col 22 colon-aligned
     view-as fill-in 
     size 3 by .88
     font 1

   i-cod-gr-cli-fim no-label
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Listagem de Clientes - clien3AA"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "clien3AA".
...
PROCEDURE enable_UI :
   ...
   i-cod-gr-cli-ini i-cod-gr-cli-fim
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "clien3AA" + "." + v-cod-extens-arq.
    ...
    assign tt-param.i-cod-emitente-ini = input frame f-pg-sel i-cod-emitente-ini
           ...
           tt-param.i-cod-emitente-fim = input frame f-pg-sel i-cod-emitente-fim
           tt-param.i-cod-gr-cli-ini = input frame f-pg-sel i-cod-gr-cli-ini
           tt-param.i-cod-gr-cli-fim = input frame f-pg-sel i-cod-gr-cli-fim
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "dtv/clien327.p".
