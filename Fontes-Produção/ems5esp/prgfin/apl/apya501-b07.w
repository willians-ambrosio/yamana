...
&Scoped-define FIELDS-IN-QUERY-br-table es_operac_financ.cod_operac_financ ~
operac_financ.val_operac_financ 
...
&Scoped-define QUERY-STRING-br-table FOR EACH es_operac_financ WHERE es_operac_financ.cod_contrat_apf = contrat_apf.cod_contrat_apf ~
      AND es_operac_financ.log_atualizado = TRUE NO-LOCK, ~
...
/* Query rebuild information for BROWSE br-table
     ...
     _Where[1]         = "mgesp.es_operac_financ.log_atualizado = TRUE"
     _FldNameList[1]   = mgesp.es_operac_financ.cod_operac_financ
     _FldNameList[2]   = ems5.operac_financ.val_operac_financ
