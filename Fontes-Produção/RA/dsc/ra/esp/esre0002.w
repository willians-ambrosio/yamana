...
**
******************************************************************************/
{include/i-prgvrs.i ESRE0002 12.1.00.000}
...
DEFINE VARIABLE dt-trans-fim AS DATE FORMAT "99/99/9999" INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.
...
DEFINE VARIABLE nro-docto-ini AS CHARACTER FORMAT "X(16)":U 
     LABEL "Documento" 
     VIEW-AS FILL-IN 
     SIZE 17 BY .88 NO-UNDO.

DEFINE VARIABLE usuario-fim AS CHARACTER FORMAT "X(12)":U INITIAL "ZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 13 BY .88 NO-UNDO.

DEFINE VARIABLE usuario-ini AS CHARACTER FORMAT "X(12)":U 
     LABEL "Usu†rio" 
     VIEW-AS FILL-IN 
     SIZE 13 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     cod-estabel-ini AT ROW 2.25 COL 17 COLON-ALIGNED WIDGET-ID 64
     cod-estabel-fim AT ROW 2.25 COL 43 COLON-ALIGNED NO-LABEL WIDGET-ID 90
     cod-emitente-ini AT ROW 3.25 COL 17 COLON-ALIGNED WIDGET-ID 50
     cod-emitente-fim AT ROW 3.25 COL 43 COLON-ALIGNED NO-LABEL WIDGET-ID 58
     dt-trans-ini AT ROW 4.25 COL 17 COLON-ALIGNED WIDGET-ID 72
     dt-trans-fim AT ROW 4.25 COL 43 COLON-ALIGNED NO-LABEL WIDGET-ID 66
     nro-docto-ini AT ROW 5.25 COL 17 COLON-ALIGNED WIDGET-ID 68
     nro-docto-fim AT ROW 5.25 COL 43 COLON-ALIGNED NO-LABEL WIDGET-ID 62
     usuario-ini AT ROW 6.25 COL 17 COLON-ALIGNED WIDGET-ID 76
     usuario-fim AT ROW 6.25 COL 43 COLON-ALIGNED NO-LABEL WIDGET-ID 92
     dt-emissao-ini AT ROW 7.25 COL 17 COLON-ALIGNED WIDGET-ID 84
     dt-emissao-fim AT ROW 7.25 COL 43 COLON-ALIGNED NO-LABEL WIDGET-ID 82
     ...
     IMAGE-13 AT ROW 6.25 COL 36.57 WIDGET-ID 80
     IMAGE-14 AT ROW 6.25 COL 41.57 WIDGET-ID 78
     IMAGE-15 AT ROW 7.25 COL 36.57 WIDGET-ID 88
     IMAGE-16 AT ROW 7.25 COL 41.57 WIDGET-ID 86
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.83
         SIZE 73.29 BY 10.63
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Relat¢rio Notas Pendentes"
         HEIGHT             = 14.92
         WIDTH              = 81.57
         MAX-HEIGHT         = 30.13
         MAX-WIDTH          = 182.86
...
ON END-ERROR OF C-Win /* Relat¢rio Notas Pendentes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Relat¢rio Notas Pendentes */
DO:
...
ON LEAVE OF dt-emissao-fim IN FRAME f-pg-sel
DO:
/*   {cdp\cd9998.i}  */
END.
...
&Scoped-define SELF-NAME dt-trans-fim
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL dt-trans-fim C-Win
ON LEAVE OF dt-trans-fim IN FRAME f-pg-sel /* Data Transaá∆o */
DO:
/*   {cdp\cd9998.i}  */
END.
...
{utp/ut9000.i "ESRE0002" "12.1.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY cod-estabel-ini cod-estabel-fim cod-emitente-ini cod-emitente-fim 
          dt-trans-ini dt-trans-fim nro-docto-ini nro-docto-fim usuario-ini 
          usuario-fim dt-emissao-ini dt-emissao-fim 
      WITH FRAME f-pg-sel IN WINDOW C-Win.
  ENABLE IMAGE-9 IMAGE-10 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         IMAGE-13 IMAGE-14 IMAGE-15 IMAGE-16 cod-estabel-ini cod-estabel-fim 
         cod-emitente-ini cod-emitente-fim dt-trans-ini dt-trans-fim 
         nro-docto-ini nro-docto-fim usuario-ini usuario-fim dt-emissao-ini 
         dt-emissao-fim 
      WITH FRAME f-pg-sel IN WINDOW C-Win.
...
do on error undo, return error
   ...
   ASSIGN tt-param.cod-estabel-ini   = input frame f-pg-sel cod-estabel-ini 
          ...
          tt-param.nro-docto-ini     = input frame f-pg-sel nro-docto-ini   
          tt-param.nro-docto-fim     = input frame f-pg-sel nro-docto-fim   
          tt-param.usuario-ini       = input frame f-pg-sel usuario-ini     
          tt-param.usuario-fim       = input frame f-pg-sel usuario-fim     
   ...
   {include/i-rprun.i esp/esre0002rp.p}
