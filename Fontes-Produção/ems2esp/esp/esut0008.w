...
*******************************************************************************/
{include/i-prgvrs.i ESUT0008 2.06.00.000}
...
DEFINE VARIABLE data-pedido-fim AS DATE FORMAT "99/99/9999" INITIAL 12/31/2999 
     VIEW-AS FILL-IN 
     SIZE 12.57 BY .88.
...
DEFINE FRAME f-pg-sel
     num-pedido-ini AT ROW 2.25 COL 13 COLON-ALIGNED HELP
          "N£mero do Pedido" WIDGET-ID 8
     num-pedido-fim AT ROW 2.25 COL 50 COLON-ALIGNED HELP
          "N£mero do Pedido" NO-LABEL WIDGET-ID 34
     cod-emitente-ini AT ROW 3.25 COL 13 COLON-ALIGNED WIDGET-ID 46
     cod-emitente-fim AT ROW 3.25 COL 50 COLON-ALIGNED NO-LABEL WIDGET-ID 50
     data-pedido-ini AT ROW 4.25 COL 13.14 COLON-ALIGNED WIDGET-ID 48
     data-pedido-fim AT ROW 4.25 COL 50 COLON-ALIGNED NO-LABEL WIDGET-ID 52
     cod-usuario-ini AT ROW 5.25 COL 13 COLON-ALIGNED WIDGET-ID 2
     cod-usuario-fim AT ROW 5.25 COL 50 COLON-ALIGNED NO-LABEL WIDGET-ID 28
     data-ini AT ROW 6.25 COL 13 COLON-ALIGNED WIDGET-ID 4
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Relat¢rio LOG de Elimina‡Æo de Pedidos de Compra"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Relat¢rio LOG de Elimina‡Æo de Pedidos de Compra */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Relat¢rio LOG de Elimina‡Æo de Pedidos de Compra */
DO:
...
{utp/ut9000.i "ESUT0008" "2.06.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY num-pedido-ini num-pedido-fim cod-emitente-ini cod-emitente-fim 
          data-pedido-ini data-pedido-fim cod-usuario-ini cod-usuario-fim 
          data-ini data-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 IMAGE-9 IMAGE-10 
         IMAGE-11 IMAGE-12 num-pedido-ini num-pedido-fim cod-emitente-ini 
         cod-emitente-fim data-pedido-ini data-pedido-fim cod-usuario-ini 
         cod-usuario-fim data-ini data-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    IF INPUT FRAME f-pg-sel cod-emitente-ini > INPUT FRAME f-pg-sel cod-emitente-fim THEN DO:
       APPLY "MOUSE-SELECT-CLICK":U to im-pg-sel in frame f-relat.
       RUN utp/ut-msgs.p (INPUT "show":U, INPUT 142, input "Fornecedor~~Fornecedor").
       APPLY "ENTRY":U TO cod-emitente-ini IN FRAME f-pg-sel.
       return error.
    END.


    IF INPUT FRAME f-pg-sel data-pedido-ini > INPUT FRAME f-pg-sel data-pedido-fim THEN DO:
       APPLY "MOUSE-SELECT-CLICK":U to im-pg-sel in frame f-relat.
       RUN utp/ut-msgs.p (INPUT "show":U, INPUT 142, input "Data Pedido~~Data Pedido").
       APPLY "ENTRY":U TO data-pedido-ini IN FRAME f-pg-sel.
       return error.
    END.
    ...
    ASSIGN tt-param.num-pedido-ini    = input frame f-pg-sel num-pedido-ini   
    ...
    {include/i-rprun.i esp/esut0008rp.p}
