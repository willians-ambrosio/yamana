...
/*------------------------------------------------------------------------
File.............: esbtb015.w
Description......: Sincroniza Login do AD
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
...
define variable c-prog-gerado as character no-undo initial "esbtb015".
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Extra‡Æo Cadastro de Funcionario - esbtb015"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "esbtb015".
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "esbtb015" + "." + v-cod-extens-arq.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "esp\esbtb015rp.p".
