...
define variable c-prog-gerado as character no-undo initial "MOD01I".
...
def var c-titulo           as char init "Modifica IP" no-undo.        
def var v-cod-prog-gerado  as char init "MOD01I" no-undo.           
...
assign v-cod-prog-gerado = "MOD01I".
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK 
   ON END-KEY UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK:
        ...
        assign c-lista = "Modifica IP".

        assign c-prog = "MOD01IP.w".
