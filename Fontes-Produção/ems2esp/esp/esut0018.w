...
*******************************************************************************/
{include/i-prgvrs.i ESUT0018 2.06.00.000}
...
DEFINE VARIABLE l-ambos AS LOGICAL INITIAL yes 
     LABEL "Ambos" 
     VIEW-AS TOGGLE-BOX
     SIZE 44 BY 1.08 NO-UNDO.
...
DEFINE VARIABLE l-fornecedor AS LOGICAL INITIAL yes 
     LABEL "Fornecedor" 
     VIEW-AS TOGGLE-BOX
     SIZE 44 BY 1.08 NO-UNDO.
...
DEFINE VARIABLE nome-abrev-fim AS CHARACTER FORMAT "X(12)" INITIAL "zzzzzzzzzzzzz" 
     VIEW-AS FILL-IN 
     SIZE 16.14 BY .88.

DEFINE VARIABLE nome-abrev-ini AS CHARACTER FORMAT "X(12)" 
...
DEFINE FRAME f-pg-sel
     cod-emitente-ini AT ROW 1.25 COL 36.15 RIGHT-ALIGNED WIDGET-ID 2
     cod-emitente-fim AT ROW 1.25 COL 61.86 RIGHT-ALIGNED NO-LABEL WIDGET-ID 6
     nome-abrev-ini AT ROW 2.25 COL 36.14 RIGHT-ALIGNED HELP
          "Nome abreviado do cliente/fornecedor" WIDGET-ID 4
     nome-abrev-fim AT ROW 2.25 COL 66.57 RIGHT-ALIGNED HELP
          "Nome abreviado do cliente/fornecedor" NO-LABEL WIDGET-ID 8
     IMAGE-1 AT ROW 1.25 COL 38.43
     IMAGE-2 AT ROW 1.25 COL 47.29
     IMAGE-3 AT ROW 2.25 COL 38.43 WIDGET-ID 10
     IMAGE-4 AT ROW 2.25 COL 47.29 WIDGET-ID 12
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
DEFINE FRAME f-pg-par
     l-cliente AT ROW 1.25 COL 3.29
     l-fornecedor AT ROW 2.25 COL 3.29 WIDGET-ID 2
     l-ambos AT ROW 3.25 COL 3.29 WIDGET-ID 4
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Relat¢rio de Fornecedores"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
/* SETTINGS FOR FILL-IN cod-emitente-ini IN FRAME f-pg-sel
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN nome-abrev-fim IN FRAME f-pg-sel
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN nome-abrev-ini IN FRAME f-pg-sel
   ALIGN-R                                                              */
...
ON END-ERROR OF w-relat /* Relat¢rio de Fornecedores */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Relat¢rio de Fornecedores */
DO:
...
{utp/ut9000.i "ESUT0018" "2.06.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY cod-emitente-ini cod-emitente-fim nome-abrev-ini nome-abrev-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 cod-emitente-ini cod-emitente-fim 
         nome-abrev-ini nome-abrev-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY l-cliente l-fornecedor l-ambos 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE l-cliente l-fornecedor l-ambos 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    IF INPUT FRAME f-pg-sel cod-emitente-ini > INPUT FRAME f-pg-sel cod-emitente-fim THEN DO:
       ...
       run utp/ut-msgs.p (input "show":U, input 142, input "C¢digo~~C¢digo").
       apply "ENTRY":U to cod-emitente-ini in FRAME f-pg-sel.
       return error.
    END.
    
    IF INPUT FRAME f-pg-sel nome-abrev-ini > INPUT FRAME f-pg-sel nome-abrev-fim THEN DO:
       apply "MOUSE-SELECT-CLICK":U to im-pg-sel in frame f-relat.
       run utp/ut-msgs.p (input "show":U, input 142, input "Nome Abrev~~Nome Abrev").
       apply "ENTRY":U to nome-abrev-ini in FRAME f-pg-sel.
       return error.
    END.
    ...
    ASSIGN tt-param.cod-emitente-ini = INPUT FRAME f-pg-sel cod-emitente-ini
           ...
           tt-param.nome-abrev-ini   = INPUT FRAME f-pg-sel nome-abrev-ini
           tt-param.nome-abrev-fim   = INPUT FRAME f-pg-sel nome-abrev-fim
           tt-param.cliente          = INPUT FRAME f-pg-par l-cliente
           tt-param.fornecedor       = INPUT FRAME f-pg-par l-fornecedor
           tt-param.ambos            = INPUT FRAME f-pg-par l-ambos.
    ...
    {include/i-rprun.i esp/esut0018rp.p}   
