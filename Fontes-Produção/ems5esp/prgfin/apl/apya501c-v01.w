...
&Scoped-Define ENABLED-FIELDS es_operac_financ.arquivo 
&Scoped-define ENABLED-TABLES es_operac_financ
&Scoped-define FIRST-ENABLED-TABLE es_operac_financ
&Scoped-Define ENABLED-OBJECTS rt-key bt-arquivo-entrada 
&Scoped-Define DISPLAYED-FIELDS es_operac_financ.arquivo 
...
&Scoped-define ADM-CREATE-FIELDS c-arquivo-entrada 
...
DEFINE FRAME f-main
     c-arquivo-entrada AT ROW 1.13 COL 21.14 NO-LABEL WIDGET-ID 40
     es_operac_financ.arquivo AT ROW 1.17 COL 5 WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 70 BY .88
     bt-arquivo-entrada AT ROW 1.17 COL 83.14 HELP
...
DO:
    ...
    ASSIGN es_operac_financ.arquivo:SCREEN-VALUE IN FRAME {&FRAME-NAME} = c-arquivo-entrada:SCREEN-VALUE IN FRAME {&FRAME-NAME}.
END.
...
------------------------------------------------------------------------------*/
 ...
 ASSIGN c-arquivo-entrada = c-arquivo-entrada:SCREEN-VALUE IN FRAME {&FRAME-NAME}.
   ...
   ASSIGN es_operac_financ.arquivo = c-arquivo-entrada.
...
------------------------------------------------------------------------------*/
    ...
    IF INPUT FRAME {&FRAME-NAME} es_operac_financ.arquivo = "" THEN DO:
       {include/i-vldprg.i}                                            
