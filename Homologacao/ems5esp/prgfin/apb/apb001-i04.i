/****************************************************************************************** 
**         Programa: apb001-i04.i
**            Autor: Vando Ribeiro
**       Fornecedor: DKP
**       Data: 05/11/2018
** Change/Chamado: REQ04
**    Objetivo: Cabe‡alhos das colunas dos movtos pendentes na prepara‡Æo de e-mail.
**
...
c-mess-top = "<html>"                                                                          
             ...
             + "<body>"
             + "<p>Prezado(a)(s),<p>"
             + "<p> Segue abaixo a lista dos movimentos pendentes de sua aprova‡Æo:</p>"
