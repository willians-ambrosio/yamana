...
{include/i-prgvrs.i ESTIP0002 2.12.00.004}
...
DEFINE VARIABLE rs-todos AS INTEGER INITIAL 1 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Todos", 1,
"Rejeitados", 2
...
DEFINE VARIABLE tg-reimporta AS LOGICAL INITIAL no 
     LABEL "Reimporta" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME f-pg-par
     tg-reimporta AT ROW 6.17 COL 4 WIDGET-ID 4
     bt-arquivo-entrada-2 AT ROW 9.75 COL 43.57 HELP
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "ESTIP0002 - Importaá∆o % TIP"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF C-Win /* ESTIP0002 - Importaá∆o % TIP */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* ESTIP0002 - Importaá∆o % TIP */
DO:
...
ASSIGN CURRENT-WINDOW                = {&WINDOW-NAME} 
 ...
 {utp/ut9000.i "ESTIP0002" "2.12.00.004"} 
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {include/i-imvrf.i &programa=esim0001 &versao-layout=001}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-11 RECT-7 RECT-9 rs-destino bt-arquivo-destino 
         bt-config-impr-destino c-arquivo-destino rs-execucao 
      WITH FRAME f-pg-log IN WINDOW C-Win.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-log}
  DISPLAY tg-reimporta c-arquivo-entrada 
      WITH FRAME f-pg-par IN WINDOW C-Win.
  ENABLE RECT-8 tg-reimporta bt-arquivo-entrada-2 c-arquivo-entrada 
      WITH FRAME f-pg-par IN WINDOW C-Win.
...
do  on error undo, return error
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.l-reimp         = INPUT FRAME f-pg-par tg-reimporta
           tt-param.arq-destino     = input frame f-pg-par c-arquivo-entrada 
    ...
    {include/i-imrun.i esp/estip0002rp.p}
