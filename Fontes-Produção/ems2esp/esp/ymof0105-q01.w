...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-mensagem-ben NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-mensagem-ben NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-mensagem-ben
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-mensagem-ben
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.es-mensagem-ben"
     _Options          = "NO-LOCK"
