...
*******************************************************************************/
{include/i-prgvrs.i esapb007-z01 2.06.00.000}
...
DEFINE VARIABLE h_esapb007-b01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-implantar AT ROW 20.92 COL 1.57
     bt-ajuda AT ROW 20.92 COL 79
     bt-ok AT ROW 22.63 COL 3
     bt-cancela AT ROW 22.63 COL 14
     rt-button AT ROW 22.38 COL 2
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Cat Code' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.17 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 19.58 , 88.57 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapb007-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esapb007-b01 ).
       RUN set-position IN h_esapb007-b01 ( 3.25 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 16.29 , 80.14 ) */

       /* Links to SmartBrowser h_esapb007-b01. */
       RUN add-link IN adm-broker-hdl ( h_esapb007-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esapb007-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esabp007-z01" "2.06.00.000"}
