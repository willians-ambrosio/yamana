...
&Scoped-define QUERY-STRING-Query-Main FOR EACH ctrl-conflito-it NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH ctrl-conflito-it NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main ctrl-conflito-it
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main ctrl-conflito-it
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "MGESP.ctrl-conflito-it"
