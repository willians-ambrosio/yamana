...
*******************************************************************************/
{esp/esapb009-bf.i}
{include/i-prgvrs.i ESAPB009-Z01 2.06.00.000}
...
DEFINE VARIABLE h_esapb009-b01 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Forn Cat Code' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapb009-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esapb009-b01 ).
       RUN set-position IN h_esapb009-b01 ( 2.50 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.08 , 84.57 ) */

       /* Links to SmartBrowser h_esapb009-b01. */
       RUN add-link IN adm-broker-hdl ( h_esapb009-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esapb009-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESAPB009-Z01" "2.06.00.000"}
