...
*******************************************************************************/
{include/i-prgvrs.i APYA501E2 12.1.17.000}  /*** 010007 ***/


&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i APYA501e2 APL}
&ENDIF
...
DEFINE VARIABLE h_apya501e2-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_apya501e2-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 5.71 COL 2.72 HELP
          "Salva e sai"
     bt-save AT ROW 5.71 COL 13.14 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 5.71 COL 23.72 HELP
          "Cancela"
     bt-ajuda AT ROW 5.71 COL 79
     rt-button AT ROW 5.46 COL 1.72
...
ON END-ERROR OF w-cadsim /* Manuten‡Æo de ROF */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manuten‡Æo de ROF */
DO:
...
DO:
{include/okfil.i h_apya501e2-v01}
END.
...
DO:
{include/salvafil.i h_apya501e2-v01}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apl/apya501e2-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_apya501e2-v01 ).
       RUN set-position IN h_apya501e2-v01 ( 1.21 , 1.86 ) NO-ERROR.
       /* Size in UIB:  ( 4.00 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apl/apya501e2-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_apya501e2-q01 ).
       RUN set-position IN h_apya501e2-q01 ( 5.00 , 47.86 ) NO-ERROR.
       /* Size in UIB:  ( 1.79 , 8.29 ) */

       /* Links to SmartViewer h_apya501e2-v01. */
       RUN add-link IN adm-broker-hdl ( h_apya501e2-q01 , 'Record':U , h_apya501e2-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_apya501e2-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_apya501e2-v01 ,
...
{utp/ut9000.i "APYA501E2" "12.1.17.000"}
  
  run pi-atualiza-parent in h_apya501e2-v01 (input v-row-parent). 
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_apya501e2-q01 (input v-row-table).
...
-------------------------------------------------------------*/
  RUN prgfin/apl/apya501e2-q01.w.
  RUN prgfin/apl/apya501e2-v01.w.
