...
*******************************************************************************/
{include/i-prgvrs.i ESCD006 12.1.13.001}
...
DEFINE VARIABLE text-modo-2 AS CHARACTER FORMAT "X(256)":U INITIAL "Formato" 
      VIEW-AS TEXT 
     SIZE 10.86 BY .63 NO-UNDO.
...
DEFINE VARIABLE rs-formato-arquivo AS INTEGER INITIAL 1 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "XLSX", 1,
"CSV", 2
...
DEFINE VARIABLE cod_modul_dtsul_fim AS CHARACTER FORMAT "X(3)":U INITIAL "FGL" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.

DEFINE VARIABLE cod_modul_dtsul_ini AS CHARACTER FORMAT "X(3)":U INITIAL "FGL" 
     LABEL "M¢dulo" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.

DEFINE VARIABLE cod_usuario-fim AS CHARACTER FORMAT "x(12)" INITIAL "zzzzzzzzzzzz" 
     VIEW-AS FILL-IN 
     SIZE 16.14 BY .88.

DEFINE VARIABLE cod_usuario-ini AS CHARACTER FORMAT "x(12)" 
     LABEL "Usu rio" 
     VIEW-AS FILL-IN 
     SIZE 16.14 BY .88.

DEFINE VARIABLE dat_lancto_ctbl_fim AS DATE FORMAT "99/99/9999" INITIAL 12/31/2999 
     VIEW-AS FILL-IN 
     SIZE 12.57 BY 1.

DEFINE VARIABLE dat_lancto_ctbl_ini AS DATE FORMAT "99/99/9999" INITIAL 01/01/1900 
     LABEL "Data Lan‡amento":R15 
     VIEW-AS FILL-IN 
     SIZE 12.57 BY 1.
...
DEFINE FRAME f-pg-imp
     ...
     bt-modelo-rtf AT ROW 6.63 COL 43 HELP
          "Escolha do nome do arquivo"
     rs-execucao AT ROW 8.46 COL 3 HELP
          "Modo de Execu‡Æo" NO-LABEL WIDGET-ID 2
     rs-formato-arquivo AT ROW 10.08 COL 3 HELP
     ...
     text-modo AT ROW 7.83 COL 1.14 COLON-ALIGNED NO-LABEL
     text-modo-2 AT ROW 9.5 COL 1.14 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     rect-rtf AT ROW 4.46 COL 2
     RECT-7 AT ROW 1.33 COL 2.14
     RECT-9 AT ROW 8.04 COL 2
     RECT-10 AT ROW 9.75 COL 2 WIDGET-ID 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
...
DEFINE FRAME f-pg-sel
     cod_modul_dtsul_ini AT ROW 1.25 COL 23.57 COLON-ALIGNED WIDGET-ID 10
     cod_modul_dtsul_fim AT ROW 1.25 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     dat_lancto_ctbl_ini AT ROW 2.25 COL 16.29 COLON-ALIGNED WIDGET-ID 2
     dat_lancto_ctbl_fim AT ROW 2.25 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     cod_usuario-ini AT ROW 3.25 COL 13 COLON-ALIGNED HELP
          "C¢digo Usu rio" WIDGET-ID 14
     cod_usuario-fim AT ROW 3.25 COL 49 COLON-ALIGNED HELP
          "C¢digo Usu rio" NO-LABEL WIDGET-ID 20
     IMAGE-1 AT ROW 2.25 COL 31.86
     IMAGE-2 AT ROW 2.25 COL 47.29
     IMAGE-3 AT ROW 1.25 COL 31.86 WIDGET-ID 6
     IMAGE-4 AT ROW 1.25 COL 47.29 WIDGET-ID 8
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Extrator de Lan‡amentos Cont beis"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.33
         MAX-WIDTH          = 194.86
...
ON END-ERROR OF w-relat /* Extrator de Lan‡amentos Cont beis */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Extrator de Lan‡amentos Cont beis */
DO:
...
DO:
   ...
   IF SELF:SCREEN-VALUE = "2" THEN
      ASSIGN rs-formato-arquivo:SCREEN-VALUE IN FRAME f-pg-imp = "2".
END.
...
&Scoped-define SELF-NAME rs-formato-arquivo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL rs-formato-arquivo w-relat
ON VALUE-CHANGED OF rs-formato-arquivo IN FRAME f-pg-imp
DO:
   {include/i-rprse.i}
END.
...
{utp/ut9000.i "ESCD006" "12.1.13.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY cod_modul_dtsul_ini cod_modul_dtsul_fim dat_lancto_ctbl_ini 
          dat_lancto_ctbl_fim cod_usuario-ini cod_usuario-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 cod_modul_dtsul_ini 
         cod_modul_dtsul_fim dat_lancto_ctbl_ini dat_lancto_ctbl_fim 
         cod_usuario-ini cod_usuario-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY rs-destino c-arquivo l-habilitaRtf c-modelo-rtf rs-execucao 
          rs-formato-arquivo text-rtf text-modelo-rtf 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
  ENABLE rect-rtf RECT-7 RECT-9 RECT-10 rs-destino bt-config-impr bt-arquivo 
         c-arquivo l-habilitaRtf bt-modelo-rtf rs-execucao rs-formato-arquivo 
...
do on error undo, return error on stop  undo, return error:
    ...
    IF INPUT FRAME f-pg-sel cod_modul_dtsul_ini > INPUT FRAME f-pg-sel cod_modul_dtsul_fim THEN DO:
       APPLY "MOUSE-SELECT-CLICK":U to im-pg-sel in frame f-relat.
       RUN utp/ut-msgs.p (input "show":U, INPUT 142, input "M¢dulo~~M¢dulo").
       APPLY "ENTRY":U TO cod_modul_dtsul_ini IN FRAME f-pg-sel.
       RETURN ERROR.
    END.

    IF INPUT FRAME f-pg-sel dat_lancto_ctbl_ini > INPUT FRAME f-pg-sel dat_lancto_ctbl_fim THEN DO:
       APPLY "MOUSE-SELECT-CLICK":U to im-pg-sel in frame f-relat.
       RUN utp/ut-msgs.p (input "show":U, INPUT 142, input "Data Lan‡amento~~Data Lan‡amento").
       APPLY "ENTRY":U TO dat_lancto_ctbl_ini IN FRAME f-pg-sel.
       RETURN ERROR.
    END.
    ...
    ASSIGN tt-param.cod_modul_dtsul_ini = INPUT FRAME f-pg-sel cod_modul_dtsul_ini
           tt-param.cod_modul_dtsul_fim = INPUT FRAME f-pg-sel cod_modul_dtsul_fim
           tt-param.dat_lancto_ctbl_ini = INPUT FRAME f-pg-sel dat_lancto_ctbl_ini
           tt-param.dat_lancto_ctbl_fim = INPUT FRAME f-pg-sel dat_lancto_ctbl_fim
           tt-param.cod_usuario_ini     = INPUT FRAME f-pg-sel cod_usuario-ini 
           tt-param.cod_usuario_fim     = INPUT FRAME f-pg-sel cod_usuario-fim .
        .

    ASSIGN tt-param.rs-formato-arquivo = INPUT FRAME f-pg-imp rs-formato-arquivo.
    ...
    {include/i-rprun.i cdp/escd006rp.p}
