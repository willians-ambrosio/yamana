...
DEFINE VARIABLE c-it-codigo-fim AS CHARACTER FORMAT "x(16)" INITIAL "ZZZZZZZZZZZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 17.14 BY .88.
...
DEFINE FRAME f-pg-sel
     c-it-codigo-ini AT ROW 1.25 COL 12 COLON-ALIGNED HELP
          "C¢digo do Item"
     c-it-codigo-fim AT ROW 1.25 COL 49 COLON-ALIGNED HELP
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Alteraá∆oTipo Controle Cont†bil"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Alteraá∆oTipo Controle Cont†bil */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Alteraá∆oTipo Controle Cont†bil */
DO:
...
/*   run pi-passa-handle in h_v81in172 (h_p-cadsi2).  */
...
/*     end.                                                                                         */
    ...
    {include/i-rprun.i esp/esce0108rp.p}
