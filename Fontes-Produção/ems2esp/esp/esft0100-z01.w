...
/* --------------------------------------------------------------------------------------- 
   ...
   Descricao..............: Integraá∆o Totvs 12 X MES
...
{include/i-prgvrs.i esft0100-z02 2.12.10.001}
...
DEFINE VARIABLE h_esft0100-b01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esft0100-b02 AS HANDLE NO-UNDO.
...
ON END-ERROR OF w-pesquisa /* Integraá∆o TOTVS x MES */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Integraá∆o TOTVS x MES */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Data Emiss∆o|Nr.Nota Fisc' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esft0100-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esft0100-b01 ).
       RUN set-position IN h_esft0100-b01 ( 2.46 , 2.14 ) NO-ERROR.
       /* Size in UIB:  ( 12.04 , 87.00 ) */

       /* Links to SmartBrowser h_esft0100-b01. */
       RUN add-link IN adm-broker-hdl ( h_esft0100-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esft0100-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esft0100-b02.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esft0100-b02 ).
       RUN set-position IN h_esft0100-b02 ( 2.46 , 2.14 ) NO-ERROR.
       /* Size in UIB:  ( 12.04 , 87.00 ) */

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esft0100-b02 ,
             h_folder , 'AFTER':U ).
    END. /* Page 2 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esft0100-z01" "2.12.10.001"}
