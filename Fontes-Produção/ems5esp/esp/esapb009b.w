...
*******************************************************************************/
{include/i-prgvrs.i ESAPB009B 12.01.20.000}
...
DEFINE VARIABLE h_esapb009-q02 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esapb009-v02 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 4.92 COL 2.57 HELP
          "Salva e sai"
     bt-save AT ROW 4.92 COL 13 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 4.92 COL 23.57 HELP
          "Cancela"
     bt-ajuda AT ROW 4.92 COL 73.29
     rt-button AT ROW 4.75 COL 1.57
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 85.43 BY 17 WIDGET-ID 100.
...
DO:
{include/okfil.i h_esapb009-v02}
END.
...
DO:
{include/salvafil.i h_esapb009-v02}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapb009-v02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esapb009-v02 ).
       RUN set-position IN h_esapb009-v02 ( 1.08 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 3.50 , 84.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapb009-q02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_esapb009-q02 ).
       RUN set-position IN h_esapb009-q02 ( 4.33 , 58.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_esapb009-v02. */
       RUN add-link IN adm-broker-hdl ( h_esapb009-q02 , 'Record':U , h_esapb009-v02 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_esapb009-v02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esapb009-v02 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESAPB009B" "12.01.20.000"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent IN h_esapb009-v02 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_esapb009-q02 (input v-row-table).
