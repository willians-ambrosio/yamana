...
*******************************************************************************/
{include/i-prgvrs.i YMCD0202 11.5.11.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i YMCD0202 MCD}
&ENDIF
...
bt-config-impr c-arquivo rs-execucao text-rtf text-modelo-rtf 
...
{utp/ut9000.i "YMCD0202" "11.5.11.000"}
...
/*                                             rs-classif:radio-buttons in frame f-pg-cla) */
    ...
    {include/i-rprun.i esp/ymcd0202rp.p}
