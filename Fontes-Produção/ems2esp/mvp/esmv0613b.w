...
*******************************************************************************/
{include/i-prgvrs.i ESMV0613B 2.00.00.001}  /*** 010005 ***/
/********************************************************************************
...
&GLOBAL-DEFINE Program        ESMV0613B
...
DO:
    ...
    /**Fun‡Æo multi idioma**/
    &if "{&FNC_MULTI_IDIOMA}" = "Yes" &then 
        /** A visÆo (Equipamento) deve sempre estar selecionada **/
        assign iOK = 0.
        do iCont = 1 to num-entries (slSelect:LIST-ITEM-PAIRS):
            case trim(substring(entry(iCont, slSelect:LIST-ITEM-PAIRS),1,2)):
                when "11":U then assign iOK = iOK + 1.
            end case.
        end.
        if iOK < 1 then do:
    ...
    &else
        ...
        assign iOK = 0.
        do iCont = 1 to num-entries (slSelect:list-items):
            case trim(substring(entry(iCont, slSelect:list-items),1,2)):
                when "11":U then assign iOK = iOK + 1.
            end case.
        end.
        if iOK < 1 then do:
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN cDimensoes2 = '01 '                + fnLabels(01)
           ...
           cDimensoes2 = cDimensoes2 + ',04 ' + fnLabels(04)
           cDimensoes2 = cDimensoes2 + ',05 ' + fnLabels(05)
           cDimensoes2 = cDimensoes2 + ',06 ' + fnLabels(06)
           cDimensoes2 = cDimensoes2 + ',07 ' + fnLabels(07)
           cDimensoes2 = cDimensoes2 + ',08 ' + fnLabels(08)
           cDimensoes2 = cDimensoes2 + ',09 ' + fnLabels(09)
           ...
           cDimensoes2 = cDimensoes2 + ',15 ' + fnLabels(15)
           cDimensoes2 = cDimensoes2 + ',16 ' + fnLabels(16).
