...
*******************************************************************************/
{include/i-prgvrs.i ESUT0019 2.06.00.000}
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Manutená∆o Formato Conta/Agencia bancaria"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Manutená∆o Formato Conta/Agencia bancaria */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Manutená∆o Formato Conta/Agencia bancaria */
DO:
...
{utp/ut9000.i "ESUT0019" "2.06.00.000"}
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/esut0019rp.p}
