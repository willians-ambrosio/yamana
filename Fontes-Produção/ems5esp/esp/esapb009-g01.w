...
*******************************************************************************/
{esp/esapb009-bf.i}
{include/i-prgvrs.i ESAPB009-G01 12.01.20.000}
...
&Scoped-Define ENABLED-FIELDS es-cat-code-fornec.cdn_fornecedor ~
es-cat-code-fornec.cat-code 
...
DEFINE FRAME d-vapara
     es-cat-code-fornec.cdn_fornecedor AT ROW 1.5 COL 27 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 13.72 BY .88
     es-cat-code-fornec.cat-code AT ROW 2.5 COL 27 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 17.14 BY .88
...
DO:
  find es-cat-code-fornec no-lock 
      where es-cat-code-fornec.cdn_fornecedor = input frame {&frame-name} es-cat-code-fornec.cdn_fornecedor 
      AND   es-cat-code-fornec.cat-code = input frame {&frame-name} es-cat-code-fornec.cat-code no-error.
  if  not avail es-cat-code-fornec then do:
      {utp/ut-table.i EMS5_ESP es-cat-code-fornec 1}
      run utp/ut-msgs.p (input "show",
                         input 2,
                         input RETURN-VALUE).
      return no-apply.
  end.
  assign p-row-tabela = rowid(es-cat-code-fornec).
END.
...
------------------------------------------------------------------------------*/
  IF AVAILABLE es-cat-code-fornec THEN 
    DISPLAY es-cat-code-fornec.cdn_fornecedor es-cat-code-fornec.cat-code 
      WITH FRAME d-vapara.
  ENABLE rt-button es-cat-code-fornec.cdn_fornecedor 
         es-cat-code-fornec.cat-code bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESAPB009-G01" "12.01.20.000"}
