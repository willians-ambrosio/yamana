...
/*------------------------------------------------------------------------
File.............: esbtb005.w
Description......: Exporta Conta Contabil para Ilha(MSS)
Input Parameters : 
Output Parameters: 
Author...........: Daniel Pereira de Lima
Created..........: 22/02/11 - 09:25

------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "ESBTB005".
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Exporta Conta Contabil - ESBTB005"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "ESBTB005".
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "ESBTB005" + "." + v-cod-extens-arq.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "esp/esbtb005rp.p".
