...
AND p-ind-object = "wh-re2002a-u01-bt-ok-f" THEN DO:
    ...
    IF DEC(wh-re2002a-u01-quantidade:SCREEN-VALUE) = 0 THEN DO:
        RUN utp/ut-msgs.p(INPUT "show",
                          INPUT 17006,
                          INPUT "Quantidade não pode ser Zero" + "~~" + "Quantidade não pode ser Zero").
    ...
    END.
     ...
     IF NOT AVAIL deposito THEN DO:
         RUN utp/ut-msgs.p(INPUT "show",
                           INPUT 17006,
                           INPUT "Depósito não Cadastrado" + "~~" + "Depósito não Cadastrado").
     ...
     IF NOT AVAIL localizacao THEN DO:
         RUN utp/ut-msgs.p(INPUT "show",
                           INPUT 17006,
                           INPUT "Localização não Cadastrada" + "~~" + "Localização não Cadastrada").
...
/*AND p-wgh-object:FILE-NAME MATCHES "*b09in368*"*/ THEN DO:
        ...
        FIND FIRST item-uni-estab NO-LOCK
             WHERE item-uni-estab.cod-estabel = doc-fisico.cod-estabel
             AND   item-uni-estab.it-codigo = wh-re2002a-u01-c-it-codigo:SCREEN-VALUE NO-ERROR.
        IF AVAIL item-uni-estab THEN DO:
            ...
            ASSIGN wh-re2002a-u01-cod-depos:SCREEN-VALUE    = item-uni-estab.deposito-pad
                   wh-re2002a-u01-cod-localiz:SCREEN-VALUE  = item-uni-estab.cod-localiz.

            IF item-uni-estab.loc-unica THEN
            ASSIGN wh-re2002a-u01-cod-depos:SENSITIVE    = NO
                   wh-re2002a-u01-cod-localiz:SENSITIVE  = NO.
