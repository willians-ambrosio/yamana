...
define variable c-prog-gerado as character no-undo initial "SU0003".
...
def var c-titulo           as char init "TOTAL DE COMPRAS RECEBIDAS UF" no-undo.        
def var v-cod-prog-gerado  as char init "SU0003" no-undo.           
...
assign v-cod-prog-gerado = "SU0003".
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK 
   ON END-KEY UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK:
        ...
        assign c-lista = "CONTRATOS" + "," + 
                         "ITEM".

        assign c-prog = "SU0003A.w" + "," + 
                        "SU0003C.w".
