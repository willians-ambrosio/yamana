...
{apb\ap001-rp1.i} /* Defini‡äes espec¡ficos para a customiza‡Æo */
{apb\ap001-rp2.i} /* DEfini‡äes espec¡ficas tempor rias API Antecipa‡Æo */

/* Defini‡äes template */
{include/i-prgvrs.i AP002-RP 2.06.00.001}  /*** 010010 ***/
{include/i_dbinst.i}
{utp/ut-glob.i}

{utp/utapi019.i}

{apb\ap001-rp3.i} /* Cont‚m toda a l¢gica do programa utilizada no ap002-rp.p e ap001rp.p */
