...
*******************************************************************************/
{include/i-prgvrs.i ESOI0001 12.01.21.000}
...
DEFINE VARIABLE c-ini-campo AS INTEGER FORMAT "zzzzz9,99" INITIAL 0 
     LABEL "Ordem":R7 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-sel
     c-ini-campo AT ROW 5.25 COL 28.29 COLON-ALIGNED
     "ORDEM DE COMPRA X ORDEM INVESTIMENTO" VIEW-AS TEXT
          SIZE 45 BY .67 AT ROW 3.46 COL 16.57 WIDGET-ID 4
     RECT-12 AT ROW 3.88 COL 15 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
&Scoped-define SELF-NAME c-ini-campo
&Scoped-define FRAME-NAME f-relat
...
{utp/ut9000.i "ESOI0001" "12.01.21.000"}
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN tt-param.numero-ordem = INPUT FRAME f-pg-sel c-ini-campo.
    ...
    {include/i-rprun.i esp/esoi0001rp.p}
