...
*******************************************************************************/
{include/i-prgvrs.i cm0508H 2.06.00.005}
...
DEFINE VARIABLE c-cc-codigo-fim AS CHARACTER FORMAT "X(25)":U INITIAL "zzzzzzzzzzzzzz" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE c-cc-codigo-ini AS CHARACTER FORMAT "X(25)":U 
     LABEL "C.Custo" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE c-cod-compon-fim AS CHARACTER FORMAT "X(25)":U INITIAL "zzzzzzzzzzzzzzz" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE c-cod-compon-ini AS CHARACTER FORMAT "X(25)":U 
     LABEL "Componente" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE c-cod-eqpto-fim AS CHARACTER FORMAT "X(25)":U INITIAL "zzzzzzzzzzzz" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE c-cod-eqpto-ini AS CHARACTER FORMAT "X(25)":U 
     LABEL "Equipamento" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE c-ct-codigo-fim AS CHARACTER FORMAT "X(25)":U INITIAL "zzzzzzzzzzzzzzz" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE c-ct-codigo-ini AS CHARACTER FORMAT "X(25)":U 
     LABEL "Conta" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE c-it-codigo-fim AS CHARACTER FORMAT "X(25)":U INITIAL "zzzzzzzzzzzzzzz" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE c-it-codigo-ini AS CHARACTER FORMAT "X(25)":U 
     LABEL "Item" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE da-dt-trans-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/2999 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.

DEFINE VARIABLE da-dt-trans-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/01 
...
DEFINE VARIABLE i-cd-tipo-fim AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 99999999 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE i-cd-tipo-ini AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 0 
...
DEFINE VARIABLE i-nr-ord-produ-ini AS INTEGER FORMAT "999,999,999":U INITIAL 0 
     LABEL "Ord.Prodruá∆o" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     da-dt-trans-ini AT ROW 1.25 COL 22.29 COLON-ALIGNED WIDGET-ID 2
     da-dt-trans-fim AT ROW 1.25 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     i-nr-ord-produ-ini AT ROW 2.25 COL 19.43 COLON-ALIGNED WIDGET-ID 10
     i-nr-ord-produ-fim AT ROW 2.25 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     c-cod-eqpto-ini AT ROW 3.25 COL 19.43 COLON-ALIGNED WIDGET-ID 20
     c-cod-eqpto-fim AT ROW 3.25 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 22
     c-cc-codigo-ini AT ROW 4.25 COL 19.43 COLON-ALIGNED WIDGET-ID 28
     c-cc-codigo-fim AT ROW 4.25 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 30
     c-ct-codigo-ini AT ROW 5.25 COL 19.43 COLON-ALIGNED WIDGET-ID 36
     c-ct-codigo-fim AT ROW 5.25 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 38
     c-it-codigo-ini AT ROW 6.25 COL 19.43 COLON-ALIGNED WIDGET-ID 44
     c-it-codigo-fim AT ROW 6.25 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 48
     c-cod-compon-ini AT ROW 7.25 COL 19.43 COLON-ALIGNED WIDGET-ID 54
     c-cod-compon-fim AT ROW 7.25 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 58
     i-cd-tipo-ini AT ROW 8.25 COL 19.43 COLON-ALIGNED
     i-cd-tipo-fim AT ROW 8.25 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 64
     fi-cod-estabel-ini AT ROW 9.25 COL 23 COLON-ALIGNED HELP
          "C¢digo do Estabelecimento" WIDGET-ID 72
     fi-cod-estabel-fim AT ROW 9.25 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 70
     Frotas AT ROW 10.58 COL 50 WIDGET-ID 68
     Manutencao AT ROW 10.63 COL 21.43 WIDGET-ID 66
     IMAGE-1 AT ROW 8.38 COL 35.72
     IMAGE-2 AT ROW 8.38 COL 47.14
     IMAGE-3 AT ROW 1.25 COL 35.72 WIDGET-ID 6
     IMAGE-4 AT ROW 1.25 COL 47.14 WIDGET-ID 8
     IMAGE-5 AT ROW 2.29 COL 35.72 WIDGET-ID 16
     IMAGE-6 AT ROW 2.29 COL 47.14 WIDGET-ID 18
     IMAGE-7 AT ROW 3.33 COL 35.72 WIDGET-ID 24
     IMAGE-8 AT ROW 3.33 COL 47.14 WIDGET-ID 26
     IMAGE-9 AT ROW 4.33 COL 35.72 WIDGET-ID 32
     IMAGE-10 AT ROW 4.33 COL 47.14 WIDGET-ID 34
     IMAGE-11 AT ROW 5.33 COL 35.72 WIDGET-ID 42
     IMAGE-12 AT ROW 5.33 COL 47.14 WIDGET-ID 40
     IMAGE-13 AT ROW 6.38 COL 35.72 WIDGET-ID 50
     IMAGE-14 AT ROW 6.38 COL 47.14 WIDGET-ID 52
     IMAGE-15 AT ROW 7.42 COL 35.72 WIDGET-ID 60
     IMAGE-16 AT ROW 7.42 COL 47.14 WIDGET-ID 62
     IMAGE-17 AT ROW 9.38 COL 35.72 WIDGET-ID 74
     IMAGE-18 AT ROW 9.38 COL 47.14 WIDGET-ID 76
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
{utp/ut9000.i "Manutená∆o e Frotas - CM0508H" "2.06.00.005"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY da-dt-trans-ini da-dt-trans-fim i-nr-ord-produ-ini i-nr-ord-produ-fim 
          c-cod-eqpto-ini c-cod-eqpto-fim c-cc-codigo-ini c-cc-codigo-fim 
          c-ct-codigo-ini c-ct-codigo-fim c-it-codigo-ini c-it-codigo-fim 
          c-cod-compon-ini c-cod-compon-fim i-cd-tipo-ini i-cd-tipo-fim 
          fi-cod-estabel-ini fi-cod-estabel-fim Frotas Manutencao 
  ...
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         ...
         IMAGE-17 IMAGE-18 da-dt-trans-ini da-dt-trans-fim i-nr-ord-produ-ini 
         i-nr-ord-produ-fim c-cod-eqpto-ini c-cod-eqpto-fim c-cc-codigo-ini 
         c-cc-codigo-fim c-ct-codigo-ini c-ct-codigo-fim c-it-codigo-ini 
         c-it-codigo-fim c-cod-compon-ini c-cod-compon-fim i-cd-tipo-ini 
         i-cd-tipo-fim fi-cod-estabel-ini fi-cod-estabel-fim Frotas Manutencao 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
/*                                             rs-classif:radio-buttons in frame f-pg-cla) */
    ...
    assign tt-param.da-dt-trans-ini     = input frame f-pg-sel da-dt-trans-ini
           ...
           tt-param.c-cod-eqpto-ini     = input frame f-pg-sel c-cod-eqpto-ini
           tt-param.c-cod-eqpto-fim     = input frame f-pg-sel c-cod-eqpto-fim
           tt-param.c-cc-codigo-ini     = input frame f-pg-sel c-cc-codigo-ini
           tt-param.c-cc-codigo-fim     = input frame f-pg-sel c-cc-codigo-fim
           tt-param.c-ct-codigo-ini     = input frame f-pg-sel c-ct-codigo-ini
           tt-param.c-ct-codigo-fim     = input frame f-pg-sel c-ct-codigo-fim
           ...
           tt-param.c-cod-compon-ini    = input frame f-pg-sel c-cod-compon-ini
           tt-param.c-cod-compon-fim    = input frame f-pg-sel c-cod-compon-fim
           tt-param.i-cd-tipo-ini       = input frame f-pg-sel i-cd-tipo-ini
           tt-param.i-cd-tipo-fim       = input frame f-pg-sel i-cd-tipo-fim
    ...
    {include/i-rprun.i dtv/cm0508Hrp.p}
