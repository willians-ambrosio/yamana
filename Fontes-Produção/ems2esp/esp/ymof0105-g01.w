...
&Scoped-Define ENABLED-OBJECTS rt-button i_cod-mensagem bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS i_cod-mensagem 
...
DEFINE VARIABLE i_cod-mensagem AS INTEGER FORMAT "->,>>>,>>9":U 
     LABEL "Mensagwm" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     i_cod-mensagem AT ROW 2 COL 26 COLON-ALIGNED WIDGET-ID 2
...
DO:
FIND es-mensagem-ben NO-LOCK
    WHERE es-mensagem-ben.cod-mensagem EQ INPUT FRAME {&FRAME-NAME} i_cod-mensagem NO-ERROR.

IF NOT AVAILABLE es-mensagem-ben THEN DO:
    {utp/ut-table.i mgesp es-mensagem-ben 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-mensagem-ben).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY i_cod-mensagem 
      WITH FRAME d-vapara.
  ENABLE rt-button i_cod-mensagem bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
