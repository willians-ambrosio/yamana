...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es_categ_ptoelet ~
      WHERE es_categ_ptoelet.cdn_empresa = v_cdn_empres_usuar NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es_categ_ptoelet ~
      WHERE es_categ_ptoelet.cdn_empresa = v_cdn_empres_usuar NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es_categ_ptoelet
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es_categ_ptoelet
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Options          = "NO-LOCK"
     _Where[1]         = "hresp.es_categ_ptoelet.cdn_empresa = v_cdn_empres_usuar"
