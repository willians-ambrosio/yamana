...
DEFINE VARIABLE r-tipo AS INTEGER INITIAL 1 
     ...
     RADIO-BUTTONS 
          "Usu rio", 1,
"Grupo Usu rio", 2
     SIZE 17 BY 1.46 NO-UNDO.

DEFINE VARIABLE rs-usuario AS INTEGER INITIAL 1 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Ativos", 1,
"Inativos", 2
...
DEFINE FRAME f-pg-sel
     r-tipo AT ROW 2.54 COL 19 NO-LABEL WIDGET-ID 14
     fi_cod_usuario_ini AT ROW 5 COL 17 COLON-ALIGNED HELP
          "C¢digo Usu rio" WIDGET-ID 2
     fi_cod_usuario_fim AT ROW 5 COL 41 COLON-ALIGNED HELP
          "C¢digo Usu rio" NO-LABEL WIDGET-ID 4
     fi_cod_grp_usuar_ini AT ROW 6 COL 17 COLON-ALIGNED HELP
          "C¢digo Grupo de Usu rios" WIDGET-ID 6
     fi_cod_grp_usuar_fim AT ROW 6 COL 41 COLON-ALIGNED HELP
          "C¢digo Grupo de Usu rios" NO-LABEL WIDGET-ID 8
     rs-usuario AT ROW 7.04 COL 19 NO-LABEL WIDGET-ID 20
     "Lista usu rios:" VIEW-AS TEXT
          SIZE 15 BY .67 AT ROW 7.25 COL 4.14 WIDGET-ID 24
     IMAGE-1 AT ROW 5 COL 35.86
     IMAGE-2 AT ROW 5 COL 40
     IMAGE-3 AT ROW 6 COL 35.86 WIDGET-ID 10
     IMAGE-4 AT ROW 6 COL 40 WIDGET-ID 12
     RECT-10 AT ROW 2.25 COL 17 WIDGET-ID 18
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL r-tipo w-relat
ON VALUE-CHANGED OF r-tipo IN FRAME f-pg-sel
DO:
  IF INT(SELF:SCREEN-VALUE) = 1 THEN DO:

      ENABLE {&list-1} with frame f-pg-sel.
      DISABLE {&list-2} with frame f-pg-sel.

      ASSIGN fi_cod_grp_usuar_ini:SCREEN-VALUE = ''
          fi_cod_grp_usuar_fim:SCREEN-VALUE = 'ZZZ'.

      APPLY 'entry' TO fi_cod_usuario_ini.
  ...
  ELSE DO:
      ...
      ASSIGN fi_cod_usuario_ini:SCREEN-VALUE = ''
    fi_cod_usuario_fim:SCREEN-VALUE = 'ZZZZZZZZZZZZ'.

    APPLY 'entry' TO fi_cod_grp_usuar_ini.
...
{utp/ut9000.i "ESMEN013" "1.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    APPLY 'entry' TO fi_cod_usuario_ini IN FRAME f-pg-sel.
END.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY r-tipo fi_cod_usuario_ini fi_cod_usuario_fim fi_cod_grp_usuar_ini 
          fi_cod_grp_usuar_fim rs-usuario 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 RECT-10 r-tipo fi_cod_usuario_ini 
         fi_cod_usuario_fim rs-usuario 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.tipo            = INPUT FRAME f-pg-sel r-tipo
           tt-param.tp-usu          = INPUT FRAME f-pg-sel rs-usuario.
    ...
    {include/i-rprun.i esp/esmen013rp.p}
