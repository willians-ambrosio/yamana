...
DEFINE VARIABLE c-arquivo-entrada AS CHARACTER INITIAL "D:/temp/modeloparacarga.xlsx" 
     VIEW-AS EDITOR MAX-CHARS 256
     SIZE 40 BY .88
     BGCOLOR 15  NO-UNDO.
...
DEFINE FRAME f-pg-par
     c-arquivo-entrada AT ROW 4.79 COL 8.29 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     bt-arquivo-entrada AT ROW 4.79 COL 48.14 HELP
          "Escolha do nome do arquivo"
     text-entrada AT ROW 3.75 COL 9.14 NO-LABEL
     RECT-8 AT ROW 4.08 COL 7
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
...
/* SETTINGS FOR FRAME f-pg-log
                                                                        */
/* SETTINGS FOR RECTANGLE RECT-11 IN FRAME f-pg-log
   NO-ENABLE                                                            */
ASSIGN 
...
ASSIGN 
       rs-todos:HIDDEN IN FRAME f-pg-log           = TRUE.
...
/* SETTINGS FOR FILL-IN text-destino-2 IN FRAME f-pg-log
   NO-DISPLAY NO-ENABLE ALIGN-L                                         */
ASSIGN 
       text-destino-2:HIDDEN IN FRAME f-pg-log           = TRUE
...
DO:
    ...
    assign c-arquivo-entrada = replace(input frame {&frame-name} c-arquivo-entrada, "/", "~\").
...
{utp/ut9000.i "YMOF0110" "1.00.00.000"}
...
do  on error undo, return error
    ...
    {include/i-imrun.i ESP\YMOF0110rp.p}
