...
**       Data....: 30/03/12
**       Autor...: DATASUL S.A.
**       Objetivo: Lista Fornecedores - CtaPagar
**       VersÆo..: 1.00.000 - adm
**       OBS.....: Este fonte foi gerado pelo Data Viewer 3.00
*******************************************************************************/

define variable c-prog-gerado as character no-undo initial "FORN2255".
...
form emitente.cod-emitente column-label "C¢digo" format ">>>>>>>>9" at 001
     emitente.cod-gr-forn column-label "Gr" format ">9" at 011
     emitente.nome-abrev column-label "Nome Abrev" format "X(12)" at 014
     emitente.nome-emit column-label "Nome" format "X(40)" at 027
     emitente.cgc column-label "CGC/CPF" format "99.999.999/9999-99" at 068
     emitente.ins-estadual column-label "Inscr Estad" format "X(19)" at 088
     emitente.ins-municipal column-label "Inscr Munic" format "X(19)" at 108
     emitente.cod-cond-pag column-label "Cond" format ">>9" at 128
...
assign c-programa     = "forn2255"
       c-versao       = "2.06"
       c-revisao      = ".00.000"
       c-titulo-relat = "Lista Fornecedores - CtaPagar"
       c-sistema      = "".
...
assign i-ep-codigo-usuario = tt-param.ep-codigo
       ...
       i-cod-gr-forn-ini = tt-param.i-cod-gr-forn-ini
       i-cod-gr-forn-fim = tt-param.i-cod-gr-forn-fim
.
...
for each emitente no-lock
         where emitente.cod-emitente >= i-cod-emitente-ini and 
               ...
               emitente.cod-gr-forn >= i-cod-gr-forn-ini and 
               emitente.cod-gr-forn <= i-cod-gr-forn-fim and
               emitente.data-implant >= da-data-implant-ini and 
               emitente.data-implant <= da-data-implant-fim:
...
if  tt-param.parametro then do:
   ...
   disp stream str-rp 
      ...
      i-cod-gr-forn-ini colon 22 "|< >|"   at 46 i-cod-gr-forn-fim no-label
   ...
   disp stream str-rp "   Lista Fornecedores - CtaPagar"
