...
*******************************************************************************/
{include/i-prgvrs.i YMFR0003 1.02.00.003 } /*** 010003 ***/
/*------------------------------------------------------------------------
...
DEFINE VARIABLE i-tp-res AS INTEGER FORMAT "9":U INITIAL 0 
     LABEL "Tipo Rescis∆o" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-cla
     rs-classif AT ROW 4.71 COL 19.86 HELP
...
DEFINE FRAME f-pg-sel
     i-es-ini AT ROW 2.75 COL 23.57 COLON-ALIGNED HELP
          "Informe C¢digo do Estabelecimento Inicial"
     i-es-fim AT ROW 2.75 COL 48.43 COLON-ALIGNED HELP
          "Informe C¢digo do Estabelecimento Final" NO-LABEL
     i-ban-liq-ini AT ROW 3.75 COL 23.57 COLON-ALIGNED HELP
          "Informe C¢digo do Banco Inicial"
     i-ban-liq-fin AT ROW 3.75 COL 48.43 COLON-ALIGNED HELP
          "Informe C¢digo do Banco Final" NO-LABEL
     da-pgto-ini AT ROW 4.75 COL 23.57 COLON-ALIGNED HELP
          "Informe Data de Pagamento Inicial"
     da-pgto-fin AT ROW 4.75 COL 62.43 RIGHT-ALIGNED HELP
     ...
     IMAGE-1 AT ROW 2.75 COL 38.43
     IMAGE-2 AT ROW 2.75 COL 47.86
     IMAGE-5 AT ROW 4.75 COL 38.43
     IMAGE-6 AT ROW 3.75 COL 38.43
     IMAGE-7 AT ROW 3.75 COL 47.86
     IMAGE-9 AT ROW 4.75 COL 47.86
...
DEFINE FRAME f-pg-par
     c-arq-lqd AT ROW 1.96 COL 1.57 COLON-ALIGNED HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     bt-arquivo-3 AT ROW 1.96 COL 43.43 HELP
          "Escolha do nome do arquivo"
     i-tp-res AT ROW 3.42 COL 26.43 COLON-ALIGNED HELP
          "Informe o Tipo de Rescisao"
     v_dat_lancto AT ROW 4.42 COL 26.43 COLON-ALIGNED
     v_cdn_banco AT ROW 5.42 COL 26.43 COLON-ALIGNED
     v_cdn_agencia AT ROW 6.42 COL 26.43 COLON-ALIGNED
     v_cod_dv_agencia AT ROW 6.42 COL 33.14 COLON-ALIGNED NO-LABEL
     v_num_conta AT ROW 7.42 COL 26.43 COLON-ALIGNED
     v_cod_dv AT ROW 7.42 COL 40.14 COLON-ALIGNED NO-LABEL
     v_cdn_estab_centr AT ROW 8.42 COL 26.43 COLON-ALIGNED
     v_num_convenio AT ROW 9.42 COL 26.43 COLON-ALIGNED HELP
          "Contrato do Convànio entre Empresa e o banco"
     v_cod_docto AT ROW 10.42 COL 26.43 COLON-ALIGNED
     v_log_cred_conta AT ROW 3.42 COL 52.14
     v_log_doc AT ROW 4.13 COL 52.14
     v_log_cheque AT ROW 4.83 COL 52.14
     v_log_cartao AT ROW 5.58 COL 52.14
     v_des_texto AT ROW 2.67 COL 51.14 COLON-ALIGNED NO-LABEL
     v_log_conta_poup AT ROW 6.33 COL 52.14
     v_log_gera_seg_b AT ROW 8.08 COL 51.86
     v_num_seq AT ROW 9.33 COL 65.86 COLON-ALIGNED
     "Arquivo L°quidos" VIEW-AS TEXT
          SIZE 17.14 BY .67 AT ROW 1 COL 4.29
     "Segmento B" VIEW-AS TEXT
          SIZE 17.29 BY .71 AT ROW 7.33 COL 53
     RECT-15 AT ROW 3 COL 49.72
     RECT-21 AT ROW 1.38 COL 2
     ret_cpfpis-2 AT ROW 7.63 COL 49.72
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 77 BY 10.65.
...
{utp/ut9000.i "YMFR0003" "1.02.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    if avail param_empres_rh then do:
       assign da-pgto-ini:screen-value in frame f-pg-sel = string(date(param_empres_rh.num_mes_refer_calc_efetd,01,param_empres_rh.num_ano_refer_calc_efetd))
              da-pgto-fin:screen-value in frame f-pg-sel = if (param_empres_rh.num_mes_refer_calc_efetd + 1) > 12 then
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-arq-lqd i-tp-res v_dat_lancto v_cdn_banco v_cdn_agencia 
          ...
          v_des_texto v_log_conta_poup v_log_gera_seg_b v_num_seq 
      WITH FRAME f-pg-par IN WINDOW C-Win.
  ENABLE c-arq-lqd bt-arquivo-3 i-tp-res v_dat_lancto v_cdn_banco v_cdn_agencia 
         v_cod_dv_agencia v_num_conta v_cod_dv v_cdn_estab_centr v_num_convenio 
         v_cod_docto v_log_cred_conta v_log_doc v_log_cheque v_log_cartao 
         v_log_conta_poup v_log_gera_seg_b v_num_seq RECT-15 RECT-21 
         ret_cpfpis-2 
      WITH FRAME f-pg-par IN WINDOW C-Win.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-par}
  DISPLAY i-es-ini i-es-fim i-ban-liq-ini i-ban-liq-fin da-pgto-ini da-pgto-fin 
          l-mensal l-horista l-semanal l-quinzenal l-tarefa l-diarista 
      WITH FRAME f-pg-sel IN WINDOW C-Win.
  ENABLE i-es-ini i-es-fim i-ban-liq-ini i-ban-liq-fin da-pgto-ini da-pgto-fin 
         l-mensal l-horista l-semanal l-quinzenal l-tarefa l-diarista IMAGE-1 
         IMAGE-2 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-9 RECT-14 
      WITH FRAME f-pg-sel IN WINDOW C-Win.
  ...
  ENABLE RECT-7 RECT-9 RECT-98 rs-destino bt-config-impr bt-arquivo c-arquivo 
...
do  on error undo, return error
    ...
    if input frame f-pg-par i-tp-res < 0 or
       input frame f-pg-par i-tp-res > 10 then do:
       run utp/ut-msgs.p (input "show",
                          input 1845,
                          input "").
       apply 'mouse-select-click' to im-pg-par in frame f-relat.
       apply 'entry' to i-tp-res in frame f-pg-par.
       return error.
    end.
   ...
   assign  tt-param.c-arq-lqd       = input frame f-pg-par c-arq-lqd
           ...
           tt-param.d-dt-ini        = input frame f-pg-sel da-pgto-ini
           tt-param.d-dt-fim        = input frame f-pg-sel da-pgto-fin
           ...
           tt-param.i-tp-res        = input frame f-pg-par i-tp-res
    ...
    {include/i-rprun.i prghur/esp/ymfr0003rp.p}
