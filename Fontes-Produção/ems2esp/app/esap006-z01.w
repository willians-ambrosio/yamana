...
*******************************************************************************/
{include/i-prgvrs.i esap006-z01 2.06.00.001}
...
DEFINE VARIABLE h_esap006-b01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-implantar AT ROW 14 COL 2
     bt-ok AT ROW 15.71 COL 3.43
     bt-cancela AT ROW 15.71 COL 14.43
     bt-ajuda AT ROW 15.71 COL 79.43
     rt-button AT ROW 15.46 COL 2.43
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Fornecedor' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.08 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 12.58 , 88.57 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'app/esap006-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esap006-b01 ).
       RUN set-position IN h_esap006-b01 ( 2.88 , 3.57 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 84.57 ) */

       /* Links to SmartBrowser h_esap006-b01. */
       RUN add-link IN adm-broker-hdl ( h_esap006-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esap006-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esap006-z01" "2.06.00.001"}
