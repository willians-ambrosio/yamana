...
*******************************************************************************/
{include/i-prgvrs.i YMRE0001 11.5.11.002}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i YMRE0001 MRE}
&ENDIF
...
DEFINE VARIABLE h_ymre0001-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_ymre0001-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 22.38 COL 3
     bt-cancela AT ROW 22.38 COL 14
     bt-imprime AT ROW 22.38 COL 25
     bt-ajuda AT ROW 22.38 COL 69
     rt-button AT ROW 22.17 COL 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 79.72 BY 22.88 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_folder ( 21.00 , 78.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymre0001-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ymre0001-v01 ).
       RUN set-position IN h_ymre0001-v01 ( 2.50 , 3.14 ) NO-ERROR.
       /* Size in UIB:  ( 19.08 , 75.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymre0001-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_ymre0001-q01 ).
       RUN set-position IN h_ymre0001-q01 ( 1.25 , 62.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_ymre0001-v01. */
       RUN add-link IN adm-broker-hdl ( h_ymre0001-q01 , 'Record':U , h_ymre0001-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_ymre0001-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             bt-ok:HANDLE IN FRAME f-cad , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymre0001-v01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "YMRE0001" "11.5.11.002"}
