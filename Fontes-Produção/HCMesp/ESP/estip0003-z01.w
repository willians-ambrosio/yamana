...
*******************************************************************************/
{include/i-prgvrs.i ESTIP0001Z 2.12.00.004}
...
DEFINE VARIABLE h_estip0003-bz01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/estip0003-bz01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_estip0003-bz01 ).
       RUN set-position IN h_estip0003-bz01 ( 3.25 , 4.43 ) NO-ERROR.
       /* Size in UIB:  ( 11.00 , 84.72 ) */

       /* Links to SmartBrowser h_estip0003-bz01. */
       RUN add-link IN adm-broker-hdl ( h_estip0003-bz01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_estip0003-bz01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESTIP0001Z" "2.12.00.004"}
