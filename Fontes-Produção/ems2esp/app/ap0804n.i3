/***************************************************************************
***
*** crp/cr0804n.i3 - Defini»’o das Form's do Relat½rio.
***
***************************************************************************/
...
def frame f-total 
    skip(2)
    de-tot-aberto   colon 80
    de-tot-anterior colon 80 
    skip(0)
    with no-box side-labels width 132 stream-io.

{utp/ut-liter.i Total_Saldo_Aberto}
assign de-tot-aberto:label in frame f-total = trim(return-value).

{utp/ut-liter.i Saldo_Anterior_do_Cliente}
assign de-tot-anterior:label in frame f-total = trim(return-value).
