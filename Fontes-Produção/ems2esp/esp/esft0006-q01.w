...
&Scoped-define INTERNAL-TABLES es-cfop-excecao

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-cfop-excecao NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-cfop-excecao NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-cfop-excecao
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-cfop-excecao
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.es-cfop-excecao"
     _Options          = "NO-LOCK"
