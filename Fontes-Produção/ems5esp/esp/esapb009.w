...
*******************************************************************************/
{include/i-prgvrs.i ESAPB009 12.01.20.000}
...
DEFINE VARIABLE h_esapb009-b02 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esapb009-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esapb009-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 90 BY 24.21 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapb009-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esapb009-v01 ).
       RUN set-position IN h_esapb009-v01 ( 2.63 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.67 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'New Cat Code' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 7.42 , 1.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 11.00 , 89.29 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapb009-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/esapb009-z01.w,
                     ProgVaPara = esp/esapb009-g01.w,
                     ProgIncMod = esp/esapb009a.w,
                     Implantar = no':U ,
             OUTPUT h_esapb009-q01 ).
       RUN set-position IN h_esapb009-q01 ( 1.00 , 63.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.50 , 8.00 ) */

       /* Links to SmartViewer h_esapb009-v01. */
       RUN add-link IN adm-broker-hdl ( h_esapb009-q01 , 'Record':U , h_esapb009-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadpai , 'TableIO':U , h_esapb009-v01 ).

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to SmartQuery h_esapb009-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-cadpai , 'State':U , h_esapb009-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_esapb009-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esapb009-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esapb009-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadpai , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esapb009-v01 ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_esapb009-v01 , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapb009-b02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?,
                     ProgAtributo = ,
                     ProgIncMod = esp/esapb009b.w,
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_esapb009-b02 ).
       RUN set-position IN h_esapb009-b02 ( 9.50 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.50 , 85.00 ) */

       /* Links to BrowserCadastro2 h_esapb009-b02. */
       RUN add-link IN adm-broker-hdl ( h_esapb009-q01 , 'Record':U , h_esapb009-b02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esapb009-b02 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESAPB009" "12.01.20.000"}
