...
&Scoped-define QUERY-STRING-br-table FOR EACH es_Gestor WHERE ~{&KEY-PHRASE} ~
      AND es_Gestor.nom_gestor BEGINS c-nome-gestor NO-LOCK ~
    BY es_Gestor.nom_gestor INDEXED-REPOSITION
...
&Scoped-Define ENABLED-OBJECTS c-nome-gestor bt-confirma br-table 
&Scoped-Define DISPLAYED-OBJECTS c-nome-gestor 
...
DEFINE VARIABLE c-nome-gestor AS CHARACTER FORMAT "X(50)" 
     LABEL "Nome Iniciado com" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME F-Main
     c-nome-gestor AT ROW 1 COL 17.86 COLON-ALIGNED
     bt-confirma AT ROW 1 COL 72
...
/* Query rebuild information for BROWSE br-table
     ...
     _OrdList          = "hresp.es_Gestor.nom_gestor|yes"
     _Where[1]         = "hresp.es_Gestor.nom_gestor BEGINS c-nome-gestor"
...
DO:
  assign input frame {&frame-name} c-nome-gestor.
