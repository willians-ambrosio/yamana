...
*******************************************************************************/
{include/i-prgvrs.i ESUT0017 2.06.00.001}  /*** 010017 ***/

&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
{include/i-license-manager.i ESUT0017 HCM}
&ENDIF
...
ON END-ERROR OF C-Win /* Alteraá∆o de DIRF */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Alteraá∆o de DIRF */
DO:
...
{utp/ut9000.i "ESUT0017" "2.06.00.001"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {include/i-imvrf.i &programa=ESUT0017 &versao-layout=001}
    ...
    if  c-nom-prog-appc-mg97 <> "" then do:
        ...
        IF l-TMS-401 THEN DO:
            {include/i-imvrf.i &programa=ESUT0017 &versao-layout=002}
        END.
        ELSE IF l-TMS-402 THEN DO:
            {include/i-imvrf.i &programa=ESUT0017 &versao-layout=003}
        END.
...
do  on error undo, return error
    ...
    {include/i-imrun.i esp/esut0017rp.p}
