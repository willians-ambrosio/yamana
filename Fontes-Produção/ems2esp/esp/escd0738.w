...
*******************************************************************************/
{include/i-prgvrs.i escd0738 0.12.00.001}
...
DEFINE VARIABLE c-fim-cd-equipto AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-fim-cd-tecnico AS CHARACTER FORMAT "99999-9":U INITIAL "99999999" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-fim-dat-trans AS DATE FORMAT "99/99/9999":U INITIAL 12/01/9999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-fim-nr-ord-produ AS INTEGER FORMAT ">>>>>>>>9":U INITIAL 99999999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-fim-nr-requisicao AS INTEGER FORMAT ">>>>>>>>9":U INITIAL 99999999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-ini-cd-equipto AS CHARACTER FORMAT "X(16)":U 
     LABEL "C¢digo Equipamento" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-ini-cd-tecnico AS CHARACTER FORMAT "99999-9":U INITIAL "000000" 
     LABEL "TÇcnico" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-ini-dat-trans AS DATE FORMAT "99/99/9999":U INITIAL 12/01/50 
     LABEL "Per°odo" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-ini-nr-ord-produ AS INTEGER FORMAT ">>>>>>>>9":U INITIAL 0 
     LABEL "N£mero Ordem" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-ini-nr-requisicao AS INTEGER FORMAT ">>>>>>>>9":U INITIAL 0 
     LABEL "N£mero Requisiá∆o" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-ini-cd-tecnico AT ROW 2.25 COL 20 COLON-ALIGNED
     c-fim-cd-tecnico AT ROW 2.25 COL 53 COLON-ALIGNED NO-LABEL
     c-ini-dat-trans AT ROW 3.25 COL 20 COLON-ALIGNED WIDGET-ID 4
     c-fim-dat-trans AT ROW 3.25 COL 53 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     c-ini-nr-ord-produ AT ROW 4.25 COL 20 COLON-ALIGNED WIDGET-ID 12
     c-fim-nr-ord-produ AT ROW 4.25 COL 53 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     c-ini-nr-requisicao AT ROW 5.25 COL 20 COLON-ALIGNED WIDGET-ID 20
     c-fim-nr-requisicao AT ROW 5.25 COL 53 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     c-ini-cd-equipto AT ROW 6.25 COL 20 COLON-ALIGNED WIDGET-ID 28
     c-fim-cd-equipto AT ROW 6.25 COL 53 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     IMAGE-1 AT ROW 2.25 COL 36.86
     IMAGE-2 AT ROW 2.25 COL 52.29
     IMAGE-3 AT ROW 3.25 COL 36.86 WIDGET-ID 6
     IMAGE-4 AT ROW 3.25 COL 52.29 WIDGET-ID 8
     IMAGE-5 AT ROW 4.25 COL 36.86 WIDGET-ID 14
     IMAGE-6 AT ROW 4.25 COL 52.29 WIDGET-ID 16
     IMAGE-7 AT ROW 5.25 COL 36.86 WIDGET-ID 22
     IMAGE-8 AT ROW 5.25 COL 52.29 WIDGET-ID 24
     IMAGE-9 AT ROW 6.25 COL 36.86 WIDGET-ID 30
     IMAGE-10 AT ROW 6.25 COL 52.29 WIDGET-ID 32
     RECT-10 AT ROW 1.75 COL 5 WIDGET-ID 42
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
{utp/ut9000.i "escd0738" "0.12.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-ini-cd-tecnico c-fim-cd-tecnico c-ini-dat-trans c-fim-dat-trans 
          c-ini-nr-ord-produ c-fim-nr-ord-produ c-ini-nr-requisicao 
          c-fim-nr-requisicao c-ini-cd-equipto c-fim-cd-equipto 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         IMAGE-9 IMAGE-10 RECT-10 c-ini-cd-tecnico c-fim-cd-tecnico 
         c-ini-dat-trans c-fim-dat-trans c-ini-nr-ord-produ c-fim-nr-ord-produ 
         c-ini-nr-requisicao c-fim-nr-requisicao c-ini-cd-equipto 
         c-fim-cd-equipto 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    ASSIGN 
      tt-param.tt-ini-cd-tecnico      = INPUT FRAME f-pg-sel c-ini-cd-tecnico   
      tt-param.tt-fim-cd-tecnico      = INPUT FRAME f-pg-sel c-fim-cd-tecnico   
      tt-param.tt-ini-dat-trans       = INPUT FRAME f-pg-sel c-ini-dat-trans    
      tt-param.tt-fim-dat-trans       = INPUT FRAME f-pg-sel c-fim-dat-trans    
      tt-param.tt-ini-nr-ord-produ    = INPUT FRAME f-pg-sel c-ini-nr-ord-produ 
      tt-param.tt-fim-nr-ord-produ    = INPUT FRAME f-pg-sel c-fim-nr-ord-produ 
      tt-param.tt-ini-nr-requisicao   = INPUT FRAME f-pg-sel c-ini-nr-requisicao
      tt-param.tt-fim-nr-requisicao   = INPUT FRAME f-pg-sel c-fim-nr-requisicao
      tt-param.tt-ini-cd-equipto      = INPUT FRAME f-pg-sel c-ini-cd-equipto
      tt-param.tt-fim-cd-equipto      = INPUT FRAME f-pg-sel c-fim-cd-equipto.
    ...
    {include/i-rprun.i esp/escd0738rp.p}
