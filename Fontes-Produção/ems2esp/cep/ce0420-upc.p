...
** Empresa.: Yamana
** Programa: ce0420-upc.p
** UPC cadastrada para programa: ce0420
** Objetivo: 
******************************************************************/
{include/i-prgvrs.i CE0420-UPC 2.00.00.000}
...
if  p-ind-event  = "pi-executar":U then do:
    ...
    if mmv-rateio.cal-rat then do:
        run utp/ut-msgs.p (input "SHOW",
                           input 17006,
                           input "" + "~~" + "Rateio de contas calculado pelo es9999, efetue o descalculo para seguir com o processo.").
        return error.
    end.
end.
