...
Def Temp-table tt-mov                   No-undo                                                        
    ...
    Field dt-solicitacao-nf             As Char
    ...
    For Each docum-est No-lock
       ...
       Where item-doc-est.serie-docto    = docum-est.serie-docto       
        ...
        Assign tt-mov.serie-docto                  = item-doc-est.serie-docto     
               ...
               tt-mov.vl-mercadoria                = Round(cotacao-item.preco-unit * item-doc-est.quantidade,2) 
            ...
            For First b-item-doc-est No-lock
               Where b-item-doc-est.serie-docto  = b-docum-est.serie-docto 
                ...
                Assign tt-mov.serie-docto                  = b-item-doc-est.serie-docto     
                       ...
                       tt-mov.sequencia                    = b-item-doc-est.sequencia
                       ...
                       tt-mov.tx-di                        = fnTaxaDI()
                       tt-mov.nr-drawback                  = fnDrawback()
                       tt-mov.vl-mercadoria                = Round(b-item-doc-est.preco-unit[1] * b-item-doc-est.quantidade,2) 
                       tt-mov.qt-peso                      = b-item-doc-est.peso-liquido
                       tt-mov.qt-merc                      = b-item-doc-est.quantidade
                       tt-mov.un                           = b-item-doc-est.un
                       tt-mov.nat-operacao                 = docum-est.nat-operacao
                       ...
                       tt-mov.vl-furmigacao                = fnvalDespesaComplementar(11)
                       ...
                       tt-mov.vl-frete-rodo-santos         = fnvalDespesaComplementar(00)  /*N∆o Encontrado*/
                       tt-mov.vl-compl-armazem-porto       = fnvalDespesaComplementar(00)  /*N∆o Encontrado*/
                       tt-mov.vl-servico-entrega           = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-frete-ferro-santos        = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-lavagem-container         = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-tecnico-nf                = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-retificacao-ii            = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-outras-despesas           = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-outras-despesas-imposto   = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-compl-frete-internacional = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-tx-portuaria-origem       = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-inspec-carga-destino      = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-inspec-carga-embarque     = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-thc                       = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-coord-carga               = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-gestao-processo           = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-compl-capatazia           = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-ipi-filha                 = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-cofins-filha              = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-pis-filha                 = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-icms-filha                = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-multa-di-icms             = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-ii-filha                  = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-imposto-filha             = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-sub-total-despesas        = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.vl-ipi-a                     = b-docum-est.ipi-deb-cre  
                       tt-mov.vl-icms-a                    = b-docum-est.icm-deb-cre  
                       tt-mov.vl-frete-rodoviario-a        = fnvalDespesaComplementar(00)  /*N∆o Encontrada*/
                       tt-mov.st-nota                      = fnSitNota()
...
------------------------------------------------------------------------------*/
    ...
    For Each historico-embarque No-lock
       Where historico-embarque.cod-estabel   = embarque-imp.cod-estabel
        ...
        Return String(historico-embarque.dt-previsao,"99/99/9999").
    End.
