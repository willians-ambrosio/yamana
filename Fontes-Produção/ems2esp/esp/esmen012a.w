...
DEFINE VARIABLE h_esmen012a-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esmen012a-v01-2 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 5.04 COL 2.72 HELP
          "Salva e sai"
     bt-save AT ROW 5.04 COL 13.72 HELP
          "Salva e cria novo registro"
     bt-cancela AT ROW 5.04 COL 24.72 HELP
          "Cancela"
     bt-ajuda AT ROW 5.04 COL 77.72
     rt-button AT ROW 4.88 COL 1.57
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-incmdp ASSIGN
         HIDDEN             = YES
         TITLE              = "Inclui/Modifica Matriz de Conflito de Acesso - Programa Base"
         HEIGHT             = 5.88
         WIDTH              = 89
         MAX-HEIGHT         = 22
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-incmdp /* Inclui/Modifica Matriz de Conflito de Acesso - Programa Base */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-incmdp w-incmdp
ON WINDOW-CLOSE OF w-incmdp /* Inclui/Modifica Matriz de Conflito de Acesso - Programa Base */
DO:
...
DO:
{include/okpai.i h_esmen012a-v01-2}
END.
...
DO:
{include/salvapai.i h_esmen012a-v01-2}
 END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esmen012a-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esmen012a-v01-2 ).
       RUN set-position IN h_esmen012a-v01-2 ( 1.08 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.50 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esmen012a-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_esmen012a-q01 ).
       RUN set-position IN h_esmen012a-q01 ( 4.79 , 52.57 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_esmen012a-v01-2. */
       RUN add-link IN adm-broker-hdl ( h_esmen012a-q01 , 'Record':U , h_esmen012a-v01-2 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_esmen012a-v01-2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esmen012a-v01-2 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESMEN012A" "1.00.00.000"}
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_esmen012a-q01 (INPUT v-row-table). 
