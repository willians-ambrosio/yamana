...
*******************************************************************************/
{include/i-prgvrs.i ESUT0007 2.06.00.000}
...
DEFINE VARIABLE cod-usuario-fim AS CHARACTER FORMAT "x(12)" INITIAL "zzzzzzzzzzzz" 
     VIEW-AS FILL-IN 
     SIZE 16.14 BY .88.

DEFINE VARIABLE cod-usuario-ini AS CHARACTER FORMAT "x(12)" 
     LABEL "Usu rio" 
     VIEW-AS FILL-IN 
     SIZE 16.14 BY .88.

DEFINE VARIABLE data-fim AS DATE FORMAT "99/99/9999" INITIAL 12/31/2999 
     VIEW-AS FILL-IN 
     SIZE 13.72 BY .88.

DEFINE VARIABLE data-ini AS DATE FORMAT "99/99/9999" INITIAL 01/01/1900 
     LABEL "Data" 
     VIEW-AS FILL-IN 
     SIZE 13.72 BY .88.
...
DEFINE VARIABLE nr-requisicao-fim AS INTEGER FORMAT ">>>,>>>,>>9" INITIAL 999999999 
     VIEW-AS FILL-IN 
     SIZE 13.72 BY .88.

DEFINE VARIABLE nr-requisicao-ini AS INTEGER FORMAT ">>>,>>>,>>9" INITIAL 0 
     LABEL "Solicita‡Æo":R12 
     VIEW-AS FILL-IN 
     SIZE 13.72 BY .88.
...
DEFINE FRAME f-pg-sel
     numero-ordem-ini AT ROW 1.25 COL 12 COLON-ALIGNED WIDGET-ID 10
     numero-ordem-fim AT ROW 1.25 COL 50 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     num-pedido-ini AT ROW 2.25 COL 12 COLON-ALIGNED HELP
          "N£mero do Pedido" WIDGET-ID 8
     num-pedido-fim AT ROW 2.25 COL 50 COLON-ALIGNED HELP
          "N£mero do Pedido" NO-LABEL WIDGET-ID 34
     it-codigo-ini AT ROW 3.25 COL 12 COLON-ALIGNED WIDGET-ID 6
     it-codigo-fim AT ROW 3.25 COL 50 COLON-ALIGNED NO-LABEL WIDGET-ID 32
     nr-requisicao-ini AT ROW 4.25 COL 12 COLON-ALIGNED HELP
          "N£mero da Requisi‡Æo de Material" WIDGET-ID 42
     nr-requisicao-fim AT ROW 4.25 COL 50 COLON-ALIGNED HELP
          "N£mero da Requisi‡Æo de Material" NO-LABEL WIDGET-ID 44
     cod-usuario-ini AT ROW 5.25 COL 12 COLON-ALIGNED WIDGET-ID 2
     cod-usuario-fim AT ROW 5.25 COL 50 COLON-ALIGNED NO-LABEL WIDGET-ID 28
     data-ini AT ROW 6.25 COL 12 COLON-ALIGNED WIDGET-ID 4
     data-fim AT ROW 6.25 COL 50 COLON-ALIGNED NO-LABEL WIDGET-ID 30
     IMAGE-1 AT ROW 1.25 COL 31.86
     IMAGE-2 AT ROW 1.25 COL 47.29
     IMAGE-3 AT ROW 2.25 COL 31.86 WIDGET-ID 12
     IMAGE-4 AT ROW 2.25 COL 47.29 WIDGET-ID 14
     IMAGE-5 AT ROW 3.25 COL 31.86 WIDGET-ID 16
     IMAGE-6 AT ROW 3.25 COL 47.29 WIDGET-ID 18
     IMAGE-7 AT ROW 4.25 COL 31.86 WIDGET-ID 20
     IMAGE-8 AT ROW 4.25 COL 47.29 WIDGET-ID 22
     IMAGE-9 AT ROW 5.25 COL 31.86 WIDGET-ID 24
     IMAGE-10 AT ROW 5.25 COL 47.29 WIDGET-ID 26
     IMAGE-11 AT ROW 6.25 COL 31.86 WIDGET-ID 40
     IMAGE-12 AT ROW 6.25 COL 47.29 WIDGET-ID 38
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Relat¢rio LOG de Elimina‡Æo de Ordens de Compra"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Relat¢rio LOG de Elimina‡Æo de Ordens de Compra */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Relat¢rio LOG de Elimina‡Æo de Ordens de Compra */
DO:
...
{utp/ut9000.i "ESUT0007" "2.06.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY numero-ordem-ini numero-ordem-fim num-pedido-ini num-pedido-fim 
          it-codigo-ini it-codigo-fim nr-requisicao-ini nr-requisicao-fim 
          cod-usuario-ini cod-usuario-fim data-ini data-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         IMAGE-9 IMAGE-10 IMAGE-11 IMAGE-12 numero-ordem-ini numero-ordem-fim 
         num-pedido-ini num-pedido-fim it-codigo-ini it-codigo-fim 
         nr-requisicao-ini nr-requisicao-fim cod-usuario-ini cod-usuario-fim 
         data-ini data-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    IF INPUT FRAME f-pg-sel numero-ordem-ini > INPUT FRAME f-pg-sel numero-ordem-fim THEN DO:
       APPLY "MOUSE-SELECT-CLICK":U to im-pg-sel in frame f-relat.
       RUN utp/ut-msgs.p (INPUT "show":U, INPUT 142, input "Ordem Compra~~Ordem Compra").
       APPLY "ENTRY":U TO numero-ordem-ini IN FRAME f-pg-sel.
       return error.
    END.

    IF INPUT FRAME f-pg-sel num-pedido-ini > INPUT FRAME f-pg-sel num-pedido-fim THEN DO:
       APPLY "MOUSE-SELECT-CLICK":U to im-pg-sel in frame f-relat.
       RUN utp/ut-msgs.p (INPUT "show":U, INPUT 142, input "Pedido~~Pedido").
       APPLY "ENTRY":U TO num-pedido-ini IN FRAME f-pg-sel.
       return error.
    END.
    ...
    IF INPUT FRAME f-pg-sel nr-requisicao-ini > INPUT FRAME f-pg-sel nr-requisicao-fim THEN DO:
       APPLY "MOUSE-SELECT-CLICK":U to im-pg-sel in frame f-relat.
       RUN utp/ut-msgs.p (INPUT "show":U, INPUT 142, input "Solicita‡Æo~~Solicita‡Æo").
       APPLY "ENTRY":U TO nr-requisicao-ini IN FRAME f-pg-sel.
       return error.
    END.


    IF INPUT FRAME f-pg-sel cod-usuario-ini > INPUT FRAME f-pg-sel cod-usuario-fim THEN DO:
       APPLY "MOUSE-SELECT-CLICK":U to im-pg-sel in frame f-relat.
       RUN utp/ut-msgs.p (INPUT "show":U, INPUT 142, input "Usu rio~~Usu rio").
       APPLY "ENTRY":U TO cod-usuario-ini IN FRAME f-pg-sel.
       return error.
    END.


    IF INPUT FRAME f-pg-sel data-ini > INPUT FRAME f-pg-sel data-fim THEN DO:
       APPLY "MOUSE-SELECT-CLICK":U to im-pg-sel in frame f-relat.
       RUN utp/ut-msgs.p (INPUT "show":U, INPUT 142, input "Data~~Data").
       APPLY "ENTRY":U TO data-ini IN FRAME f-pg-sel.
       return error.
    END.
    ...
    ASSIGN tt-param.numero-ordem-ini  = input frame f-pg-sel numero-ordem-ini 
           tt-param.numero-ordem-fim  = input frame f-pg-sel numero-ordem-fim 
           ...
           tt-param.nr-requisicao-ini = input frame f-pg-sel nr-requisicao-ini
           tt-param.nr-requisicao-fim = input frame f-pg-sel nr-requisicao-fim
           tt-param.data-ini          = input frame f-pg-sel data-ini         
           tt-param.data-fim          = input frame f-pg-sel data-fim         
           tt-param.cod-usuario-ini   = input frame f-pg-sel cod-usuario-ini  
           tt-param.cod-usuario-fim   = input frame f-pg-sel cod-usuario-fim .
    ...
    {include/i-rprun.i esp/esut0007rp.p}
