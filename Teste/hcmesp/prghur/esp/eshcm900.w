...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "<Funcionarios Desligados_uso restrito - ESHCM900>"
         HEIGHT             = 12.29
         WIDTH              = 72
         MAX-HEIGHT         = 31.29
         MAX-WIDTH          = 182.86
...
ON END-ERROR OF C-Win /* <Funcionarios Desligados_uso restrito - ESHCM900> */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* <Funcionarios Desligados_uso restrito - ESHCM900> */
DO:
...
/************************************************************/
    ...
    /*************** Imprime altera‡äes **************************/
    /*************** Cabe»alho ***********************************/
    chWorkSheet:Range("a1"):Value = "Funcionarios Desligados_uso restrito - " + string(today).
    ...
    chWorkSheet:Range("aj3"):Value = "Dt Desligamento".
    chWorkSheet:Range("ak3"):Value = "Cod Desligamento". 
    chWorkSheet:Range("al3"):Value = "Descri‡Æo Desligamento". 

    
    chWorkSheet:Range("a3:al3"):Font:Bold = TRUE.
    ...
    chWorkSheet:Columns("af"):ColumnWidth = 12.
    chWorkSheet:Columns("ag"):ColumnWidth = 40.
    chWorkSheet:Columns("ah"):ColumnWidth = 12.
    chWorkSheet:Columns("ai"):ColumnWidth = 30.
    chWorkSheet:Columns("aj"):ColumnWidth = 12.
    chWorkSheet:Columns("ak"):ColumnWidth = 12.
    chWorkSheet:Columns("al"):ColumnWidth = 20.
   ...
   FOR EACH  funcionario 
      WHERE funcionario.cdn_empresa       >= fi-empresa-ini
        ...
        ASSIGN chExcelApplication:range( "a" + STRING(i-linha) ):value = funcionario.cdn_empresa
               ...
               chExcelApplication:range( "aj" + STRING(i-linha) ):value = funcionario.dat_desligto_func 
               chExcelApplication:range( "ak" + STRING(i-linha) ):value = cdn-sit
               chExcelApplication:range( "al" + STRING(i-linha) ):value = sit-afast.
