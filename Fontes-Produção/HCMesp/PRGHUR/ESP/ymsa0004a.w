...
*******************************************************************************/
{include/i-prgvrs.i YMSA0004A 1.00.00.000}
...
DEFINE VARIABLE h_ymsa0004a-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_ymsa0004a-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 7.21 COL 2.57 HELP
          "Salva e sai"
     bt-save AT ROW 7.21 COL 13 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 7.21 COL 23.57 HELP
          "Cancela"
     bt-ajuda AT ROW 7.21 COL 64.43
     rt-button AT ROW 7.04 COL 1.57
...
DO:
   {include/okfil.i h_ymsa0004a-v01}
END.
...
DO:
   {include/salvafil.i h_ymsa0004a-v01}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prghur/esp/ymsa0004a-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ymsa0004a-v01 ).
       RUN set-position IN h_ymsa0004a-v01 ( 1.08 , 1.86 ) NO-ERROR.
       /* Size in UIB:  ( 5.75 , 74.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prghur/esp/ymsa0004a-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_ymsa0004a-q01 ).
       RUN set-position IN h_ymsa0004a-q01 ( 6.79 , 63.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_ymsa0004a-v01. */
       RUN add-link IN adm-broker-hdl ( h_ymsa0004a-q01 , 'Record':U , h_ymsa0004a-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_ymsa0004a-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymsa0004a-v01 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "YMSA0004A" "1.00.00.000"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .
  
  /* Code placed here will execute AFTER standard behavior.    */
  run pi-atualiza-parent in h_ymsa0004a-v01 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_ymsa0004a-q01 (input v-row-table).
