...
*******************************************************************************/
{include/i-prgvrs.i escdr024a 2.06.00.001}
...
DEFINE VARIABLE fi-cod-cond-pag-fim AS INTEGER FORMAT ">>>9":U INITIAL 9999 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.

DEFINE VARIABLE fi-cod-cond-pag-ini AS INTEGER FORMAT ">>>9":U INITIAL 0 
     LABEL "Cond" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.
...
DEFINE VARIABLE tg-cond-ativa AS LOGICAL INITIAL no 
     LABEL "Condiá∆o de Pagto Desativada" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME f-pg-sel
     fi-cod-cond-pag-ini AT ROW 1.25 COL 24.86 COLON-ALIGNED
     fi-cod-cond-pag-fim AT ROW 1.25 COL 48.14 COLON-ALIGNED NO-LABEL
     tg-cond-ativa AT ROW 2.25 COL 26.86 WIDGET-ID 2
...
{utp/ut9000.i "escdr024a" "2.06.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-cod-cond-pag-ini fi-cod-cond-pag-fim tg-cond-ativa 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 fi-cod-cond-pag-ini fi-cod-cond-pag-fim tg-cond-ativa 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
/*     end.                                                                                         */
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.cod-cond-pag-ini = input frame f-pg-sel fi-cod-cond-pag-ini
           tt-param.cod-cond-pag-fim = input frame f-pg-sel fi-cod-cond-pag-fim
           tt-param.cd-ativa         = input frame f-pg-sel tg-cond-ativa
           .
    ...
    {include/i-rprun.i cdp/escdr024arp.p}
