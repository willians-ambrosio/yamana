...
*******************************************************************************/
{include/i-prgvrs.i APYA503 12.1.17.000}
...
DEFINE VARIABLE h_apya503-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_apya503-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 6.25 COL 3
     bt-cancela AT ROW 6.25 COL 14
     bt-imprime AT ROW 6.25 COL 25
     bt-ajuda AT ROW 6.25 COL 84.72
     rt-button AT ROW 6 COL 2.14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 111.72 BY 12.58 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Manuten‡Æo de Parƒmetros APL"
         HEIGHT             = 6.58
         WIDTH              = 96.43
         MAX-HEIGHT         = 22
         MAX-WIDTH          = 114.72
...
ON END-ERROR OF w-cadsim /* Manuten‡Æo de Parƒmetros APL */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manuten‡Æo de Parƒmetros APL */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apl/apya503-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_apya503-v01 ).
       RUN set-position IN h_apya503-v01 ( 1.29 , 2.14 ) NO-ERROR.
       /* Size in UIB:  ( 4.50 , 94.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apl/apya503-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_apya503-q01 ).
       RUN set-position IN h_apya503-q01 ( 6.29 , 51.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.33 , 7.72 ) */

       /* Links to SmartViewer h_apya503-v01. */
       RUN add-link IN adm-broker-hdl ( h_apya503-q01 , 'Record':U , h_apya503-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_apya503-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_apya503-v01 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "APYA503" "12.1.17.000"}
