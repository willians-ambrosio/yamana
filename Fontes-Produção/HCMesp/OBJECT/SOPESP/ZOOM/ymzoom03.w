...
*******************************************************************************/
{include/i-prgvrs.i YMZOOM03 1.02.10.000 } /*** 01010001 ***/
...
DEFINE VARIABLE h_ymbrw004 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa de M‚tricas PLR"
         HEIGHT             = 17
         WIDTH              = 90
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 90
...
ON END-ERROR OF w-pesquisa /* Pesquisa de M‚tricas PLR */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de M‚tricas PLR */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'object/sopesp/brw/ymbrw004.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ymbrw004 ).
       RUN set-position IN h_ymbrw004 ( 3.25 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.08 , 80.14 ) */

       /* Links to SmartBrowser h_ymbrw004. */
       RUN add-link IN adm-broker-hdl ( h_ymbrw004 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymbrw004 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "YMZOOM03" "1.02.00.000"}
