...
*******************************************************************************/
{include/i-prgvrs.i escd0007-G01 2.06.00.000}
...
d_dat_valid_ini bt-ok bt-cancela bt-ajuda 
...
FIND es_parametros NO-LOCK
    WHERE es_parametros.cod_prog_dtsul EQ INPUT FRAME {&FRAME-NAME} c_cod_prog_dtsul
      AND es_parametros.cod_referencia EQ INPUT FRAME {&FRAME-NAME} c_cod_referencia
      AND es_parametros.dat_valid_ini EQ INPUT FRAME {&FRAME-NAME} d_dat_valid_ini NO-ERROR.

IF NOT AVAILABLE es_parametros THEN DO:
    {utp/ut-table.i mgesp es_parametros 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es_parametros).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod_prog_dtsul c_cod_referencia d_dat_valid_ini 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cod_prog_dtsul c_cod_referencia d_dat_valid_ini bt-ok 
         bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "escd0007-G01" "2.06.00.000"}
