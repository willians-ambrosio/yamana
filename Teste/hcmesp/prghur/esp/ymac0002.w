...
*******************************************************************************/
{include/i-prgvrs.i YMAC0002 1.02.00.003 } /*** 010003 ***/
/*------------------------------------------------------------------------
...
DEFINE FRAME f-pg-sel
     i-es-ini AT ROW 2 COL 28 COLON-ALIGNED HELP
          "Informe C¢digo do Estabelecimento Inicial"
     i-es-fim AT ROW 2 COL 46 COLON-ALIGNED HELP
          "Informe C¢digo do Estabelecimento Final" NO-LABEL
     i-ban-liq-ini AT ROW 3 COL 28 COLON-ALIGNED HELP
          "Informe C¢digo do Banco Inicial"
     i-ban-liq-fin AT ROW 3 COL 46 COLON-ALIGNED HELP
          "Informe C¢digo do Banco Final" NO-LABEL
     v_matr_ini AT ROW 4 COL 19 COLON-ALIGNED WIDGET-ID 2
     v_matr_fim AT ROW 4 COL 46 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     ...
     IMAGE-1 AT ROW 2 COL 35.72
     IMAGE-2 AT ROW 2 COL 44.72
     IMAGE-6 AT ROW 3 COL 35.72
     IMAGE-7 AT ROW 3 COL 44.72
     RECT-14 AT ROW 5.92 COL 18.72
     IMAGE-8 AT ROW 4 COL 35.57 WIDGET-ID 6
     IMAGE-9 AT ROW 4 COL 44.57 WIDGET-ID 8
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62.
...
{utp/ut9000.i "YMAC0002" "1.02.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY i-es-ini i-es-fim i-ban-liq-ini i-ban-liq-fin v_matr_ini v_matr_fim 
          l-mensal l-horista l-semanal l-quinzenal l-tarefa l-diarista 
      WITH FRAME f-pg-sel IN WINDOW C-Win.
  ENABLE i-es-ini i-es-fim i-ban-liq-ini i-ban-liq-fin v_matr_ini v_matr_fim 
         l-mensal l-horista l-semanal l-quinzenal l-tarefa l-diarista IMAGE-1 
         IMAGE-2 IMAGE-6 IMAGE-7 RECT-14 IMAGE-8 IMAGE-9 
      WITH FRAME f-pg-sel IN WINDOW C-Win.
  ...
  ENABLE c-arquivo-entrada bt-arquivo-entrada v_cb_tipo_folha i-parcela 
         ...
         v_num_convenio v_cod_docto v_num_seq RECT-15 RECT-8 ret_cpfpis-2 
      WITH FRAME f-pg-par IN WINDOW C-Win.
...
do  on error undo, return error
    ...
    if input frame f-pg-par v_dat_lancto = ? then do:
       {utp/ut-liter.i Data_Lanáamento MFP C}
        run utp/ut-msgs.p (input "show",
                           input 54,
                           input return-value).                               
        apply 'mouse-select-click' to im-pg-par in frame f-relat.
    ...
    {include/i-rprun.i prghur/esp/ymac0002rp.p}
