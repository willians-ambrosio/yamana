...
{include/i-prgvrs.i YMRE0501 11.5.11.002}

&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i YMRE0501 MRE}
&ENDIF
...
{utp/ut9000.i "YMRE0501" "11.5.11.002"}

/*:T inicializa»„es do template de relat½rio */
/* {include/i-rpini.i} */

/************** Tratamento especifico de inicializa»’o **************/
...
/* Preprocessor para elimina¯Êo de arquivos tempor˜rios */
...
/*                         rs-destino = 3.     */
    ...
    run utp/ut-liter.p (input "Arquivo":U, 
                        input "*",
                        input "R").
    ...
    /*Alterado tech1007 - 14/02/2005 - C½digo removido pois o template foi alterado
      para que a op»’o de RTF n’o seja uma op»’o de destino
    &IF "{&RTF}":U = "YES":U &THEN
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp\ymre0501rp.p}
