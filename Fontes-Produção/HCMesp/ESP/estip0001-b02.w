...
*******************************************************************************/
{include/i-prgvrs.i ESTIP00001b02 2.12.00.004}
...
&Scoped-define INTERNAL-TABLES es_controle_sit sit_afast

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br-table                                      */
&Scoped-define FIELDS-IN-QUERY-br-table es_controle_sit.cdn_sit_afast_func ~
sit_afast.des_sit_afast_func 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table 
&Scoped-define QUERY-STRING-br-table FOR EACH es_controle_sit OF es_controle WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH sit_afast OF es_controle_sit NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br-table OPEN QUERY br-table FOR EACH es_controle_sit OF es_controle WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH sit_afast OF es_controle_sit NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br-table es_controle_sit sit_afast
&Scoped-define FIRST-TABLE-IN-QUERY-br-table es_controle_sit
&Scoped-define SECOND-TABLE-IN-QUERY-br-table sit_afast
...
<FOREIGN-KEYS>
cdn_empresa||y|hresp.es_controle_sit.cdn_empresa
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      es_controle_sit.cdn_sit_afast_func FORMAT "z9":U
      sit_afast.des_sit_afast_func FORMAT "x(30)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br-table
     _TblList          = "hresp.es_controle_sit OF hresp.es_controle,hcm.sit_afast OF hresp.es_controle_sit"
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = hresp.es_controle_sit.cdn_sit_afast_func
     _FldNameList[2]   = hcm.sit_afast.des_sit_afast_func
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cdn_empresa" "es_controle_sit" "cdn_empresa"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "es_controle_sit"}
  {src/adm/template/snd-list.i "sit_afast"}
