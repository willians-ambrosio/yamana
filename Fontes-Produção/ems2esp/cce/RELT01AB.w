...
DEFINE FRAME f-pg-sel
   ...
   c-cod-comprado-fim no-label
     at row 3 col 37 colon-aligned
     view-as fill-in 
     size 13 by .88
     font 1

   IMAGE-1 AT ROW 01.00 COL 30
   IMAGE-2 AT ROW 01.00 COL 35
   WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY
   SIDE-LABELS NO-UNDERLINE THREE-D
   AT COL 3 ROW 2.85
   SIZE 76.86 BY 10.62.
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "RELT01AB" + "." + v-cod-extens-arq.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "CCE/RELT0128.p".
