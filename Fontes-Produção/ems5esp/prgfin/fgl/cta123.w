...
define variable c-prog-gerado as character no-undo initial "CTA123".
...
def var c-titulo           as char init "Conta Cont bil" no-undo.        
def var v-cod-prog-gerado  as char init "cta123" no-undo.           
...
assign v-cod-prog-gerado = "cta123".
