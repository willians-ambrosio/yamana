...
*****************************************************************************/
{include/i-prgvrs.i esfnd001-z01 5.06.00.000}
...
DEFINE VARIABLE h_esfnd001-b02 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-ok AT ROW 13.25 COL 3
     bt-cancela AT ROW 13.25 COL 14
     bt-ajuda AT ROW 13.25 COL 71
     rt-button AT ROW 13 COL 2
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esfnd001-b02.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esfnd001-b02 ).
       RUN set-position IN h_esfnd001-b02 ( 1.25 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_esfnd001-b02. */
       RUN add-link IN adm-broker-hdl ( h_esfnd001-b02 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esfnd001-b02 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esfnd001-z01" "5.06.00.000"}
