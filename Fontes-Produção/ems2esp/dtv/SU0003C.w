...
/*------------------------------------------------------------------------
File.............: SU0003C.w
Description......: TOTAL DE COMPRAS RECEBIDAS UF
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 31/08/10 - 10:54 - 20100038
OBS..............: Este fonte foi gerado pelo Data Viewer
------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "SU0003C".
...
DEFINE FRAME f-pg-sel
   ...
   i-num-pedido-ini label "Pedido"
     at row 2 col 20 colon-aligned
     view-as fill-in 
     size 10 by .88
     font 1

   i-num-pedido-fim no-label
     at row 2 col 47 colon-aligned
     view-as fill-in 
     size 10 by .88
     font 1

   da-data-movto-ini label "Data Movimento"
     at row 3 col 20 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

   da-data-movto-fim no-label
   ...
   i-num-ord-inv-ini label "Ordem Invest"
     at row 6 col 20 colon-aligned
     view-as fill-in 
     size 12 by .88
     font 1

   i-num-ord-inv-fim no-label
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "TOTAL DE COMPRAS RECEBIDAS UF - SU0003C"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "SU0003C".
...
PROCEDURE enable_UI :
   ...
   i-num-pedido-ini i-num-pedido-fim
   da-data-movto-ini da-data-movto-fim
   c-cod-estabel-ini c-cod-estabel-fim
   c-cod-comprado-ini c-cod-comprado-fim
   i-num-ord-inv-ini i-num-ord-inv-fim
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "SU0003C" + "." + v-cod-extens-arq.

    assign tt-param.c-it-codigo-ini = input frame f-pg-sel c-it-codigo-ini
           tt-param.c-it-codigo-fim = input frame f-pg-sel c-it-codigo-fim
           tt-param.c-it-codigo-fim = input frame f-pg-sel c-it-codigo-fim
           tt-param.i-num-pedido-ini = input frame f-pg-sel i-num-pedido-ini
           tt-param.i-num-pedido-fim = input frame f-pg-sel i-num-pedido-fim
           tt-param.da-data-movto-ini = input frame f-pg-sel da-data-movto-ini
           tt-param.da-data-movto-fim = input frame f-pg-sel da-data-movto-fim
           ...
           tt-param.i-num-ord-inv-ini = input frame f-pg-sel i-num-ord-inv-ini
           tt-param.i-num-ord-inv-fim = input frame f-pg-sel i-num-ord-inv-fim
.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "DTV/SU00033.p".
