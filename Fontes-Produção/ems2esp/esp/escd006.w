...
*******************************************************************************/
{include/i-prgvrs.i ESCD006 2.06.00.000}
...
DEFINE VARIABLE cod_modul_dtsul_fim AS CHARACTER FORMAT "X(3)":U INITIAL "zzz" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.

DEFINE VARIABLE cod_modul_dtsul_ini AS CHARACTER FORMAT "X(3)":U 
     LABEL "M¢dulo" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.
...
{utp/ut9000.i "ESCD006" "2.06.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 cod_modul_dtsul_ini 
