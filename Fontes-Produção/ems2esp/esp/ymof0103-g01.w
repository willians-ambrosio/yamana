...
&Scoped-Define ENABLED-OBJECTS rt-button i_cod-beneficio bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS i_cod-beneficio 
...
DEFINE FRAME d-vapara
     i_cod-beneficio AT ROW 1.75 COL 24 COLON-ALIGNED WIDGET-ID 2
...
DO:
FIND es-beneficio NO-LOCK
    WHERE es-beneficio.cod-beneficio EQ INPUT FRAME {&FRAME-NAME} i_cod-beneficio NO-ERROR.

IF NOT AVAILABLE es-beneficio THEN DO:
    {utp/ut-table.i mgesp es-beneficio 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-beneficio).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY i_cod-beneficio 
      WITH FRAME d-vapara.
  ENABLE rt-button i_cod-beneficio bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
