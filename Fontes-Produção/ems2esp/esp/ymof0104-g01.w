...
&Scoped-Define ENABLED-OBJECTS rt-button c_cod-estabel i_cod-beneficio ~
bt-ok bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod-estabel i_cod-beneficio 
...
DEFINE VARIABLE i_cod-beneficio AS INTEGER FORMAT ">>9":U 
     LABEL "Beneficio" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     c_cod-estabel AT ROW 1.5 COL 30 COLON-ALIGNED WIDGET-ID 2
     i_cod-beneficio AT ROW 2.5 COL 30 COLON-ALIGNED WIDGET-ID 4
...
DO:
FIND es-ben-estab NO-LOCK
    WHERE es-ben-estab.cod-estabel EQ INPUT FRAME {&FRAME-NAME} c_cod-estabel
      AND es-ben-estab.cod-beneficio EQ INPUT FRAME {&FRAME-NAME} i_cod-beneficio NO-ERROR.

IF NOT AVAILABLE es-ben-estab THEN DO:
    {utp/ut-table.i mgesp es-ben-estab 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-ben-estab).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod-estabel i_cod-beneficio 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cod-estabel i_cod-beneficio bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
