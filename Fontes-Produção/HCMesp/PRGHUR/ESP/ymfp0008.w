...
DEFINE VARIABLE h_YMFP0008-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_YMFP0008-v01 AS HANDLE NO-UNDO.
...
ON END-ERROR OF w-cadsim /* Manuten‡Æo Gestores */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manuten‡Æo Gestores */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prghur/esp/YMFP0008-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_YMFP0008-v01 ).
       RUN set-position IN h_YMFP0008-v01 ( 2.75 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 7.25 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prghur/esp/YMFP0008-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = prghur\esp\YMFP0008-z01.w,
                     ProgVaPara = prghur\esp\YMFP0008-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_YMFP0008-q01 ).
       RUN set-position IN h_YMFP0008-q01 ( 1.50 , 62.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_YMFP0008-v01. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_YMFP0008-v01 ).
       RUN add-link IN adm-broker-hdl ( h_YMFP0008-q01 , 'Record':U , h_YMFP0008-v01 ).

       /* Links to SmartQuery h_YMFP0008-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_YMFP0008-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_YMFP0008-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_YMFP0008-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_YMFP0008-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "YMFP0008" "12.1.11.000"}
