...
*******************************************************************************/
{include/i-prgvrs.i esap003 2.06.00.001}  /*** 010022 ***/
...
DEFINE VARIABLE h_esap003-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esap003-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     rt-button AT ROW 1.21 COL 1.86
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Cadastro Espec¡fico Conta Cosmos - esap003"
         HEIGHT             = 5.38
         WIDTH              = 89.86
         MAX-HEIGHT         = 27.54
         MAX-WIDTH          = 194.86
...
ON END-ERROR OF w-cadsim /* Cadastro Espec¡fico Conta Cosmos - esap003 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Cadastro Espec¡fico Conta Cosmos - esap003 */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-exihel ).
       RUN set-position IN h_p-exihel ( 1.29 , 74.00 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esap003-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esap003-v01 ).
       RUN set-position IN h_esap003-v01 ( 2.75 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.50 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esap003-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp\esap003-z01.w,
                     ProgVaPara = esp\esap003-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esap003-q01 ).
       RUN set-position IN h_esap003-q01 ( 1.25 , 63.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.75 , 9.00 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_esap003-v01. */
       RUN add-link IN adm-broker-hdl ( h_esap003-q01 , 'Record':U , h_esap003-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esap003-v01 ).
       RUN add-link IN adm-broker-hdl ( h_esap003-v01 , 'State':U , THIS-PROCEDURE ).

       /* Links to SmartQuery h_esap003-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_esap003-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esap003-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esap003-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-cadsim ,
             h_p-navega , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esap003-v01 ,
             h_p-cadsim , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  /* Dispatch standard ADM method.                             */
{utp/ut9000.i "esap003" "2.06.00.001"}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pi_ems_xref w-cadsim 
...
-------------------------------------------------------------*/
  ...
  RUN "panel/p-cadsim.w *RTB-SmObj* ".
  RUN "invwr/v01in142.w *RTB-SmObj* ".
  RUN "inqry/q01in142.w *RTB-SmObj* ".
