...
define variable c-prog-gerado as character no-undo initial "SU0024".
...
def var c-titulo           as char init "RELATàRIO PAR¶METRO DE ESTOQUE" no-undo.        
def var v-cod-prog-gerado  as char init "SU0024" no-undo.           
...
assign v-cod-prog-gerado = "SU0024".
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK 
   ON END-KEY UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK:
        ...
        assign c-lista = "ITENS".

        assign c-prog = "SU0024A.w".
