...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "<Funcion rios Admitidos no Per¡odo - ESHCM008.001 >"
         HEIGHT             = 12.29
         WIDTH              = 72
         MAX-HEIGHT         = 31.29
         MAX-WIDTH          = 182.86
...
ON END-ERROR OF C-Win /* <Funcion rios Admitidos no Per¡odo - ESHCM008.001 > */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* <Funcion rios Admitidos no Per¡odo - ESHCM008.001 > */
DO:
...
/************************************************************/
    ...
    /*************** Imprime altera‡äes **************************/
    /*************** Cabe»alho ***********************************/
    chWorkSheet:Range("a1"):Value = "Funcion rios Admitidos no Per¡odo " /*+ string(fi-mes-ini,"99") + " / " + string(fi-ano-ini)*/ .
    ...
    chWorkSheet:Range("a3:ah3"):Font:Bold = TRUE.
