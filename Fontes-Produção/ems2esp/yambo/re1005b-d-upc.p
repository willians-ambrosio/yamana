/*****************************************************************************************
** Programa: re1005b-d-upc.p
** Autor...: Log°stica (log339640)
** Data....: 07/2008
** OBS.....: UPC utilizada pelos programas: RE1005B.P e RE1005D.P
** Objetivo: Ao efetuar a atualizaá∆o da nota de importaá∆o (embarque vinculado Ö despesa) 
             ser† atualizado o valor REALIZADO da verba. Ser† retirado da tabela 
             espec°fica o valor compromissado que foi gerado na inclus∆o das despesas de 
             importaá∆o e atualizado o valor da despesa da nota fiscal. O controle de 
             estouro de verba ser† o mesmo do produto padr∆o -  n∆o ser† exibida mensagem 
             e sempre ser† gravado as informaá‰es. 
             Conforme definido no escopo inicial - N∆o ser† gerado valor compromissado 
             para as despesas que fizerem parte da nota fiscal principal de importaá∆o.
*****************************************************************************************/

{include/i-prgvrs.i re1005b-d-upc 2.00.00.000}  /*** 010000 ***/
...
if p-ind-event = "antes-atualizacao-investimentos" then do:
