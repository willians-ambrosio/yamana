...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-beneficio-ncm NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-beneficio-ncm NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-beneficio-ncm
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-beneficio-ncm
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.es-beneficio-ncm"
     _Options          = "NO-LOCK"
