...
define variable c-prog-gerado as character no-undo initial "CTL001".
...
def var c-titulo           as char init "Implantacao de titulos por usuario" no-undo.        
def var v-cod-prog-gerado  as char init "CTL001" no-undo.           
...
assign v-cod-prog-gerado = "CTL001".
