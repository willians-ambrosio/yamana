...
define variable c-prog-gerado as character no-undo initial "ESP002".
...
def var c-titulo           as char init "Relat¢rio de Consulta de Contratos" no-undo.        
def var v-cod-prog-gerado  as char init "esp002" no-undo.           
...
assign v-cod-prog-gerado = "esp002".
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK 
   ON END-KEY UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK:
        ...
        assign c-lista = "Contratos vigentes".

        assign c-prog = "esp002AA.w".
