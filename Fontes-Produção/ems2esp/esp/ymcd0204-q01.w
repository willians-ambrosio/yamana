...
*******************************************************************************/
{include/i-prgvrs.i YMCD0204-Q01 11.5.11.000}
...
&Scoped-define INTERNAL-TABLES es-estab-carga

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-estab-carga ~
      WHERE es-estab-carga.ep-codigo = i-ep-codigo-usuario NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-estab-carga ~
      WHERE es-estab-carga.ep-codigo = i-ep-codigo-usuario NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main es-estab-carga
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-estab-carga
...
<FOREIGN-KEYS>
cod-estabel||y|ems5_esp.es-estab-carga.cod-estabel
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems5_esp.es-estab-carga"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cod-estabel" "es-estab-carga" "cod-estabel"}
