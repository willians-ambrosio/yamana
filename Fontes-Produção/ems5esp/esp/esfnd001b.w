...
*****************************************************************************/
{include/i-prgvrs.i esfnd001b 5.06.00.000}
...
DEFINE VARIABLE h_esfnd001-q02 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esfnd001-v02 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 6.83 COL 2 HELP
          "Salva e sai"
     bt-save AT ROW 6.83 COL 12.43 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 6.83 COL 23 HELP
          "Cancela"
     bt-ajuda AT ROW 6.83 COL 70.14
     rt-button AT ROW 6.67 COL 1
...
DO:
{include/okfil.i h_esfnd001-v02}
END.
...
DO:
{include/salvafil.i h_esfnd001-v02}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esfnd001-v02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esfnd001-v02 ).
       RUN set-position IN h_esfnd001-v02 ( 1.75 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.50 , 79.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esfnd001-q02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_esfnd001-q02 ).
       RUN set-position IN h_esfnd001-q02 ( 6.50 , 55.43 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_esfnd001-v02. */
       RUN add-link IN adm-broker-hdl ( h_esfnd001-q02 , 'Record':U , h_esfnd001-v02 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_esfnd001-v02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esfnd001-v02 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esfnd001b" "5.06.00.000"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_esfnd001-v02 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_esfnd001-q02 (input v-row-table).
