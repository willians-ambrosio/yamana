...
/*****************************************************************************
** Programa..............: esjd200
** Descricao.............: Verifica Lancamentos Modulos Industriais
** Versao................: 1.00.00.000
** Procedimento..........: 
** Nome Externo..........: 
...
&Scoped-Define ENABLED-OBJECTS bt-busca-arq rt_rgf rt_cxcf bt-busca-arq-2 ~
IMAGE-15 IMAGE-16 RECT-12 bt_executar IMAGE-17 IMAGE-18 RECT-13 rs-saida ~
fi-cod_cta_ctbl-ini fi-cod_cta_ctbl-fim fi-data-ini fi-data-fim ~
fi-arquivo bt_fechar bt_cancelar Btn_Help 
&Scoped-Define DISPLAYED-OBJECTS rs-saida fi-cod_cta_ctbl-ini ~
fi-cod_cta_ctbl-fim fi-data-ini fi-data-fim fi-diretorio fi-arquivo 
...
DEFINE FRAME f_main
     bt-busca-arq AT ROW 13.79 COL 72.57
     bt-busca-arq-2 AT ROW 11.96 COL 72.57
     ...
     rs-saida AT ROW 1.25 COL 30 NO-LABEL
          ...
          "Per¡odo" NO-LABEL
     fi-diretorio AT ROW 12.17 COL 10.72 COLON-ALIGNED
     fi-arquivo AT ROW 14 COL 10.72 COLON-ALIGNED
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = ".: Verifica Lancamentos Modulos Industriais - ESJD200 :."
         HEIGHT             = 16
         WIDTH              = 80
         MAX-HEIGHT         = 42.42
         MAX-WIDTH          = 274.29
...
/* SETTINGS FOR FILL-IN fi-diretorio IN FRAME f_main
   NO-ENABLE                                                            */
...
ON END-ERROR OF C-Win /* .: Verifica Lancamentos Modulos Industriais - ESJD200 :. */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* .: Verifica Lancamentos Modulos Industriais - ESJD200 :. */
DO:
...
DO:
    ...
    assign fi-diretorio:screen-value in frame {&FRAME-NAME} = v_cod_dwb_file + "\".
END.
...
------------------------------------------------------------------------------*/
  DISPLAY rs-saida fi-cod_cta_ctbl-ini fi-cod_cta_ctbl-fim fi-data-ini 
          fi-data-fim fi-diretorio fi-arquivo 
      WITH FRAME f_main IN WINDOW C-Win.
  ENABLE bt-busca-arq rt_rgf rt_cxcf bt-busca-arq-2 IMAGE-15 IMAGE-16 RECT-12 
         bt_executar IMAGE-17 IMAGE-18 RECT-13 rs-saida fi-cod_cta_ctbl-ini 
         fi-cod_cta_ctbl-fim fi-data-ini fi-data-fim fi-arquivo 
...
IF NOT AVAIL dwb_rpt_param THEN DO:
    ...
    ASSIGN dwb_rpt_param.cod_dwb_program = "esjd200rp"
...
ASSIGN dwb_rpt_param.cod_dwb_parameters = STRING (INPUT FRAME {&FRAME-NAME} fi-cod_cta_ctbl-ini)
       ...
       dwb_rpt_param.cod_dwb_parameters = dwb_rpt_param.cod_dwb_parameters + ";" + STRING (INPUT FRAME {&FRAME-NAME} fi-data-ini)
       dwb_rpt_param.cod_dwb_parameters = dwb_rpt_param.cod_dwb_parameters + ";" + STRING (INPUT FRAME {&FRAME-NAME} fi-data-fim)
       dwb_rpt_param.cod_dwb_parameters = dwb_rpt_param.cod_dwb_parameters + ";" /* anteriormente existia desabilitar a conta-contab */
       dwb_rpt_param.cod_dwb_parameters = dwb_rpt_param.cod_dwb_parameters + ";" + STRING (INPUT FRAME {&FRAME-NAME} fi-diretorio)
...
IF INTEGER (INPUT FRAME {&FRAME-NAME} rs-saida) = 2 THEN DO: /* Batch */
    run prgtec/btb/btb911za.p (Input "esjd200rp",
                               Input "5.06.00.001",
                               Input 40,
...
*/
    ...
    assign fi-diretorio:screen-value = SESSION:TEMP-DIRECTORY
           fi-arquivo  :screen-value = SESSION:TEMP-DIRECTORY + "esjd200-" + STRING(TIME) + ".csv"
           fi-data-ini :screen-value = STRING (TODAY,"99/99/9999")
           fi-data-fim :screen-value = STRING (TODAY,"99/99/9999").
    end.
END PROCEDURE.
