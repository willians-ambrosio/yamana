...
/*------------------------------------------------------------------------
File.............: esbtb004.w
Description......: Exporta para Ilha a Condi‡Æo de Pagamento
Input Parameters : 
Output Parameters: 
Author...........: Daniel Pereira de Lima
Created..........: 08/12/10 - 10:52

------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "esbtb004".
...
DEFINE FRAME f-pg-sel
   i-cod-cond-pag-ini label "Cond"
     at row 1 col 22 colon-aligned
     view-as fill-in 
     size 4 by .88
     font 1

   i-cod-cond-pag-fim no-label
     at row 1 col 36 colon-aligned
     view-as fill-in 
     size 4 by .88
     font 1

   IMAGE-1 AT ROW 01.00 COL 29
   IMAGE-2 AT ROW 01.00 COL 34
   WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY
   SIDE-LABELS NO-UNDERLINE THREE-D
   AT COL 3 ROW 2.85
   SIZE 76.86 BY 10.62.
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Exporta para Ilha a Condi‡Æo de Pagamento - esbtb004"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "esbtb004".
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "esbtb004" + "." + v-cod-extens-arq.

    assign tt-param.i-cod-cond-pag-ini = input frame f-pg-sel i-cod-cond-pag-ini
           tt-param.i-cod-cond-pag-fim = input frame f-pg-sel i-cod-cond-pag-fim
           tt-param.i-cod-cond-pag-fim = input frame f-pg-sel i-cod-cond-pag-fim
.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "esp/esbtb004rp.p".
