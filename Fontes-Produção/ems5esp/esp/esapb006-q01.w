...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-cat-code NO-LOCK ~
    BY es-cat-code.cat-code
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-cat-code NO-LOCK ~
    BY es-cat-code.cat-code.
&Scoped-define TABLES-IN-QUERY-Query-Main es-cat-code
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-cat-code
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Options          = "NO-LOCK"
     _OrdList          = "ems5_esp.es-cat-code.cat-code|yes"
