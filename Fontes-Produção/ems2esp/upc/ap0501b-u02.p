DEFINE NEW GLOBAL SHARED VARIABLE wh-ap0501b-ccusto   AS HANDLE        NO-UNDO.
DEFINE NEW GLOBAL SHARED VARIABLE wh-ap0501b-conta    AS HANDLE        NO-UNDO.
...
def new global shared var v_rec_cta_ctbl
    ...
    if  v_rec_cta_ctbl <> ? then do:
        ...
        assign wh-ap0501b-conta:screen-value = string(cta_ctbl.cod_cta_ctbl,plano_cta_ctbl.cod_format_cta_ctbl).
    end.
