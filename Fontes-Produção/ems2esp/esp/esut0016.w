...
*******************************************************************************/
{include/i-prgvrs.i ESUT0016 2.06.00.000}
...
DEFINE VARIABLE dt-corte AS DATE FORMAT "99/99/9999":U 
     LABEL "Data de Corte" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 TOOLTIP "Data de Corte" NO-UNDO.
...
DEFINE FRAME f-pg-sel
     cod_usuario-ini AT ROW 1.67 COL 13 COLON-ALIGNED HELP
          "C¢digo Usu rio" WIDGET-ID 2
     cod_usuario-fim AT ROW 1.67 COL 48.14 COLON-ALIGNED HELP
          "C¢digo Usu rio" NO-LABEL WIDGET-ID 4
     IMAGE-1 AT ROW 1.67 COL 31.86
     IMAGE-2 AT ROW 1.67 COL 47.29
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
DEFINE FRAME f-pg-par
     dt-corte AT ROW 1.25 COL 16 COLON-ALIGNED WIDGET-ID 2
     l-elimina AT ROW 2.79 COL 4 WIDGET-ID 4
     RECT-2 AT ROW 1 COL 1 WIDGET-ID 6
     RECT-3 AT ROW 2.5 COL 1 WIDGET-ID 8
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Elimina‡Æo de Grupos de Seguran‡a de Usu rios Inativos"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
/* SETTINGS FOR FRAME f-pg-par
                                                                        */
/* SETTINGS FOR RECTANGLE RECT-2 IN FRAME f-pg-par
   NO-ENABLE                                                            */
/* SETTINGS FOR RECTANGLE RECT-3 IN FRAME f-pg-par
   NO-ENABLE                                                            */
...
ON END-ERROR OF w-relat /* Elimina‡Æo de Grupos de Seguran‡a de Usu rios Inativos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Elimina‡Æo de Grupos de Seguran‡a de Usu rios Inativos */
DO:
...
{utp/ut9000.i "ESUT0016" "2.06.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN dt-corte:SCREEN-VALUE IN FRAME f-pg-par = STRING(TODAY,'99/99/9999').
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY cod_usuario-ini cod_usuario-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 cod_usuario-ini cod_usuario-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY dt-corte l-elimina 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE dt-corte l-elimina 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    IF INPUT FRAME f-pg-sel cod_usuario-ini > INPUT FRAME f-pg-sel cod_usuario-fim THEN DO:
       apply "MOUSE-SELECT-CLICK":U to im-pg-sel in frame f-relat.
       run utp/ut-msgs.p (input "show":U, input 142, input "Usu rio~~Usu rio").
       apply "ENTRY":U to cod_usuario-ini in FRAME f-pg-sel.
       return error.
    END.
    ...
    ASSIGN tt-param.cod_usuario-ini = INPUT FRAME f-pg-sel cod_usuario-ini
           tt-param.cod_usuario-fim = INPUT FRAME f-pg-sel cod_usuario-fim
           tt-param.dt-corte        = INPUT FRAME f-pg-par dt-corte
           tt-param.l-elimina       = INPUT FRAME f-pg-par l-elimina.
    ...
    {include/i-rprun.i esp/esut0016rp.p}
