...
*****************************************************************************/
{include/i-prgvrs.i esfnd001-q01 5.06.00.000}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-param-prog-pai NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-param-prog-pai NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main es-param-prog-pai
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-param-prog-pai
...
<FOREIGN-KEYS>
cod_prog_dtsul||y|emp.es-param-prog-pai.cod_prog_dtsul
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
