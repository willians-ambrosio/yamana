...
**       Data....: 09/12/10
**       Autor...: DATASUL S.A.
**       Objetivo: SEGURADORA - ENVIOS NO M“S
**       Vers∆o..: 1.00.000 - adm
**       OBS.....: Este fonte foi gerado pelo Data Viewer 3.00
*******************************************************************************/

define variable c-prog-gerado as character no-undo initial "RELT0655".
...
form nota-fiscal.dt-emis-nota column-label "Emiss∆o" format "99/99/9999" at 001
     ...
     emitente.cidade column-label "Cidade" format "X(25)" at 075
     emitente.estado column-label "UF" format "x(4)" at 101
     emitente.pais column-label "Pa°s" format "X(20)" at 106
...
assign c-programa     = "RELT0655"
       c-versao       = "2.06"
       c-revisao      = ".00.000"
       c-titulo-relat = "SEGURADORA - ENVIOS NO M“S"
       c-sistema      = "EMS".
