...
*******************************************************************************/
{include/i-prgvrs.i ESAP006 2.06.00.001}
...
DEFINE VARIABLE h_esap006-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esap006-v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'app/esap006-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esap006-v01 ).
       RUN set-position IN h_esap006-v01 ( 2.67 , 1.43 ) NO-ERROR.
       /* Size in UIB:  ( 2.25 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'app/esap006-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = app/esap006-z01.w,
                     ProgVaPara = app/esap006-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esap006-q01 ).
       RUN set-position IN h_esap006-q01 ( 1.33 , 68.43 ) NO-ERROR.
       /* Size in UIB:  ( 1.25 , 5.00 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_esap006-v01. */
       RUN add-link IN adm-broker-hdl ( h_esap006-q01 , 'Record':U , h_esap006-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esap006-v01 ).

       /* Links to SmartQuery h_esap006-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_esap006-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esap006-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esap006-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esap006-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESAP006" "2.06.00.001"}
