...
*******************************************************************************/
{include/i-prgvrs.i YMAC0004 1.02.00.003 } /*** 010003 ***/
/*------------------------------------------------------------------------
...
DEFINE FRAME f-pg-sel
     i-es-ini AT ROW 1.5 COL 24 COLON-ALIGNED HELP
          "Informe C¢digo do Estabelecimento Inicial"
     i-es-fim AT ROW 1.5 COL 48.86 COLON-ALIGNED HELP
          "Informe C¢digo do Estabelecimento Final" NO-LABEL
     i-ban-liq-ini AT ROW 2.5 COL 24 COLON-ALIGNED HELP
          "Informe C¢digo do Banco Inicial"
     i-ban-liq-fin AT ROW 2.5 COL 48.86 COLON-ALIGNED HELP
          "Informe C¢digo do Banco Final" NO-LABEL
     da-pgto-ini AT ROW 3.5 COL 24 COLON-ALIGNED HELP
          "Informe Data de Pagamento Inicial"
     da-pgto-fin AT ROW 3.5 COL 62.86 RIGHT-ALIGNED HELP
          "Informe Data de Pagamento Final" NO-LABEL
     v_matr_ini AT ROW 4.5 COL 23 COLON-ALIGNED WIDGET-ID 2
     v_matr_fim AT ROW 4.5 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     ...
     IMAGE-1 AT ROW 1.5 COL 38.86
     IMAGE-2 AT ROW 1.5 COL 48.29
     IMAGE-5 AT ROW 3.5 COL 38.86
     IMAGE-6 AT ROW 2.5 COL 38.86
     IMAGE-7 AT ROW 2.5 COL 48.29
     IMAGE-9 AT ROW 3.5 COL 48.29
     RECT-14 AT ROW 6.25 COL 18.72
     IMAGE-8 AT ROW 4.5 COL 39 WIDGET-ID 6
     IMAGE-10 AT ROW 4.5 COL 48 WIDGET-ID 8
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62.
...
{utp/ut9000.i "YMAC0004" "1.02.00.000"}
...
do  on error undo, return error
   ...
   assign  tt-param.c-arq-lqd       = input frame f-pg-par c-arq-lqd
    ...
    {include/i-rprun.i prghur/esp/ymac0004rp.p}
