...
define {1} {2} temp-table tt-param
    ...
    field i-ban-liq-ini           as integer
    field i-ban-liq-fin           as integer
    field da-pgto-ini             as date format "99/99/9999"
    field da-pgto-fin             as date format "99/99/9999"
    ...
    field num_convenio            as int     format "999999"
