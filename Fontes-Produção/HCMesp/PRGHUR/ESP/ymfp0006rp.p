...
{include/i-prgvrs.i YMFP0006RP 1.02.00.003 } /*** 010003 ***/
/*******************************************************************************
**
...
{utp/ut-liter.i Liquido_Meio_Magn‚tico_Banco_Bradesco MFP C}
      ...
      do v_num_index = 1 to 6:
         if (v_num_index = 1 and
            ...
            for each funcionario of param_empres_rh no-lock where
                ...
                run pi-acompanhar in h-acomp (input string(v_num_cont)).
