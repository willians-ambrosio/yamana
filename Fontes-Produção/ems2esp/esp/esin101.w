...
*******************************************************************************/
{include/i-prgvrs.i esin101 2.00.00.002}  /*** 010002 ***/
...
DEFINE VARIABLE c-arquivo-2 AS CHARACTER INITIAL "esin101.TXT" 
     VIEW-AS EDITOR MAX-CHARS 256
     SIZE 44 BY .88
     BGCOLOR 15  NO-UNDO.
...
DEFINE VARIABLE text-modo-2 AS CHARACTER FORMAT "X(256)":U INITIAL "Arquivo de destino" 
      VIEW-AS TEXT 
...
DEFINE VARIABLE i-data-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.

DEFINE VARIABLE i-data-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/1900 
     LABEL "Periodo" 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     i-emp-ini AT ROW 1.92 COL 19 COLON-ALIGNED
     c-est-ini AT ROW 2.96 COL 19 COLON-ALIGNED
     c-est-fim AT ROW 2.96 COL 48.86 COLON-ALIGNED NO-LABEL
     i-proj-ini AT ROW 3.96 COL 19 COLON-ALIGNED
     i-proj-fim AT ROW 3.96 COL 48.86 COLON-ALIGNED NO-LABEL
     i-ordem-ini AT ROW 4.96 COL 19 COLON-ALIGNED
     i-ordem-fim AT ROW 4.96 COL 48.86 COLON-ALIGNED NO-LABEL
     i-data-ini AT ROW 5.92 COL 19 COLON-ALIGNED
     i-data-fim AT ROW 6 COL 49 COLON-ALIGNED NO-LABEL
     IMAGE-1 AT ROW 1.96 COL 32.57
     IMAGE-10 AT ROW 2.96 COL 48
     IMAGE-11 AT ROW 6 COL 32.57
     IMAGE-12 AT ROW 6 COL 48
     IMAGE-5 AT ROW 4.96 COL 32.57
     IMAGE-6 AT ROW 4.96 COL 48
     IMAGE-7 AT ROW 3.96 COL 32.57
     IMAGE-8 AT ROW 3.96 COL 48
     IMAGE-9 AT ROW 2.96 COL 32.57
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62.
...
DEFINE FRAME f-pg-imp
     ...
     bt-config-impr AT ROW 3.54 COL 43.43 HELP
     ...
     c-arquivo-2 AT ROW 8.04 COL 3 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     text-destino AT ROW 1.63 COL 3.86 NO-LABEL
     text-modo AT ROW 5 COL 1.29 COLON-ALIGNED NO-LABEL
     text-modo-2 AT ROW 7.25 COL 1.14 COLON-ALIGNED NO-LABEL
     RECT-10 AT ROW 7.54 COL 2
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "<Cost Detailed Report - esin101.001 >"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 30.25
         MAX-WIDTH          = 182.86
...
ON END-ERROR OF w-relat /* <Cost Detailed Report - esin101.001 > */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* <Cost Detailed Report - esin101.001 > */
DO:
...
{utp/ut9000.i "esin101" "2.00.00.002"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN i-emp-ini:SCREEN-VALUE IN FRAME f-pg-sel = string(param-globa.empresa-prin).
   {include/i-rpmbl.i}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY i-emp-ini c-est-ini c-est-fim i-proj-ini i-proj-fim i-ordem-ini 
          i-ordem-fim i-data-ini i-data-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE i-emp-ini c-est-ini c-est-fim i-proj-ini i-proj-fim i-ordem-ini 
         i-ordem-fim i-data-ini i-data-fim IMAGE-1 IMAGE-10 IMAGE-11 IMAGE-12 
         IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 IMAGE-9 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-sel}
  DISPLAY rs-destino c-arquivo rs-execucao c-arquivo-2 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
  ENABLE rs-destino bt-config-impr bt-arquivo c-arquivo rs-execucao c-arquivo-2 
         RECT-10 RECT-7 RECT-9 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.classif-1       = 2
           tt-param.desc-classifica = "Data"
           ...
           tt-param.i-data-ini      = input frame f-pg-sel i-data-ini
           tt-param.i-data-fim      = input frame f-pg-sel i-data-fim
           tt-param.i-moeda-par     = 1
           tt-param.atualiza        = NO .
    ...
    then assign tt-param.arquivo = "".
         ...
         ASSIGN tt-param.arquivo-destino = input frame f-pg-imp c-arquivo-2.
    ...
    {include/i-rprun.i esp/esin101rp.p}
