...
*******************************************************************************/
{include/i-prgvrs.i APYA501f 12.1.17.000}  /*** 010007 ***/


&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i APYA501f APL}
&ENDIF
...
DEFINE VARIABLE h_apya501f-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_apya501f-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 8.83 COL 2 HELP
          "Salva e sai"
     bt-save AT ROW 8.83 COL 12 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 8.83 COL 22 HELP
          "Cancela"
     bt-ajuda AT ROW 8.83 COL 78.57
     rt-button AT ROW 8.58 COL 1
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Manuten‡Æo de Contrato Filho"
         HEIGHT             = 9.79
         WIDTH              = 89.43
         MAX-HEIGHT         = 26.75
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-cadsim /* Manuten‡Æo de Contrato Filho */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manuten‡Æo de Contrato Filho */
DO:
...
DO:
     RUN local-assign-record IN h_apya501f-v01.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apl/apya501f-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_apya501f-v01 ).
       RUN set-position IN h_apya501f-v01 ( 1.13 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 7.25 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apl/apya501f-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_apya501f-q01 ).
       RUN set-position IN h_apya501f-q01 ( 8.00 , 65.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.79 , 8.29 ) */

       /* Links to SmartViewer h_apya501f-v01. */
       RUN add-link IN adm-broker-hdl ( h_apya501f-q01 , 'Record':U , h_apya501f-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_apya501f-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_apya501f-v01 ,
...
{utp/ut9000.i "APYA501f" "12.1.17.000"}
  
 

  run pi-atualiza-parent in h_apya501f-v01 (input v-row-parent). 
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
 RUN pi-reposiciona-query IN h_apya501f-q01 (input v-row-table).
...
-------------------------------------------------------------*/
  RUN prgfin/apl/apya501f-q01.w.
  RUN prgfin/apl/apya501f-v01.w.
