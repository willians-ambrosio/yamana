...
DEFINE VARIABLE h_estip0001b-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_estip0001b-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 6.17 COL 2 HELP
          "Salva e sai"
     bt-save AT ROW 6.17 COL 12.43 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 6.17 COL 23 HELP
          "Cancela"
     bt-ajuda AT ROW 6.17 COL 70.14
     rt-button AT ROW 6 COL 1
...
DO:
{include/okfil.i h_estip0001b-v01}
END.
...
DO:
{include/salvafil.i h_estip0001b-v01}
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_folder ( 4.46 , 79.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/estip0001b-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_estip0001b-v01 ).
       RUN set-position IN h_estip0001b-v01 ( 3.00 , 2.43 ) NO-ERROR.
       /* Size in UIB:  ( 3.00 , 78.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/estip0001b-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_estip0001b-q01 ).
       RUN set-position IN h_estip0001b-q01 ( 6.08 , 43.43 ) NO-ERROR.
       /* Size in UIB:  ( 1.00 , 9.00 ) */

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_estip0001b-v01. */
       RUN add-link IN adm-broker-hdl ( h_estip0001b-q01 , 'Record':U , h_estip0001b-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_estip0001b-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             bt-ok:HANDLE IN FRAME f-cad , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_estip0001b-v01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESTIP0001B" "2.12.00.004"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_estip0001b-v01 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_estip0001b-q01 (input v-row-table).
