...
**         Data: 24/07/2018
** Change/Chamado: 
**      Objetivo: Retorna a forma de lanáamento para o header do lote - posiá∆o de 12 a 13   e
**                A vers∆o do layout posiá∆o 14 a 16 
**
...
def var v_layout  as char no-undo.
def var v_banco   as char no-undo.
...
/* Tratamento para a forma de lanáamento e vers∆o do layout */
...
if avail tt_param_program_formul then do:
    ...
    if avail reg_proces_entr_edi then do:
           ...
           else do: /* Qdo movimento Ç agrupado */
    ...
    CASE v_retorno:
         ...
         /* Igual para todos os bancos - Bradesco Forma de lanáamento e layout*/
         ...
         WHEN "18" THEN assign v_retorno = v_retorno + "012". /* DARF Simples */ 
         WHEN "19" THEN assign v_retorno = v_retorno + "012". /* DARF Simples */ 
         WHEN "21" THEN assign v_retorno = v_retorno + "012". /* DARJ Simples */ 
         WHEN "22" THEN assign v_retorno = v_retorno + "012". /* GARE-SP (ICMS/DR/ITCMD) N4 */                                       
         WHEN "23" THEN assign v_retorno = v_retorno + "012". /* GARE-SP (ICMS/DR/ITCMD) N4 */                                     
         WHEN "24" THEN assign v_retorno = v_retorno + "012". /* GARE-SP (ICMS/DR/ITCMD) N4 */  
         WHEN "25" THEN assign v_retorno = v_retorno + "012". /* IPVA */
         WHEN "26" THEN assign v_retorno = v_retorno + "012". /* LICENCIAMENTO */
         WHEN "27" THEN assign v_retorno = v_retorno + "012". /* DPVAT */
         WHEN "40" THEN assign v_retorno = "11012". /* FGTS */
