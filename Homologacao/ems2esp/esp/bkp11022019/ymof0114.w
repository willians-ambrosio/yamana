...
DEFINE VARIABLE c-cfa-f AS CHARACTER FORMAT "x(4)":U INITIAL "ZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-cfa-i AS CHARACTER FORMAT "X(4)":U 
     LABEL "CFA" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-class-f AS CHARACTER FORMAT "9999.99.99":U INITIAL "999999999" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-class-i AS CHARACTER FORMAT "9999.99.99" INITIAL "000000000000" 
     LABEL "Classifica‡Æo Fiscal" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-item-f AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-item-i AS CHARACTER FORMAT "X(16)":U 
     LABEL "Item" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-cla
     rs-classif AT ROW 1.29 COL 2.14 HELP
          "Classifica‡Æo para emissão do relat¢rio" NO-LABEL
...
DEFINE FRAME f-pg-imp
     rs-destino AT ROW 1.63 COL 3.29 HELP
          "Destino de Impressão do Relat¢rio" NO-LABEL
...
DEFINE FRAME f-pg-sel
     c-item-i AT ROW 2.75 COL 19 COLON-ALIGNED
     c-item-f AT ROW 2.75 COL 39.86 COLON-ALIGNED NO-LABEL
     c-class-i AT ROW 3.75 COL 19 COLON-ALIGNED WIDGET-ID 4
     c-class-f AT ROW 3.75 COL 40.29 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     c-cfa-i AT ROW 4.75 COL 19 COLON-ALIGNED WIDGET-ID 10
     c-cfa-f AT ROW 4.75 COL 40.29 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     IMAGE-1 AT ROW 2.75 COL 35.86
     IMAGE-2 AT ROW 2.75 COL 39
     IMAGE-11 AT ROW 3.75 COL 36.29 WIDGET-ID 6
     IMAGE-12 AT ROW 3.75 COL 39.29 WIDGET-ID 8
     IMAGE-13 AT ROW 4.75 COL 36.29 WIDGET-ID 14
     IMAGE-14 AT ROW 4.75 COL 39.29 WIDGET-ID 16
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
DO:
    /*:T É aqui que a grava‡Æo da linha da temp-table é efetivada.
...
&Scoped-define SELF-NAME c-cfa-f
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-cfa-f w-relat
ON MOUSE-SELECT-DBLCLICK OF c-cfa-f IN FRAME f-pg-sel
DO:
...
&Scoped-define SELF-NAME c-cfa-i
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-cfa-i w-relat
ON MOUSE-SELECT-DBLCLICK OF c-cfa-i IN FRAME f-pg-sel /* CFA */
DO:
  {include/zoomvar.i &prog-zoom=ESP\YMOF0103B-P01.W
                        &campo=c-cfa-i
                        &campozoom=CLASSE
...
&Scoped-define SELF-NAME c-class-f
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-class-f w-relat
ON MOUSE-SELECT-DBLCLICK OF c-class-f IN FRAME f-pg-sel
DO:
...
&Scoped-define SELF-NAME c-class-i
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-class-i w-relat
ON MOUSE-SELECT-DBLCLICK OF c-class-i IN FRAME f-pg-sel /* Classifica‡Æo Fiscal */
DO:
  {include/zoomvar.i &prog-zoom=inzoom\z01in046.r
                        &campo=c-class-i
                        &campozoom=class-fiscal
...
&Scoped-define SELF-NAME c-item-f
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-item-f w-relat
ON MOUSE-SELECT-DBLCLICK OF c-item-f IN FRAME f-pg-sel
DO:
...
&Scoped-define SELF-NAME c-item-i
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL c-item-i w-relat
ON MOUSE-SELECT-DBLCLICK OF c-item-i IN FRAME f-pg-sel /* Item */
DO:
  {include/zoomvar.i &prog-zoom=inzoom\z02in172.r
                        &campo=c-item-i
                        &campozoom=it-codigo
...
{utp/ut9000.i "YMOF0114" "1.00.00.000"}

   c-cfa-f:LOAD-MOUSE-POINTER('image/lupa.cur').
   c-cfa-i:LOAD-MOUSE-POINTER('image/lupa.cur').
   c-class-f:LOAD-MOUSE-POINTER('image/lupa.cur').
   c-class-i:LOAD-MOUSE-POINTER('image/lupa.cur').
   c-item-f:LOAD-MOUSE-POINTER('image/lupa.cur').
   c-item-i:LOAD-MOUSE-POINTER('image/lupa.cur').
...
/*:T inicializações do template de relat¢rio */
{include/i-rpini.i}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-item-i c-item-f c-class-i c-class-f c-cfa-i c-cfa-f 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-11 IMAGE-12 IMAGE-13 IMAGE-14 c-item-i c-item-f 
         c-class-i c-class-f c-cfa-i c-cfa-f 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    /*:T Coloque aqui as validações da página de Digita‡Æo, lembrando que elas devem
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.c-ncm-i         = INPUT FRAME f-pg-sel c-class-i
           tt-param.c-ncm-f         = INPUT FRAME f-pg-sel c-class-f
           tt-param.c-cfa-i         = INPUT frame f-pg-sel c-cfa-i
           tt-param.c-cfa-f         = INPUT frame f-pg-sel c-cfa-f
           ...
           /*Alterado 14/02/2005 - tech1007 - Armazena a informa‡Æo se o RTF está habilitado ou não*/
           tt-param.l-habilitaRtf     = INPUT FRAME f-pg-imp l-habilitaRtf
           /*Fim alteracao 14/02/2005*/ 
           &endif
           .
    
    /*Alterado 14/02/2005 - tech1007 - Alterado o teste para verificar se a op‡Æo de RTF está selecionada*/
    ...
    /*:T Executar do programa RP.P que irá criar o relat¢rio */
    {include/i-rpexb.i}
    
    SESSION:SET-WAIT-STATE("general":U).
    
    {include/i-rprun.i esp/ymof0114rp.p}
