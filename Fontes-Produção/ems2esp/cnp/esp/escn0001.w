...
*******************************************************************************/
{include/i-prgvrs.i ESCN0001 2.00.00.001 } /*** 010001 ***/
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESCN0001 CNP}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESCN0001
...
&GLOBAL-DEFINE page4Widgets   bt-dir-destino
...
&GLOBAL-DEFINE page4Text      text-dir-destino
...
&GLOBAL-DEFINE page4Fields    c-dir-destino 
...
DEFINE BUTTON bt-dir-destino 
     IMAGE-UP FILE "image\im-sea":U
     IMAGE-INSENSITIVE FILE "image\ii-sea":U
     LABEL "" 
     SIZE 4 BY 1.

DEFINE VARIABLE c-dir-destino AS CHARACTER FORMAT "x(255)" 
     VIEW-AS FILL-IN 
     SIZE 40 BY .88
     BGCOLOR 15 FONT 1 NO-UNDO.

DEFINE VARIABLE text-dir-destino AS CHARACTER FORMAT "X(256)":U INITIAL "Diret¢rio Destino" 
      VIEW-AS TEXT 
     SIZE 14.86 BY .63
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage4
     c-dir-destino AT ROW 5.04 COL 19.14 COLON-ALIGNED HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     bt-dir-destino AT ROW 5.04 COL 61.14 HELP
          "Escolha do nome do arquivo"
     text-dir-destino AT ROW 4 COL 22.14 NO-LABEL
     RECT-12 AT ROW 4.25 COL 20
...
/* SETTINGS FOR FRAME fPage4
                                                                        */
/* SETTINGS FOR FILL-IN text-dir-destino IN FRAME fPage4
   NO-DISPLAY NO-ENABLE ALIGN-L                                         */
ASSIGN 
       text-dir-destino:PRIVATE-DATA IN FRAME fPage4     = 
                "Diret¢rio Destino".
...
&Scoped-define SELF-NAME bt-dir-destino
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-dir-destino wReport
ON CHOOSE OF bt-dir-destino IN FRAME fPage4
DO:
    {report/imarq.i c-dir-destino fPage4}
END.
...
------------------------------------------------------------------------------*/
    ...
    DEF VAR c-nr-contrato AS CHAR NO-UNDO.
    ...
    FIND FIRST contrato-for NO-LOCK
        WHERE ROWID(contrato-for) = gr-contrato-for NO-ERROR.
    IF AVAIL contrato-for THEN
        ASSIGN c-nr-contrato = STRING(contrato-for.nr-contrato).
    
    FIND FIRST usuar_mestre NO-LOCK
        WHERE usuar_mestre.cod_usuario = c-seg-usuario NO-ERROR.
    IF AVAIL usuar_mestre THEN DO:
        ASSIGN c-dir-spool = usuar_mestre.nom_dir_spool + "\" + usuar_mestre.nom_subdir_spool + "\".
    END.

    ASSIGN c-dir-destino = REPLACE(c-dir-spool, "~\":U, "~/":U) + "Exporta_Contrato_" + c-nr-contrato + "~.csv"
           c-dir-destino = REPLACE(c-dir-destino, "~//":U, "~/":U).

    DISPLAY c-dir-destino
        WITH FRAME fPage4.
...
do on error undo, return error on stop  undo, return error:
    ...
    FIND FIRST contrato-for NO-LOCK
        WHERE ROWID(contrato-for) = gr-contrato-for NO-ERROR.
    IF AVAIL contrato-for THEN
        ASSIGN tt-param.nr-contrato = contrato-for.nr-contrato.
    
    ASSIGN tt-param.arquivo-destino = INPUT FRAME fPage4 c-dir-destino.
    ...
    {report/rprun.i cnp/esp/escn0001rp.p}
