...
PROCEDURE pi-tt-export:
  ...
  Assign 
    ...
    tt-export.cod_pais_ender        = rh_pessoa_fisic.cod_pais_ender
    ...
    tt-export.nom_bairro_rh         = rh_pessoa_fisic.nom_bairro_rh
    ...
    tt-export.val_salario_atual     = funcionario.val_salario_atual * 13
