...
*******************************************************************************/
{include/i-prgvrs.i ESCC002 2.06.00.002}
...
DEFINE VARIABLE l-csv AS LOGICAL INITIAL yes 
     LABEL "Gera arquivo em Formato CSV" 
     VIEW-AS TOGGLE-BOX
     SIZE 44 BY 1.08 NO-UNDO.
...
DEFINE VARIABLE cod-estab-gestor-fim AS CHARACTER FORMAT "X(3)" INITIAL "zzz" 
     VIEW-AS FILL-IN 
     SIZE 7.14 BY .88.

DEFINE VARIABLE cod-estab-gestor-ini AS CHARACTER FORMAT "X(3)" 
     LABEL "Estabel Gestor":R17 
     VIEW-AS FILL-IN 
     SIZE 7.14 BY .88.
...
DEFINE VARIABLE dt-ini-validade-fim AS DATE FORMAT "99/99/9999" INITIAL 12/31/2999 
     VIEW-AS FILL-IN 
     SIZE 12.57 BY .88.

DEFINE VARIABLE dt-ini-validade-ini AS DATE FORMAT "99/99/9999" INITIAL 01/01/1900 
     LABEL "Data In¡cio Validade":R24 
     VIEW-AS FILL-IN 
     SIZE 12.57 BY .88.

DEFINE VARIABLE dt-ter-validade-fim AS DATE FORMAT "99/99/9999" INITIAL 12/31/2999 
     VIEW-AS FILL-IN 
     SIZE 12.57 BY .88.

DEFINE VARIABLE dt-ter-validade-ini AS DATE FORMAT "99/99/9999" INITIAL 01/01/1900 
     LABEL "Data T‚rmino":R15 
     VIEW-AS FILL-IN 
     SIZE 12.57 BY .88.

DEFINE VARIABLE gestor-tecnico-fim AS CHARACTER FORMAT "x(12)" INITIAL "zzzzzzzzzzzz" 
     VIEW-AS FILL-IN 
     SIZE 16.14 BY .88.

DEFINE VARIABLE gestor-tecnico-ini AS CHARACTER FORMAT "x(12)" 
     LABEL "Gestor T‚cnico":R17 
     VIEW-AS FILL-IN 
     SIZE 16.14 BY .88.

DEFINE VARIABLE nr-contrato-fim AS INTEGER FORMAT ">>>>>>>>9" INITIAL 999999999 
     VIEW-AS FILL-IN 
     SIZE 11.43 BY .88.

DEFINE VARIABLE nr-contrato-ini AS INTEGER FORMAT ">>>>>>>>9" INITIAL 0 
...
DEFINE FRAME f-pg-sel
     cod-estabel-ini AT ROW 1.17 COL 35 RIGHT-ALIGNED HELP
          "Estabelecimento" WIDGET-ID 40
     cod-estabel-fim AT ROW 1.17 COL 49.43 COLON-ALIGNED HELP
          "Estabelecimento" NO-LABEL WIDGET-ID 38
     cod-estab-gestor-ini AT ROW 2.17 COL 35 RIGHT-ALIGNED HELP
          "Estabelecimento Gestor" WIDGET-ID 18
     cod-estab-gestor-fim AT ROW 2.17 COL 49.43 COLON-ALIGNED HELP
          "Estabelecimento Gestor" NO-LABEL WIDGET-ID 28
     nr-contrato-ini AT ROW 3.17 COL 35 RIGHT-ALIGNED HELP
          "Permite informar o numero do contrato de fornecimento" WIDGET-ID 26
     nr-contrato-fim AT ROW 3.17 COL 49.43 COLON-ALIGNED HELP
          "Permite informar o numero do contrato de fornecimento" NO-LABEL WIDGET-ID 36
     dt-ini-validade-ini AT ROW 4.17 COL 35 RIGHT-ALIGNED HELP
          "Data in¡cio da validade do contrato de fornecimento" WIDGET-ID 20
     dt-ini-validade-fim AT ROW 4.17 COL 49.43 COLON-ALIGNED HELP
          "Data in¡cio da validade do contrato de fornecimento" NO-LABEL WIDGET-ID 30
     dt-ter-validade-ini AT ROW 5.17 COL 35 RIGHT-ALIGNED HELP
          "Data de t‚rmino da validade do contrato de fornecimento" WIDGET-ID 22
     dt-ter-validade-fim AT ROW 5.17 COL 49.43 COLON-ALIGNED HELP
          "Data de t‚rmino da validade do contrato de fornecimento" NO-LABEL WIDGET-ID 32
     gestor-tecnico-ini AT ROW 6.17 COL 35 RIGHT-ALIGNED HELP
          "Gestor T‚cnico respons vel pelo contrato" WIDGET-ID 24
     gestor-tecnico-fim AT ROW 6.17 COL 49.43 COLON-ALIGNED HELP
          "Gestor T‚cnico respons vel pelo contrato" NO-LABEL WIDGET-ID 34
     IMAGE-1 AT ROW 2.17 COL 37
     IMAGE-2 AT ROW 2.17 COL 47.29
     IMAGE-39 AT ROW 3.17 COL 37 WIDGET-ID 2
     IMAGE-40 AT ROW 3.17 COL 47.29 WIDGET-ID 4
     IMAGE-41 AT ROW 4.17 COL 37 WIDGET-ID 6
     IMAGE-42 AT ROW 4.17 COL 47.29 WIDGET-ID 8
     IMAGE-43 AT ROW 5.17 COL 37 WIDGET-ID 10
     IMAGE-44 AT ROW 5.17 COL 47.29 WIDGET-ID 12
     IMAGE-45 AT ROW 6.17 COL 37 WIDGET-ID 14
     IMAGE-46 AT ROW 6.17 COL 47.29 WIDGET-ID 16
     IMAGE-47 AT ROW 1.17 COL 37 WIDGET-ID 42
     IMAGE-48 AT ROW 1.17 COL 47.29 WIDGET-ID 44
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
DEFINE FRAME f-pg-imp
     ...
     l-csv AT ROW 9.83 COL 3.29 WIDGET-ID 2
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Relat¢rio Hist¢rico de Contratos"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
/* SETTINGS FOR FRAME f-pg-sel
                                                                        */
/* SETTINGS FOR FILL-IN cod-estab-gestor-ini IN FRAME f-pg-sel
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN cod-estabel-ini IN FRAME f-pg-sel
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN dt-ini-validade-ini IN FRAME f-pg-sel
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN dt-ter-validade-ini IN FRAME f-pg-sel
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN gestor-tecnico-ini IN FRAME f-pg-sel
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN nr-contrato-ini IN FRAME f-pg-sel
   ALIGN-R                                                              */
...
ON END-ERROR OF w-relat /* Relat¢rio Hist¢rico de Contratos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Relat¢rio Hist¢rico de Contratos */
DO:
...
&Scoped-define FRAME-NAME f-pg-imp
&Scoped-define SELF-NAME l-csv
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL l-csv w-relat
ON VALUE-CHANGED OF l-csv IN FRAME f-pg-imp /* Gera arquivo em Formato CSV */
DO:
    &IF "{&RTF}":U = "YES":U &THEN
    RUN pi-habilitaRtf.
    &endif
...
{utp/ut9000.i "ESCC002" "2.06.00.002"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY cod-estabel-ini cod-estabel-fim cod-estab-gestor-ini 
          cod-estab-gestor-fim nr-contrato-ini nr-contrato-fim 
          dt-ini-validade-ini dt-ini-validade-fim dt-ter-validade-ini 
          dt-ter-validade-fim gestor-tecnico-ini gestor-tecnico-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-39 IMAGE-40 IMAGE-41 IMAGE-42 IMAGE-43 IMAGE-44 
         IMAGE-45 IMAGE-46 IMAGE-47 IMAGE-48 cod-estabel-ini cod-estabel-fim 
         cod-estab-gestor-ini cod-estab-gestor-fim nr-contrato-ini 
         nr-contrato-fim dt-ini-validade-ini dt-ini-validade-fim 
         dt-ter-validade-ini dt-ter-validade-fim gestor-tecnico-ini 
         gestor-tecnico-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY rs-destino c-arquivo l-habilitaRtf c-modelo-rtf rs-execucao l-csv 
          text-rtf text-modelo-rtf 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
  ENABLE rect-rtf RECT-7 RECT-9 rs-destino bt-arquivo bt-config-impr c-arquivo 
         l-habilitaRtf bt-modelo-rtf rs-execucao l-csv text-rtf text-modelo-rtf 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    IF INPUT FRAME f-pg-sel cod-estabel-ini > INPUT FRAME f-pg-sel cod-estabel-fim  THEN DO:   
       ...
       {utp/ut-field.i mgcad contrato-for cod-estabel 1}
    ...
    IF INPUT FRAME f-pg-sel cod-estab-gestor-ini > INPUT FRAME f-pg-sel cod-estab-gestor-fim  THEN DO:   
       APPLY "MOUSE-SELECT-CLICK":U TO im-pg-sel IN FRAME f-relat.

       {utp/ut-field.i mgcad contrato-for cod-estab-gestor 1}
       RUN utp/ut-msgs.p (INPUT "show":U, INPUT 142, input RETURN-VALUE + "~~" + RETURN-VALUE).
       APPLY "ENTRY":U TO cod-estab-gestor-ini IN FRAME f-pg-sel.
       RETURN ERROR.
    END.

    IF INPUT FRAME f-pg-sel nr-contrato-ini > INPUT FRAME f-pg-sel nr-contrato-fim  THEN DO:   
       APPLY "MOUSE-SELECT-CLICK":U TO im-pg-sel IN FRAME f-relat.

       {utp/ut-field.i mgcad contrato-for nr-contrato 1}
       RUN utp/ut-msgs.p (INPUT "show":U, INPUT 142, input RETURN-VALUE + "~~" + RETURN-VALUE).
       APPLY "ENTRY":U TO nr-contrato-ini IN FRAME f-pg-sel.
       RETURN ERROR.
    END.

    IF INPUT FRAME f-pg-sel dt-ini-validade-ini > INPUT FRAME f-pg-sel dt-ini-validade-fim  THEN DO:   
       APPLY "MOUSE-SELECT-CLICK":U TO im-pg-sel IN FRAME f-relat.

       {utp/ut-field.i mgcad contrato-for dt-ini-validade 1}
       RUN utp/ut-msgs.p (INPUT "show":U, INPUT 142, input RETURN-VALUE + "~~" + RETURN-VALUE).
       APPLY "ENTRY":U TO dt-ini-validade-ini IN FRAME f-pg-sel.
       RETURN ERROR.
    END.

    IF INPUT FRAME f-pg-sel dt-ter-validade-ini > INPUT FRAME f-pg-sel dt-ter-validade-fim  THEN DO:   
       APPLY "MOUSE-SELECT-CLICK":U TO im-pg-sel IN FRAME f-relat.

       {utp/ut-field.i mgcad contrato-for dt-ter-validade 1}
       RUN utp/ut-msgs.p (INPUT "show":U, INPUT 142, input RETURN-VALUE + "~~" + RETURN-VALUE).
       APPLY "ENTRY":U TO dt-ter-validade-ini IN FRAME f-pg-sel.
       RETURN ERROR.
    END.

    IF INPUT FRAME f-pg-sel gestor-tecnico-ini > INPUT FRAME f-pg-sel gestor-tecnico-fim  THEN DO:   
       APPLY "MOUSE-SELECT-CLICK":U TO im-pg-sel IN FRAME f-relat.

       {utp/ut-field.i mgcad contrato-for gestor-tecnico 1}
       RUN utp/ut-msgs.p (INPUT "show":U, INPUT 142, input RETURN-VALUE + "~~" + RETURN-VALUE).
       APPLY "ENTRY":U TO gestor-tecnico-ini IN FRAME f-pg-sel.
       RETURN ERROR.
    END.
    ...
    ASSIGN tt-param.cod-estabel-ini        = INPUT FRAME f-pg-sel cod-estabel-ini     
           ...
           tt-param.cod-estab-gestor-ini   = INPUT FRAME f-pg-sel cod-estab-gestor-ini
           tt-param.cod-estab-gestor-fim   = INPUT FRAME f-pg-sel cod-estab-gestor-fim
           tt-param.nr-contrato-ini        = INPUT FRAME f-pg-sel nr-contrato-ini     
           tt-param.nr-contrato-fim        = INPUT FRAME f-pg-sel nr-contrato-fim     
           tt-param.dt-ini-validade-ini    = INPUT FRAME f-pg-sel dt-ini-validade-ini 
           tt-param.dt-ini-validade-fim    = INPUT FRAME f-pg-sel dt-ini-validade-fim 
           tt-param.dt-ter-validade-ini    = INPUT FRAME f-pg-sel dt-ter-validade-ini 
           tt-param.dt-ter-validade-fim    = INPUT FRAME f-pg-sel dt-ter-validade-fim 
           tt-param.gestor-tecnico-ini     = INPUT FRAME f-pg-sel gestor-tecnico-ini  
           tt-param.gestor-tecnico-fim     = INPUT FRAME f-pg-sel gestor-tecnico-fim 
           tt-param.l-csv                  = INPUT FRAME f-pg-imp l-csv.
    ...
    {include/i-rprun.i esp/escc002rp.p}
