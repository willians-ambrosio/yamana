...
DEFINE VARIABLE h_esapb010-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esapb010-v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapb010-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_esapb010-v01 ).
       RUN set-position IN h_esapb010-v01 ( 2.75 , 1.57 ) NO-ERROR.
       /* Position in AB:  ( 2.83 , 1.72 ) */
       /* Size in UIB:  ( 7.54 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapb010-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/esapb010-z01.w,
                     ProgVaPara = esp/esapb010-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esapb010-q01 ).
       RUN set-position IN h_esapb010-q01 ( 1.04 , 61.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to  h_esapb010-v01. */
       RUN add-link IN adm-broker-hdl ( h_esapb010-q01 , 'Record':U , h_esapb010-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esapb010-v01 ).

       /* Links to SmartQuery h_esapb010-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esapb010-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esapb010-q01 ).
