...
*******************************************************************************/
{include/i-prgvrs.i YMQRY006 1.02.10.000 } /*** 01010004 ***/
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH tip_metricas_plr ~
      WHERE tip_metricas_plr.cdn_empresa = v_cdn_empres_usuar NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH tip_metricas_plr ~
      WHERE tip_metricas_plr.cdn_empresa = v_cdn_empres_usuar NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main tip_metricas_plr
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main tip_metricas_plr
...
cdn_estab||y|tip_metricas_plr.cdn_estab
log_corporativo||y|tip_metricas_plr.log_corporativo
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "cdn_empresa,cdn_estab,log_corporativo"':U).
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Options          = "NO-LOCK"
     _Where[1]         = "tip_metricas_plr.cdn_empresa = v_cdn_empres_usuar"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cdn_estab" "tip_metricas_plr" "cdn_estab"}
  {src/adm/template/sndkycas.i "log_corporativo" "tip_metricas_plr" "log_corporativo"}
