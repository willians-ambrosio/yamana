...
/*------------------------------------------------------------------------
File.............: ESP039AA.w
Description......: Relat¢rio Materiais Alocados
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 30/03/12 - 19:46 - adm
OBS..............: Este fonte foi gerado pelo Data Viewer
------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "ESP039AA".
...
DEFINE FRAME f-pg-sel
   c-it-codigo-ini label "Item Reserva"
   ...
   da-dt-reserva-ini label "Data Reserva"
     at row 2 col 17 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

   da-dt-reserva-fim no-label
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Relat¢rio Materiais Alocados - ESP039AA"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "ESP039AA".
...
PROCEDURE enable_UI :
   ...
   da-dt-reserva-ini da-dt-reserva-fim
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "ESP039AA" + "." + v-cod-extens-arq.
    ...
    assign tt-param.c-it-codigo-ini = input frame f-pg-sel c-it-codigo-ini
           ...
           tt-param.c-it-codigo-fim = input frame f-pg-sel c-it-codigo-fim
           tt-param.da-dt-reserva-ini = input frame f-pg-sel da-dt-reserva-ini
           tt-param.da-dt-reserva-fim = input frame f-pg-sel da-dt-reserva-fim
.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "dtv/ESP03927.p".
