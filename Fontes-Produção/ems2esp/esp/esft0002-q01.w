...
&Scoped-define INTERNAL-TABLES es-param-terceiros

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-param-terceiros NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-param-terceiros NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-param-terceiros
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-param-terceiros
...
<FOREIGN-KEYS>
qt-limite-dias||y|ems5_esp.es-param-terceiros.qt-limite-dias
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems5_esp.es-param-terceiros"
     _Options          = "NO-LOCK"
