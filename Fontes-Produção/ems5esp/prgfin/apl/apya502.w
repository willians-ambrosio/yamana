...
*******************************************************************************/
{include/i-prgvrs.i APYA502 12.1.17.000}
...
DEFINE VARIABLE h_apya502-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_apya502-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 90.43 BY 5.67 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Manuten‡Æo Administradora"
         HEIGHT             = 5.67
         WIDTH              = 90.43
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 90.43
...
ON END-ERROR OF w-cadsim /* Manuten‡Æo Administradora */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manuten‡Æo Administradora */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apl/apya502-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_apya502-v01 ).
       RUN set-position IN h_apya502-v01 ( 2.79 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 3.75 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apl/apya502-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = prgfin/apl/apya502-z01.w,
                     ProgVaPara = prgfin/apl/apya502-g01.w,
                     Implantar = no':U ,
             OUTPUT h_apya502-q01 ).
       RUN set-position IN h_apya502-q01 ( 1.25 , 64.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_apya502-v01. */
       RUN add-link IN adm-broker-hdl ( h_apya502-q01 , 'Record':U , h_apya502-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_apya502-v01 ).

       /* Links to SmartQuery h_apya502-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_apya502-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_apya502-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_apya502-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_apya502-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "APYA502" "12.1.17.000"}
