...
*******************************************************************************/
{include/i-prgvrs.i ESAPB009A 12.001.20.000}
...
DEFINE FRAME f-cad
     bt-ok AT ROW 6.08 COL 3.14 HELP
          "Salva e sai"
     bt-save AT ROW 6.08 COL 14.14 HELP
          "Salva e cria novo registro"
     bt-cancela AT ROW 6.08 COL 25.14 HELP
          "Cancela"
     bt-ajuda AT ROW 6.08 COL 78.14
     rt-button AT ROW 5.92 COL 2
...
DO:
{include/okpai.i h_esapb009-v01}
END.
...
DO:
{include/salvapai.i h_esapb009-v01}
 END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_esapb009-v01 ( 1.08 , 1.72 ) NO-ERROR.
       ...
       RUN set-position IN h_esapb009-q01 ( 5.33 , 52.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_esapb009-v01 ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESAPB009A" "12.001.20.000"}
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_esapb009-q01 (INPUT v-row-table). 
