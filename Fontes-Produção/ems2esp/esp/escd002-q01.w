...
&Scoped-define INTERNAL-TABLES es-tipo-docto

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-tipo-docto NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-tipo-docto NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main es-tipo-docto
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-tipo-docto
...
<FOREIGN-KEYS>
cod-tipo-docto||y|es-tipo-docto.cod-tipo-docto
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "cod-tipo-docto"':U).
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cod-tipo-docto" "es-tipo-docto" "cod-tipo-docto"}
