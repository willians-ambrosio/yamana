...
*******************************************************************************/
{include/i-prgvrs.i esapb006-g01 2.06.00.000}
...
&Scoped-Define ENABLED-OBJECTS rt-button c_cat-code bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cat-code 
...
DEFINE VARIABLE c_cat-code AS CHARACTER FORMAT "x(16)":U 
     LABEL "Cat Code" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     c_cat-code AT ROW 2.25 COL 24 COLON-ALIGNED WIDGET-ID 2
...
DO:
FIND es-cat-code NO-LOCK
    WHERE es-cat-code.cat-code EQ INPUT FRAME {&FRAME-NAME} c_cat-code NO-ERROR.

IF NOT AVAILABLE es-cat-code THEN DO:
    {utp/ut-table.i ems5_esp es-cat-code 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-cat-code).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY c_cat-code 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cat-code bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esapb006-g01" "2.06.00.000"}
