...
&Scoped-Define DISPLAYED-FIELDS es-conta-cfop.nat-operacao ~
es-conta-cfop.ct-codigo 
&Scoped-define DISPLAYED-TABLES es-conta-cfop
&Scoped-define FIRST-DISPLAYED-TABLE es-conta-cfop
&Scoped-Define DISPLAYED-OBJECTS fi-descricao-cfop fi-descricao-conta 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,ADM-MODIFY-FIELDS,List-4,List-5,List-6 */
&Scoped-define ADM-CREATE-FIELDS es-conta-cfop.nat-operacao ~
es-conta-cfop.ct-codigo 
...
DEFINE FRAME f-main
     es-conta-cfop.nat-operacao AT ROW 1.17 COL 16.86 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 10.14 BY .88
     fi-descricao-cfop AT ROW 1.17 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 8
     es-conta-cfop.ct-codigo AT ROW 2.17 COL 16.86 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 12.14 BY .88
     fi-descricao-conta AT ROW 2.17 COL 29.29 COLON-ALIGNED NO-LABEL WIDGET-ID 6
