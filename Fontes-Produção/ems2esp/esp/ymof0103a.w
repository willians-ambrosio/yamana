...
DEFINE VARIABLE h_ymof0103a-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_ymof0103a-v01-2 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1.25
         SIZE 81.43 BY 16.75 WIDGET-ID 100.
...
DO:
{include/okfil.i  h_ymof0103a-v01-2}
...
DO:
{include/salvafil.i  h_ymof0103a-v01-2}
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_folder ( 7.71 , 80.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymof0103a-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ymof0103a-v01-2 ).
       RUN set-position IN h_ymof0103a-v01-2 ( 3.29 , 2.57 ) NO-ERROR.
       /* Size in UIB:  ( 4.25 , 66.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymof0103a-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_ymof0103a-q01 ).
       RUN set-position IN h_ymof0103a-q01 ( 1.00 , 52.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.00 , 7.72 ) */

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_ymof0103a-v01-2. */
       RUN add-link IN adm-broker-hdl ( h_ymof0103a-q01 , 'Record':U , h_ymof0103a-v01-2 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_ymof0103a-v01-2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             bt-ok:HANDLE IN FRAME f-cad , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymof0103a-v01-2 ,
             h_folder , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  run pi-atualiza-parent in  h_ymof0103a-v01-2 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN  h_ymof0103a-q01 (input v-row-table).
