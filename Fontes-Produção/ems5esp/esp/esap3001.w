...
DEFINE BUTTON bt-avmn 
     LABEL "Pesquisa" 
     SIZE 15 BY .88.

DEFINE VARIABLE c-arquivo-avmn AS CHARACTER FORMAT "X(100)":U 
     LABEL "Arquivo AVMN" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-sel
     c-arquivo-avmn AT ROW 4.5 COL 15 COLON-ALIGNED
     bt-avmn AT ROW 5.5 COL 59 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
&Scoped-define SELF-NAME bt-avmn
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-avmn w-relat
ON CHOOSE OF bt-avmn IN FRAME f-pg-sel /* Pesquisa */
DO:
    ...
    ASSIGN c-arquivo-avmn:SCREEN-VALUE IN FRAME {&FRAME-NAME} = wc-arq.
...
{utp/ut9000.i "ESAP3001" "TOTVS-12"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-arquivo-avmn 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE c-arquivo-avmn bt-avmn 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.c-arquivo-avmn  = wc-arq.
    ...
    {include/i-rprun.i esp/esap3001rp.p}
