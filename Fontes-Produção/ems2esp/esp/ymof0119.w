...
DEFINE FRAME f-import
     ...
     im-pg-log AT ROW 1.5 COL 18.14
...
DEFINE FRAME f-pg-par
     ...
     c-arquivo-entrada AT ROW 5.29 COL 13.29 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     bt-arquivo-entrada AT ROW 5.29 COL 53.14 HELP
          "Escolha do nome do arquivo"
     text-entrada AT ROW 4.25 COL 14.14 NO-LABEL
     RECT-8 AT ROW 4.58 COL 12
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
...
/* SETTINGS FOR FRAME f-pg-par
                                                                        */
/* SETTINGS FOR TOGGLE-BOX l-param-1 IN FRAME f-pg-par
   NO-ENABLE                                                            */
ASSIGN 
...
DO:
    {include/i-imarq.i c-arquivo-entrada f-pg-par " '*.XLSX' '*.xl*', 'Todos' '*.*' "}
END.
...
{utp/ut9000.i "YMOF0119" "1.00.00.000"}
...
do  on error undo, return error
    ...
    {include/i-imrun.i esp/ymof0119rp.p}
