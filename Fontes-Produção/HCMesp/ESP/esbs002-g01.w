...
{include/i-prgvrs.i VESBS002 2.04.00.001}
...
DEFINE FRAME d-vapara
     estab_benef_prev_brad.cdn_empresa AT ROW 1.29 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 8 BY 1
     estab_benef_prev_brad.cdn_estab AT ROW 2.29 COL 16 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 8 BY 1
...
DO:
  find estab_benef_prev_brad no-lock 
      WHERE estab_benef_prev_brad.cdn_empresa = input frame {&frame-name} estab_benef_prev_brad.cdn_empresa
      AND   estab_benef_prev_brad.cdn_estab   = input frame {&frame-name} estab_benef_prev_brad.cdn_estab no-error.
  if  not avail estab_benef_prev_brad then do:
      {utp/ut-table.i hresp estab_benef_prev_brad 1}
      run utp/ut-msgs.p (input "show",
                         input 2,
                         input RETURN-VALUE).
      return no-apply.
  end.
  assign p-row-tabela = rowid(estab_benef_prev_brad).
END.
...
------------------------------------------------------------------------------*/
  IF AVAILABLE estab_benef_prev_brad THEN 
    DISPLAY estab_benef_prev_brad.cdn_empresa estab_benef_prev_brad.cdn_estab 
          estab_benef_prev_brad.cdn_beneficio 
      WITH FRAME d-vapara.
  ENABLE rt-button estab_benef_prev_brad.cdn_empresa 
         estab_benef_prev_brad.cdn_estab estab_benef_prev_brad.cdn_beneficio 
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "GESBS002" "2.04.00.001"}
