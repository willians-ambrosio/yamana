...
/*------------------------------------------------------------------------
File.............: EXSABA003.w
Description......: Export SABA
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 29/07/13 - 10:46 - adm
...
assign v-cod-prog-gerado = "EXSABA003".
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "int_organization" + "." + v-cod-extens-arq.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "esp\EXSABA003.p".
