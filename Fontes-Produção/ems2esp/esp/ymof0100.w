...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_ymof0100-v01 ( 2.75 , 1.72 ) NO-ERROR.
       ...
       RUN set-position IN h_ymof0100-q01 ( 1.25 , 60.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_ymof0100-v01 ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ymof0100" "1.00.00.000"}
  ...
  RUN enable-copia IN h_p-cadsim
    ( INPUT NO /* LOGICAL */).
