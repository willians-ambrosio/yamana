...
PROCEDURE pi_processa_padrao:
    ...
    */
        ...
        DO:
         ...
         /* Inicio - Renato Oliveira - Inicializa as Variaveis */
         ASSIGN v_cod_receita      = "000000"
                v_cod_referencia   = "00000000000000000"
                v_per_apuracao     = "00000000"
                v_dt_vencto-aux    = "00000000"
                v_Id_fgts          = "0000000000000000"
                v_lacre            = "000000000"
                v_digla            = "00"
                v_vl_tributo       = "000000000000000"
                v_vl_out_entid     = "000000000000000" 
                v_vl_receita_bruta = "000000000000000"
                v_percentual       = "0000000"
                v_cod_id_contrib   = "0000000000000000".
         /* Fim - Inicializa as Variaveis */
