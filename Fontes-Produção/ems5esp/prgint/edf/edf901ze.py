...
**         Data: 09/07/2018
** Change/Chamado: 
**      Objetivo: Retorna o total de registro do arquivo - trailer do arquivo 
**
...
def new global shared var i_cont_trailer as int NO-UNDO. /* Vari†vel gravada no programa edf900zi-bb.py  totalizar os contadores do trailer de cada bloco */

def stream s-arq.

if  v_cod_arq <> '' and v_cod_arq <> ?
then do:
    run pi_version_extract ('fnc_extracao_banco_brasil_moeda':U, 'prgint/edf/edf901ze.py':U, '1.00.00.003':U, 'pro':U).
end /* if */.
...
def var i_tot as int no-undo.

assign i_tot = i_tot_trailer + 2.

assign i_tot_trailer = 0.

RETURN STRING(i_tot,'999999').
