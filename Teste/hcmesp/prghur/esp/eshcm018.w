...
DEF TEMP-TABLE tt-imprime
    ...
    field tt-dat_nascimento     like funcionario.dat_nascimento
    field tt-qti_depend_irf     like funcionario.qti_depend_irf   
    field tt-cod_id_feder       like rh_pessoa_fisic.cod_id_feder.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "<Funcionarios Desligados no Periodo - ESHCM018.001 >"
         HEIGHT             = 12.29
         WIDTH              = 72
         MAX-HEIGHT         = 31.29
         MAX-WIDTH          = 182.86
...
ON END-ERROR OF C-Win /* <Funcionarios Desligados no Periodo - ESHCM018.001 > */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* <Funcionarios Desligados no Periodo - ESHCM018.001 > */
DO:
...
/************************************************************/
    ...
    /*************** Imprime altera‡äes **************************/
    /*************** Cabe»alho ***********************************/
    chWorkSheet:Range("a1"):Value = "Funcionarios Desligados no Periodo -   " + string(today).
    ...
    chWorkSheet:Range("v3"):Value = "Categoria".
    chWorkSheet:Range("w3"):Value = "Cod.M.Obra".
    chWorkSheet:Range("x3"):Value = "Desc_Tipo M.Obra".
    chWorkSheet:Range("y3"):Value = "Cod Cargo".
    chWorkSheet:Range("z3"):Value = "N¡vel Cargo".
    chWorkSheet:Range("aa3"):Value = "Cargo".
    chWorkSheet:Range("ab3"):Value = "CBO".
    chWorkSheet:Range("ac3"):Value = "Turno".
    chWorkSheet:Range("ad3"):Value = "Turma".
    chWorkSheet:Range("ae3"):Value = "Unid Lota‡Æo". 
    chWorkSheet:Range("af3"):Value = "Descri‡Æo Lota‡Æo". 
    chWorkSheet:Range("ag3"):Value = "Cod CCusto". 
    chWorkSheet:Range("ah3"):Value = "Descri‡Æo CCusto".
    chWorkSheet:Range("ai3"):Value = "Dt Desligamento".
    chWorkSheet:Range("aj3"):Value = "Cod Desligamento". 
    chWorkSheet:Range("ak3"):Value = "Descri‡Æo Desligamento".
    
    chWorkSheet:Range("a3:ak3"):Font:Bold = TRUE.
    ...
    chWorkSheet:Columns("y"):ColumnWidth = 08.
    chWorkSheet:Columns("z"):ColumnWidth = 04.
    chWorkSheet:Columns("aa"):ColumnWidth = 25.
    chWorkSheet:Columns("ab"):ColumnWidth = 06.
    chWorkSheet:Columns("ac"):ColumnWidth = 06.
    chWorkSheet:Columns("ad"):ColumnWidth = 06.
    chWorkSheet:Columns("ae"):ColumnWidth = 12.
    chWorkSheet:Columns("af"):ColumnWidth = 30.
    chWorkSheet:Columns("ag"):ColumnWidth = 12.
    chWorkSheet:Columns("ah"):ColumnWidth = 30.
    chWorkSheet:Columns("ai"):ColumnWidth = 15.
    chWorkSheet:Columns("aj"):ColumnWidth = 20.
    chWorkSheet:Columns("ak"):ColumnWidth = 20.
   ...
   FOR EACH  funcionario 
      WHERE funcionario.cdn_empresa       >= fi-empresa-ini
        ...
        FIND FIRST habilit_rescis WHERE habilit_rescis.cdn_empresa = funcionario.cdn_empresa
                              AND habilit_rescis.cdn_estab    = funcionario.cdn_estab
                              AND habilit_rescis.cdn_func     = funcionario.cdn_funcionario NO-LOCK NO-ERROR.

        ASSIGN cdn-sit   = ?
               sit-afast = "".

        IF AVAIL habilit_rescis THEN DO: 
           
           FIND sit_afast WHERE cdn_sit_afast_func = habilit_rescis.cdn_sit_rescis_contratual NO-LOCK NO-ERROR.

           ASSIGN cdn-sit   = habilit_rescis.cdn_sit_rescis_contratual
                  sit-afast = sit_afast.des_sit_afast_func.     
        END.

        IF NOT AVAIL habilit_rescis AND funcionario.idi_tip_func = 14  THEN DO:
           FIND last sit_afast_func 
            ...
            IF AVAIL sit_afast_func THEN DO: 
               ...
               ASSIGN cdn-sit   = sit_afast_func.cdn_sit_afast_func 
                      sit-afast = sit_afast.des_sit_afast_func.   
            END.
        ...
        ASSIGN chExcelApplication:range( "a" + STRING(i-linha) ):value = funcionario.cdn_empresa
               ...
               chExcelApplication:range( "v" + STRING(i-linha) ):value = c-categ
               chExcelApplication:range( "w" + STRING(i-linha) ):value = funcionario.cod_tip_mdo
               chExcelApplication:range( "x" + STRING(i-linha) ):value = tip_mdo.des_tip_mdo
               chExcelApplication:range( "y" + STRING(i-linha) ):value = funcionario.cdn_cargo_basic
               chExcelApplication:range( "z" + STRING(i-linha) ):value = funcionario.cdn_niv_cargo
               chExcelApplication:range( "aa" + STRING(i-linha) ):value = cargo_basic.des_cargo_basic /*funcionario.cdn_cargo_basic*/
               chExcelApplication:range( "ab" + STRING(i-linha) ):value = cargo_basic.cod_classif_ocupac
               chExcelApplication:range( "ac" + STRING(i-linha) ):value = funcionario.cdn_turno_trab
               chExcelApplication:Range( "ac" + STRING(i-linha)):Numberformat = "0000"
               chExcelApplication:range( "ad" + STRING(i-linha) ):value = funcionario.cdn_turma_trab   
               chExcelApplication:range( "ae" + STRING(i-linha) ):value = funcionario.cod_unid_lotac 
               chExcelApplication:range( "af" + STRING(i-linha) ):value = unid_lotac.des_unid_lotac 
               chExcelApplication:range( "ag" + STRING(i-linha) ):value = funcionario.cod_rh_ccusto 
               chExcelApplication:range( "ah" + STRING(i-linha) ):value = rh_ccusto.des_rh_ccusto  
               chExcelApplication:range( "ai" + STRING(i-linha) ):value = funcionario.dat_desligto_func 
               chExcelApplication:range( "aj" + STRING(i-linha) ):value = cdn-sit
               chExcelApplication:range( "ak" + STRING(i-linha) ):value = sit-afast.
