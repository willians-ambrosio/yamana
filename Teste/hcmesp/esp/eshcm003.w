...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "<Avaliaá∆o por Competància - Funcion†rio>"
         HEIGHT             = 14.46
         WIDTH              = 72
         MAX-HEIGHT         = 31.29
         MAX-WIDTH          = 182.86
...
ON END-ERROR OF C-Win /* <Avaliaá∆o por Competància - Funcion†rio> */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* <Avaliaá∆o por Competància - Funcion†rio> */
DO:
...
IF rs-tipo = 1  THEN DO: /* Grupo de Assunto */
    ...
    chWorkSheet:Range("i3"):Value = "MÇdia Grupo ".       
    ...
    FOR EACH   tt-dados
      BREAK BY tt-dados.cdn_empresa
        ...
        IF LAST-OF (tt-dados.cdn_funcionario) THEN DO: /* cod_unid_lotac */
           ...
           chExcelApplication:range( "h" + STRING(i-linha) ):value = "* MÇdia Funcion†rio => " .
        ...
        IF LAST-OF(tt-dados.cdn_empresa) THEN DO:
           ...
           ASSIGN i-linha = i-linha + 2.
           chExcelApplication:range( "h" + STRING(i-linha) ):value = "* MÇdia Geral => " .
...
IF rs-tipo = 2  THEN DO: /* Pergunta */
    ...
    chWorkSheet:Range("j3"):Value = "MÇdia Pergunta".    
