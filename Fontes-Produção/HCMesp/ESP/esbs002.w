...
{include/i-prgvrs.i ESBS002 2.04.00.001}
...
DEFINE VARIABLE h_esbs002-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esbs002-v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esbs002-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esbs002-v01 ).
       RUN set-position IN h_esbs002-v01 ( 3.00 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.04 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esbs002-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/esbs002-z01.w,
                     ProgVaPara = esp/esbs002-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esbs002-q01 ).
       RUN set-position IN h_esbs002-q01 ( 1.25 , 60.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_esbs002-v01. */
       RUN add-link IN adm-broker-hdl ( h_esbs002-q01 , 'Record':U , h_esbs002-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esbs002-v01 ).

       /* Links to SmartQuery h_esbs002-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_esbs002-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esbs002-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esbs002-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esbs002-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esbs002" "2.04.00.001"}
