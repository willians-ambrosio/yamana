...
*******************************************************************************/
{include/i-prgvrs.i ESAPB013-G01 12.01.23.000}
...
&Scoped-Define ENABLED-OBJECTS rt-button c_cod_plano_cta_ctbl ~
c_cod_cta_ctbl bt-ok bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod_plano_cta_ctbl c_cod_cta_ctbl 
...
DEFINE VARIABLE c_cod_cta_ctbl AS CHARACTER FORMAT "x(20)":U 
     LABEL "Conta Ctbl" 
     VIEW-AS FILL-IN 
     SIZE 20 BY .88 NO-UNDO.

DEFINE VARIABLE c_cod_plano_cta_ctbl AS CHARACTER FORMAT "x(8)":U 
...
DEFINE FRAME d-vapara
     c_cod_plano_cta_ctbl AT ROW 1.5 COL 30 COLON-ALIGNED WIDGET-ID 4
     c_cod_cta_ctbl AT ROW 2.42 COL 30 COLON-ALIGNED WIDGET-ID 6
...
DO:
FIND es-cat-code-cta-ex NO-LOCK
    WHERE es-cat-code-cta-ex.cod_plano_cta_ctbl EQ INPUT FRAME {&FRAME-NAME} c_cod_plano_cta_ctbl
      AND es-cat-code-cta-ex.cod_cta_ctbl EQ INPUT FRAME {&FRAME-NAME} c_cod_cta_ctbl NO-ERROR.

IF NOT AVAILABLE es-cat-code-cta-ex THEN DO:
    {utp/ut-table.i ems5_esp es-cat-code-cta-ex 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-cat-code-cta-ex).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod_plano_cta_ctbl c_cod_cta_ctbl 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cod_plano_cta_ctbl c_cod_cta_ctbl bt-ok bt-cancela 
         bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESAPB013-G01" "12.01.23.000"}
