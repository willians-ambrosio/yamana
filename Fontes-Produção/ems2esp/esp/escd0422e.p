...
*******************************************************************************/
{include/i-prgvrs.i CD0422E 2.00.00.001}  /*** 010001 ***/

&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i cd0422e MCD}
&ENDIF
...
form emitente.nome-emit     format "X(40)"  colon 025 skip
     emitente.nome-abrev    format "X(12)"  colon 025
     emitente.cod-emitente  format ">>>>>>>>9" colon 070 skip
     emitente.cgc           format "x(19)"  colon 025
     emitente.ins-estadual  format "X(19)"  colon 070
     emitente.nome-matriz   format "x(12)"  colon 105 skip
     emitente.endereco      format "X(40)"  colon 025 skip
     emitente.bairro        format "X(30)"  colon 025
     emitente.cidade        format "X(25)"  colon 105 skip 
     emitente.estado        format "x(4)"   colon 025
     emitente.cep           format "x(12)"  colon 070
     emitente.caixa-postal  format "X(10)"  colon 105 skip
     emitente.telefone[2]   format "x(15)"  colon 025
     emitente.telefone[1]   format "x(15)"  colon 070
     emitente.telefax       format "x(15)"  colon 105 skip
     emitente.ramal-fax     format "x(05)"  colon 025
     emitente.cod-gr-forn   format ">9"     colon 070
     emitente.telef-fac     format "x(15)"  colon 105 skip
     emitente.linha-produt  format "X(08)"  colon 025
     emitente.telex         format "x(15)"  colon 070
     emitente.telef-modem   format "x(15)"  colon 105 skip
     emitente.cod-cond-pag  format ">>9"    colon 025
     emitente.atividade     format "X(12)"  colon 070
     emitente.nat-operacao  format "9.99-xxx" colon 105 skip
     emitente.data-taxa     format "99/99/9999" colon 025
     emitente.bonificacao   label "Bonifica‡Æo" format ">>9.99" colon 070
     emitente.taxa-financ   format ">>9.99" colon 105 skip
     emitente.cod-banco     format "999"    colon 025
     emitente.emissao-ped   format ">9"     colon 070
     emitente.cod-transp    format ">>,>>9" colon 105 skip
     emitente.conta-corren  format "x(20)"  colon 025
     emitente.agencia       format "x(8)"   colon 070
     emitente.pais          format "X(20)"  colon 105 skip
