...
*******************************************************************************/
{include/i-prgvrs.i ap004 2.12.00.000}
...
DEFINE VARIABLE h_ap004-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_ap004-v01 AS HANDLE NO-UNDO.
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?':U ,
             OUTPUT h_ap004-v01 ).
       RUN set-position IN h_ap004-v01 ( 2.83 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.50 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'apb/ap004-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = apb/ap004-z01.w,
                     ProgVaPara = apb/ap004-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_ap004-q01 ).
       RUN set-position IN h_ap004-q01 ( 1.00 , 61.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.75 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_ap004-v01. */
       RUN add-link IN adm-broker-hdl ( h_ap004-q01 , 'Record':U , h_ap004-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_ap004-v01 ).

       /* Links to SmartQuery h_ap004-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_ap004-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_ap004-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_ap004-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_ap004-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ap004" "2.12.00.000"}
