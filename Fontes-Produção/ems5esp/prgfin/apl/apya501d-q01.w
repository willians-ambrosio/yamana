...
&Scoped-define QUERY-STRING-Query-Main FOR EACH rof_contrat_apf NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH rof_contrat_apf NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main rof_contrat_apf
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main rof_contrat_apf
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems5_esp.rof_contrat_apf"
     _Options          = "NO-LOCK"
