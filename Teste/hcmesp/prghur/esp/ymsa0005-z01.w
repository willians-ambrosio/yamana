...
*******************************************************************************/
{include/i-prgvrs.i YMSA0005-Z01 1.00.00.000}
...
DEFINE VARIABLE h_ymsa0005-z01-b01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-implantar AT ROW 13.33 COL 1.57
     bt-ok AT ROW 14.83 COL 3
     bt-cancela AT ROW 14.83 COL 14
     bt-ajuda AT ROW 14.83 COL 79
     rt-button AT ROW 14.58 COL 2
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Data' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.17 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 12.08 , 88.57 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prghur/esp/ymsa0005-z01-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ymsa0005-z01-b01 ).
       RUN set-position IN h_ymsa0005-z01-b01 ( 2.67 , 5.14 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_ymsa0005-z01-b01. */
       RUN add-link IN adm-broker-hdl ( h_ymsa0005-z01-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymsa0005-z01-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
