...
*******************************************************************************/
/*{include/i-prgvrs.i ES0001 2.00.00.000}  /*** 010000 ***/*/
...
ON END-ERROR OF C-Win /* Importaá∆o de Tabela */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Importaá∆o de Tabela */
DO:
...
/*{utp/ut9000.i "ES0001" "2.00.00.000"}*/
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {include/i-imvrf.i &programa=es0001 &versao-layout=001}
...
do  on error undo, return error
    ...
    if  tt-param.destino = 2 then 
        ...
        assign tt-param.arq-destino = session:temp-directory + c-programa-mg97 + "es0001.tmp".
    ...
    {include/i-imrun.i esp/es0001rp.p}
