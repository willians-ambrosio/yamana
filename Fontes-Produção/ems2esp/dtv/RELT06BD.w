...
/*------------------------------------------------------------------------
File.............: RELT06BD.w
Description......: SEGURADORA COM IPI
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 04/10/10 - 09:33 - 01575407
OBS..............: Este fonte foi gerado pelo Data Viewer
------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "RELT06BD".
...
DEFINE FRAME f-pg-sel
   da-dt-docto-ini label "Dt Documento"
     at row 1 col 17 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

   da-dt-docto-fim no-label
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "SEGURADORA COM IPI - RELT06BD"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "RELT06BD".
...
PROCEDURE enable_UI :
   ...
   DISPLAY  
   da-dt-docto-ini da-dt-docto-fim
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "RELT06BD" + "." + v-cod-extens-arq.

    assign tt-param.da-dt-docto-ini = input frame f-pg-sel da-dt-docto-ini
           tt-param.da-dt-docto-fim = input frame f-pg-sel da-dt-docto-fim
           tt-param.da-dt-docto-fim = input frame f-pg-sel da-dt-docto-fim
.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "DTV/RELT0656.p".
