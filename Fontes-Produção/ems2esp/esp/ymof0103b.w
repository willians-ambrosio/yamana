...
DEFINE VARIABLE h_ymof0103b-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_ymof0103b-v01 AS HANDLE NO-UNDO.
...
DO:
{include/okfil.i  h_ymof0103b-v01}
...
DO:
{include/salvafil.i  h_ymof0103b-v01}
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymof0103b-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ymof0103b-v01 ).
       RUN set-position IN h_ymof0103b-v01 ( 3.38 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.25 , 76.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymof0103b-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_ymof0103b-q01 ).
       RUN set-position IN h_ymof0103b-q01 ( 1.00 , 55.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.25 , 7.72 ) */

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_ymof0103b-v01. */
       RUN add-link IN adm-broker-hdl ( h_ymof0103b-q01 , 'Record':U , h_ymof0103b-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_ymof0103b-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             bt-ok:HANDLE IN FRAME f-cad , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymof0103b-v01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  run pi-atualiza-parent in  h_ymof0103b-v01 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN  h_ymof0103b-q01 (input v-row-table).
