...
------------------------------------------------------------------------------*/
    ...
    DEFINE VARIABLE cId AS CHARACTER   NO-UNDO INITIAL "01".
    DEFINE VARIABLE cProc AS CHARACTER   NO-UNDO INITIAL "EnviaRemessa".

    FIND FIRST es_param_van_dir NO-LOCK 
          WHERE es_param_van_dir.identificador   = cId  
            AND es_param_van_dir.nomeserv        = cProc
      ...
      END.
           ...
           FIND FIRST es_param_webserver NO-LOCK 
                WHERE es_param_webserver.identificador = es_param_van_dir.identificador
                  AND es_param_webserver.nomeserv      = es_param_van_dir.nomeserv NO-ERROR.
    ...
    IF RETURN-VALUE <> "OK" THEN DO:
        ...
        MESSAGE RETURN-VALUE SKIP
                "N∆o foi poss°vel enviar os arquivos!"
            VIEW-AS ALERT-BOX INFO BUTTONS OK.
