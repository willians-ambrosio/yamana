...
&Scoped-define INTERNAL-TABLES es-conta-cfop

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-conta-cfop NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-conta-cfop NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-conta-cfop
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-conta-cfop
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems5_esp.es-conta-cfop"
     _Options          = "NO-LOCK"
