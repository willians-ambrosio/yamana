...
*******************************************************************************/
{include/i-prgvrs.i FP3500R3 1.02.11.013 } /*** 0101113 ***/

&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i fp3500r3 MFP}
&ENDIF
...
def shared var i-empresa         like empresa.ep-codigo                 no-undo.
...
DEFINE     VAR v_status_enviado  AS CHAR FORMAT "x(11)"                NO-UNDO.
DEFINE     VAR v_status_nao_enviado  AS CHAR FORMAT "x(11)"            NO-UNDO.
...
/* Include com a definiá∆o das Temp-Tables da faixa de eventos reservada para a Datasul */
{prghur/fpp/fp0024.i} 
/* Programa de criaá∆o da Temp-table da faixa de eventos(900 a 999) reservada da Datasul */
RUN prghur/fpp/fp0024rp.p(INPUT v_cdn_empresa_evento,
                          OUTPUT TABLE tt-event-900,
                          OUTPUT TABLE tt-event-901).

/* chamada epc */             
{include/i-epc200.i fp3500r3}
...
define temp-table w-mvtocalc no-undo
       ...
       field idi-unidade like event_fp.idi_unid_medid_efp
  ...
  {prghur/fpp/fp9200.i6}
   for each tt_lotac_funcionario no-lock,
       ...
       if funcionario.cdn_local_pagto <> 0 then 
           assign v_cdn_local = string(funcionario.cdn_local_pagto).
       else
           assign v_cdn_local = string(funcionario.cdn_estab).
       ...
       for each movto_calcul_func of funcionario no-lock where
           ...
           repeat:
              ...
              /* verifica se evento > 900 */
              find first tt-event-900 where 
                  tt-event-900.cdn_empresa  = tt-param.v_cdn_empresa_evento and
                  tt-event-900.cdn_event_fp = movto_calcul_func.cdn_event_fp[i-inx] no-error.
              if avail tt-event-900 and not event_fp.log_impr_envel_fp then next.
              ...
              if movto_calcul_func.idi_tip_fp = 3 and
                 ...
                 assign w-mvtocalc.fc-codigo   = movto_calcul_func.cdn_funcionario
                        ...
                        w-mvtocalc.idi-unidade = event_fp.idi_unid_medid_efp
       ...
       assign c-nome-compl = funcionario.nom_pessoa_fisic.
            ...
            for each w-mvtocalc break by w-mvtocalc.fc-codigo
                ...
                if  first-of(w-mvtocalc.fc-codigo) or
                   ...
                   if tt-param.l-layout-detalhado then do:
                       put c-empresa                            at  02
                           ...
                           "|"                                  at  01
                           i-impr-func                          to  16
                           funcionario.nom_abrev_pessoa_fisic   at  17
                           empresa.ep-codigo                    at  49
                           v_cdn_local                          at  53
                           funcionario.cod_unid_lotac           at  59
                           "|" at 80
                           "|      Conta-DV"                    at  01
                           i-cta-corrente                       at  17
                           c-hifen
                           c-dig-conta
                           "|" at 80
                           "|         Cargo"                    at  01
                           cargo.des_envel_pagto format "x(20)" at  17
                           "|" at 80 
                           "|" at 01 
                           "|" at 80.
                   end.
                       ...
                       put c-empresa                           at  02
                           ...
                           c-hifen                             at  17
                           c-dig-conta                         at  18
                           cargo.des_envel_pagto format "x(20)"   at  22 /*cargo_basic.cod_classif_ocupac*/ 
                           empresa.ep-codigo                   at  43
                           v_cdn_local                         at  47
                           funcionario.cod_unid_lotac          at  53 skip(2).
                   assign i-cont-linha = 7.

                   if tt-param.l-layout-detalhado then
                       put "+-----+---------------------------+---------+-----------------+----------------+" at 01 skip
                           "| Cod | Descriá∆o                 |  Refer  |   Vencimentos   |   Descontos    |" at 01 skip
                           "+-----+---------------------------+---------+-----------------+----------------+" at 01 skip.
                end.
                ...
                if tt-param.l-layout-detalhado then do:
                    put "|"                  at  01
                        w-mvtocalc.ev-codigo at  03
                        "|"                  at  07
                        w-mvtocalc.descricao at  09
                        "|"                  at  35.
                    if  w-mvtocalc.horas > 0 then
                        put w-mvtocalc.horas at  37.
                    if  w-mvtocalc.inc-liquido = 2 then
                        put "|"              at  45
                            "|"              at  63
                            w-mvtocalc.valor at  65
                            c-inc-liquido    at  78
                            "|"              at  80.
                    else
                        put "|"              at  45
                            w-mvtocalc.valor at  48
                            c-inc-liquido    at  61
                            "|"              at  63
                            "|"              at  80.
                end.
                ...
                if  last-of(w-mvtocalc.fc-codigo) then do:
                   ...
                   if tt-param.l-layout-detalhado then do:
                       put "+-----+---------------------------+---------+-----------------+----------------+" at 01 skip
                           ...
                           c-parabens            at 03
                           "|"                   at 45
                           "Total Vencimentos"   at 46
                           "|"                   at 63
                           "Total Descontos"     at 65
                           "|"                   at 80 skip
                           "|"                   at 01
                           "|"                   at 45
                           d-total-vencto        at 48
                           "|"                   at 63
                           d-total-descto        at 65 "-"
                           "|"                   at 80 skip
                           "|"                   at 01
                           c-mensagem[1]         at 03 format "x(40)"
                           "+-----------------+----------------+" at 45 skip
                           "|"                   at 01
                           c-mensagem[2]         at 03 format "x(40)"
                           "|"                   at 45
                           "Total L°quido:"      at 50
                           d-liquido-pagar       at 65
                           "|"                   at 80 skip
                           "+-------------------------------------------+----------------------------------+" at 01 skip
                           "|"                   at 01
                           "Sal†rio Base"        at 03
                           "Sal. Contr. INSS"    at 17
                           "Base C†lc. FGTS"     at 35
                           "FGTS do Màs"         at 52
                           "Base C†lc. IRRF"     at 65
                           "|"                   at 80 skip
                           "|"                   at 01
                           d-salar-atual         at 03 format ">>>>>,>>9.99"
                           d-base-iapas          at 20
                           d-base-fgts           at 37
                           d-valor-fgts          at 51
                           d-base-irrf           at 67
                           "|"                   at 80 skip
                           "+------------------------------------------------------------------------------+" skip
                           "|     DECLARO TER RECEBIDO A IMPORT∂NCIA L÷QUIDA DISCRIMINADA NESTE RECIBO     |" skip
                           "|"                   at 01
                           "|"                   at 80 skip
                           "|        __/__/____             _________________________________________      |" skip
                           "|          Data                         Assinatura do Funcion†rio              |" skip
                           "+------------------------------------------------------------------------------+" skip(5) skip.
                       page.
                   end.
                   else
