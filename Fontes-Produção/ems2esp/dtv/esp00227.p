...
**       Data....: 26/05/09
**       Autor...: DATASUL S.A.
**       Objetivo: Relat¢rio de Consulta de Contratos
**       VersÆo..: 1.00.000 - 30100986
**       OBS.....: Este fonte foi gerado pelo Data Viewer 3.00
*******************************************************************************/

define variable c-prog-gerado as character no-undo initial "ESP00227".
...
define temp-table tt-param
    ...
    field l-log-libera-ini like contrato-for.log-libera
    field l-log-libera-fim like contrato-for.log-libera
...
def new shared var l-log-libera-ini like contrato-for.log-libera format "Sim/NÆo" initial no no-undo.
def new shared var l-log-libera-fim like contrato-for.log-libera format "Sim/NÆo" initial yes no-undo.
...
form contrato-for.cod-estabel column-label "Est" format "x(3)" at 003
     contrato-for.nr-contrato column-label "Nr Contrato" format ">>>>>>>>9" at 007
     contrato-for.des-contrat column-label "Descri‡Æo" format "x(32)" at 024
     contrato-for.log-libera column-label "Ativo" format "Sim/NÆo" at 063
     contrato-for.dt-ter-validade column-label "T‚rmino" format "99/99/9999" at 071
...
assign c-programa     = "esp00227"
       c-versao       = "2.00"
       c-revisao      = ".00.000"
       c-titulo-relat = "Relat¢rio de Consulta de Contratos"
       c-sistema      = "Contratos".
...
assign i-ep-codigo-usuario = tt-param.ep-codigo
       ...
       l-log-libera-ini = tt-param.l-log-libera-ini
       l-log-libera-fim = tt-param.l-log-libera-fim
...
for each contrato-for no-lock
         where contrato-for.cod-estabel >= c-cod-estabel-ini and 
               ...
               contrato-for.log-libera >= l-log-libera-ini and 
               contrato-for.log-libera <= l-log-libera-fim:
    ...
    if  tt-param.formato = 2 then do:
        ...
        display stream str-rp contrato-for.cod-estabel
...
if  tt-param.parametro then do:
   ...
   disp stream str-rp 
      ...
      l-log-libera-ini colon 20 "|< >|"   at 44 l-log-libera-fim no-label
      da-dt-ter-validade-ini colon 20 "|< >|"   at 44 da-dt-ter-validade-fim no-label
   ...
   disp stream str-rp "   Contratos vigentes"
