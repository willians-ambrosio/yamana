...
&Scoped-Define ENABLED-OBJECTS RECT-12 RECT-13 fi-dt-ini btn-executar ~
btn-close 
&Scoped-Define DISPLAYED-OBJECTS fi-dt-ini 
...
DEFINE FRAME DEFAULT-FRAME
     fi-dt-ini AT ROW 3.75 COL 33 COLON-ALIGNED WIDGET-ID 24
...
ON END-ERROR OF C-Win /* Data de Validade - CD0303 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Data de Validade - CD0303 */
DO:
...
DO:
    DEFINE VARIABLE da-data-valid AS DATE        NO-UNDO.
 

/* ===> INFORME A DATA, LEMBRANDO QUE NO PROGRESS E MM/DD/AAAA <=== 
ASSIGN da-data-valid  = 01/01/2011. */

ASSIGN FRAME {&FRAME-NAME} fi-dt-ini.

FOR EACH sit-tribut-relacto:
  ASSIGN sit-tribut-relacto.dat-valid-inic  = fi-dt-ini.
END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-12 RECT-13 fi-dt-ini btn-executar btn-close 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
