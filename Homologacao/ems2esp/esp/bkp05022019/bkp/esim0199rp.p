...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD fnCotacao Procedure  _DB-REQUIRED
...
------------------------------------------------------------------------------*/
    ...
    Find First mguni.cotacao No-lock
         Where mguni.cotacao.mo-codigo    = ordem-compra.mo-codigo
           And mguni.cotacao.ano-periodo  = String(Year (dataDi),"9999")
        No-error.


    If  mguni.cotacao.cotacao[Day(dataDI)] = 0 
    Then taxa = 1.
    Else taxa = mguni.cotacao.cotacao[Day(dataDI)].
