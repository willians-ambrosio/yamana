...
/*------------------------------------------------------------------------
File.............: forn22BC.w
Description......: Lista Fornecedores - CtaPagar
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
...
define variable c-prog-gerado as character no-undo initial "FORN22BC".
...
define temp-table tt-param
    ...
    field i-cod-gr-forn-ini like emitente.cod-gr-forn
    field i-cod-gr-forn-fim like emitente.cod-gr-forn
.
...
def new shared var i-cod-gr-forn-ini like emitente.cod-gr-forn format ">9" initial 0 no-undo.
def new shared var i-cod-gr-forn-fim like emitente.cod-gr-forn format ">9" initial 99 no-undo.
...
DEFINE FRAME f-pg-sel
   i-cod-emitente-ini label "C¢digo"
   ...
   da-data-implant-ini label "Data Implanta‡Æo"
     at row 2 col 22 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

   da-data-implant-fim no-label
     at row 2 col 43 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

   i-cod-gr-forn-ini label "Grupo"
     at row 3 col 22 colon-aligned
     view-as fill-in 
     size 3 by .88
     font 1

   i-cod-gr-forn-fim no-label
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Lista Fornecedores - CtaPagar - forn22BC"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "forn22BC".
...
PROCEDURE enable_UI :
   ...
   da-data-implant-ini da-data-implant-fim
   i-cod-gr-forn-ini i-cod-gr-forn-fim
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "forn22BC" + "." + v-cod-extens-arq.
    ...
    assign tt-param.i-cod-emitente-ini = input frame f-pg-sel i-cod-emitente-ini
           ...
           tt-param.i-cod-emitente-fim = input frame f-pg-sel i-cod-emitente-fim
           tt-param.da-data-implant-ini = input frame f-pg-sel da-data-implant-ini
           tt-param.da-data-implant-fim = input frame f-pg-sel da-data-implant-fim
           tt-param.i-cod-gr-forn-ini = input frame f-pg-sel i-cod-gr-forn-ini
           tt-param.i-cod-gr-forn-fim = input frame f-pg-sel i-cod-gr-forn-fim
.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "dtv/forn2255.p".
