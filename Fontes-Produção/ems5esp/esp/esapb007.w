...
*******************************************************************************/
{include/i-prgvrs.i ESAPB007 5.06.00.000}
...
DEFINE VARIABLE h_esapb007-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esapb007-v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapb007-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esapb007-v01 ).
       RUN set-position IN h_esapb007-v01 ( 2.75 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 10.00 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapb007-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp\esapb007-z01.w,
                     ProgVaPara = ,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esapb007-q01 ).
       RUN set-position IN h_esapb007-q01 ( 1.25 , 61.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.25 , 9.00 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_esapb007-v01. */
       RUN add-link IN adm-broker-hdl ( h_esapb007-q01 , 'Record':U , h_esapb007-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esapb007-v01 ).

       /* Links to SmartQuery h_esapb007-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_esapb007-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esapb007-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esapb007-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esapb007-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESAPB007" "5.06.00.000"}
