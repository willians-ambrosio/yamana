...
DEFINE VARIABLE h_ymof0112-bz01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymof0112-bz01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ymof0112-bz01 ).
       RUN set-position IN h_ymof0112-bz01 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.00 ) */

       /* Links to SmartBrowser h_ymof0112-bz01. */
       RUN add-link IN adm-broker-hdl ( h_ymof0112-bz01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymof0112-bz01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "YMOF0112-P01" "1.00.00.000"}
