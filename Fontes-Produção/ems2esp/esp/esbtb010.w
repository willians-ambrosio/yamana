...
/*------------------------------------------------------------------------
File.............: esbtb010.w
Description......: Exporta Movimento AP
Author...........: Daniel P. de Lima
Created..........: 24/02/11 - 09:31
------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "ESBTB010".
...
DEFINE FRAME f-pg-par
   ...
   l-cargaini
     at row 1.3 col 2 colon-aligned

   d-data-corte
     at row 1.3 col 40 colon-aligned
     view-as fill-in
     size 11 by .88
     font 1
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Exporta Movimento AP - ESBTB010"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign l-cargaini = no.
ASSIGN d-data-corte = today - 365.
assign v-cod-prog-gerado = "ESBTB010".
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    assign v-cod-pg-mouse-selec = "im-pg-par".
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "ESBTB010" + "." + v-cod-extens-arq.

    assign tt-param.l-cargaini = input frame f-pg-par l-cargaini
           tt-param.d-data-corte = input frame f-pg-par d-data-corte
.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "esp/esbtb010rp.p".
