...
DEFINE VARIABLE h_ymfp0008-b02 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'hcm/hcmesp/prghur/esp/ymfp0008-b02.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ymfp0008-b02 ).
       RUN set-position IN h_ymfp0008-b02 ( 2.75 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.25 , 80.00 ) */

       /* Links to SmartBrowser h_ymfp0008-b02. */
       RUN add-link IN adm-broker-hdl ( h_ymfp0008-b02 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymfp0008-b02 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
