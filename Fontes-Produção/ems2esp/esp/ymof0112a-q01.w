...
&Scoped-define INTERNAL-TABLES es-it-uf-estorno-cred

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-it-uf-estorno-cred NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-it-uf-estorno-cred NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-it-uf-estorno-cred
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-it-uf-estorno-cred
...
DEFINE QUERY Query-Main FOR 
      es-it-uf-estorno-cred SCROLLING.
&ANALYZE-RESUME
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.es-it-uf-estorno-cred"
     _Options          = "NO-LOCK"
