...
*******************************************************************************/
{include/i-prgvrs.i ESUT0013 2.06.00.000}  /*** 010013 ***/

&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
{include/i-license-manager.i ESUT0013 MDC}
&ENDIF
...
{utp/ut9000.i "ESUT0013" "2.06.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {include/i-imvrf.i &programa=ESUT0013 &versao-layout=001}
    ...
    if  c-nom-prog-appc-mg97 <> "" then do:
        ...
        IF l-TMS-401 THEN DO:
            {include/i-imvrf.i &programa=ESUT0013 &versao-layout=002}
        END.
        ELSE IF l-TMS-402 THEN DO:
            {include/i-imvrf.i &programa=ESUT0013 &versao-layout=003}
        END.
...
do  on error undo, return error
    ...
    {include/i-imrun.i esp/esut0013rp.p}
