...
/*------------------------------------------------------------------------
File.............: esbtb001.w
Description......: Exportar Estabelecimento para Ilha
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 06/12/10 - 17:56 - adm

------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "esbtb001".
...
DEFINE FRAME f-pg-sel
   c-cod-estabel-ini label "Estab"
     at row 1 col 9 colon-aligned
     view-as fill-in 
     size 4 by .88
     font 1

   c-cod-estabel-fim no-label
     at row 1 col 23 colon-aligned
     view-as fill-in 
     size 4 by .88
     font 1

   IMAGE-1 AT ROW 01.00 COL 16
   IMAGE-2 AT ROW 01.00 COL 21
   WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY
   SIDE-LABELS NO-UNDERLINE THREE-D
   AT COL 3 ROW 2.85
   SIZE 76.86 BY 10.62.
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Exportar Estabelecimento para Ilha - esbtb001"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "esbtb001".
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "esbtb001" + "." + v-cod-extens-arq.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "esp/esbtb001rp.p".
