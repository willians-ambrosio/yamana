...
DEFINE VARIABLE h_ymof0112-q02 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_ymof0112-v02-2 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 11.54 COL 2.57 HELP
          "Salva e sai"
     bt-save AT ROW 11.54 COL 13 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 11.54 COL 23.57 HELP
          "Cancela"
     bt-ajuda AT ROW 11.54 COL 70.72
     rt-button AT ROW 11.38 COL 1.57
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1.17
         SIZE 86.57 BY 16.83 WIDGET-ID 100.
...
DO:
{include/okfil.i  h_ymof0112-v02-2}
END.
...
DO:
{include/salvafil.i  h_ymof0112-v02-2}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.75 , 2.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 9.50 , 85.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymof0112-v02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ymof0112-v02-2 ).
       RUN set-position IN h_ymof0112-v02-2 ( 3.79 , 2.29 ) NO-ERROR.
       /* Size in UIB:  ( 5.25 , 78.43 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymof0112-q02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_ymof0112-q02 ).
       RUN set-position IN h_ymof0112-q02 ( 1.00 , 59.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_ymof0112-v02-2. */
       RUN add-link IN adm-broker-hdl ( h_ymof0112-q02 , 'Record':U , h_ymof0112-v02-2 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'tableio':U , h_ymof0112-v02-2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             bt-ok:HANDLE IN FRAME f-cad , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymof0112-v02-2 ,
             h_folder , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  run pi-atualiza-parent in  h_ymof0112-v02-2 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN  h_ymof0112-q02 (input v-row-table).
