...
DEFINE FRAME f-main
     ctrl-conflito.dat_ult_alter AT ROW 1 COL 75 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 12.57 BY 1
     ctrl-conflito.cod_prog_dtsul_base AT ROW 1.25 COL 1.29 WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 45 BY .88
     fi-descricao AT ROW 2.29 COL 22.43 COLON-ALIGNED WIDGET-ID 4
     fi_nom_prog_ext AT ROW 3.33 COL 22.43 COLON-ALIGNED WIDGET-ID 8
...
FOR EACH ctrl-conflito-it OF ctrl-conflito:

    DELETE ctrl-conflito-it.
...
ASSIGN fi-descricao:SCREEN-VALUE IN FRAME {&FRAME-NAME} = IF AVAIL prog_dtsul THEN prog_dtsul.des_prog_dtsul ELSE ''
    fi_nom_prog_ext:SCREEN-VALUE IN FRAME {&FRAME-NAME} = IF AVAIL prog_dtsul THEN prog_dtsul.nom_prog_ext ELSE ''.
