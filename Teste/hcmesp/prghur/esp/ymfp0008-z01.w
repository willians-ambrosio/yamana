...
*******************************************************************************/
{include/i-prgvrs.i YMFP0008-Z01 12.1.11.000}
...
DEFINE VARIABLE h_YMFP0008-b01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_ymfp0008-b04 AS HANDLE NO-UNDO.
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Gestores */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Gestores */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Codigo|Nome' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prghur/esp/YMFP0008-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_YMFP0008-b01 ).
       RUN set-position IN h_YMFP0008-b01 ( 2.50 , 2.72 ) NO-ERROR.
       /* Size in UIB:  ( 12.00 , 80.14 ) */

       /* Links to SmartBrowser h_YMFP0008-b01. */
       RUN add-link IN adm-broker-hdl ( h_YMFP0008-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_YMFP0008-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prghur/esp/ymfp0008-b04.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ymfp0008-b04 ).
       RUN set-position IN h_ymfp0008-b04 ( 2.75 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 12.00 , 80.00 ) */

       /* Links to SmartBrowser h_ymfp0008-b04. */
       RUN add-link IN adm-broker-hdl ( h_ymfp0008-b04 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymfp0008-b04 ,
             h_folder , 'AFTER':U ).
    END. /* Page 2 */
