...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es_operac_financ NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es_operac_financ NO-LOCK.
