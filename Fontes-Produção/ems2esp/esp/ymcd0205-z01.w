...
*******************************************************************************/
{include/i-prgvrs.i YMCD0205-Z01 11.5.11.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i YMCD0205 MCD}
&ENDIF
...
DEFINE VARIABLE h_ymcd0205-b01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_ymcd0205-b02 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_ymcd0205-b03 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Item Orig|Item Padr|Desc Orig' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Layout = ,
                     Create-On-Add = ?':U ,
             OUTPUT h_ymcd0205-b01 ).
       RUN set-position IN h_ymcd0205-b01 ( 2.50 , 1.86 ) NO-ERROR.
       /* Size in UIB:  ( 12.17 , 88.14 ) */

       /* Links to SmartBrowser h_ymcd0205-b01. */
       RUN add-link IN adm-broker-hdl ( h_ymcd0205-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymcd0205-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymcd0205-b02.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ymcd0205-b02 ).
       RUN set-position IN h_ymcd0205-b02 ( 2.50 , 1.86 ) NO-ERROR.
       /* Size in UIB:  ( 12.17 , 88.14 ) */

       /* Links to SmartBrowser h_ymcd0205-b02. */
       RUN add-link IN adm-broker-hdl ( h_ymcd0205-b02 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymcd0205-b02 ,
             h_folder , 'AFTER':U ).
    END. /* Page 2 */
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymcd0205-b03.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     Hide-on-Init = no,
                     Disable-on-Init = no,
                     ...
                     Layout = ,
                     Create-On-Add = ?':U ,
             OUTPUT h_ymcd0205-b03 ).
       RUN set-position IN h_ymcd0205-b03 ( 2.58 , 1.86 ) NO-ERROR.
       /* Size in UIB:  ( 12.17 , 88.14 ) */

       /* Links to SmartBrowser h_ymcd0205-b03. */
       RUN add-link IN adm-broker-hdl ( h_ymcd0205-b03 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymcd0205-b03 ,
             h_folder , 'AFTER':U ).
    END. /* Page 3 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "YMCD0205-Z01" "11.5.11.000"}
