...
*******************************************************************************/
{include/i-prgvrs.i ESIN0521 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESIN0521 CNP}
&ENDIF

CREATE WIDGET-POOL. 

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        esin0521
...
DEFINE VARIABLE cod-ep-fim AS INTEGER FORMAT ">>9" INITIAL 999 
     VIEW-AS FILL-IN 
     SIZE 4 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE cod-ep-ini AS INTEGER FORMAT ">>9" INITIAL 0 
     LABEL "Empresa" 
     VIEW-AS FILL-IN 
     SIZE 4 BY .88
     FONT 1 NO-UNDO.
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i inp/esp/esin0521rp.p}
