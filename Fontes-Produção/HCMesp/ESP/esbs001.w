...
{include/i-prgvrs.i ESBS001 2.04.00.001}
...
DEFINE VARIABLE cdn_empresa-fim AS INTEGER FORMAT "zz9" INITIAL 999 
     VIEW-AS FILL-IN 
     SIZE 7.86 BY .88 NO-UNDO.

DEFINE VARIABLE cdn_empresa-ini AS INTEGER FORMAT "zz9" INITIAL 0 
     LABEL "Empresa":R9 
     VIEW-AS FILL-IN 
     SIZE 7.86 BY .88 NO-UNDO.

DEFINE VARIABLE cdn_estab-fim AS INTEGER FORMAT "zz9" INITIAL 999 
     VIEW-AS FILL-IN 
     SIZE 7.86 BY .88 NO-UNDO.

DEFINE VARIABLE cdn_estab-ini AS INTEGER FORMAT "zz9" INITIAL 0 
     LABEL "Estabelecimento":R18 
     VIEW-AS FILL-IN 
     SIZE 7.86 BY .88 NO-UNDO.

DEFINE VARIABLE cdn_funcionario-fim AS INTEGER FORMAT "zzzzzzz9" INITIAL 99999999 
     VIEW-AS FILL-IN 
     SIZE 11.43 BY .88 NO-UNDO.

DEFINE VARIABLE cdn_funcionario-ini AS INTEGER FORMAT "zzzzzzz9" INITIAL 0 
     LABEL "Matr­cula":R11 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-sel
     cdn_empresa-ini AT ROW 2.5 COL 20 COLON-ALIGNED HELP
          "C¢digo Empresa" WIDGET-ID 14
     cdn_empresa-fim AT ROW 2.5 COL 42.57 COLON-ALIGNED HELP
          "C¢digo Empresa" NO-LABEL WIDGET-ID 12
     cdn_estab-ini AT ROW 3.5 COL 20.14 COLON-ALIGNED HELP
          "C½digo Nœmero Estabelecimento"
     cdn_estab-fim AT ROW 3.5 COL 42.72 COLON-ALIGNED HELP
          "C½digo Nœmero Estabelecimento" NO-LABEL
     cdn_funcionario-ini AT ROW 4.5 COL 20 COLON-ALIGNED HELP
          "Nœmero da matr­cula do funcionÿrio" WIDGET-ID 6
     cdn_funcionario-fim AT ROW 4.5 COL 42.57 COLON-ALIGNED HELP
          "Nœmero da matr­cula do funcionÿrio" NO-LABEL WIDGET-ID 4
     IMAGE-1 AT ROW 3.5 COL 33.29
     IMAGE-2 AT ROW 3.5 COL 41.57
     IMAGE-3 AT ROW 4.5 COL 33.14 WIDGET-ID 8
     IMAGE-4 AT ROW 4.5 COL 41.43 WIDGET-ID 10
     IMAGE-5 AT ROW 2.5 COL 33.14 WIDGET-ID 16
     IMAGE-6 AT ROW 2.5 COL 41.43 WIDGET-ID 18
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
{utp/ut9000.i "ESBS001" "2.04.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY cdn_empresa-ini cdn_empresa-fim cdn_estab-ini cdn_estab-fim 
          cdn_funcionario-ini cdn_funcionario-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 cdn_empresa-ini 
         cdn_empresa-fim cdn_estab-ini cdn_estab-fim cdn_funcionario-ini 
         cdn_funcionario-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario             = c-seg-usuario
           ...
           tt-param.cdn-empresa-ini     = INPUT FRAME f-pg-sel cdn_empresa-ini
           tt-param.cdn-empresa-fim     = INPUT FRAME f-pg-sel cdn_empresa-fim
           tt-param.cdn-estab-ini       = INPUT FRAME f-pg-sel cdn_estab-ini
           tt-param.cdn-estab-fim       = INPUT FRAME f-pg-sel cdn_estab-fim
           tt-param.cdn-funcionario-ini = INPUT FRAME f-pg-sel cdn_funcionario-ini
           tt-param.cdn-funcionario-fim = INPUT FRAME f-pg-sel cdn_funcionario-fim
    ...
    {include/i-rprun.i esp\ESBS001rp.p}
