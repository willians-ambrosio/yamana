...
ON END-ERROR OF w-cadpaifilho-ambos /* Manuten‡Æo M‚tricas PLR */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadpaifilho-ambos w-cadpaifilho-ambos
ON WINDOW-CLOSE OF w-cadpaifilho-ambos /* Manuten‡Æo M‚tricas PLR */
DO:
...
FOR EACH tip_contrib_margin NO-LOCK:
    IF NOT CAN-FIND(FIRST b_tip_contrib_margin
        ...
        ASSIGN c-aux = IF tip_contrib_margin.LOG_corporativo THEN "Corporativo" ELSE "NÆo Corporativo".
