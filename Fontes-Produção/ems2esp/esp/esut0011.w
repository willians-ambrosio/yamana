...
DEFINE VARIABLE tg-atualiza AS LOGICAL INITIAL no 
     LABEL "Atualiza as ordens de compra com o preáo alterado?" 
     VIEW-AS TOGGLE-BOX
     SIZE 43 BY .83 TOOLTIP "Caso sim, todos os movimentos pendentes ter∆o seus preáos alterados." NO-UNDO.
