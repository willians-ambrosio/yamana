...
*******************************************************************************/
{include/i-prgvrs.i APYA501C 12.1.17.000}
...
DEFINE VARIABLE h_apya501C-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_apya501C-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 2.88 COL 2.57 HELP
          "Salva e sai"
     bt-save AT ROW 2.88 COL 13 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 2.88 COL 23.57 HELP
          "Cancela"
     bt-ajuda AT ROW 2.88 COL 79.72
     rt-button AT ROW 2.71 COL 1.57
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 106.72 BY 17 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Inclui/Modifica Contrato Filho Contrato Intercompany"
         HEIGHT             = 3.42
         WIDTH              = 91.14
         MAX-HEIGHT         = 26.75
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-cadsim /* Inclui/Modifica Contrato Filho Contrato Intercompany */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Inclui/Modifica Contrato Filho Contrato Intercompany */
DO:
...
DO:
{include/okfil.i h_apya501C-v01}
END.
...
DO:
{include/salvafil.i h_apya501C-v01}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apl/apya501C-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_apya501C-v01 ).
       RUN set-position IN h_apya501C-v01 ( 1.21 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 1.25 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apl/apya501C-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_apya501C-q01 ).
       RUN set-position IN h_apya501C-q01 ( 2.79 , 50.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_apya501C-v01. */
       RUN add-link IN adm-broker-hdl ( h_apya501C-q01 , 'Record':U , h_apya501C-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'tableio':U , h_apya501C-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_apya501C-v01 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "APYA501C" "12.1.17.000"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_apya501C-v01 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_apya501C-q01 (input v-row-table).
