...
DEF TEMP-TABLE tt-imprime
    ...
    field tt-num_pessoa_fisic   like rh_pessoa_fisic.num_pessoa_fisic.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "<Listagem Geral de Funcion rios - ESHCM020.001 >"
         HEIGHT             = 12.29
         WIDTH              = 72
         MAX-HEIGHT         = 31.29
         MAX-WIDTH          = 182.86
...
ON END-ERROR OF C-Win /* <Listagem Geral de Funcion rios  - ESHCM020.001 > */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* <Listagem Geral de Funcion rios  - ESHCM020.001 > */
DO:
...
/************************************************************/
    ...
    /*************** Imprime altera‡äes **************************/
    /*************** Cabe»alho ***********************************/
    chWorkSheet:Range("a1"):Value = "Listagem Geral de Funcionarios -   " + string(today).
    ...
    chWorkSheet:Range("c3"):Value = "Matr¡cula".
    chWorkSheet:Range("d3"):Value = "Cod.Pessoa F¡sica".
    chWorkSheet:Range("e3"):Value = "Nome Abrev".
    chWorkSheet:Range("f3"):Value = "Nome do Funcion rio".
    chWorkSheet:Range("g3"):Value = "Estado Civil".
    chWorkSheet:Range("h3"):Value = "Sexo".
    chWorkSheet:Range("i3"):Value = "Num.Depend.IRF".
    chWorkSheet:Range("j3"):Value = "Depend.SalFamilia".
    chWorkSheet:Range("k3"):Value = "CPF".
    chWorkSheet:Range("l3"):Value = "RG".
    chWorkSheet:Range("m3"):Value = "OrgÆo Emissor".
    chWorkSheet:Range("n3"):Value = "PIS".
    chWorkSheet:Range("o3"):Value = "No. CPTS".
    chWorkSheet:Range("p3"):Value = "Serie CPTS".
    chWorkSheet:Range("q3"):Value = "UF CPTS".
    chWorkSheet:Range("r3"):Value = "Dt Nascimento".
    chWorkSheet:Range("s3"):Value = "Tipo Sanguinio".
    chWorkSheet:Range("t3"):Value = "Cidade Residˆncia".
    chWorkSheet:Range("u3"):Value = "Estado".
    chWorkSheet:Range("v3"):Value = "Dt AdmissÆo".
    chWorkSheet:Range("w3"):Value = "Termino Contrato_1o.Periodo".
    chWorkSheet:Range("x3"):Value = "Termino Contrato_2o.Periodo".
    chWorkSheet:Range("y3"):Value = "Grau Instru‡Æo".
    chWorkSheet:Range("z3"):Value = "Categoria".
    chWorkSheet:Range("aa3"):Value = "Cod.M.Obra".
    chWorkSheet:Range("ab3"):Value = "Desc_Tipo M.Obra".
    chWorkSheet:Range("ac3"):Value = "Cod Cargo".
    chWorkSheet:Range("ad3"):Value = "N¡vel Cargo".
    chWorkSheet:Range("ae3"):Value = "Cargo".
    chWorkSheet:Range("af3"):Value = "CBO".
    chWorkSheet:Range("ag3"):Value = "Turno".
    chWorkSheet:Range("ah3"):Value = "Turma".
    chWorkSheet:Range("ai3"):Value = "Unid Lota‡Æo". 
    chWorkSheet:Range("aj3"):Value = "Descri‡Æo Lota‡Æo". 
    chWorkSheet:Range("ak3"):Value = "Cod CCusto". 
    chWorkSheet:Range("al3"):Value = "Descri‡Æo CCusto".
    chWorkSheet:Range("am3"):Value = "Banco".
    chWorkSheet:Range("an3"):Value = "Agˆncia". 
    chWorkSheet:Range("ao3"):Value = "Conta Corrente".
    chWorkSheet:Range("ap3"):Value = "Digito".
    
    chWorkSheet:Range("a3:ap3"):Font:Bold = TRUE.
    ...
    chWorkSheet:Columns("f"):ColumnWidth = 35.
    chWorkSheet:Columns("g"):ColumnWidth = 14.
    chWorkSheet:Columns("h"):ColumnWidth = 05.
    ...
    chWorkSheet:Columns("q"):ColumnWidth = 08.
    chWorkSheet:Columns("r"):ColumnWidth = 15.
    chWorkSheet:Columns("s"):ColumnWidth = 15.
    chWorkSheet:Columns("t"):ColumnWidth = 15.
    chWorkSheet:Columns("u"):ColumnWidth = 06.
    chWorkSheet:Columns("v"):ColumnWidth = 12.
    chWorkSheet:Columns("w"):ColumnWidth = 20.
    chWorkSheet:Columns("x"):ColumnWidth = 20.
    chWorkSheet:Columns("y"):ColumnWidth = 20.
    chWorkSheet:Columns("z"):ColumnWidth = 06.
    chWorkSheet:Columns("aa"):ColumnWidth = 06.
    chWorkSheet:Columns("ab"):ColumnWidth = 15.
    chWorkSheet:Columns("ac"):ColumnWidth = 08.
    chWorkSheet:Columns("ad"):ColumnWidth = 04.
    chWorkSheet:Columns("ae"):ColumnWidth = 25.
    chWorkSheet:Columns("af"):ColumnWidth = 06.
    chWorkSheet:Columns("ag"):ColumnWidth = 06.
    chWorkSheet:Columns("ah"):ColumnWidth = 06.
    chWorkSheet:Columns("ai"):ColumnWidth = 15.
    chWorkSheet:Columns("aj"):ColumnWidth = 40.
    chWorkSheet:Columns("ak"):ColumnWidth = 10.
    chWorkSheet:Columns("al"):ColumnWidth = 30.
    chWorkSheet:Columns("am"):ColumnWidth = 07.
    chWorkSheet:Columns("an"):ColumnWidth = 10.
    chWorkSheet:Columns("ao"):ColumnWidth = 15.
    chWorkSheet:Columns("ap"):ColumnWidth = 06.
   ...
   FOR EACH  funcionario 
      WHERE funcionario.cdn_empresa       >= fi-empresa-ini
        ...
        ASSIGN chExcelApplication:range( "a" + STRING(i-linha) ):value = funcionario.cdn_empresa
               ...
               chExcelApplication:range( "e" + STRING(i-linha) ):value = rh_pessoa_fisic.nom_abrev_pessoa_fisic
               chExcelApplication:range( "f" + STRING(i-linha) ):value = funcionario.nom_pessoa_fisic
               chExcelApplication:range( "g" + STRING(i-linha) ):value = c-estado-civil
               chExcelApplication:range( "h" + STRING(i-linha) ):value = c-sexo
               /* chExcelApplication:Range( "h" + STRING(i-linha)):Numberformat = "0000000" */
               chExcelApplication:range( "i" + STRING(i-linha) ):value = funcionario.qti_depend_irf
               chExcelApplication:range( "j" + STRING(i-linha) ):value = funcionario.qti_depend_salfam
               chExcelApplication:range( "k" + STRING(i-linha) ):value = rh_pessoa_fisic.cod_id_feder
               chExcelApplication:Range( "k" + STRING(i-linha)):Numberformat = "00000000000"
               chExcelApplication:range( "l" + STRING(i-linha) ):value = rh_pessoa_fisic.cod_id_estad_fisic
               chExcelApplication:range( "m" + STRING(i-linha) ):value = rh_pessoa_fisic.cod_orgao_emis_id_estad
               chExcelApplication:range( "n" + STRING(i-linha) ):value = funcionario.cod_pis
               chExcelApplication:Range( "n" + STRING(i-linha)):Numberformat = "00000000000"
               chExcelApplication:range( "o" + STRING(i-linha) ):value = funcionario.cod_cart_trab
               chExcelApplication:range( "p" + STRING(i-linha) ):value = funcionario.cod_ser_cart_trab
               chExcelApplication:range( "q" + STRING(i-linha) ):value = funcionario.cod_unid_federac_cart_trab
               chExcelApplication:range( "r" + STRING(i-linha) ):value = rh_pessoa_fisic.dat_nascimento
               chExcelApplication:range( "s" + STRING(i-linha) ):value = c-tipo-sangue
               chExcelApplication:range( "t" + STRING(i-linha) ):value = rh_pessoa_fisic.nom_cidad_rh
               chExcelApplication:range( "u" + STRING(i-linha) ):value = rh_pessoa_fisic.cod_unid_federac_rh
               chExcelApplication:range( "v" + STRING(i-linha) ):value = funcionario.dat_admis_func
               chExcelApplication:range( "w" + STRING(i-linha) ):value = funcionario.dat_term_contrat_trab
               chExcelApplication:range( "x" + STRING(i-linha) ):value = funcionario.dat_term_prorrog_contrat_trab
               chExcelApplication:range( "y" + STRING(i-linha) ):value = c-grau_instruc
               chExcelApplication:range( "z" + STRING(i-linha) ):value = c-categ
               chExcelApplication:range( "aa" + STRING(i-linha) ):value = funcionario.cod_tip_mdo
               chExcelApplication:range( "ab" + STRING(i-linha) ):value = tip_mdo.des_tip_mdo
               chExcelApplication:range( "ac" + STRING(i-linha) ):value = funcionario.cdn_cargo_basic
               chExcelApplication:range( "ad" + STRING(i-linha) ):value = funcionario.cdn_niv_cargo
               chExcelApplication:range( "ae" + STRING(i-linha) ):value = cargo.des_cargo /*cargo_basic.des_cargo_basic*/
               chExcelApplication:range( "af" + STRING(i-linha) ):value = cargo_basic.cod_classif_ocupac
               chExcelApplication:range( "ag" + STRING(i-linha) ):value = funcionario.cdn_turno_trab
               chExcelApplication:Range( "ag" + STRING(i-linha)):Numberformat = "0000"
               chExcelApplication:range( "ah" + STRING(i-linha) ):value = funcionario.cdn_turma_trab
               chExcelApplication:range( "ai" + STRING(i-linha) ):value = funcionario.cod_unid_lotac 
               chExcelApplication:range( "aj" + STRING(i-linha) ):value = unid_lotac.des_unid_lotac 
               chExcelApplication:range( "ak" + STRING(i-linha) ):value = funcionario.cod_rh_ccusto 
               chExcelApplication:range( "al" + STRING(i-linha) ):value = rh_ccusto.des_rh_ccusto 
               chExcelApplication:range( "am" + STRING(i-linha) ):value = funcionario.cdn_bco_liq 
               chExcelApplication:range( "an" + STRING(i-linha) ):value = funcionario.cdn_agenc_bcia_liq
               chExcelApplication:range( "ao" + STRING(i-linha) ):value = funcionario.cdn_cta_corren 
               chExcelApplication:range( "ap" + STRING(i-linha) ):value = funcionario.cod_digito_cta_corren.
