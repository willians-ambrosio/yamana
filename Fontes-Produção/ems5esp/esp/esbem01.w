...
&Scoped-define FIELDS-IN-QUERY-br-salvage /* */ tt-cod-cenar-ctbl tt-cod-exerc-ctbl tt-num-period-ctbl tt-cod-indic-econ tt-val-salvage   
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 56 BY 6.5
...
DEFINE FRAME DEFAULT-FRAME
     ...
     br-salvage AT ROW 6 COL 8
     bt-inclui AT ROW 12.5 COL 8 HELP
          "Dispara a execuá∆o do relat¢rio"
     bt-altera AT ROW 12.5 COL 18 HELP
          "Dispara a execuá∆o do relat¢rio"
     bt-exclui AT ROW 12.5 COL 28 HELP
          "Dispara a execuá∆o do relat¢rio"
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "<Campo Salvage Value no Bem - ESBEM01.001>"
         HEIGHT             = 14.29
         WIDTH              = 70.43
         MAX-HEIGHT         = 31.29
         MAX-WIDTH          = 182.86
...
ON END-ERROR OF C-Win /* <Campo Salvage Value no Bem - ESBEM01.001> */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* <Campo Salvage Value no Bem - ESBEM01.001> */
DO:
...
DO:
   ...
   FIND bem_pat_salvage_value
      WHERE bem_pat_salvage_value.num_id_bem_pat   = tt-num-id-bem-pat
        ...
        AND bem_pat_Salvage_value.num_seq_incorp_bem_pat = 0 NO-ERROR.
    ...
    FIND  bem_pat_salvage_value 
     ...
     ELSE DO:
          ...
          ASSIGN bem_pat_salvage_value.num_id_bem_pat    = bem_pat.num_id_bem_pat
                 ...
                 bem_pat_Salvage_value.num_seq_incorp_bem_pat = 0.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE fi-cenar-cont fi-exerc-ctbl fi-per-ctbl fi-moeda fi-salvage-value 
         fi-fin-econ BtnOK-3 BtnOK-2 BtnOK bt-canc RECT-20 RECT-21 
      WITH FRAME fr-salvage-value IN WINDOW C-Win.
