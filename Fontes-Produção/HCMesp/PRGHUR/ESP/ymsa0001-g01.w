...
*******************************************************************************/
{include/i-prgvrs.i YMSA0001-g01 1.00.00.000}
...
&Scoped-Define ENABLED-OBJECTS rt-button i_cdn_tip_refeicao bt-ok ~
bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS i_cdn_tip_refeicao 
...
DEFINE VARIABLE i_cdn_tip_refeicao AS INTEGER FORMAT ">>9":U 
     LABEL "Tipo Refei‡Æo" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     i_cdn_tip_refeicao AT ROW 1.17 COL 30 COLON-ALIGNED WIDGET-ID 2
...
DO:
FIND tip_refeicao NO-LOCK
    WHERE tip_refeicao.cdn_tip_refeicao EQ INPUT FRAME {&FRAME-NAME} i_cdn_tip_refeicao NO-ERROR.

IF NOT AVAILABLE tip_refeicao THEN DO:
    {utp/ut-table.i dthresp tip_refeicao 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(tip_refeicao).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY i_cdn_tip_refeicao 
      WITH FRAME d-vapara.
  ENABLE rt-button i_cdn_tip_refeicao bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "YMSA0001-g01" "1.00.00.000"}
