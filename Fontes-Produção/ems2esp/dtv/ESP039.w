...
define variable c-prog-gerado as character no-undo initial "ESP039".
...
def var c-titulo           as char init "Relat¢rio Materiais Alocados" no-undo.        
def var v-cod-prog-gerado  as char init "ESP039" no-undo.           
...
assign v-cod-prog-gerado = "ESP039".
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK 
   ON END-KEY UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK:
        ...
        assign c-lista = "Relat¢rio de Materiais Alocados" + "," + 
                         "Relat¢rio de Materiais Alocados".

        assign c-prog = "ESP039AA.w" + "," + 
                        "ESP039AA.w".
