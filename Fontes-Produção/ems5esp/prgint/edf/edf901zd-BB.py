/****************************************************************************************** 
** 	   Programa: edf901zd-BB.p
**   	  Autor: Daniela Campos
** 	 Fornecedor: DKP
**         Data: 09/07/2018
** Change/Chamado/: 
**      Objetivo: Retornar a quantidade de registros do trailler do lote e do arquivo - Layout  
**
...
then do:
    run pi_version_extract ('fnc_extracao_banco_brasil':U, 'prgint/edf/edf901zd-BB.py':U, '1.00.00.003':U, 'pro':U).
end /* if */.
/* End_Include: i_version_extract */

/* Retorno para o Trailer do Lote - Totais Qtde. de Moedas - posiá∆o 42 a 59 Tam: 13 */
 output to c:\temp\dados_trailer.txt append.
        message 1 view-as alert-box.

        put unformatted "p_cdn_segment_edi" p_cdn_segment_edi skip(01).
...
run pi_extracao_banco_brasil.

procedure pi_extracao_banco_brasil:
    output to c:\temp\dados_trailer.txt append.
        message 1 view-as alert-box.
...
/* Para trailer do lote retorna Somat¢rio dos registros tipo 1, 3 e 5. */

/* Para trailer do arquivo retorna quantidade de registro do arquivo - Somat¢ria dos registros de tipo 0, 1, 3, 5 e 9.  */
