...
&Scoped-define QUERY-STRING-Query-Main FOR EACH admdra_apf NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH admdra_apf NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main admdra_apf
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main admdra_apf
