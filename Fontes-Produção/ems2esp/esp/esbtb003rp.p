/*****************************************************************************
**       Programa: esbtb003rp.p
**       Data....: 16/02/11
**       Autor...: Daniel P. de Lima
**       Objetivo: Exportaá∆o Portador
**       Vers∆o..: 1.00.000 
*******************************************************************************/

define variable c-prog-gerado as character no-undo initial "esbtb003rp".
...
form ems2cadme.portador.cod-portador column-label "Port" format ">>>>9" at 001
     ems2cadme.portador.ep-codigo column-label "Emp" format ">>9" at 007
     ems2cadme.portador.nome column-label "Nome" format "x(40)" at 011
     ems2cadme.portador.nome-abrev column-label "Nome Abreviado" format "x(10)" at 052
     ems2cadme.portador.agencia column-label "Agància" format "x(8)" at 098
     ems2cadme.portador.conta-corren column-label "Cta Corrente" format "x(20)" at 107
...
assign c-programa     = "esbtb003rp"
       c-versao       = "2.00"
       c-revisao      = ".00.000"
       c-titulo-relat = "Exportaá∆o Portador"
       c-sistema      = "".
...
/* Prepara tabela es_portador para receber os registros */
                             
FIND FIRST es_portador NO-LOCK NO-ERROR.
    IF AVAIL es_portador THEN DO:
        RUN esp/esidelete.i 'es_portador'.
    END.

/* Prepara tabela es_portador para receber os registros */

for each ems2cadme.portador no-lock:
    CREATE es_portador.
    ASSIGN es_portador.cod_portador = portador.cod-portador  
           es_portador.ep_codigo    = portador.ep-codigo     
           es_portador.nome         = portador.nome          
           es_portador.nome_abrev   = portador.nome-abrev    
           es_portador.agencia      = portador.agencia       
           es_portador.conta_corren = portador.conta-corren
           es_portador.id           = v-num-reg-lidos.  
    ...
    if  tt-param.formato = 2 then do:
        ...
        display stream str-rp ems2cadme.portador.cod-portador
            ems2cadme.portador.ep-codigo
            ems2cadme.portador.nome
            ems2cadme.portador.nome-abrev
            ems2cadme.portador.agencia
            ems2cadme.portador.conta-corren
