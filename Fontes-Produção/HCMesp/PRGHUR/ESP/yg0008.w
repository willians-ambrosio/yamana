...
DEFINE VARIABLE h_yg0008-b01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_yg0008-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_yg0008-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 90.14 BY 22.04 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadpaifilho-ambos ASSIGN
         HIDDEN             = YES
         TITLE              = "Manuten‡Æo Parametros Horas In Intineres"
         HEIGHT             = 22.25
         WIDTH              = 90
         MAX-HEIGHT         = 22.25
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-cadpaifilho-ambos /* Manuten‡Æo Parametros Horas In Intineres */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadpaifilho-ambos w-cadpaifilho-ambos
ON WINDOW-CLOSE OF w-cadpaifilho-ambos /* Manuten‡Æo Parametros Horas In Intineres */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prghur/esp/yg0008-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_yg0008-v01 ).
       RUN set-position IN h_yg0008-v01 ( 2.67 , 1.43 ) NO-ERROR.
       /* Size in UIB:  ( 10.25 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Situa‡äes' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 13.00 , 2.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 10.00 , 88.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prghur/esp/yg0008-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = prghur/esp/yg0008-z01.w,
                     ProgVaPara = prghur/esp/yg0008-g01.w,
                     ProgIncMod = prghur/esp/yg0008a.w,
                     Implantar = no':U ,
             OUTPUT h_yg0008-q01 ).
       RUN set-position IN h_yg0008-q01 ( 1.00 , 51.14 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_yg0008-v01. */
       RUN add-link IN adm-broker-hdl ( h_p-cadpai , 'TableIO':U , h_yg0008-v01 ).
       RUN add-link IN adm-broker-hdl ( h_yg0008-q01 , 'Record':U , h_yg0008-v01 ).

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to SmartQuery h_yg0008-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-cadpai , 'State':U , h_yg0008-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_yg0008-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_yg0008-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_yg0008-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadpai , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_yg0008-v01 ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_yg0008-v01 , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prghur/esp/yg0008-b01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?,
                     ProgAtributo = ,
                     ProgIncMod = prghur/esp/yg0008b.w,
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_yg0008-b01 ).
       RUN set-position IN h_yg0008-b01 ( 14.96 , 4.43 ) NO-ERROR.
       /* Size in UIB:  ( 7.50 , 66.00 ) */

       /* Links to BrowserCadastro2 h_yg0008-b01. */
       RUN add-link IN adm-broker-hdl ( h_yg0008-q01 , 'Record':U , h_yg0008-b01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_yg0008-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "YG0008" "12.1.17.001"}
  ...
  IF gr-categ_ptoelet <> ? THEN DO:
     FIND categ_ptoelet
          WHERE ROWID(categ_ptoelet) = gr-categ_ptoelet
          NO-LOCK NO-ERROR.
     IF AVAILABLE(categ_ptoelet) THEN DO:
        FIND FIRST es_categ_ptoelet OF categ_ptoelet
             NO-LOCK NO-ERROR.
        IF AVAILABLE(es_categ_ptoelet) THEN
           RUN pi-reposiciona-query IN h_yg0008-q01 (ROWID(es_categ_ptoelet)).  /*reposiciona no registro informado pelo usuario*/
     END.
  END.
