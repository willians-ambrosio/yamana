...
** 19/11/2018   Vando Ribeiro   Grupo DKP   REQ02/Mudar o vencto da duplicata para a 5¶ 
                                                  seguinte Ö data de vencto informada.
**
****************************** INFORMAÄÂES ADICIONAIS ************************************
** PAR∂METROS DE ENTRADA:new-dupli-apagar e old-dupli-apagar
...
/*Vando Ribeiro*/
FIND FIRST es-fornec-ap NO-LOCK /*n∆o considerea fornec priorit†rio*/
     WHERE es-fornec-ap.cod-emitente = new-dupli-apagar.cod-emitente NO-ERROR.
IF NOT AVAIL es-fornec-ap THEN
DO:
