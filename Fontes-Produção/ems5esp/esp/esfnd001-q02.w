...
*****************************************************************************/
{include/i-prgvrs.i esfnd001-q02 5.06.00.000}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-param-prog NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-param-prog NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main es-param-prog
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-param-prog
...
<FOREIGN-KEYS>
cod_prog_dtsul||y|emp.es-param-prog.cod_prog_dtsul
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems5_esp.es-param-prog"
