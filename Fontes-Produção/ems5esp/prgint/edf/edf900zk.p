...
/*     OUTPUT TO c:\temp\dados.txt APPEND.                     */
/*                                                             */
...
/*     OUTPUT CLOSE.                                           */
    ...
    and   bf_tt_param_program_formul.tta_cdn_element_edi = 8:
        ...
        case p_cdn_element_edi:
             /* Cod. Segmento */
             when 4678 then return substring(bf_tt_param_program_formul.ttv_des_contdo,07,05). /* Agància Banc†ria */
             when 3941 then return substring(bf_tt_param_program_formul.ttv_des_contdo,12,01). /* Dig Ag*/
             when 4679 then return substring(bf_tt_param_program_formul.ttv_des_contdo,13,12). /* Conta */
             when 3904 then return substring(bf_tt_param_program_formul.ttv_des_contdo,25,01). /* Dig Conta */
             when 3728 then return "0".                                                     /* Forma pagto */
             when 3729 then return "0".                                                     /* Tipo Pagto */
             when 3743 then return trim(substring(bf_tt_param_program_formul.ttv_des_contdo,118,20)). /*Nr docto banco Nosso N£mero */
             when 3928 then return trim(substring(bf_tt_param_program_formul.ttv_des_contdo,166,25)). /* Seu n£mero - Docto Empresa */
             when 3709 then return substring(bf_tt_param_program_formul.ttv_des_contdo,128,08). /* Dt Pagto */
             when 4436 then return substring(bf_tt_param_program_formul.ttv_des_contdo,146,13).  /* Valor pagto */               
             when 2705 then return substring(bf_tt_param_program_formul.ttv_des_contdo,128,08).  /* Dt Efetivaá∆o */
             when 4439 then return substring(bf_tt_param_program_formul.ttv_des_contdo,146,13).  /* Valor Efetivo Pagto */    
...
IF tt_param_program_formul.ttv_des_contdo = 'A' THEN DO:
    ...
    case p_cdn_element_edi:   
         ...
         when 3928 then return trim(substring(tt_param_program_formul.ttv_des_contdo,57,20)). /* Seu n£mero - Docto Empresa */
...
IF tt_param_program_formul.ttv_des_contdo = 'O' THEN DO:
    ...
    case p_cdn_element_edi:   
         ...
         when 3729 then return "0".                                                     /* Tipo Pagto */                       
         when 3743 then return "". /*Nr docto banco Nosso N£mero */
         when 3928 then return trim(substring(tt_param_program_formul.ttv_des_contdo,106,20)). /* Seu n£mero - Docto Empresa */
...
IF tt_param_program_formul.ttv_des_contdo = 'N' THEN DO:
    ...
    case p_cdn_element_edi:   
         ...
         when 3729 then return "0".                                                     /* Tipo Pagto */                       
         when 3743 then return "". /*Nr docto banco Nosso N£mero */
         when 3928 then return trim(substring(tt_param_program_formul.ttv_des_contdo,1,20)). /* Seu n£mero - Docto Empresa */
