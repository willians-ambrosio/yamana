...
&Scoped-define INTERNAL-TABLES es-cat-code-fornec-estab

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-cat-code-fornec-estab NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-cat-code-fornec-estab NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main es-cat-code-fornec-estab
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-cat-code-fornec-estab
...
DEFINE QUERY Query-Main FOR 
      es-cat-code-fornec-estab SCROLLING.
&ANALYZE-RESUME
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems5_esp.es-cat-code-fornec-estab"
