...
*******************************************************************************/
{include/i-prgvrs.i CR0709G 2.00.00.000}  /*** 010000 ***/
...
&Scoped-Define ENABLED-OBJECTS RECT-1 bt-ok bt-cancelar bt-ajuda 
...
DEFINE VARIABLE h_cr0709g-b01 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Mv. Diferen‡a' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.13 , 1.43 ) NO-ERROR.
       RUN set-size IN h_folder ( 10.54 , 78.86 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'crp/cr0709g-b01.w':U ,
             INPUT  FRAME F-Main:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_cr0709g-b01 ).
       RUN set-position IN h_cr0709g-b01 ( 2.67 , 3.29 ) NO-ERROR.
       /* Size in UIB:  ( 8.42 , 74.72 ) */
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_cr0709g-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ENABLE RECT-1 bt-ok bt-cancelar bt-ajuda 
...
{utp/ut9000.i "CR0709G" "2.00.00.000"}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE RTB_xref_generator w-window 
