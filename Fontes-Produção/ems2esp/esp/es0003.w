...
*******************************************************************************/
/*{include/i-prgvrs.i ES0003 2.00.00.000}  /*** 010000 ***/*/
...
DEFINE FRAME f-pg-par
     c-arquivo-entrada AT ROW 3.42 COL 3 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     bt-arquivo-entrada AT ROW 3.42 COL 42.86 HELP
          "Escolha do nome do arquivo"
     text-entrada AT ROW 2.38 COL 3.86 NO-LABEL
     RECT-8 AT ROW 2.71 COL 1.72
...
DEFINE FRAME f-pg-log
     rs-destino AT ROW 2.63 COL 3.29 HELP
          "Destino de Impress∆o do Relat¢rio" NO-LABEL
     bt-config-impr-destino AT ROW 3.83 COL 43.29 HELP
          "Configuraá∆o da impressora"
     bt-arquivo-destino AT ROW 3.83 COL 43.29 HELP
          "Escolha do nome do arquivo"
     c-arquivo-destino AT ROW 3.88 COL 3.29 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     rs-execucao AT ROW 6 COL 3.14 HELP
          "Modo de Execuá∆o" NO-LABEL
     text-destino AT ROW 1.88 COL 3.86 NO-LABEL
     text-modo AT ROW 5.25 COL 1.14 COLON-ALIGNED NO-LABEL
     RECT-7 AT ROW 2.17 COL 2
     RECT-9 AT ROW 5.54 COL 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 76.29 BY 10.46.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Importaá∆o da Tabela Xtivity"
         HEIGHT             = 15.17
         WIDTH              = 81.29
         MAX-HEIGHT         = 38.29
         MAX-WIDTH          = 182.86
...
ON END-ERROR OF C-Win /* Importaá∆o da Tabela Xtivity */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Importaá∆o da Tabela Xtivity */
DO:
...
{utp/ut9000.i "ES0003" "2.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {include/i-imvrf.i &programa=es0003 &versao-layout=002}
...
do  on error undo, return error
    ...
    IF input frame f-pg-log rs-execucao = 1 THEN DO:
        assign c-arq-conv        = replace(input frame f-pg-par c-arquivo-entrada, "/", "\")
               c-arquivo-entrada = replace(c-arq-conv, "\", "/")
    ...
    if  tt-param.destino = 2 then 
        ...
        assign tt-param.arq-destino = session:temp-directory + c-programa-mg97 + "es0003.tmp".
    ...
    {include/i-imrun.i esp/es0003rp.p}
