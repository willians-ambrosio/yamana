...
*******************************************************************************/
{include/i-prgvrs.i YMSA0002 1.00.00.000}
...
&Scoped-define FIELDS-IN-QUERY-br-digita tt-digita.cdn_tip_refeicao tt-digita.des_tip_refeicao   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-digita tt-digita.cdn_tip_refeicao   
...
DEFINE VARIABLE v_cdn_disposit_fim AS INTEGER FORMAT "zzzz9" INITIAL 99999 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 NO-UNDO.

DEFINE VARIABLE v_cdn_disposit_ini AS INTEGER FORMAT "zzzz9" INITIAL 0 
     LABEL "Dispositivo" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 NO-UNDO.

DEFINE VARIABLE v_dat_ref_fim AS DATE FORMAT "99/99/9999":U 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.

DEFINE VARIABLE v_dat_ref_ini AS DATE FORMAT "99/99/9999":U 
     LABEL "Data Refeiá∆o" 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-digita w-relat _FREEFORM
  QUERY br-digita DISPLAY
      tt-digita.cdn_tip_refeicao    LABEL "Tipo Refeiá∆o"
      tt-digita.des_tip_refeicao    LABEL "Descriá∆o"       WIDTH 50
      ENABLE
      tt-digita.cdn_tip_refeicao
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME f-pg-sel
     v_cdn_disposit_ini AT ROW 5 COL 20.72 COLON-ALIGNED HELP
          "C¢digo Dispositivo Controle Acesso" WIDGET-ID 4
     v_cdn_disposit_fim AT ROW 5 COL 45 COLON-ALIGNED HELP
          "C¢digo Dispositivo Controle Acesso" NO-LABEL WIDGET-ID 6
     v_dat_ref_ini AT ROW 6 COL 20.72 COLON-ALIGNED WIDGET-ID 8
     v_dat_ref_fim AT ROW 6 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     IMAGE-1 AT ROW 5 COL 34.43
     IMAGE-2 AT ROW 5 COL 43.43
     IMAGE-3 AT ROW 6 COL 34.43 WIDGET-ID 12
     IMAGE-4 AT ROW 6 COL 43.43 WIDGET-ID 14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
DO:
   if br-digita:new-row in frame f-pg-dig then do:
      ...
      display tt-digita.cdn_tip_refeicao
              tt-digita.des_tip_refeicao with browse br-digita. 
   end.
   return no-apply.
END.
...
DO:
    ...
    do transaction on error undo, return no-apply:
        create tt-digita.
        assign input browse br-digita tt-digita.cdn_tip_refeicao
               input browse br-digita tt-digita.des_tip_refeicao.
...
DO:
   apply 'entry':U to tt-digita.cdn_tip_refeicao in browse br-digita. 
END.
...
{utp/ut9000.i "YMSA0002" "1.00.00.000"}

/*:T inicializaá‰es do template de relat¢rio */
{include/i-rpini.i}

ON "LEAVE":U OF tt-digita.cdn_tip_refeicao IN BROWSE br-digita DO:
   FIND FIRST tip_refeicao NO-LOCK
        WHERE tip_refeicao.cdn_tip_refeicao = INPUT BROWSE br-digita tt-digita.cdn_tip_refeicao NO-ERROR.
   IF AVAIL tip_refeicao THEN
      ASSIGN tt-digita.des_tip_refeicao:SCREEN-VALUE IN BROWSE br-digita = tip_refeicao.des_tip_refeicao NO-ERROR.
   ELSE
      ASSIGN tt-digita.des_tip_refeicao:SCREEN-VALUE IN BROWSE br-digita = "" NO-ERROR.
END.

ON "MOUSE-SELECT-DBLCLICK":U OF tt-digita.cdn_tip_refeicao IN BROWSE br-digita OR
   "F5":U OF tt-digita.cdn_tip_refeicao IN BROWSE br-digita DO:
   {include/zoomvar.i &prog-zoom="prghur/esp/ymsa0001-z01.w"  
                      &campo=tt-digita.cdn_tip_refeicao
                      &campozoom=cdn_tip_refeicao
                      &campo2=tt-digita.des_tip_refeicao
                      &campozoom2=des_tip_refeicao
                      &browse=br-digita}
END.
...
ASSIGN wh-label-dig:SCREEN-VALUE = "Refeiá∆o".
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN v_dat_ref_ini = DATE(MONTH(TODAY),01,YEAR(TODAY))
           v_dat_ref_fim = TODAY.

    FOR EACH tip_refeicao NO-LOCK:
       CREATE tt-digita.
       ASSIGN tt-digita.cdn_tip_refeicao = tip_refeicao.cdn_tip_refeicao
              tt-digita.des_tip_refeicao = tip_refeicao.des_tip_refeicao.
    END.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY v_cdn_disposit_ini v_cdn_disposit_fim v_dat_ref_ini v_dat_ref_fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 v_cdn_disposit_ini v_cdn_disposit_fim 
         v_dat_ref_ini v_dat_ref_fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
   ...
   IF NOT CAN-FIND(FIRST tt-digita) THEN DO:
      ...
      RUN utp/ut-msgs.p (INPUT "show":U, INPUT 17006, INPUT "Nenhum dado encontrado!~~" + 
                                                            "Pelo menos um Tipo de Refeiá∆o deve ser informado.").
      RETURN ERROR.
   END.
   ...
   FOR EACH tt-digita:
      ...
      FIND FIRST b-tt-digita
           WHERE b-tt-digita.cdn_tip_refeicao  = tt-digita.cdn_tip_refeicao
      ...
      IF NOT CAN-FIND(FIRST tip_refeicao
                      WHERE tip_refeicao.cdn_tip_refeicao = tt-digita.cdn_tip_refeicao) THEN DO:
         APPLY "MOUSE-SELECT-CLICK":U TO im-pg-dig IN FRAME f-relat.
         REPOSITION br-digita TO ROWID ROWID(tt-digita).
         RUN utp/ut-msgs.p (INPUT "show":U, INPUT 56, INPUT "Tipo Refeiá∆o").
         APPLY "ENTRY":U TO tt-digita.cdn_tip_refeicao IN BROWSE br-digita.
         RETURN ERROR.
      END.
   END.
   ...
   ASSIGN tt-param.usuario       = c-seg-usuario
          ...
          tt-param.cdn_disp_ini  = INPUT FRAME f-pg-sel v_cdn_disposit_ini
          tt-param.cdn_disp_fim  = INPUT FRAME f-pg-sel v_cdn_disposit_fim
          tt-param.dat_ref_ini   = INPUT FRAME f-pg-sel v_dat_ref_ini
          tt-param.dat_ref_fim   = INPUT FRAME f-pg-sel v_dat_ref_fim
          .
   ...
   {include/i-rprun.i prghur/esp/YMSA0002rp.p}
