...
{include/i-prgvrs.i YMQRY002 1.00.00.000}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH grp_usuar_esp EXCLUSIVE-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH grp_usuar_esp EXCLUSIVE-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main grp_usuar_esp
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main grp_usuar_esp
...
<FOREIGN-KEYS>
cod_grp_usuar||y|grp_usuar_esp.cod_grp_usuar
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Options          = "EXCLUSIVE-LOCK INDEXED-REPOSITION SORTBY-PHRASE"
     _TblOptList       = "USED"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cod_grp_usuar" "grp_usuar_esp" "cod_grp_usuar"}
