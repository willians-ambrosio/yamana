...
def temp-table tt_rpt_bem_pat no-undo like bem_pat
    ...
    /* Begins Rev01 */
    FIELD ttv_cod_docto_entr               LIKE docto_entr.cod_docto_entr
    FIELD ttv_cod_ser_nota                 LIKE docto_entr.cod_ser_nota
    /* End Rev01 */
...
PROCEDURE pi_tratar_tt_rpt_bem_pat_sit_geral_pat:
    ...
    &endif.
                     ...
                     /* Begins.......: Rev01  
                        Data.........: 25/06/2018
                        Descriá∆o....: Inclus∆o da chamada para localizar as notas oriundas do recebimento.
                        Autor........: Willians Ambrosio / Grupo DKP */
                     RUN piLocalizaDocReceb.
                     /* End.......: Rev01 */
...
/*                  /* Begins: Rev01 ponto revisado e adequado aos campos j† existesntes nas colunas u e v*/                                                     */
/*                  ";" tt_rpt_bem_pat.ttv_cod_docto_entr    /*DOCUMENTO               * */ */
/*                  ";" tt_rpt_bem_pat.ttv_cod_ser_nota      /*SERIE                   * */ */
/*                  /* End: Rev01 */                                                        */
                 SKIP.
    END.
...
PROCEDURE piLocalizaDocReceb:
    IF tt_rpt_bem_pat.cod_docto_entr = "" THEN
    DO:  
        ...
        DO:  
           ...
           DO:
              ...
              IF AVAIL docto_entr THEN
                 ASSIGN tt_rpt_bem_pat.ttv_cod_docto_entr = docto_entr.cod_docto_entr      
                        tt_rpt_bem_pat.ttv_cod_ser_nota   = docto_entr.cod_ser_nota.
           END.
        END.

        ASSIGN tt_rpt_bem_pat.cod_docto_entr = tt_rpt_bem_pat.ttv_cod_docto_entr
               tt_rpt_bem_pat.cod_ser_nota   = tt_rpt_bem_pat.ttv_cod_ser_nota. 
