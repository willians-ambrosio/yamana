...
define variable c-prog-gerado as character no-undo initial "ESP001".
...
def var c-titulo           as char init "Relat¢rio espec¡fico investimentos" no-undo.        
def var v-cod-prog-gerado  as char init "ESP001" no-undo.           
...
assign v-cod-prog-gerado = "ESP001".
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK 
   ON END-KEY UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK:
        ...
        assign c-lista = "Numero Projeto" + "," + 
                         "Numero Projeto".

        assign c-prog = "ESP001A.w" + "," + 
                        "ESP001C.w".
