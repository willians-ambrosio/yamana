...
*******************************************************************************/
{include/i-prgvrs.i ESMAT001 2.06.00.001}
...
&Scoped-Define ENABLED-OBJECTS idi-destino rs-destino bt-config-impr ~
bt-arquivo c-arquivo COMBO-PRINT rs-execucao RECT-7 RECT-9 
&Scoped-Define DISPLAYED-OBJECTS idi-destino rs-destino c-arquivo ~
...
DEFINE FRAME f-pg-sel
     dt-corte AT ROW 1.75 COL 15 COLON-ALIGNED
     dt-corte-fim AT ROW 1.75 COL 50 COLON-ALIGNED NO-LABEL
     fi-cc-ini AT ROW 2.75 COL 15 COLON-ALIGNED
     fi-cc-fim AT ROW 2.75 COL 50 COLON-ALIGNED NO-LABEL
     fi-item-ini AT ROW 3.75 COL 15 COLON-ALIGNED
     fi-item-fim AT ROW 3.75 COL 50 COLON-ALIGNED NO-LABEL
     fi-est-ini AT ROW 4.75 COL 15 COLON-ALIGNED
     fi-est-fim AT ROW 4.75 COL 50 COLON-ALIGNED NO-LABEL
     rs-tp-contr AT ROW 8 COL 11 NO-LABEL
     IMAGE-13 AT ROW 1.75 COL 35
     IMAGE-14 AT ROW 1.75 COL 46
     IMAGE-15 AT ROW 2.75 COL 46
     IMAGE-16 AT ROW 3.75 COL 46
     IMAGE-17 AT ROW 2.75 COL 35
     IMAGE-18 AT ROW 3.75 COL 35
     IMAGE-19 AT ROW 4.75 COL 35
     IMAGE-20 AT ROW 4.75 COL 46
     RECT-10 AT ROW 7.5 COL 9
     "     Controle do Item" VIEW-AS TEXT
          SIZE 15 BY 1 AT ROW 7 COL 18
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
{utp/ut9000.i "ESMAT001" "2.06.00.001"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN dt-corte:SCREEN-VALUE IN FRAME f-pg-sel = STRING(TODAY)
           dt-corte-fim:SCREEN-VALUE IN FRAME f-pg-sel = STRING(TODAY).
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY dt-corte dt-corte-fim fi-cc-ini fi-cc-fim fi-item-ini fi-item-fim 
          fi-est-ini fi-est-fim rs-tp-contr 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE dt-corte dt-corte-fim fi-cc-ini fi-cc-fim fi-item-ini fi-item-fim 
         fi-est-ini fi-est-fim rs-tp-contr IMAGE-13 IMAGE-14 IMAGE-15 IMAGE-16 
         IMAGE-17 IMAGE-18 IMAGE-19 IMAGE-20 RECT-10 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-sel}
  DISPLAY idi-destino rs-destino c-arquivo COMBO-PRINT rs-execucao 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
  ENABLE idi-destino rs-destino bt-config-impr bt-arquivo c-arquivo COMBO-PRINT 
...
do on error undo, return error on stop  undo, return error:
    ...
    /* Coloque aqui as valida»„es da pÿgina de Digita»’o, lembrando que elas devem
       apresentar uma mensagem de erro cadastrada, posicionar nesta pÿgina e colocar
       o focus no campo com problemas */
    /*browse br-digita:SET-REPOSITIONED-ROW (browse br-digita:DOWN, "ALWAYS":U).*/
    
    
    /* Coloque aqui as valida»„es das outras pÿginas, lembrando que elas devem 
    ...
    ASSIGN  tt-param.idi-tipo-imp = input frame f-pg-imp idi-destino
            tt-param.impressora   = input frame f-pg-imp combo-print
            tt-param.dt-base      = DATE(dt-corte:SCREEN-VALUE IN FRAME f-pg-sel)
            tt-param.dt-base-fim  = DATE(dt-corte-fim:SCREEN-VALUE IN FRAME f-pg-sel)
            tt-param.fi-cc-ini    = string(fi-cc-ini:SCREEN-VALUE IN FRAME f-pg-sel)
            tt-param.fi-cc-fim    = string(fi-cc-fim:SCREEN-VALUE IN FRAME f-pg-sel)
            tt-param.fi-item-ini  =       (fi-item-ini:SCREEN-VALUE IN FRAME f-pg-sel)
            tt-param.fi-item-fim  =       (fi-item-fim:SCREEN-VALUE IN FRAME f-pg-sel)
            tt-param.rs-tp-contr  =    INT(rs-tp-contr:SCREEN-VALUE IN FRAME f-pg-sel)
            tt-param.fi-est-ini   =       (fi-est-ini:SCREEN-VALUE IN FRAME f-pg-sel)
            tt-param.fi-est-fim   =       (fi-est-fim:SCREEN-VALUE IN FRAME f-pg-sel).
    ...
    {include/i-rprun.i esp/esmat001rp.p}
