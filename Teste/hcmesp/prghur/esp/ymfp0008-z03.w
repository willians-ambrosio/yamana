...
DEFINE VARIABLE h_ymfp0008-b03 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa de Funcionarios"
         HEIGHT             = 17
         WIDTH              = 90
         MAX-HEIGHT         = 28.33
         MAX-WIDTH          = 194.86
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Funcionarios */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Funcionarios */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prghur/esp/ymfp0008-b03.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ymfp0008-b03 ).
       RUN set-position IN h_ymfp0008-b03 ( 2.75 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.25 , 80.00 ) */

       /* Links to SmartBrowser h_ymfp0008-b03. */
       RUN add-link IN adm-broker-hdl ( h_ymfp0008-b03 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymfp0008-b03 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
