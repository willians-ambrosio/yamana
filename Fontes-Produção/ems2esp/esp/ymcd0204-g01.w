...
*******************************************************************************/
{include/i-prgvrs.i ymcd0204-g01 11.5.11.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i YMCD0204-G01 MUT}
&ENDIF
...
DEFINE FRAME d-vapara
     c_cod-estabel AT ROW 1.75 COL 29 COLON-ALIGNED WIDGET-ID 2
...
DO:
FIND es-estab-carga NO-LOCK
    WHERE es-estab-carga.ep-codigo  = i-ep-codigo-usuario
      AND es-estab-carga.cod-estabel EQ INPUT FRAME {&FRAME-NAME} c_cod-estabel NO-ERROR.

IF NOT AVAILABLE es-estab-carga THEN DO:
    {utp/ut-table.i ems5_esp es-estab-carga 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-estab-carga).
END.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "YMCD0204-G01" "11.5.11.000"}
