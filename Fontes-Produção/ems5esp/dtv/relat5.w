...
define variable c-prog-gerado as character no-undo initial "RELAT5".
...
def var c-titulo           as char init "Relat¢rio EMS5 Grupo x Programa x Empresa x User" no-undo.        
def var v-cod-prog-gerado  as char init "relat5" no-undo.           
...
assign v-cod-prog-gerado = "relat5".
