...
*******************************************************************************/
{include/i-prgvrs.i CD0422D 2.00.00.001}  /*** 010001 ***/

&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i cd0422d MCD}
&ENDIF
...
def var c-desc-situacao as char    label "Situa‡Æo"           format "x(40)"    no-undo.
...
form emitente.cod-gr-forn   format ">9"     colon 025
     emitente.cod-emitente  format ">>>>>>>>9" colon 070
     emitente.nome-abrev    format "X(12)"  colon 105 skip
     emitente.nome-emit     format "X(40)"  colon 025 skip
     emitente.cgc           format "x(19)"  colon 025
     emitente.ins-estadual  format "X(19)"  colon 070 skip
     ...
     emitente.estado        format "x(4)"   colon 105 skip
     ...
     emitente.ramal-fax     format "x(05)"  colon 070
     emitente.telex         format "x(15)"  colon 105 skip
     emitente.telefax       format "x(15)"  colon 025
     emitente.telef-fac     format "x(15)"  colon 070 skip
     emitente.telef-modem   format "x(15)"  colon 025
     emitente.linha-produt  format "X(08)"  colon 070
     emitente.atividade     format "X(12)"  colon 105 skip
     emitente.nat-operacao  format "9.99-xxx" colon 025
     emitente.cod-cond-pag  format ">>9"    colon 070
     emitente.bonificacao   label "Bonifica‡Æo" format ">>9.99" colon 105 skip
     emitente.taxa-financ   format ">>9.99" colon 025
     emitente.data-taxa     format "99/99/9999" colon 070
     emitente.emissao-ped   format ">9"     colon 105 skip
     emitente.cod-transp    format ">>,>>9" colon 025
     emitente.cod-banco     format "999"    colon 070
     emitente.agencia       format "x(8)"   colon 105 skip
     emitente.conta-corren  format "x(20)"  colon 025
     emitente.pais          format "X(20)"  colon 070 skip
     c-desc-situacao        format "x(25)"      colon 025
...
for each emitente no-lock
    ...
    display stream str-rp emitente.cod-gr-forn
