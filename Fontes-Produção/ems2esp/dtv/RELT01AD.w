...
/*------------------------------------------------------------------------
File.............: RELT01AD.w
Description......: PEDIDOS POR COMPRADOR - INVESTIMENTO
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 31/07/12 - 11:34 - adm
OBS..............: Este fonte foi gerado pelo Data Viewer
------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "RELT01AD".
...
def new shared var c-ct-codigo-ini like ordem-compra.ct-codigo format "x(20)" initial "" no-undo.
def new shared var c-ct-codigo-fim like ordem-compra.ct-codigo format "x(20)" initial "ZZZZZZZZZZZZZZZZZ" no-undo.
...
DEFINE FRAME f-pg-sel
   ...
   da-data-pedido-ini label "Data Pedido"
     at row 3 col 20 colon-aligned
     view-as fill-in 
     size 12 by .88
     font 1

   da-data-pedido-fim no-label
   ...
   c-ct-codigo-ini label "Conta Cont bil"
   ...
   IMAGE-1 AT ROW 01.00 COL 41
   IMAGE-2 AT ROW 01.00 COL 46
   WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY
   SIDE-LABELS NO-UNDERLINE THREE-D
   AT COL 3 ROW 2.85
   SIZE 76.86 BY 10.62.
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "PEDIDOS POR COMPRADOR - INVESTIMENTO - RELT01AD"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "RELT01AD".
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    assign c-ct-codigo-ini:screen-value in frame f-pg-sel = string("17202014").
    assign c-ct-codigo-fim:screen-value in frame f-pg-sel = string("17202014").
    assign da-data-pedido-ini:screen-value in frame f-pg-sel = string(01/01/2005).
    assign da-data-pedido-fim:screen-value in frame f-pg-sel = string(12/31/9999).
...
PROCEDURE enable_UI :
   ...
   da-data-pedido-ini da-data-pedido-fim
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "RELT01AD" + "." + v-cod-extens-arq.
    ...
    assign tt-param.i-cod-emitente-ini = input frame f-pg-sel i-cod-emitente-ini
           ...
           tt-param.da-data-pedido-ini = input frame f-pg-sel da-data-pedido-ini
           tt-param.da-data-pedido-fim = input frame f-pg-sel da-data-pedido-fim
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "DTV/RELT0130.p".
