...
{include/i-prgvrs.i ZESBS002 2.04.00.001}
...
DEFINE VARIABLE h_esbs002-b01a AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esbs002-b01a.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esbs002-b01a ).
       RUN set-position IN h_esbs002-b01a ( 3.25 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 84.57 ) */

       /* Links to SmartBrowser h_esbs002-b01a. */
       RUN add-link IN adm-broker-hdl ( h_esbs002-b01a , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esbs002-b01a ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "Zesbs002" "2.04.00.001"}
