...
*******************************************************************************/
{include/i-prgvrs.i APYA501E-Z01 12.1.17.000}
...
DEFINE VARIABLE h_apya501e-b04 AS HANDLE NO-UNDO.
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Opera‡äes */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Opera‡äes */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Opera‡äes' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apl/apya501e-b04.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_apya501e-b04 ).
       RUN set-position IN h_apya501e-b04 ( 2.67 , 6.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.75 , 80.14 ) */

       /* Links to SmartBrowser h_apya501e-b04. */
       RUN add-link IN adm-broker-hdl ( h_apya501e-b04 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_apya501e-b04 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "APYA501E-Z01" "12.1.17.000"}
