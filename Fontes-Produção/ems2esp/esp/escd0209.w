...
*******************************************************************************/
{include/i-prgvrs.i ESCD0209 2.06.00.002}
...
ON END-ERROR OF C-Win /* Importaá∆o de Itens */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Importaá∆o de Itens */
DO:
...
DO:
    {include/i-imarq.i c-arquivo-entrada f-pg-par "'*.csv' '*.*'"}
END.
...
{utp/ut9000.i "ESCD0209" "2.06.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    {include/i-imvrf.i &programa=escd0209 &versao-layout=001}
...
------------------------------------------------------------------------------*/
    ...
    do  on error undo, return error
        ...
        {include/i-imrun.i esp/escd0209rp.p}
...
/* -----------------------------------------------------------
  ...
  Notes:       
-------------------------------------------------------------*/
    def input param p-issuer-hdl as handle no-undo.
    def input param p-state      as char   no-undo.
