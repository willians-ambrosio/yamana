...
*******************************************************************************/
{include/i-prgvrs.i ESAP004 2.06.00.001}  /*** 010006 ***/
...
DEFINE FRAME f-pg-sel
     fi-dt-ini AT ROW 1.5 COL 22 COLON-ALIGNED HELP
          "Data Transa‡Æo" WIDGET-ID 6
     fi-dt-fim AT ROW 1.5 COL 44 COLON-ALIGNED HELP
          "Data Transa‡Æo" NO-LABEL WIDGET-ID 10
     IMAGE-7 AT ROW 1.54 COL 37
     IMAGE-12 AT ROW 1.54 COL 42.72
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62.
...
{utp/ut9000.i "ESAP004" "2.06.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE IMAGE-7 IMAGE-12 fi-dt-ini fi-dt-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    {include/i-rprun.i esp/ESAP004rp.p}
