...
/****************************************************************************************** 
** 	   Programa: rep001-q02.w
**   	      Autor: Felipe Vieira
**   	 Fornecedor: DKP
**    	 Data: 25/09/2018
** Change/Chamado: 
**    Objetivo: Cadastro de aprovadores (query 2)
**
...
******************************************************************************************/
{include/i-prgvrs.i REP001Q02 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i REP001Q02 REP}
&ENDIF
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH esp_aprovador NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH esp_aprovador NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main esp_aprovador
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main esp_aprovador
...
<FOREIGN-KEYS>
cod-estabel||y|ems2cademp.estab-mat.cod-estabel
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cod-estabel" "estab-mat" "cod-estabel"}
