...
*******************************************************************************/
{include/i-prgvrs.i ESFT0006-G01 2.06.00.000}
...
DEFINE FRAME d-vapara
     c_nat-operacao AT ROW 1.17 COL 30 COLON-ALIGNED WIDGET-ID 2
     bt-ok AT ROW 2.67 COL 2.14
     bt-cancela AT ROW 2.67 COL 13
     bt-ajuda AT ROW 2.67 COL 58
     rt-button AT ROW 2.42 COL 1
     SPACE(0.13) SKIP(0.19)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "V  Para Exce‡Æo CFOP Terceiros"
...
ON GO OF FRAME d-vapara /* V  Para Exce‡Æo CFOP Terceiros */
DO:
FIND es-cfop-excecao NO-LOCK
    WHERE es-cfop-excecao.nat-operacao EQ INPUT FRAME {&FRAME-NAME} c_nat-operacao NO-ERROR.

IF NOT AVAILABLE es-cfop-excecao THEN DO:
    ...
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es-cfop-excecao).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Exce‡Æo CFOP Terceiros */
DO:  
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESFT0006-G01" "2.06.00.000"}
