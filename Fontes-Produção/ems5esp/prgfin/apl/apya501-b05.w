...
&Scoped-define FIELDS-IN-QUERY-br-table rof_contrat_apf.cod_rof_contrat_apf ~
rof_contrat_apf.des_rof_contrat_apf ~
rof_contrat_apf.arquivo 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      ...
      rof_contrat_apf.des_rof_contrat_apf FORMAT "x(40)":U WIDTH 56.86
      rof_contrat_apf.arquivo FORMAT "x(100)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"rof_contrat_apf.des_rof_contrat_apf" ? ? "character" ? ? ? ? ? ? no ? no no "56.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   = ems5_esp.rof_contrat_apf.arquivo
...
DO:
    RUN prgfin/apl/apya599.p (INPUT rof_contrat_apf.arquivo).
END.
