...
*******************************************************************************/
{include/i-prgvrs.i APYA501-G01 12.1.17.000}
...
&Scoped-Define ENABLED-OBJECTS c_cod_empresa rt-button c_cod_contrat_apf ~
bt-ok bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod_empresa c_cod_contrat_apf 
...
DEFINE VARIABLE c_cod_empresa AS CHARACTER FORMAT "x(3)":U 
     LABEL "Empresa" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     c_cod_empresa AT ROW 1 COL 30 COLON-ALIGNED WIDGET-ID 2
     c_cod_contrat_apf AT ROW 2 COL 30 COLON-ALIGNED WIDGET-ID 4
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "V  Para Contrato Intercompany"
...
ON GO OF FRAME d-vapara /* V  Para Contrato Intercompany */
DO:
FIND contrat_apf NO-LOCK
    WHERE contrat_apf.cod_empresa EQ INPUT FRAME {&FRAME-NAME} c_cod_empresa
      AND contrat_apf.cod_contrat_apf EQ INPUT FRAME {&FRAME-NAME} c_cod_contrat_apf NO-ERROR.

IF NOT AVAILABLE contrat_apf THEN DO:
    {utp/ut-table.i ems5_esp contrat_apf 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(contrat_apf).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Contrato Intercompany */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod_empresa c_cod_contrat_apf 
      WITH FRAME d-vapara.
  ENABLE c_cod_empresa rt-button c_cod_contrat_apf bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "APYA501-G01" "12.1.17.000"}
