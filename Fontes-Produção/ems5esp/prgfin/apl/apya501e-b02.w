...
&Scoped-define INTERNAL-TABLES es_operac_financ_cambio
...
es_operac_financ_cambio.cod_cambio_operacao ~
es_operac_financ_cambio.des_cambio_operacao es_operac_financ_cambio.arquivo 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table 
&Scoped-define QUERY-STRING-br-table FOR EACH es_operac_financ_cambio OF es_operac_financ WHERE ~{&KEY-PHRASE} NO-LOCK
&Scoped-define OPEN-QUERY-br-table OPEN QUERY br-table FOR EACH es_operac_financ_cambio OF es_operac_financ WHERE ~{&KEY-PHRASE} NO-LOCK.
&Scoped-define TABLES-IN-QUERY-br-table es_operac_financ_cambio
&Scoped-define FIRST-TABLE-IN-QUERY-br-table es_operac_financ_cambio
...
<FOREIGN-KEYS>
cod_produt_financ||y|mgesp.es_operac_financ_cambio.cod_produt_financ
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
DEFINE QUERY br-table FOR 
      es_operac_financ_cambio SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      es_operac_financ_cambio.cod_cambio_operacao COLUMN-LABEL "Cambio" FORMAT "x(10)":U
      es_operac_financ_cambio.des_cambio_operacao FORMAT "x(40)":U
      es_operac_financ_cambio.arquivo FORMAT "x(100)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br-table
     _TblList          = "mgesp.es_operac_financ_cambio OF mgesp.es_operac_financ"
     _Options          = "NO-LOCK KEY-PHRASE"
     _FldNameList[1]   > mgesp.es_operac_financ_cambio.cod_cambio_operacao
"es_operac_financ_cambio.cod_cambio_operacao" "Cambio" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   = mgesp.es_operac_financ_cambio.des_cambio_operacao
     _FldNameList[3]   = mgesp.es_operac_financ_cambio.arquivo
...
DO:
    IF AVAILABLE(es_operac_financ_cambio) THEN DO:

        IF SEARCH(es_operac_financ_cambio.arquivo) <> ? THEN
            RUN prgfin/apl/apya599.p (INPUT es_operac_financ_cambio.arquivo).
        ELSE 
            MESSAGE "NÆo foi poss¡vel localizar o arquivo" SKIP
                    es_operac_financ_cambio.arquivo SKIP
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cod_produt_financ" "es_operac_financ_cambio" "cod_produt_financ"}
