...
define new global shared VAR wh-cc0509a-bt-hist-msg     AS WIDGET-HANDLE NO-UNDO.
define new global shared VAR wh-cc0509a-bt-narrativa    AS WIDGET-HANDLE NO-UNDO.
define new global shared VAR wh-cc0509a-f-nr-contrato   AS WIDGET-HANDLE NO-UNDO.
define new global shared VAR c-nr-contrato-01             as char          no-undo.
define new global shared VAR wh-cc0509a-num-pedido      AS WIDGET-HANDLE NO-UNDO. 
define new global shared VAR i-num-pedido               AS INT NO-UNDO.



RUN findWidget (INPUT "bt-narrativa",INPUT "BUTTON",INPUT p-wgh-frame, OUTPUT wh-cc0509a-bt-narrativa).
RUN findWidget (INPUT "nr-contrato", INPUT "FILL-IN",INPUT p-wgh-frame,OUTPUT wh-cc0509a-f-nr-contrato).
RUN findWidget (INPUT "pedido", INPUT "FILL-IN",INPUT p-wgh-frame,OUTPUT wh-cc0509a-num-pedido ).
...
IF  p-ind-event  = "BEFORE-INITIALIZE":U  THEN DO:
    ...
    IF VALID-HANDLE(wh-cc0509a-bt-narrativa) THEN DO:
        CREATE BUTTON wh-cc0509a-bt-hist-msg 
        ASSIGN FRAME     = wh-cc0509a-bt-narrativa:FRAME
               WIDTH     = wh-cc0509a-bt-narrativa:WIDTH + 4
               HEIGHT    = wh-cc0509a-bt-narrativa:HEIGHT
               LABEL     = "Hist.Beneficios" 
               COLUMN    = wh-cc0509a-bt-narrativa:COLUMN + 10
               ROW       = wh-cc0509a-bt-narrativa:ROW
               SENSITIVE = YES
               VISIBLE   = YES
               TRIGGERS:
                    ON CHOOSE PERSISTENT RUN esp/ymof0111.w.
               END TRIGGERS.
