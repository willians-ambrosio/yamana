...
FOR EACH es_funcionario:
    ...
    IF AVAIL usuar_mestre THEN
        FIND LAST usuar_mestre_ext NO-LOCK
             WHERE usuar_mestre_ext.cod_usuario = usuar_mestre.cod_usuario NO-ERROR. 
        IF AVAIL usuar_mestre_ext THEN
            ASSIGN es_funcionario.login_ad = usuar_mestre_ext.cod_usuar_so.
