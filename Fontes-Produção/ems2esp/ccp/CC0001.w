...
Author...........: DATASUL S.A.
Created..........: 30/03/12 - 16:04 - adm
OBS..............: Este fonte foi gerado pelo Data Viewer
------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "CC0001".
...
def var c-titulo           as char init "Ordens de Compra" no-undo.        
def var v-cod-prog-gerado  as char init "CC0001" no-undo.           
...
assign v-cod-prog-gerado = "CC0001".
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK 
   ON END-KEY UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK:
        ...
        assign c-lista = "Estabelecimento \ Nr documento" + "," + 
                         "Conta \ CC" + "," + 
                         "Estabelecimento  Nr documento".

        assign c-prog = "CC0001a.w" + "," + 
                        "CC0001B.w" + "," + 
                        "CC0001a.w".
