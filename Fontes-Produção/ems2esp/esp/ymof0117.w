...
*******************************************************************************/
{include/i-prgvrs.i ymof0117 12.01.19.002}
...
DEFINE FRAME f-pg-sel
     ...
     "Integraá∆o de Itens com Integra" VIEW-AS TEXT
          SIZE 73 BY 5.5 AT ROW 3.75 COL 2.72 WIDGET-ID 2
          FONT 8
...
/* SETTINGS FOR FILL-IN c-fim-campo IN FRAME f-pg-sel
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       c-fim-campo:HIDDEN IN FRAME f-pg-sel           = TRUE.

/* SETTINGS FOR FILL-IN c-ini-campo IN FRAME f-pg-sel
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       c-ini-campo:HIDDEN IN FRAME f-pg-sel           = TRUE.
...
{utp/ut9000.i "YMOF0117RP" "12.01.19.002"}
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/ymof0117rp.p}
