...
*******************************************************************************/
{include/i-prgvrs.i Q01AD106 2.00.00.002}  /*** 010002 ***/

&IF "{&EMSFND_VERSION}" >= "1.00"
&THEN
{include/i-license-manager.i Q01AD106 MUT}
&ENDIF
...
&Scoped-define INTERNAL-TABLES est-ap

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH est-ap WHERE est-ap.cod-fornec = emitente.cod-emitente NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH est-ap WHERE est-ap.cod-fornec = emitente.cod-emitente NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main est-ap
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main est-ap
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems2cadme.est-ap WHERE ems2cadme.emitente <external> ..."
     _Options          = "NO-LOCK KEY-PHRASE"
     _TblOptList       = "USED"
     _JoinCode[1]      = "ems2cadme.est-ap.cod-fornec = ems2cadme.emitente.cod-emitente"
