...
fi-cod_cta_ctbl-fim fi-arquivo 
...
DEFINE VARIABLE fi-cod_cta_ctbl-ini AS CHARACTER FORMAT "x(20)" 
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = ".: Valida‡Æo Mapa EMS5 X JDE - ESJD003 :."
         HEIGHT             = 16
         WIDTH              = 80
         MAX-HEIGHT         = 42.42
         MAX-WIDTH          = 274.29
...
ON END-ERROR OF C-Win /* .: Valida‡Æo Mapa EMS5 X JDE - ESJD003 :. */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* .: Valida‡Æo Mapa EMS5 X JDE - ESJD003 :. */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY rs-saida fi-cod_cta_ctbl-ini fi-cod_cta_ctbl-fim fi-arquivo 
      WITH FRAME f_main IN WINDOW C-Win.
  ENABLE bt-busca-arq rt_rgf rt_cxcf bt_executar IMAGE-15 IMAGE-16 RECT-12 
         rs-saida fi-cod_cta_ctbl-ini fi-cod_cta_ctbl-fim fi-arquivo bt_fechar 
...
IF NOT AVAIL dwb_rpt_param THEN DO:
    ...
    ASSIGN dwb_rpt_param.cod_dwb_program = "esjd003rp"
...
IF INTEGER (INPUT FRAME {&FRAME-NAME} rs-saida) = 2 THEN DO: /* Batch */
    run prgtec/btb/btb911za.p (Input "esjd003rp",
                               Input "5.06.00.001",
                               Input 40,
...
*/
    do with frame {&frame-name}:
        ...
        assign fi-arquivo:screen-value = session:temp-directory + "esjd003-" + string(time) + ".csv".
    end.
END PROCEDURE.
