...
{include/i-prgvrs.i ESIN0521RP 1.00.00.000}
...
ASSIGN  c-programa 	    = "ESIN0521RP"
	    c-versao	    = "1.00"
	    c-revisao	    = "1.00.000"
	    c-empresa       = string(v_nom_razao_social)
        c-titulo-relat  = "Relat¢rio Investimentos Realizados".
...
RUN inp/esp/esin0521a.p (INPUT-OUTPUT TABLE tt-param).
