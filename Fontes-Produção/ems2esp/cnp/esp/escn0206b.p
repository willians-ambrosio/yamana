...
RUN pi-inicializar IN h-acomp (INPUT "Gerando arqui6vo").
RUN pi-arquivo.
RUN pi-inicia-excel.
RUN pi-ccin.
RUN pi-cc00.
...
PROCEDURE pi-cc00: 
   ...
   */
   ...
   ASSIGN tt-cc00.sequencia  = 1
          ...
          tt-cc00.coluna-c   = fcTrataCampoCaracter(chWorksheet:Range("AA" + STRING(5)):VALUE)                          /*  Logico    */
          ...
          tt-cc00.coluna-h   = fcTrataCampoCaracter(chWorksheet:Range("X"  + STRING(5)):VALUE)                          /*  Decimal   */
          tt-cc00.coluna-i   = fcTrataCampoCaracter(chWorksheet:Range("Y"  + STRING(5)):VALUE)                          /*  Decimal   */
          ...
          tt-cc00.coluna-af  = fcTrataCampoInteiro(chWorksheet:Range("M"  + STRING(5)):VALUE)     /*  Caracter  */
...
PROCEDURE pi-cc01: 
   ...
   */
   ...
   ASSIGN tt-cc01.sequencia  = 1
          ...
          tt-cc01.coluna-o   = fcTrataCampoInteiro(chWorksheet:Range("K"  + STRING(5)):VALUE)  /*   Inteiro    */
...
PROCEDURE pi-pd00: 
   ...
   */
   ...
   DO i-cont = 5 TO 65000:
      ASSIGN c-valor = chWorksheet:Range("A" + STRING(i-cont)):VALUE.
   ...
   DO i-cont = 5 TO 65000:
      ...
      IF c-valor <> ? THEN DO:
         ...
         ASSIGN tt-ic00.sequencia   = i-cont
                ...
                tt-ic00.coluna-h    = fcTrataCampoCaracter(chWorksheet:Range("H"  + STRING(i-cont)):VALUE)                          /*  Logico   */        
                ...
                tt-ic00.coluna-n    = fcTrataCampoCaracter(chWorksheet:Range("U"  + STRING(i-cont)):VALUE)                          /*  Caracter */        
                tt-ic00.coluna-o    = ""                                                                      /*  Caracter */
                tt-ic00.coluna-p    = fcTrataCampoInteiro(chWorksheet:Range("A"  + STRING(i-cont)):VALUE)     /*  Inteiro  */        
                tt-ic00.coluna-q    = fcTrataCampoInteiro(chWorksheet:Range("E"  + STRING(i-cont)):VALUE)     /*  Inteiro  */        
                ...
                tt-ic00.coluna-aa   = fcTrataCampoCaracter(chWorksheet:Range("G"  + STRING(i-cont)):VALUE)                          /*  Logico   */        
                tt-ic00.coluna-ab   = fcTrataCampoInteiro(chWorksheet:Range("P"  + STRING(i-cont)):VALUE)     /*  Inteiro  */        
                tt-ic00.coluna-ac   = ""                                                                      /*  Logico   */        
                tt-ic00.coluna-ad   = fcTrataCampoCaracter(chWorksheet:Range("J"  + STRING(i-cont)):VALUE)                          /*  Logico   */        
                ...
                tt-ic00.coluna-ag   = fcTrataCampoCaracter(chWorksheet:Range("C"  + STRING(i-cont)):VALUE)                          /*  Caracter */        
   ...
   DO i-cont = 5 TO 65000:
      ...
      IF c-valor <> ? THEN DO:
         ...
         ASSIGN tt-mi00.sequencia   = i-cont
                ...
                tt-mi00.coluna-f    = ""                                                                              /*  Inteiro   */
                tt-mi00.coluna-g    = ""                                                                              /*  Caracter  */
