...
define variable c-prog-gerado as character no-undo initial "AVAL02".
...
def var c-titulo           as char init "Avalia‡äes HCM" no-undo.        
def var v-cod-prog-gerado  as char init "aval02" no-undo.           
...
assign v-cod-prog-gerado = "aval02".
