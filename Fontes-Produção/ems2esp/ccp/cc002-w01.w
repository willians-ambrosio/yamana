...
/****************************************************************************************** 
**             Programa: cc002-w01.w
**            Autor: Vando Ribeiro
**       Fornecedor: DKP
**            Data: 24/11/2018
**  Change/Chamado: REQ02
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Execuá∆o de Pedido RPW Envio E-mail"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-relat /* Execuá∆o de Pedido RPW Envio E-mail */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Execuá∆o de Pedido RPW Envio E-mail */
DO:
...
{utp/ut9000.i "cc002-w01" "12.00.00.001"}
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    {include/i-rprun.i ccp/cc002-rp.p}
