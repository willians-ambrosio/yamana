...
/****************************************************************************************** 
**         Programa: rep002-q01.w
**            Autor: Felipe Vieira
**       Fornecedor: DKP
**       Data: 25/09/2018
** Change/Chamado: 
**    Objetivo: Cadastro de parƒmetros de bloqueio (query)
**
...
******************************************************************************************/
{include/i-prgvrs.i REP002-Q01 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i REP002-Q01 REP}
&ENDIF
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH esp_param_bloq NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH esp_param_bloq NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main esp_param_bloq
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main esp_param_bloq
...
<FOREIGN-KEYS>
cod-estabel||y|mgesp.esp_param_bloq.cod-estabel
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
