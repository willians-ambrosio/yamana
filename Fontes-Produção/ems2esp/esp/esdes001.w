...
*******************************************************************************/
{include/i-prgvrs.i ESDES001 2.06.00.000}
...
DEFINE VARIABLE i-tipo-relat AS INTEGER 
     VIEW-AS RADIO-SET VERTICAL
     RADIO-BUTTONS 
          "Relat¢rio de Conferància", 1,
"Geraá∆o da DES", 2
     SIZE 20 BY 1.75 NO-UNDO.
...
DEFINE VARIABLE d-dt-emis-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/30/9999 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-par
     i-tipo-relat AT ROW 3.42 COL 4.72 NO-LABEL
     "Tipo Relat¢rio" VIEW-AS TEXT
          SIZE 11 BY .54 AT ROW 2.5 COL 4.57
     RECT-10 AT ROW 2.75 COL 3
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 75 BY 10
...
DEFINE FRAME f-pg-sel
     i-cod-emitente-ini AT ROW 2.42 COL 20 COLON-ALIGNED
     i-cod-emitente-fim AT ROW 2.42 COL 44.57 COLON-ALIGNED NO-LABEL
     c-serie-ini AT ROW 3.5 COL 23.86 COLON-ALIGNED
     c-serie-fim AT ROW 3.5 COL 44.57 COLON-ALIGNED NO-LABEL
     c-nro-docto-ini AT ROW 4.58 COL 12.86 COLON-ALIGNED
     c-nro-docto-fim AT ROW 4.58 COL 44.57 COLON-ALIGNED NO-LABEL
     d-dt-emis-ini AT ROW 5.63 COL 19 COLON-ALIGNED
     d-dt-emis-fim AT ROW 5.63 COL 44.57 COLON-ALIGNED NO-LABEL
     IMAGE-1 AT ROW 2.42 COL 32.29
     IMAGE-10 AT ROW 5.63 COL 43.57
     IMAGE-2 AT ROW 2.42 COL 43.57
     IMAGE-3 AT ROW 3.5 COL 32.29
     IMAGE-4 AT ROW 3.5 COL 43.57
     IMAGE-5 AT ROW 4.58 COL 32.29
     IMAGE-6 AT ROW 4.58 COL 43.57
     IMAGE-9 AT ROW 5.63 COL 32.29
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Relat¢rio de Conferencia - DES"
         HEIGHT             = 15.04
         WIDTH              = 81.43
         MAX-HEIGHT         = 28.92
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-relat /* Relat¢rio de Conferencia - DES */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Relat¢rio de Conferencia - DES */
DO:
...
{utp/ut9000.i "ESDES001" "2.06.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE IMAGE-1 IMAGE-10 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-9 
         i-cod-emitente-ini i-cod-emitente-fim c-serie-ini c-serie-fim 
         c-nro-docto-ini c-nro-docto-fim d-dt-emis-ini d-dt-emis-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY i-tipo-relat 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE RECT-10 i-tipo-relat 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    ASSIGN tt-param.emitente-ini     = input frame f-pg-sel i-cod-emitente-ini    
           ...
           tt-param.tipo-relat       = input frame f-pg-par i-tipo-relat .
    ...
    {include/i-rprun.i esp/esdes001rp.p}
    
        IF tt-param.tipo-relat = 2 THEN DO:
