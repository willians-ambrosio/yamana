...
*******************************************************************************/
{include/i-prgvrs.i YMRE0101 11.5.11.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i YMRE0101 MRE}
&ENDIF
...
&Scoped-Define ENABLED-OBJECTS bt-param rt-button 
...
DEFINE VARIABLE h_ymre0101-b01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_ymre0101-q01 AS HANDLE NO-UNDO.

/* Definitions of the field level widgets                               */
DEFINE BUTTON bt-param 
     IMAGE-UP FILE "image/toolbar/im-param.bmp":U NO-FOCUS FLAT-BUTTON
     LABEL "Button 1" 
     SIZE 4 BY 1.25.
...
DEFINE FRAME f-cad
     bt-param AT ROW 1.13 COL 61 WIDGET-ID 2
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-param w-cadpaifilho-filho
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Valores' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 2.75 , 1.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 14.92 , 90.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?,
                     ProgAtributo = ,
                     ProgIncMod = esp/ymre0101b.w,
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_ymre0101-b01 ).
       RUN set-position IN h_ymre0101-b01 ( 4.00 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 13.46 , 88.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymre0101-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_ymre0101-q01 ).
       RUN set-position IN h_ymre0101-q01 ( 1.00 , 36.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to BrowserCadastro2 h_ymre0101-b01. */
       RUN add-link IN adm-broker-hdl ( h_ymre0101-q01 , 'Record':U , h_ymre0101-b01 ).

       /* Links to SmartQuery h_ymre0101-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_ymre0101-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_ymre0101-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_ymre0101-q01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymre0101-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "YMRE0101" "11.5.11.000"}
