...
*******************************************************************************/
{include/i-prgvrs.i ESTIP00001a 2.12.00.004}
...
DEFINE FRAME f-cad
     bt-ok AT ROW 6.5 COL 3.14 HELP
          "Salva e sai"
     bt-save AT ROW 6.5 COL 14.14 HELP
          "Salva e cria novo registro"
     bt-cancela AT ROW 6.5 COL 25.14 HELP
          "Cancela"
     bt-ajuda AT ROW 6.5 COL 78.14
     rt-button AT ROW 6.33 COL 2
...
DO:
{include/okpai.i h_estip0001-v01}
END.
...
DO:
{include/salvapai.i h_estip0001-v01}
 END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_folder ( 4.92 , 88.43 ) NO-ERROR.
       ...
       RUN set-position IN h_estip0001-v01 ( 2.83 , 2.29 ) NO-ERROR.
       ...
       RUN set-position IN h_estip0001-q01 ( 6.50 , 50.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.25 , 10.00 ) */

       /* Links to SmartViewer h_estip0001-v01. */
       RUN add-link IN adm-broker-hdl ( h_estip0001-q01 , 'Record':U , h_estip0001-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_estip0001-v01 ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESTIP0001A" "2.12.00.004"}
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_estip0001-q01 (INPUT v-row-table). 
