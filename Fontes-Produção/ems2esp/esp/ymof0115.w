...
*******************************************************************************/
{include/i-prgvrs.i YMOF0115 9.99.99.999}
...
DEFINE VARIABLE d-implanta-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE d-implanta-ini AS DATE FORMAT "99/99/9999" INITIAL ? 
...
DEFINE FRAME f-pg-sel
     c-item-i AT ROW 2.75 COL 18.14 COLON-ALIGNED
     c-item-f AT ROW 2.75 COL 40.29 COLON-ALIGNED NO-LABEL
     d-implanta-ini AT ROW 3.75 COL 18.14 COLON-ALIGNED WIDGET-ID 4
     d-implanta-fim AT ROW 3.75 COL 40.29 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     IMAGE-1 AT ROW 2.75 COL 35.86
     IMAGE-2 AT ROW 2.75 COL 39
     IMAGE-15 AT ROW 3.75 COL 35.86 WIDGET-ID 18
     IMAGE-16 AT ROW 3.75 COL 39 WIDGET-ID 20
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
&Scoped-define SELF-NAME d-implanta-fim
&Scoped-define SELF-NAME d-implanta-ini
&Scoped-define FRAME-NAME f-relat
...
{utp/ut9000.i "YMOF0115" "1.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-item-i c-item-f d-implanta-ini d-implanta-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-15 IMAGE-16 c-item-i c-item-f d-implanta-ini 
         d-implanta-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.d-implanta-ini  = INPUT FRAME f-pg-sel d-implanta-ini
           tt-param.d-implanta-fim  = INPUT FRAME f-pg-sel d-implanta-fim
    ...
    {include/i-rprun.i esp\ymof0115rp.p}
