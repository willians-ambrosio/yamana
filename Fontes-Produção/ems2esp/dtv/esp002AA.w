...
/*------------------------------------------------------------------------
File.............: esp002AA.w
Description......: Relat¢rio de Consulta de Contratos
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 26/05/09 - 08:46 - 30100986
OBS..............: Este fonte foi gerado pelo Data Viewer
------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "ESP002AA".
...
DEFINE FRAME f-pg-sel
   ...
   l-log-libera-ini label "Ativo"
     at row 2 col 20 colon-aligned
     view-as fill-in 
     size 8 by .88
     font 1

   l-log-libera-fim no-label
   ...
   IMAGE-11 AT ROW 02.00 COL 34
   IMAGE-12 AT ROW 02.00 COL 39
   IMAGE-13 AT ROW 03.00 COL 34
   IMAGE-14 AT ROW 03.00 COL 39
   WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY
   SIDE-LABELS NO-UNDERLINE THREE-D
   AT COL 3 ROW 2.85
   SIZE 76.86 BY 10.62.
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Relat¢rio de Consulta de Contratos - esp002AA"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "esp002AA".
...
PROCEDURE enable_UI :
   ...
   l-log-libera-ini l-log-libera-fim
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "esp002AA" + "." + v-cod-extens-arq.
    ...
    assign tt-param.c-cod-estabel-ini = input frame f-pg-sel c-cod-estabel-ini
           ...
           tt-param.c-cod-estabel-fim = input frame f-pg-sel c-cod-estabel-fim
           tt-param.l-log-libera-ini = input frame f-pg-sel l-log-libera-ini
           tt-param.l-log-libera-fim = input frame f-pg-sel l-log-libera-fim
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "esp/esp00227.p".
