...
/*------------------------------------------------------------------------
  ...
  Altera‡Æo: 20/05/2014 - L‚a Campos - 
             ...
             Alteracao: 05/09/14 - Lea - So executa a pi-carrega-infs-item se a nota
                              ...
                              de deposito ch-6664
                            - Se os campos deposito e localiza‡ao estiver
                             preenchido nao traz o sugerido no esra010.p
                           - Se nota estiver implantada nÆo atualiza os
                             campos de-fat-conv e fi-de-quantidade com o
                             sugerido, tras apenas o que atualizou na tabela             
            05/12/14 - Lea - InclusÆo da nr-seq-fat  no  FIND FIRST it-nota-fisc 
...
/* ***************************  Definitions  ************************** */
{cdp\cdcfgdis.i} /* --- Defini‡Æo versÆo do EMS --- */
...
&Scoped-Define ENABLED-OBJECTS fi-ordem-xml fi-c-it-codigo fi-i-cfop ~
...
DEFINE BUTTON bt-ser-lote 
     IMAGE-UP FILE "dsc\ra\img\im-relac.bmp":U
     LABEL "+" 
     SIZE 4 BY .96 TOOLTIP "Clique para Selecionar mais de uma S‚rie/Lote".
...
DEFINE VARIABLE fi-c-cod-localiz AS CHARACTER FORMAT "X(10)":U 
     LABEL "Localiza‡Æo" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE fi-c-ser-lote AS CHARACTER FORMAT "X(10)":U 
     LABEL "S‚rie/Lote" 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88 NO-UNDO.
...
DEFINE VARIABLE fi-c-text-2 AS CHARACTER FORMAT "X(100)":U INITIAL "Informa‡äes Adicionais do Item" 
      VIEW-AS TEXT 
     SIZE 21.43 BY .46 NO-UNDO.

DEFINE VARIABLE fi-c-text-3 AS CHARACTER FORMAT "X(100)":U INITIAL "Opera‡Æo Triangular" 
      VIEW-AS TEXT 
     SIZE 14.57 BY .5 NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     fi-c-esp-nat AT ROW 3.71 COL 100.72 COLON-ALIGNED NO-LABEL WIDGET-ID 120
     fi-de-quantidade AT ROW 5.33 COL 14 COLON-ALIGNED WIDGET-ID 146
     fi-c-un AT ROW 5.33 COL 28.72 COLON-ALIGNED NO-LABEL WIDGET-ID 150
     fi-de-qt-do-forn AT ROW 6.21 COL 14 COLON-ALIGNED WIDGET-ID 144
     fi-c-un-forn AT ROW 6.21 COL 28.72 COLON-ALIGNED NO-LABEL WIDGET-ID 148
     fi-de-pre-unit AT ROW 5.38 COL 46.29 COLON-ALIGNED WIDGET-ID 152
     fi-de-pre-unit-xml AT ROW 5.38 COL 62.43 COLON-ALIGNED NO-LABEL WIDGET-ID 266
     fi-i-num-pedido AT ROW 5.71 COL 91.72 COLON-ALIGNED WIDGET-ID 192
     fi-de-pre-ordem AT ROW 6.25 COL 46.29 COLON-ALIGNED WIDGET-ID 264
     fi-i-num-ordem AT ROW 6.58 COL 91.72 COLON-ALIGNED WIDGET-ID 142
     fi-de-desconto-ordem AT ROW 7.13 COL 46.29 COLON-ALIGNED WIDGET-ID 274
     fi-de-desconto-xml AT ROW 7.13 COL 62.43 COLON-ALIGNED NO-LABEL WIDGET-ID 276
     fi-i-parcela-oc AT ROW 7.5 COL 91.72 COLON-ALIGNED WIDGET-ID 216
     fi-de-preco-total AT ROW 8.42 COL 62.43 COLON-ALIGNED NO-LABEL WIDGET-ID 156
     bt-ordem AT ROW 8.42 COL 104.72 HELP
          "Clique para Selecionar mais de uma Ordem de Compra" WIDGET-ID 220
     tg-fifo-oc AT ROW 8.5 COL 93.72 HELP
     ...
     bt-doc-nota AT ROW 11.67 COL 100.72 HELP
          "Clique para Selecionar mais de uma Nota" WIDGET-ID 222
     bt-estrutura AT ROW 11.67 COL 104.72 HELP
     ...
     fi-i-nr-ord-produ AT ROW 14.79 COL 94 COLON-ALIGNED WIDGET-ID 212
...
DEFINE FRAME F-Main
     bt-narrativa AT ROW 17.25 COL 104.72 WIDGET-ID 244
     ...
     bt-ser-lote AT ROW 19.71 COL 104.72 HELP
          "Clique para Selecionar mais de uma S‚rie/Lote" WIDGET-ID 224
     btn-ok AT ROW 21.38 COL 34.43 WIDGET-ID 242
     btn-cancelar AT ROW 21.38 COL 63.14 WIDGET-ID 48
     fi-c-text-3 AT ROW 9.46 COL 2.43 NO-LABEL WIDGET-ID 250
     fi-c-text AT ROW 9.46 COL 58.29 NO-LABEL WIDGET-ID 204
     fi-c-text-2 AT ROW 12.96 COL 80.14 NO-LABEL WIDGET-ID 210
     fi-de-total-nosso AT ROW 8.42 COL 46.29 COLON-ALIGNED WIDGET-ID 280
     ...
     fi-cod-unid-negoc AT ROW 16.17 COL 14 COLON-ALIGNED WIDGET-ID 292
     fi-unid-neg-descri AT ROW 16.17 COL 23 COLON-ALIGNED NO-LABEL WIDGET-ID 294
     "Pedido / Ordem de Compra" VIEW-AS TEXT
          SIZE 19 BY .46 AT ROW 4.79 COL 80.72 WIDGET-ID 238
     "Narrativa:" VIEW-AS TEXT
          SIZE 7 BY 1 AT ROW 17.25 COL 97.43 WIDGET-ID 246
          FONT 7
     "Nosso Pre‡o" VIEW-AS TEXT
          SIZE 10.57 BY .46 AT ROW 4.79 COL 48.57 WIDGET-ID 270
     "Pre‡o XML" VIEW-AS TEXT
          SIZE 9 BY .46 AT ROW 4.79 COL 64.86 WIDGET-ID 272
     RECT-34 AT ROW 20.96 COL 1.29 WIDGET-ID 104
     ...
     RECT-29 AT ROW 18.54 COL 1.57 WIDGET-ID 268
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 111.14 BY 22.71
    ...
    DO WITH FRAME {&FRAME-NAME} :
        ...
        IF NOT CAN-FIND(FIRST natur-oper WHERE natur-oper.nat-operacao = INPUT fi-c-natur-oper
            ...
            ASSIGN c-mensagem-erro = "1,"                               +
                                     "Natureza de Opera‡Æo inv lida!,"  +
                                     "Preencha a Natureza de Opera‡Æo corretamente.".
...
/*             DELETE PROCEDURE h_bonfe001. */
        ...
        IF i-tipo-nfe = 2 THEN DO:
            ...
            RUN dsc\ra\esp\esnfe200z16.w (INPUT p_rowid_item,
...
ON F5 OF fi-c-cod-localiz IN FRAME F-Main /* Localiza‡Æo */
DO:
    DO WITH FRAME {&FRAME-NAME} :
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-c-cod-localiz W-Win2
ON MOUSE-SELECT-DBLCLICK OF fi-c-cod-localiz IN FRAME F-Main /* Localiza‡Æo */
DO:
  APPLY "F5" TO SELF.
END.
...
ON F5 OF fi-c-cod-refer IN FRAME F-Main /* Referˆncia */
DO:
    DO WITH FRAME {&FRAME-NAME} :
        W-Win2:SENSITIVE = NO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-c-cod-refer W-Win2
ON LEAVE OF fi-c-cod-refer IN FRAME F-Main /* Referˆncia */
DO:
    DO WITH FRAME {&FRAME-NAME}:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-c-cod-refer W-Win2
ON MOUSE-SELECT-DBLCLICK OF fi-c-cod-refer IN FRAME F-Main /* Referˆncia */
DO:
    APPLY "F5" TO SELF.
END.
...
ON LEAVE OF fi-de-total-nosso IN FRAME F-Main /* Pre‡o Total */
DO:
    do with frame {&frame-name} :
        APPLY "LEAVE" TO fi-de-quantidade.
    end.
...
ON F5 OF fi-i-nr-ord-produ IN FRAME F-Main /* Ordem Produ‡Æo */
DO:
    DO WITH FRAME {&FRAME-NAME} :
        W-Win2:SENSITIVE = YES.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-i-nr-ord-produ W-Win2
ON LEAVE OF fi-i-nr-ord-produ IN FRAME F-Main /* Ordem Produ‡Æo */
DO:
    DO WITH FRAME {&FRAME-NAME} :
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL fi-i-nr-ord-produ W-Win2
ON MOUSE-SELECT-DBLCLICK OF fi-i-nr-ord-produ IN FRAME F-Main /* Ordem Produ‡Æo */
DO:
    APPLY "F5" TO SELF.  
END.
...
/*                    fi-de-pre-ordem:SCREEN-VALUE     = STRING(ordem-compra.preco-unit /*- ordem-compra.valor-descto*/ ) */
            ...
            IF ordem-compra.aliquota-ipi <> 0 then
                ASSIGN fi-de-pre-ordem:SCREEN-VALUE   = STRING((ordem-compra.preco-unit * 100) / (100 + ordem-compra.aliquota-ipi)).
            ELSE
                ASSIGN fi-de-pre-ordem:SCREEN-VALUE   = STRING(ordem-compra.preco-unit).
               ...
               param-re.aceita-var = YES THEN DO:
                ...
                IF AVAIL item-uni-estab THEN DO:
                    ...
                    IF item-uni-estab.var-qtd-re <> 0 THEN DO:
                        ...
                        ASSIGN de-quant-variacao = INPUT fi-de-quantidade * (item-uni-estab.var-qtd-re / 100) /* varia‡Æo percentual */
                               l-erro            = YES.
                    END.
                    
                    IF item-uni-estab.lim-var-qtd <> 0 THEN DO:
                        
                        ASSIGN de-quant-variacao    = item-uni-estab.lim-var-qtd /* varia‡Æo qtde */
                               l-erro               = YES.
                    END.
                    ...
                    IF l-erro = NO THEN DO:
                        ...
                        IF AVAIL item-mat THEN DO:
                            ...
                            IF item-mat.var-qtd-re <> 0 THEN DO:
                                ...
                                ASSIGN de-quant-variacao = INPUT fi-de-quantidade * (item-mat.var-qtd-re / 100). /* varia‡Æo percentual */

                            END.
                                
                            IF item-mat.lim-var-qtd <> 0 THEN DO:
                                
                                ASSIGN de-quant-variacao = item-mat.lim-var-qtd. /* varia‡Æo qtde */
                            END.
...
ON LEAVE OF fi-serie-docto-refer IN FRAME F-Main /* S‚rie Docto */
DO:
  RUN pi-sugestao-conta.
END.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE fi-ordem-xml fi-c-it-codigo fi-i-cfop fi-c-natur-oper fi-de-quantidade 
         fi-c-un fi-de-qt-do-forn fi-c-un-forn fi-de-pre-unit fi-i-num-pedido 
         fi-i-num-ordem fi-i-parcela-oc fi-de-preco-total bt-ordem 
         fi-i-cod-emite-terc fi-c-ser-terc fi-nro-docto-refer fi-c-nat-terc 
         fi-i-nro-docto-terc fi-serie-docto-refer fi-de-seq-terc 
...
------------------------------------------------------------------------------*/
    ...
    DO WITH FRAME {&FRAME-NAME} :
        ...
        END.
        /*Come‡a assim para depois ser feito a valida‡Æo pela natureza e parametros do RE*/    
...
/*             IF fi-c-cod-localiz:SCREEN-VALUE = "" THEN                   */
/*                 ASSIGN fi-c-cod-localiz:SCREEN-VALUE = ITEM.cod-localiz. */
         ...
         IF AVAIL nfe-dfe AND nfe-dfe.sit-erp = 1 THEN DO:
            ...
            IF NOT AVAIL ordem-compra THEN DO:
                ...
                /*assign fi-c-cod-depos:SCREEN-VALUE  = IF INPUT fi-c-it-codigo <> bf-nfe-it-nota-fisc-rec.it-codigo THEN ITEM.deposito-pad ELSE fi-c-cod-depos:SCREEN-VALUE.*/
                ...
                IF ITEM.tipo-contr = 1 OR       /* --- FISICO        --- */
                   ITEM.tipo-contr = 4 THEN DO: /* --- DEBITO DIRETO --- */
                    ...
                    IF INPUT fi-c-it-codigo <> "" THEN
                    DO:
                        IF fi-c-conta-contabil:SCREEN-VALUE = "" THEN
                           ASSIGN fi-c-conta-contabil:SCREEN-VALUE = ITEM.conta-aplicacao.

                        IF fi-ct-codigo:SCREEN-VALUE = "" THEN
                        DO:
            ...
            DO:
               IF bf-nfe-it-nota-fisc-rec.item-cod-depos = '' THEN
                  ASSIGN fi-c-cod-depos:SCREEN-VALUE   = c-cod-depos-aux.

               IF bf-nfe-it-nota-fisc-rec.item-cod-localiz = '' THEN
                  ASSIGN fi-c-cod-localiz:SCREEN-VALUE = c-cod-localiz-aux.
         ...
         END. /* nfe-dfe = 1 */
            ...
            IF AVAIL nfe-param-rec THEN DO:
                ...
                IF AVAIL nfe-it-param-rec                                AND
                   TRIM(nfe-it-param-rec.valor-1-item-parametro) = "SIM" THEN DO:
                    ...
                    /*
                    FIND FIRST emitente NO-LOCK
                        WHERE emitente.cgc = bf-nfe-nota-fiscal-rec.cgc NO-ERROR.*/
                    ...
                    IF AVAIL emitente THEN DO:
                        ...
                        IF AVAIL item-fornec THEN DO:
                            ...
                            ASSIGN de-fat-conv                                          = item-fornec.fator-conver * EXP(10,(item-fornec.num-casa-dec * (-1)))
                                ...
                                /*IF fi-de-quantidade:SCREEN-VALUE IN FRAME {&FRAME-NAME} = '0' THEN 
                                                                                          STRING(INPUT FRAME {&FRAME-NAME} fi-de-qt-do-forn / de-fat-conv)
                                                                                          ELSE fi-de-quantidade:SCREEN-VALUE IN FRAME {&FRAME-NAME}.      */
        ...
        /* --- Converte valores de quantidade de acordo com a item-fornec com item da tela --- */
...
/*                     FIND FIRST item-fornec NO-LOCK                                                                                     */
/*                         WHERE item-fornec.cod-emitente = emitente.cod-emitente                                                         */
/*                         AND   item-fornec.it-codigo    = INPUT FRAME {&FRAME-NAME} fi-c-it-codigo NO-ERROR.                            */
/*                                                                                                                                        */
/*                     IF AVAIL item-fornec THEN DO:                                                                                      */
/*                         ASSIGN de-fat-conv                      = item-fornec.fator-conver * EXP(10,(item-fornec.num-casa-dec * (-1))) */
/*                                fi-de-quantidade:SCREEN-VALUE    = STRING(INPUT FRAME {&FRAME-NAME} fi-de-qt-do-forn / de-fat-conv).    */
/*                     END.                                                                                                               */
/*                 END.                                                                                                                   */
/*             END.                                                                                                                       */
/*         END.                                                                                                                           */
...
DEF VAR c-campos    AS CHAR FORMAT "x(30)" EXTENT 22
    INIT["item","pedido_compra","ordem_compra","parcela_oc","fifo_oc","qtde_fornecedor","un_fornecedor",
         "preco_unitario","quantidade","un","preco_total","cfop","natureza","classif_fiscal","conta_contabil",
    ...
    DO WITH FRAME {&FRAME-NAME} :
        ...
        /* --- Para Relacionamento de S‚rie/Lote --- */
...
IF fi-c-conta-contabil:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "" OR 
          fi-ct-codigo:SCREEN-VALUE IN FRAME {&FRAME-NAME} = ""
    THEN DO:
...
/*FOR EACH nota-fiscal NO-LOCK
    ...
    AND   nota-fiscal.nr-nota-fis = "0059879":
...
/*             DISP movto-estoq WITH WIDTH 300 1 COL. */
