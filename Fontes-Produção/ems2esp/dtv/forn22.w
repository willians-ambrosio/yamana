...
define variable c-prog-gerado as character no-undo initial "FORN22".
...
def var c-titulo           as char init "Lista Fornecedores - CtaPagar" no-undo.        
def var v-cod-prog-gerado  as char init "forn22" no-undo.           
...
assign v-cod-prog-gerado = "forn22".
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK 
   ON END-KEY UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK:
        ...
        assign c-lista = "" + "," + 
                         "Lista Fornecedores - CtaPagar".

        assign c-prog = "forn22BC.w" + "," + 
                        "forn22BC.w".
