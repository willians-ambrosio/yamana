...
ON END-ERROR OF w-cadsim /* Manuten‡Æo de Garantia */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manuten‡Æo de Garantia */
DO:
...
------------------------------------------------------------------------------*/
  RUN utp/ut-msgs.p (INPUT "show",
                     INPUT 27100,
                     INPUT "Confirma elimina‡Æo dos registros selecionados?").
