...
DEFINE VARIABLE h_ymof0103b-bz01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-ok AT ROW 13.63 COL 3
     bt-cancela AT ROW 13.63 COL 14
     bt-ajuda AT ROW 13.63 COL 79
     rt-button AT ROW 13.38 COL 2
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymof0103b-bz01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ymof0103b-bz01 ).
       RUN set-position IN h_ymof0103b-bz01 ( 2.75 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.25 , 80.00 ) */

       /* Links to SmartBrowser h_ymof0103b-bz01. */
       RUN add-link IN adm-broker-hdl ( h_ymof0103b-bz01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymof0103b-bz01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
