...
*******************************************************************************/
{include/i-prgvrs.i ESHRDM001 1.00.00.001}
...
DEFINE VARIABLE tg-cta-duplic AS LOGICAL INITIAL no 
     LABEL "Somente com Conta Duplicada" 
     VIEW-AS TOGGLE-BOX
     SIZE 37 BY .83 NO-UNDO.

DEFINE VARIABLE tg-sem-avaliac AS LOGICAL INITIAL no 
     LABEL "Somente sem Avaliaá∆o Pessoal" 
     VIEW-AS TOGGLE-BOX
     SIZE 37 BY .83 NO-UNDO.

DEFINE VARIABLE c-fim-cdn-estab AS CHARACTER FORMAT "X(05)":U INITIAL "ZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-fim-empresa AS CHARACTER FORMAT "X(03)":U INITIAL "ZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-fim-usuar-alter AS CHARACTER FORMAT "X(12)":U INITIAL "ZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-ini-cdn-estab AS CHARACTER FORMAT "x(05)":U 
     LABEL "Estab" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-ini-empresa AS CHARACTER FORMAT "x(03)":U 
     LABEL "Empresa" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-ini-usuar-alter AS CHARACTER FORMAT "X(12)":U 
     LABEL "Usuar Alter" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE i-fim-cdn-funcionario AS INTEGER FORMAT "99999999":U INITIAL 99999999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE i-ini-cdn-funcionario AS INTEGER FORMAT "99999999":U INITIAL 0 
     LABEL "Funcion†rio" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-par
     tg-cta-duplic AT ROW 3.13 COL 21.14 WIDGET-ID 18
     tg-sem-avaliac AT ROW 4 COL 21.14 WIDGET-ID 22
     "Somente com:" VIEW-AS TEXT
          SIZE 12 BY .54 AT ROW 2.04 COL 16.14 WIDGET-ID 20
     RECT-11 AT ROW 2.25 COL 12 WIDGET-ID 24
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 75 BY 10
...
DEFINE FRAME f-pg-sel
     c-ini-empresa AT ROW 1.92 COL 15 COLON-ALIGNED
     c-fim-empresa AT ROW 1.92 COL 48.14 COLON-ALIGNED NO-LABEL
     c-ini-cdn-estab AT ROW 2.92 COL 15 COLON-ALIGNED WIDGET-ID 4
     c-fim-cdn-estab AT ROW 2.92 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     i-ini-cdn-funcionario AT ROW 3.96 COL 15 COLON-ALIGNED WIDGET-ID 12
     i-fim-cdn-funcionario AT ROW 3.96 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     c-ini-usuar-alter AT ROW 4.92 COL 15 COLON-ALIGNED WIDGET-ID 26
     c-fim-usuar-alter AT ROW 4.92 COL 48.14 COLON-ALIGNED NO-LABEL WIDGET-ID 24
     IMAGE-1 AT ROW 1.92 COL 31.86
     IMAGE-2 AT ROW 1.92 COL 47.29
     IMAGE-3 AT ROW 2.92 COL 31.86 WIDGET-ID 6
     IMAGE-4 AT ROW 2.92 COL 47.29 WIDGET-ID 8
     IMAGE-5 AT ROW 3.96 COL 31.86 WIDGET-ID 14
     IMAGE-6 AT ROW 3.96 COL 47.29 WIDGET-ID 16
     IMAGE-7 AT ROW 4.92 COL 31.86 WIDGET-ID 28
     IMAGE-8 AT ROW 4.92 COL 47.29 WIDGET-ID 30
     RECT-10 AT ROW 1.5 COL 7 WIDGET-ID 32
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-ini-empresa c-fim-empresa c-ini-cdn-estab c-fim-cdn-estab 
          i-ini-cdn-funcionario i-fim-cdn-funcionario c-ini-usuar-alter 
          c-fim-usuar-alter 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         RECT-10 c-ini-empresa c-fim-empresa c-ini-cdn-estab c-fim-cdn-estab 
         i-ini-cdn-funcionario i-fim-cdn-funcionario c-ini-usuar-alter 
         c-fim-usuar-alter 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY tg-cta-duplic tg-sem-avaliac 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE RECT-11 tg-cta-duplic tg-sem-avaliac 
      WITH FRAME f-pg-par IN WINDOW w-relat.
    ...
    */
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           */                                 
           ...
           .
    ASSIGN 
      tt-param.ini-empresa       = INPUT FRAME f-pg-sel c-ini-empresa 
      tt-param.fim-empresa       = INPUT FRAME f-pg-sel c-fim-empresa
      tt-param.ini-cdn-estab     = INPUT FRAME f-pg-sel c-ini-cdn-estab
      tt-param.fim-cdn-estab     = INPUT FRAME f-pg-sel c-fim-cdn-estab
      tt-param.ini-cdn-func      = INPUT FRAME f-pg-sel i-ini-cdn-funcionario
      tt-param.fim-cdn-func      = INPUT FRAME f-pg-sel i-fim-cdn-funcionario
      tt-param.ini-usuar-alter   = INPUT FRAME f-pg-sel c-ini-usuar-alter
      tt-param.fim-usuar-alter   = INPUT FRAME f-pg-sel c-fim-usuar-alter.

    ASSIGN 
      tt-param.l-cta-duplic      = INPUT FRAME f-pg-par tg-cta-duplic
      tt-param.l-sem-avaliac     = INPUT FRAME f-pg-par tg-sem-avaliac.
    ...
    {include/i-rprun.i prghur/esp/eshrdm001rp.p}
