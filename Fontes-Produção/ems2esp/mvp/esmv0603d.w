...
*******************************************************************************/
{include/i-prgvrs.i ESMV0603D 2.03.00.003}  /*** 010003 ***/
/*:T*******************************************************************************
...
&GLOBAL-DEFINE Program        ESMV0603D
...
define input parameter i-qtd-interv-ini as integer                  no-undo.
define input parameter i-qtd-interv-fim as integer                  no-undo.
...
DEFINE VARIABLE tgParam AS LOGICAL INITIAL no 
     ...
     VIEW-AS TOGGLE-BOX
     SIZE 19.43 BY .79 NO-UNDO.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME fpage0
     btOK AT ROW 11.5 COL 2
     btCancel AT ROW 11.5 COL 13
     btHelp2 AT ROW 11.5 COL 45
...
DEFINE FRAME fPage6
     ...
     btFile AT ROW 3.58 COL 43.14 HELP
          "Escolha do nome do arquivo"
     btConfigImpr AT ROW 3.58 COL 43.14 HELP
          "Configura‡Æo da impressora"
     cFile AT ROW 3.63 COL 3.14 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     rsExecution AT ROW 5.75 COL 3 HELP
          "Modo de Execu‡Æo" NO-LABEL
     tgParam AT ROW 7.5 COL 2.57
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.i-qtd-interv-ini = i-qtd-interv-ini
           tt-param.i-qtd-interv-fim = i-qtd-interv-fim
    ...
    {report/rprun.i mvp/esmv0603rp.p}
