...
**         Objetivo: Selecionar um registro da tabela es_param_cta_corren 
**
...
******************************************************************************************/
{include/i-prgvrs.i VAN001-Z02 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i PSDID VAN}
&ENDIF
...
DEFINE FRAME f-zoom
     ...
     bt-ajuda AT ROW 16.54 COL 55.72
...
ON END-ERROR OF w-pesquisa /* Pesquisa de PSDID */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de PSDID */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'PSDID' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.17 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 13.67 , 65.43 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Layout = ':U ,
             OUTPUT h_VAN001-B01 ).
       RUN set-position IN h_VAN001-B01 ( 3.79 , 4.29 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 60.00 ) */
