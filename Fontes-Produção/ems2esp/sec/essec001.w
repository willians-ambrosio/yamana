...
*******************************************************************************/
{include/i-prgvrs.i ESSEC001 2.06.00.000}
...
ON END-ERROR OF w-relat /* Extrator de Dados HCM */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Extrator de Dados HCM */
DO:
...
{utp/ut9000.i "ESSEC001" "2.06.00.000"}
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i sec/essec001rp.p}
