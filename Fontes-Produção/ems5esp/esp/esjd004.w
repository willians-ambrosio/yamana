...
IMAGE-15 IMAGE-16 RECT-12 IMAGE-17 IMAGE-18 rs-saida fi-cod_cta_ctbl-ini ~
fi-cod_cta_ctbl-fim fi-data-ini fi-data-fim fi-arquivo bt_fechar ~
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = ".: Contas Anal¡ticas sem Parƒmetro Exclusiva - ESJD004 :."
         HEIGHT             = 15.92
         WIDTH              = 80
         MAX-HEIGHT         = 42.42
         MAX-WIDTH          = 274.29
...
ON END-ERROR OF C-Win /* .: Contas Anal¡ticas sem Parƒmetro Exclusiva - ESJD004 :. */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* .: Contas Anal¡ticas sem Parƒmetro Exclusiva - ESJD004 :. */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY rs-saida fi-cod_cta_ctbl-ini fi-cod_cta_ctbl-fim fi-data-ini 
          fi-data-fim fi-arquivo 
      WITH FRAME f_main IN WINDOW C-Win.
  ENABLE bt-busca-arq rt_rgf rt_cxcf bt_executar IMAGE-15 IMAGE-16 RECT-12 
         IMAGE-17 IMAGE-18 rs-saida fi-cod_cta_ctbl-ini fi-cod_cta_ctbl-fim 
         fi-data-ini fi-data-fim fi-arquivo bt_fechar bt_cancelar Btn_Help 
      WITH FRAME f_main IN WINDOW C-Win.
...
IF NOT AVAIL dwb_rpt_param THEN DO:
    ...
    ASSIGN dwb_rpt_param.cod_dwb_program = "esjd004rp"
...
IF INTEGER (INPUT FRAME {&FRAME-NAME} rs-saida) = 2 THEN DO: /* Batch */
    run prgtec/btb/btb911za.p (Input "esjd004rp",
                               Input "5.06.00.001",
                               Input 40,
...
*/
    ...
    assign fi-arquivo :screen-value = SESSION:TEMP-DIRECTORY + "esjd004-" + STRING(TIME) + ".txt"
           fi-data-ini:screen-value = STRING (TODAY - 365,"99/99/9999")
