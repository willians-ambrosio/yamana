...
/*------------------------------------------------------------------------
File.............: esi090.w
Description......: Extra‡Æo Cadastro de Funcionario
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 17/01/11 - 14:03 - adm
------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "esi090".
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Extra‡Æo Cadastro de Funcionario - esi090"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "esi090".
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "esi090" + "." + v-cod-extens-arq.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "esp\esi09027.p".
