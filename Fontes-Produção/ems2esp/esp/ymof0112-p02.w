...
DEFINE VARIABLE h_ymof0112-bz02 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Por Codigo' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymof0112-bz02.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ymof0112-bz02 ).
       RUN set-position IN h_ymof0112-bz02 ( 2.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.00 ) */

       /* Links to SmartBrowser h_ymof0112-bz02. */
       RUN add-link IN adm-broker-hdl ( h_ymof0112-bz02 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymof0112-bz02 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
