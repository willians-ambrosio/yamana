...
*******************************************************************************/
{include/i-prgvrs.i YG0007 12.1.17.000}
...
DEFINE BUTTON bt-abre-exce 
     IMAGE-UP FILE "image/toolbar/im-open.bmp":U NO-FOCUS FLAT-BUTTON
     LABEL "Button 7" 
     SIZE 4 BY 1.

DEFINE VARIABLE c-nome-planilha AS CHARACTER FORMAT "X(256)":U 
...
DEFINE VARIABLE rs-acao AS INTEGER 
     ...
     RADIO-BUTTONS 
          "Ativo", 1,
"Restriá∆o Compras", 2,
"Restriá∆o Compras e Recebimento",3,
"Inativo",4
...
DEFINE FRAME f-pg-par
     bt-abre-exce AT ROW 2.17 COL 71 WIDGET-ID 4 NO-TAB-STOP 
     c-nome-planilha AT ROW 2.25 COL 18 COLON-ALIGNED WIDGET-ID 2
     rs-acao AT ROW 4.04 COL 7 NO-LABEL WIDGET-ID 14
     tg-simula AT ROW 5.38 COL 42 WIDGET-ID 12
     RECT-2 AT ROW 2 COL 1 WIDGET-ID 6
     RECT-3 AT ROW 3.75 COL 1 WIDGET-ID 8
     RECT-4 AT ROW 3.75 COL 39 WIDGET-ID 10
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 75 BY 10
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Ativaá∆o/Desativaá∆o de Fornecedores"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
/* SETTINGS FOR RECTANGLE RECT-3 IN FRAME f-pg-par
   NO-ENABLE                                                            */
/* SETTINGS FOR RECTANGLE RECT-4 IN FRAME f-pg-par
   NO-ENABLE                                                            */
...
ON END-ERROR OF w-relat /* Ativaá∆o/Desativaá∆o de Fornecedores */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Ativaá∆o/Desativaá∆o de Fornecedores */
DO:
...
&Scoped-define SELF-NAME bt-abre-exce
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-abre-exce w-relat
ON CHOOSE OF bt-abre-exce IN FRAME f-pg-par /* Button 7 */
DO:
  SYSTEM-DIALOG GET-FILE c-nome-planilha
      MUST-EXIST
      FILTERS "Planilhas Excel" "*.x*"
      UPDATE l-ok.
  IF l-ok THEN c-nome-planilha:SCREEN-VALUE = c-nome-planilha.
END.
...
{utp/ut9000.i "YG0007" "12.1.17.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-nome-planilha rs-acao tg-simula 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE bt-abre-exce c-nome-planilha rs-acao tg-simula 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    ASSIGN tt-param.nome-planilha = INPUT FRAME f-pg-par c-nome-planilha
           tt-param.i-acao        = INPUT FRAME f-pg-par rs-acao
           tt-param.l-simula      = INPUT FRAME f-pg-par tg-simula.
    ...
    {include/i-rprun.i esp/yg0007rp.p}
