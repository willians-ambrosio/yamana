...
&Scoped-define INTERNAL-TABLES es_param_ws_van

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es_param_ws_van NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es_param_ws_van NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main es_param_ws_van
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es_param_ws_van
...
<FOREIGN-KEYS>
cdn_empresa||y|ems5esp.es_param_ws_van.cdn_empresa
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems5esp.es_param_ws_van"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cdn_empresa" "es_param_ws_van" "cdn_empresa"}
