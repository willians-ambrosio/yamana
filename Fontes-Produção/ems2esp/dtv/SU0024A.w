...
/*------------------------------------------------------------------------
File.............: SU0024A.w
Description......: RELATàRIO PAR¶METRO DE ESTOQUE
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 30/09/10 - 11:21 - 20100038
OBS..............: Este fonte foi gerado pelo Data Viewer
------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "SU0024A".
...
DEFINE FRAME f-pg-sel
   ...
   IMAGE-3 AT ROW 02.00 COL 31
   IMAGE-4 AT ROW 02.00 COL 36
   IMAGE-5 AT ROW 03.00 COL 31
   IMAGE-6 AT ROW 03.00 COL 36
   WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY
   SIDE-LABELS NO-UNDERLINE THREE-D
   AT COL 3 ROW 2.85
   SIZE 76.86 BY 10.62.
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "RELATàRIO PAR¶METRO DE ESTOQUE - SU0024A"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "SU0024A".
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "SU0024A" + "." + v-cod-extens-arq.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "dtv/SU00241.p".
