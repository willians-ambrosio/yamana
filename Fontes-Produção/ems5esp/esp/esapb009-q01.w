...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-cat-code-fornec NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-cat-code-fornec NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-cat-code-fornec
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-cat-code-fornec
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "emsfnd.es-cat-code-fornec"
     _Options          = "NO-LOCK"
