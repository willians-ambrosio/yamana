...
IF SELF:FRAME:WINDOW:INSTANTIATING-PROCEDURE:NAME MATCHES "*ce0330*" OR
   SELF:FRAME:WINDOW:INSTANTIATING-PROCEDURE:NAME MATCHES "*cd0138*" OR
   SELF:FRAME:WINDOW:INSTANTIATING-PROCEDURE:NAME MATCHES "*ce0106*" THEN DO:


    IF NOT NEW p-table               AND
       (p-old-table.cod-obsoleto  = 4 OR
       p-old-table.cod-obsoleto  = 3 OR
       p-old-table.cod-obsoleto  = 2) AND
       p-table.cod-obsoleto     <> 4 THEN DO:

          ASSIGN p-table.cod-obsoleto = 4.
