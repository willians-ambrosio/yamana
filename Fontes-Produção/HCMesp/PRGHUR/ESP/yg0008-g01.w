...
*******************************************************************************/
{include/i-prgvrs.i YG0008-G01 12.1.17.000}
...
&Scoped-Define ENABLED-OBJECTS rt-button c_cdn_empresa c_cdn_estab ~
i_cdn_clas_func i_cdn_categ_sal bt-ok bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cdn_empresa c_cdn_estab i_cdn_clas_func ~
i_cdn_categ_sal 
...
DEFINE VARIABLE c_cdn_empresa AS CHARACTER FORMAT "x(3)":U 
     LABEL "Empresa" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.

DEFINE VARIABLE c_cdn_estab AS CHARACTER FORMAT "x(5)":U 
     LABEL "Estabelecimento" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.

DEFINE VARIABLE i_cdn_categ_sal AS INTEGER FORMAT "99":U INITIAL 0 
     LABEL "Categoria Salarial" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.

DEFINE VARIABLE i_cdn_clas_func AS INTEGER FORMAT ">>9":U INITIAL 0 
...
DEFINE FRAME d-vapara
     c_cdn_empresa AT ROW 1.17 COL 30 COLON-ALIGNED WIDGET-ID 2
     c_cdn_estab AT ROW 2.17 COL 30 COLON-ALIGNED WIDGET-ID 4
     i_cdn_clas_func AT ROW 3.17 COL 30 COLON-ALIGNED WIDGET-ID 8
     i_cdn_categ_sal AT ROW 4.17 COL 30 COLON-ALIGNED WIDGET-ID 6
     bt-ok AT ROW 5.75 COL 2.14
     bt-cancela AT ROW 5.75 COL 13
     bt-ajuda AT ROW 5.75 COL 58
     rt-button AT ROW 5.5 COL 1
     SPACE(0.13) SKIP(0.00)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "V  Para Parƒmetros Horas In Intineres"
...
ON GO OF FRAME d-vapara /* V  Para Parƒmetros Horas In Intineres */
DO:
FIND es_categ_ptoelet NO-LOCK
    WHERE es_categ_ptoelet.cdn_empresa EQ INPUT FRAME {&FRAME-NAME} c_cdn_empresa
      AND es_categ_ptoelet.cdn_estab EQ INPUT FRAME {&FRAME-NAME} c_cdn_estab
      AND es_categ_ptoelet.cdn_categ_sal EQ INPUT FRAME {&FRAME-NAME} i_cdn_categ_sal
      AND es_categ_ptoelet.cdn_clas_func EQ INPUT FRAME {&FRAME-NAME} i_cdn_clas_func NO-ERROR.

IF NOT AVAILABLE es_categ_ptoelet THEN DO:
    ...
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(es_categ_ptoelet).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Parƒmetros Horas In Intineres */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY c_cdn_empresa c_cdn_estab i_cdn_clas_func i_cdn_categ_sal 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cdn_empresa c_cdn_estab i_cdn_clas_func i_cdn_categ_sal 
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "YG0008-G01" "12.1.17.000"}
