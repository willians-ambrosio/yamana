...
*******************************************************************************/
{include/i-prgvrs.i YMFP0005A 1.02.00.003 } /*** 010003 ***/
/*------------------------------------------------------------------------
...
&Scoped-Define ENABLED-OBJECTS im-pg-lay bt-sair bt-ajuda 
...
DEFINE FRAME f-import
     bt-sair AT ROW 14.54 COL 3 HELP
          "Cancelar"
     bt-ajuda AT ROW 14.54 COL 70 HELP
          "Ajuda"
     rt-folder-left AT ROW 2.54 COL 2.14
     rt-folder-top AT ROW 2.63 COL 3.29
...
ON CHOOSE OF bt-sair IN FRAME f-import /* Sair */
DO:
...
{utp/ut9000.i "YMFP0005A" "1.00.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    apply 'mouse-select-click' to im-pg-lay in frame f-import.

    {include/i-imvrf.i &programa=ymfp0006 &versao-layout=001} 
...
------------------------------------------------------------------------------*/
  ENABLE im-pg-lay bt-sair bt-ajuda 
