...
/****************************************************************************************** 
**         Programa: apya505-g01.w
**            Autor: Felipe Vieira
**       Fornecedor: DKP
**       Data: 31/10/2018
** Change/Chamado: ------
**    Objetivo: Vapara da tabela Cota‡Æo de dolar para intercompany (contrato_cotac)
**
...
&Scoped-Define ENABLED-OBJECTS rt-button i_mo-codigo d-dt bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS i_mo-codigo d-dt 
...
DEFINE VARIABLE d-dt AS DATE FORMAT "99/99/9999":U INITIAL ? 
     LABEL "Per¡odo" 
     VIEW-AS FILL-IN 
     SIZE 14 BY .88 NO-UNDO.

DEFINE VARIABLE i_mo-codigo AS INTEGER FORMAT ">>>9":U INITIAL 0 
     LABEL "Moeda" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     i_mo-codigo AT ROW 1.5 COL 16 COLON-ALIGNED WIDGET-ID 2
     d-dt AT ROW 2.5 COL 16 COLON-ALIGNED WIDGET-ID 4
     bt-ok AT ROW 4.5 COL 2.14
     bt-cancela AT ROW 4.5 COL 13
     bt-ajuda AT ROW 4.5 COL 30.43
...
FIND contrato_cotac NO-LOCK
    WHERE contrato_cotac.mo-codigo EQ INPUT FRAME {&FRAME-NAME} i_mo-codigo 
      AND contrato_cotac.data-periodo EQ INPUT FRAME {&FRAME-NAME} d-dt NO-ERROR.

IF NOT AVAILABLE contrato_cotac THEN DO:
    {utp/ut-table.i ems5_esp contrato_cotac 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(contrato_cotac).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY i_mo-codigo d-dt 
      WITH FRAME d-vapara.
  ENABLE rt-button i_mo-codigo d-dt bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "apya505-g01" "Vapara Cota‡Æo de dolar para intercompany"}
