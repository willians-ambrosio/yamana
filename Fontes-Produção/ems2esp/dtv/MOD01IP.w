...
/*------------------------------------------------------------------------
File.............: MOD01IP.w
Description......: Modifica IP
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 17/01/12 - 13:55 - adm
OBS..............: Este fonte foi gerado pelo Data Viewer
------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "MOD01IP".
...
DEFINE FRAME f-pg-par
   ...
   ip_new
     at row 1.35 col 9 colon-aligned
     view-as fill-in
     size 16 by .88
     font 1
...
assign v-cod-prog-gerado = "MOD01IP".
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "MOD01IP" + "." + v-cod-extens-arq.

    assign tt-param.ip_new = input frame f-pg-par ip_new
.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "dtv/MOD01I16.p".
