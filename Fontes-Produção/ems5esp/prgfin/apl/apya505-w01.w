...
/****************************************************************************************** 
**         Programa: apya505-w01.w
**            Autor: Felipe Vieira
**       Fornecedor: DKP
**       Data: 31/10/2018
** Change/Chamado: ------
**    Objetivo: Cadastro simples da tabela Cota‡Æo de dolar para intercompany (contrato_cotac)
**
...
******************************************************************************************/
{include/i-prgvrs.i apya505 1.00.00.000}
...
DEFINE VARIABLE h_apya505-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_apya505-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 76.72 BY 6.67 WIDGET-ID 100.
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 0,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_p-exihel ).
       RUN set-position IN h_p-exihel ( 1.33 , 60.43 ) NO-ERROR.
       /* Size in UIB:  ( 1.25 , 16.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apl/apya505-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_apya505-v01 ).
       RUN set-position IN h_apya505-v01 ( 2.88 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 4.50 , 75.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apl/apya505-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = prgfin\apl\apya505-z01.w,
                     ProgVaPara = prgfin\apl\apya505-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_apya505-q01 ).
       RUN set-position IN h_apya505-q01 ( 2.83 , 1.14 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_apya505-v01. */
       RUN add-link IN adm-broker-hdl ( h_apya505-q01 , 'Record':U , h_apya505-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_apya505-v01 ).

       /* Links to SmartQuery h_apya505-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_apya505-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_apya505-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_apya505-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_apya505-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "apya505-w01" "Cadastro de cota‡Æo de dolar para intercompany"}
