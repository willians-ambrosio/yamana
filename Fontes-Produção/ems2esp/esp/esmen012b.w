...
DEFINE VARIABLE h_esmen012b-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esmen012b-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 5.29 COL 2 HELP
          "Salva e sai"
     bt-save AT ROW 5.29 COL 12.43 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 5.29 COL 23 HELP
          "Cancela"
     bt-ajuda AT ROW 5.29 COL 66.57
     rt-button AT ROW 5.13 COL 1
...
DO:
{include/okfil.i h_esmen012b-v01}
END.
...
DO:
{include/salvafil.i h_esmen012b-v01}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esmen012b-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esmen012b-v01 ).
       RUN set-position IN h_esmen012b-v01 ( 1.08 , 1.29 ) NO-ERROR.
       /* Size in UIB:  ( 3.25 , 77.86 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esmen012b-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_esmen012b-q01 ).
       RUN set-position IN h_esmen012b-q01 ( 5.21 , 47.43 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_esmen012b-v01. */
       RUN add-link IN adm-broker-hdl ( h_esmen012b-q01 , 'Record':U , h_esmen012b-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_esmen012b-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esmen012b-v01 ,
...
------------------------------------------------------------------------------*/
  ...
  run pi-atualiza-parent in h_esmen012b-v01 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_esmen012b-q01 (input v-row-table).
