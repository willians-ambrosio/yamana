/****************************************************************************************** 
** 	   Programa: edf901z3-237.p
**   	  Autor: Daniela Campos
** 	 Fornecedor: DKP
**         Data: 24/07/2018
** Change/Chamado: 
**      Objetivo: Retorna a forma de pagamento para o trailer do lote - posiá∆o de 10 a 11 
**
...
then do:
    run pi_version_extract ('fnc_retorna_pagto_bradesco':U, 'prgint\edf\edf900z3-237.py':U, '1.00.00.003':U, 'pro':U).
end /* if */.
...
do on endkey undo main_block, leave main_block
     ...
     /*
     output to "c:\temp\cabec_citi.txt" append.
...
find first tt_param_program_formul
    ...
    case int(tt_param_program_formul.ttv_des_contdo):
       ...
       /* Tributos */
       when 16 then return "22". 
       when 17 then return "22". 
       when 18 then return "22". 
       when 20 then return "22". 
       when 21 then return "22". 
       when 22 then return "22". 
       when 23 then return "22". 
       when 24 then return "22". 
       when 25 then return "22". 
       when 26 then return "22". 
       when 27 then return "22". 
       when 40 then return "22". 
       when 13 then return "22". /* Tributos */

       when 01 then return "20". /* Pagamento Fornecedor */
       when 02 then return "20". /* Pagamento Fornecedor */
       when 03 then return "20". /* Pagamento Fornecedor */
       when 04 then return "20". /* Pagamento Fornecedor */
       when 05 then return "20". /* Pagamento Fornecedor */
       when 06 then return "20". /* Pagamento Fornecedor */
       when 07 then return "20". /* Pagamento Fornecedor */
       when 08 then return "20". /* Pagamento Fornecedor */

       /* Boleto */
       when 31 then return "20". /* Pagamento Fornecedor */
       when 30 then return "20". /* Pagamento Fornecedor */

       otherwise return "98". /* Pagamento Diversos */
    end.
end /* do main_block */.
