...
DEFINE INPUT PARAMETER wh-nr-ord-produ     AS WIDGET-HANDLE NO-UNDO. 
DEFINE INPUT PARAMETER wh-cd-tarefa-mi0307 AS WIDGET-HANDLE NO-UNDO.
...
ASSIGN wh-coluna = wh-cd-tarefa-mi0307:FIRST-COLUMN.



RUN mip/esmi0307.w PERSISTENT SET h-program.
