...
DEFINE VARIABLE h_ymof0100-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_ymof0100-v01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_ymof0101-b01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymof0100-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ymof0100-v01 ).
       RUN set-position IN h_ymof0100-v01 ( 2.50 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.75 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Empresa' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?,
                     ProgAtributo = ,
                     ProgIncMod = esp\ymof0101a.w,
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_ymof0101-b01 ).
       RUN set-position IN h_ymof0101-b01 ( 5.50 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.50 , 79.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymof0100-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = ESP\YMOF0103B-P01.W,
                     ProgVaPara = ESP\YMOF0100-G01.W,
                     ProgIncMod = esp\ymof0101b.w,
                     Implantar = no':U ,
             OUTPUT h_ymof0100-q01 ).
       RUN set-position IN h_ymof0100-q01 ( 1.25 , 54.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.00 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_ymof0100-v01. */
       RUN add-link IN adm-broker-hdl ( h_p-cadpai , 'TableIO':U , h_ymof0100-v01 ).
       RUN add-link IN adm-broker-hdl ( h_ymof0100-q01 , 'Record':U , h_ymof0100-v01 ).

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to BrowserCadastro2 h_ymof0101-b01. */
       RUN add-link IN adm-broker-hdl ( h_ymof0100-q01 , 'Record':U , h_ymof0101-b01 ).

       /* Links to SmartQuery h_ymof0100-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-cadpai , 'State':U , h_ymof0100-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_ymof0100-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_ymof0100-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadpai , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymof0100-v01 ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_ymof0100-v01 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymof0101-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "YMOF0101" "1.00.00.000"}
  
  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .


  RUN enable-copia IN h_p-cadpai
    ( INPUT NO /* LOGICAL */).
