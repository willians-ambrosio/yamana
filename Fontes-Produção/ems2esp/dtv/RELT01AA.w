...
/*------------------------------------------------------------------------
File.............: RELT01AA.w
Description......: PEDIDOS POR COMPRADOR
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 30/03/12 - 19:47 - adm
OBS..............: Este fonte foi gerado pelo Data Viewer
------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "RELT01AA".
...
/* DEFINE VARIABLE rs-formato-arquivo AS LOGICAL INITIAL YES */
/* LABEL "Imprimir em CSV"                       */
/* VIEW-AS TOGGLE-BOX                            */
/* SIZE 32 BY .83                                */
/* NO-UNDO.                                      */
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "PEDIDOS POR COMPRADOR - RELT01AA"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "RELT01AA".
...
PROCEDURE enable_UI :
   ...
   DISPLAY rs-destino c-arquivo rs-execucao tb-parametro rs-formato-arquivo rs-formato
   WITH FRAME f-pg-imp IN WINDOW C-Win.
   ENABLE RECT-7 rs-destino bt-arquivo bt-config-impr c-arquivo RECT-9 rect-10 rs-execucao tb-parametro rs-formato-arquivo rs-formato
   WITH FRAME f-pg-imp IN WINDOW C-Win.
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   assign tt-param.usuario              = c-seg-usuario
          ...
          tt-param.formato-arquivo      = input frame f-pg-imp rs-formato-arquivo
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "RELT01AA" + "." + v-cod-extens-arq.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "DTV/RELT0127.p".
