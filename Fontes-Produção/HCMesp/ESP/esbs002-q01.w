...
&Scoped-define QUERY-STRING-Query-Main FOR EACH estab_benef_prev_brad NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH estab_benef_prev_brad NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main estab_benef_prev_brad
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main estab_benef_prev_brad
