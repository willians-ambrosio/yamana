...
*******************************************************************************/
{include/i-prgvrs.i esap003-z01 2.06.00.001}  /*** 010007 ***/
...
DEFINE VARIABLE h_esap003-b01 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa de Tipo de Ferramenta - ESCQ003-Z01"
         HEIGHT             = 17
         WIDTH              = 90
         MAX-HEIGHT         = 23.17
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Tipo de Ferramenta - ESCQ003-Z01 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Tipo de Ferramenta - ESCQ003-Z01 */
DO:
...
DO:
  {include/i-implan.i "esp/esap003.w" "h_esap003-b01"}
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esap003-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esap003-b01 ).
       RUN set-position IN h_esap003-b01 ( 3.33 , 3.86 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 84.57 ) */

       /* Links to SmartBrowser h_esap003-b01. */
       RUN add-link IN adm-broker-hdl ( h_esap003-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esap003-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
{utp/ut9000.i "esap003-Z01" "2.06.00.001"}
