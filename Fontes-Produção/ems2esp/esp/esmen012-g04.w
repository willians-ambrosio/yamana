...
&Scoped-Define ENABLED-OBJECTS rt-button ngs-req-acesso-esmen012 bt-ok ~
bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS ngs-req-acesso-esmen012 tx-grupo tx-usu 
...
DEFINE FRAME d-vapara
     ngs-req-acesso-esmen012 AT ROW 3 COL 19 COLON-ALIGNED WIDGET-ID 6
     bt-ok AT ROW 4.5 COL 2.14
     bt-cancela AT ROW 4.5 COL 13
     bt-ajuda AT ROW 4.5 COL 38
     tx-grupo AT ROW 1.29 COL 1 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     tx-usu AT ROW 1.29 COL 26 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     rt-button AT ROW 4.25 COL 1
     SPACE(1.28) SKIP(0.20)
...
ON GO OF FRAME d-vapara /* Requisi‡Æo */
DO:
  
    ASSIGN ngs-req-acesso-esmen012.

    ASSIGN p-req = ngs-req-acesso-esmen012.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* Requisi‡Æo */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY ngs-req-acesso-esmen012 tx-grupo tx-usu 
      WITH FRAME d-vapara.
  ENABLE rt-button ngs-req-acesso-esmen012 bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESMEN012-G04" "1.00.00.000"}
