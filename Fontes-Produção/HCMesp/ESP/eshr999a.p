...
PROCEDURE pi-corpo-imp:
  ...
  PUT  
    ...
    v_cod_rh_ccusto                                               FORMAT "x(12)"             ";"
    TRIM(tt-export.sobre-nome) + "," + TRIM(tt-export.nome)       FORMAT "x(40)"             ";"
    tt-export.nom_ender_rh                                        FORMAT "x(30)"             ";"
    string(integer(tt-export.num_ender_rh))  + "-" + tt-export.nom_bairro_rh FORMAT "x(30)"             ";"
    tt-export.nom_cidad_rh                                     /* FORMAT "x(25)"         */  ";"
    tt-export.cod_unid_federec_rh + "B"                        /* FORMAT "x(2)"          */  ";"
    tt-export.cod_cep_rh                                       /* FORMAT "x(12)"         */  ";"
    tt-export.cod_pais_ender                                   /* FORMAT "x(3)"          */  ";"
                                                               /* FORMAT "x(25)"         */  ";"
                                                               /* FORMAT "x(1)"          */  ";"
                                                               /* FORMAT "x(2)"          */  ";"
                                                               /* FORMAT "x(3)"          */  ";"
