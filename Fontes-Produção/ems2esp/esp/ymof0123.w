...
*******************************************************************************/
{include/i-prgvrs.i ymof0123 1.00.00.000}
...
DEFINE VARIABLE h_ymof0123-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_ymof0123-v01 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Gerais' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.25 , 2.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 10.50 , 79.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymof0123-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_ymof0123-q01 ).
       RUN set-position IN h_ymof0123-q01 ( 1.21 , 52.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/ymof0123-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ymof0123-v01 ).
       RUN set-position IN h_ymof0123-v01 ( 2.58 , 2.43 ) NO-ERROR.
       /* Size in UIB:  ( 1.33 , 77.14 ) */

       /* Links to SmartViewer h_ymof0123-v01. */
       RUN add-link IN adm-broker-hdl ( h_ymof0123-q01 , 'Record':U , h_ymof0123-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_ymof0123-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_ymof0123-v01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "YMOF0123" "1.00.00.000"}
