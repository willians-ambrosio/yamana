...
define variable c-prog-gerado as character no-undo initial "REL01CC".
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "CONTRATOS DE COMPRAS - VIGÒNCIA - REL01CC"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "REL01CC".
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    assign da-dt-ini-validade-ini:screen-value in frame f-pg-sel = string(01/01/0001)
           da-dt-ini-validade-fim:screen-value in frame f-pg-sel = string(12/31/9999).
    assign da-dt-ter-validade-ini:screen-value in frame f-pg-sel = string(01/01/0001)
           da-dt-ter-validade-fim:screen-value in frame f-pg-sel = string(12/31/9999).
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "REL01CC" + "." + v-cod-extens-arq.

    assign tt-param.da-dt-ini-validade-ini = input frame f-pg-sel da-dt-ini-validade-ini
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "dtv/REL01C3.p".
