...
{include/i-prgvrs.i esfp3020 2.10.00.000}
...
define temp-table tt-param no-undo
    ...
    FIELD i-estabel-i       AS INT  
    FIELD i-estabel-f       AS INT  
...
&Scoped-define FIELDS-IN-QUERY-br-digita tt-digita.cdn_event_fp tt-digita.des_event_fp tt-digita.cdn_beneficio tt-digita.des_beneficio   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-digita tt-digita.cdn_event_fp tt-digita.cdn_beneficio   
...
DEFINE VARIABLE i-ano-refer-f AS INTEGER FORMAT "9999":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE i-ano-refer-i AS INTEGER FORMAT "9999":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE i-estabel-f AS INTEGER FORMAT ">>>9":U INITIAL 9999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE i-estabel-i AS INTEGER FORMAT ">>>9":U INITIAL 0 
     LABEL "Estabelecimento" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE i-matricula-f AS INTEGER FORMAT ">>>>>>>>>9":U INITIAL 99999999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE i-matricula-i AS INTEGER FORMAT ">>>>>>>>>9":U INITIAL 0 
     LABEL "Matr°cula" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE i-mes-refer-f AS INTEGER FORMAT "99":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.

DEFINE VARIABLE i-mes-refer-i AS INTEGER FORMAT "99":U INITIAL 0 
     LABEL "Màs/Ano" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-digita w-relat _FREEFORM
  QUERY br-digita DISPLAY
      tt-digita.cdn_event_fp    label 'Evento'            format 'x(05)'
tt-digita.des_event_fp    label 'Desc. Evento'      format 'x(35)'
tt-digita.cdn_beneficio   label 'Benef°cio'         format '>>>9'
tt-digita.des_beneficio   label 'Desc. Benef°cio'   format 'x(35)'
ENABLE
tt-digita.cdn_event_fp 
tt-digita.cdn_beneficio
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME f-pg-sel
     fi-empresa-ini AT ROW 2.13 COL 26 COLON-ALIGNED WIDGET-ID 24
     fi-empresa-fim AT ROW 2.13 COL 42.72 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     i-estabel-i AT ROW 3.25 COL 19 COLON-ALIGNED
     i-estabel-f AT ROW 3.25 COL 42.72 COLON-ALIGNED NO-LABEL
     i-matricula-i AT ROW 4.33 COL 19 COLON-ALIGNED WIDGET-ID 4
     i-matricula-f AT ROW 4.33 COL 42.72 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     i-mes-refer-i AT ROW 5.46 COL 19 COLON-ALIGNED WIDGET-ID 18
     i-ano-refer-i AT ROW 5.46 COL 24 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     i-mes-refer-f AT ROW 5.46 COL 42.72 COLON-ALIGNED NO-LABEL WIDGET-ID 22
     i-ano-refer-f AT ROW 5.46 COL 47.86 COLON-ALIGNED NO-LABEL WIDGET-ID 20
     IMAGE-1 AT ROW 3.25 COL 37
     IMAGE-2 AT ROW 3.25 COL 41.14
     IMAGE-25 AT ROW 4.33 COL 37 WIDGET-ID 6
     IMAGE-26 AT ROW 4.33 COL 41.14 WIDGET-ID 8
     IMAGE-27 AT ROW 5.46 COL 37 WIDGET-ID 14
     IMAGE-28 AT ROW 5.46 COL 41.14 WIDGET-ID 16
     IMAGE-29 AT ROW 2.08 COL 36.86 WIDGET-ID 28
     IMAGE-30 AT ROW 2.08 COL 41 WIDGET-ID 30
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
DO:
    if  br-digita:new-row in frame f-pg-dig then do:
        ...
        display tt-digita.cdn_event_fp
                tt-digita.des_event_fp 
                tt-digita.cdn_beneficio
                tt-digita.des_beneficio
...
DO:
   ...
   if  br-digita:new-row in frame f-pg-dig then do:
       assign tt-digita.des_event_fp:screen-value in browse br-digita = string(today, "99/99/9999").
   end.
END.
...
DO:
   if br-digita:NEW-ROW in frame f-pg-dig then 
      do transaction on error undo, return no-apply:
          create tt-digita.
          assign input browse br-digita tt-digita.cdn_event_fp
                 input browse br-digita tt-digita.cdn_beneficio.

          find first event_fp no-lock 
               WHERE event_fp.cdn_event_fp = tt-digita.cdn_event_fp NO-ERROR.

          IF AVAIL event_fp THEN DO:
              ASSIGN tt-digita.des_event_fp = event_fp.des_event_fp.
          END.
          ELSE DO:
              ASSIGN tt-digita.des_event_fp = '0'.
          END.

          find first beneficio no-lock 
               WHERE beneficio.cdn_beneficio = tt-digita.cdn_beneficio NO-ERROR.

          IF AVAIL beneficio THEN DO:
              ASSIGN tt-digita.des_beneficio = beneficio.des_beneficio.
          END.
          ELSE DO:
              ASSIGN tt-digita.des_beneficio = '0'.
          END.
...
DO:
   apply 'entry':U to tt-digita.cdn_event_fp in browse br-digita. 
END.
...
{utp/ut9000.i "esfp3020" "2.10.00.000"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    on leave of tt-digita.cdn_event_fp in browse br-digita do:
        find first event_fp no-lock 
             WHERE event_fp.cdn_event_fp = tt-digita.cdn_event_fp:screen-value in browse br-digita NO-ERROR.

        IF AVAIL event_fp THEN DO:
            ASSIGN tt-digita.des_event_fp:screen-value in browse br-digita = event_fp.des_event_fp.
        END.
        ELSE DO:
            ASSIGN tt-digita.des_event_fp:screen-value in browse br-digita = 'N∆o encontrado'.
        END.

    end.

    on leave of tt-digita.cdn_beneficio in browse br-digita do:
        find first beneficio no-lock 
             WHERE beneficio.cdn_beneficio = INT(tt-digita.cdn_beneficio:screen-value in browse br-digita) NO-ERROR.

        IF AVAIL beneficio THEN DO:
            ASSIGN tt-digita.des_beneficio:screen-value in browse br-digita = beneficio.des_beneficio.
        END.
        ELSE DO:
            ASSIGN tt-digita.des_beneficio:screen-value in browse br-digita = 'N∆o encontrado'.
        END.
    end.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-empresa-ini fi-empresa-fim i-estabel-i i-estabel-f i-matricula-i 
          i-matricula-f i-mes-refer-i i-ano-refer-i i-mes-refer-f i-ano-refer-f 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-25 IMAGE-26 IMAGE-27 IMAGE-28 IMAGE-29 IMAGE-30 
         fi-empresa-ini fi-empresa-fim i-estabel-i i-estabel-f i-matricula-i 
         i-matricula-f i-mes-refer-i i-ano-refer-i i-mes-refer-f i-ano-refer-f 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  ENABLE rect-rtf RECT-7 RECT-9 bt-arquivo text-rtf text-modelo-rtf 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
...
define variable d-periodo-i as date no-undo.
define variable d-periodo-f as date no-undo.
DEFINE VARIABLE i-mes AS INT EXTENT 12 NO-UNDO 
...
do on error undo, return error on stop  undo, return error:
    ...
    for each tt-digita no-lock:
        ...
        find first b-tt-digita where b-tt-digita.cdn_event_fp = tt-digita.cdn_event_fp and 
        ...
        if tt-digita.cdn_event_fp <= '0' then do:
            assign browse br-digita:CURRENT-COLUMN = tt-digita.cdn_event_fp:HANDLE in browse br-digita.
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.i-estabel-i     = input frame f-pg-sel i-estabel-i  
           tt-param.i-estabel-f     = input frame f-pg-sel i-estabel-f  
           tt-param.i-matricula-i   = input frame f-pg-sel i-matricula-i
           tt-param.i-matricula-f   = input frame f-pg-sel i-matricula-f
           tt-param.i-ano-refer-i   = input frame f-pg-sel i-ano-refer-i
           tt-param.i-ano-refer-f   = input frame f-pg-sel i-ano-refer-f
           tt-param.i-mes-refer-i   = input frame f-pg-sel i-mes-refer-i
           tt-param.i-mes-refer-f   = input frame f-pg-sel i-mes-refer-f
           tt-param.cdn_empresa-ini = INPUT FRAME f-pg-sel fi-empresa-ini
           tt-param.cdn_empresa-fim = INPUT FRAME f-pg-sel fi-empresa-fim.
    ...
    {include/i-rprun.i esp/esfp3020rp.p}
