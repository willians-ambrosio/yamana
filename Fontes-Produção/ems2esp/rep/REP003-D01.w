...
/****************************************************************************************** 
**         Programa: rep003-d00.w
**            Autor: Vando Ribeiro
**       Fornecedor: DKP
**       Data: 05/11/2018
** Change/Chamado: REQ03
**    Objetivo: Informar o motivo da reprova‡Æo da atualiza‡Æo de docto.
**
...
** PAR¶METROS DE ENTRADA: p-cod-estabel,p-serie-docto,p-nro-docto,p-cod-emitente
...
&Scoped-Define ENABLED-OBJECTS rt-buttom RECT-25 c-cod-estabel c-nro-docto ~
c-cod-emitente c-serie-docto c-mot-reprov bt-ok bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c-cod-estabel c-nro-docto c-cod-emitente ~
c-serie-docto c-mot-reprov 
...
DEFINE FRAME D-Dialog
     c-cod-estabel AT ROW 1.5 COL 12 COLON-ALIGNED WIDGET-ID 6
     c-nro-docto AT ROW 1.5 COL 42 COLON-ALIGNED WIDGET-ID 8
     c-cod-emitente AT ROW 2.5 COL 12 COLON-ALIGNED WIDGET-ID 10
     c-serie-docto AT ROW 2.5 COL 42 COLON-ALIGNED WIDGET-ID 12
     c-mot-reprov AT ROW 5 COL 2 NO-LABEL WIDGET-ID 2
     bt-ok AT ROW 11.75 COL 3
     bt-cancela AT ROW 11.75 COL 14
     bt-ajuda AT ROW 11.75 COL 59
     "Motivo da Reprova‡Æo:" VIEW-AS TEXT
          SIZE 24 BY .67 AT ROW 4 COL 2 WIDGET-ID 4
     rt-buttom AT ROW 11.5 COL 2
     RECT-25 AT ROW 1 COL 1 WIDGET-ID 14
     SPACE(0.13) SKIP(9.53)
...
ASSIGN 
       c-nro-docto:READ-ONLY IN FRAME D-Dialog        = TRUE.

ASSIGN 
       c-serie-docto:READ-ONLY IN FRAME D-Dialog        = TRUE.
...
DO:
    ...
    DO:
        RUN utp/ut-msgs.p ("show",17006,"Motivo da Reaprova‡Æo Inv lido~~O motivo da reaprova‡Æo deve ser informado.").
...
------------------------------------------------------------------------------*/
  DISPLAY c-cod-estabel c-nro-docto c-cod-emitente c-serie-docto c-mot-reprov 
      WITH FRAME D-Dialog.
  ENABLE rt-buttom RECT-25 c-cod-estabel c-nro-docto c-cod-emitente 
         c-serie-docto c-mot-reprov bt-ok bt-cancela bt-ajuda 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "REP003-DO1" "Motivo Reprova‡Æo" "1.00.00.000"} 
  ...
  ASSIGN 
      ...
      c-nro-docto:SCREEN-VALUE    = p-nro-docto   
      c-serie-docto:SCREEN-VALUE  = p-serie-docto.
