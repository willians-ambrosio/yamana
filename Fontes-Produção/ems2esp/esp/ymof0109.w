...
DEFINE VARIABLE c-ben-fim AS INTEGER FORMAT ">>9":U INITIAL 999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE C-BEN-INI AS INTEGER FORMAT ">>9" INITIAL 0 
     LABEL "Beneficio" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE C-CFA-FIM AS CHARACTER FORMAT "X(4)":U INITIAL "ZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-cfa-ini AS CHARACTER FORMAT "X(4)":U 
     LABEL "CFA" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE c-estab-fim AS CHARACTER FORMAT "X(5)":U INITIAL "ZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE c-fam-fim AS CHARACTER FORMAT "X(8)":U INITIAL "ZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 9.29 BY .88 NO-UNDO.

DEFINE VARIABLE c-fam-ini AS CHARACTER FORMAT "x(8)" 
     LABEL "Fam°lia" 
     VIEW-AS FILL-IN 
     SIZE 10 BY .88 NO-UNDO.

DEFINE VARIABLE c-ge-fim AS INTEGER FORMAT ">9":U INITIAL 99 
     VIEW-AS FILL-IN 
     SIZE 5.43 BY .88 NO-UNDO.

DEFINE VARIABLE c-ge-ini AS INTEGER FORMAT ">9" INITIAL 0 
     LABEL "Grupo Estoque" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE c-ncm-fim AS CHARACTER FORMAT "9999.99.99":U INITIAL "999999999" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE C-NCM-INI AS CHARACTER FORMAT "9999.99.99" INITIAL "00000000" 
     LABEL "NCM" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     c-item-ini AT ROW 1.25 COL 15 COLON-ALIGNED
     c-item-fim AT ROW 1.29 COL 37.57 COLON-ALIGNED NO-LABEL WIDGET-ID 58
     c-fam-ini AT ROW 2.29 COL 15 COLON-ALIGNED HELP
          "Fam°lia de material a que pertence o item" WIDGET-ID 68
     c-fam-fim AT ROW 2.33 COL 37.72 COLON-ALIGNED NO-LABEL WIDGET-ID 66
     c-ge-ini AT ROW 3.29 COL 15 COLON-ALIGNED HELP
          "Grupo de estoque a que pertence o item" WIDGET-ID 80
     c-ge-fim AT ROW 3.33 COL 37.57 COLON-ALIGNED NO-LABEL WIDGET-ID 76
     c-estab-ini AT ROW 4.33 COL 15 COLON-ALIGNED WIDGET-ID 78
     c-estab-fim AT ROW 4.38 COL 37.72 COLON-ALIGNED NO-LABEL WIDGET-ID 74
     C-BEN-INI AT ROW 5.33 COL 15 COLON-ALIGNED WIDGET-ID 104
     c-ben-fim AT ROW 5.38 COL 37.57 COLON-ALIGNED NO-LABEL WIDGET-ID 96
     C-NCM-INI AT ROW 6.38 COL 15.14 COLON-ALIGNED WIDGET-ID 98
     c-ncm-fim AT ROW 6.42 COL 37.72 COLON-ALIGNED NO-LABEL WIDGET-ID 90
     c-cfa-ini AT ROW 7.38 COL 15 COLON-ALIGNED WIDGET-ID 102
     C-CFA-FIM AT ROW 7.42 COL 37.57 COLON-ALIGNED NO-LABEL WIDGET-ID 94
     IMAGE-1 AT ROW 1.25 COL 31.86
     IMAGE-3 AT ROW 1.25 COL 31.86 WIDGET-ID 6
     IMAGE-5 AT ROW 1.25 COL 31.86 WIDGET-ID 14
     IMAGE-7 AT ROW 1.25 COL 31.86 WIDGET-ID 22
     IMAGE-9 AT ROW 1.25 COL 31.86 WIDGET-ID 30
     IMAGE-11 AT ROW 1.25 COL 31.86 WIDGET-ID 40
     IMAGE-13 AT ROW 1.25 COL 31.86 WIDGET-ID 46
     IMAGE-15 AT ROW 1.25 COL 31.86 WIDGET-ID 54
     IMAGE-17 AT ROW 1.25 COL 31.86 WIDGET-ID 62
     IMAGE-18 AT ROW 1.25 COL 36 WIDGET-ID 64
     IMAGE-19 AT ROW 2.29 COL 32 WIDGET-ID 70
     IMAGE-20 AT ROW 2.29 COL 36 WIDGET-ID 72
     IMAGE-21 AT ROW 3.29 COL 31.86 WIDGET-ID 82
     IMAGE-22 AT ROW 3.29 COL 36 WIDGET-ID 84
     IMAGE-23 AT ROW 4.33 COL 32 WIDGET-ID 86
     IMAGE-24 AT ROW 4.33 COL 36 WIDGET-ID 88
     IMAGE-25 AT ROW 5.33 COL 31.86 WIDGET-ID 106
     IMAGE-26 AT ROW 5.33 COL 36 WIDGET-ID 108
     IMAGE-27 AT ROW 6.38 COL 32 WIDGET-ID 110
     IMAGE-28 AT ROW 6.38 COL 36 WIDGET-ID 112
     IMAGE-29 AT ROW 7.38 COL 31.86 WIDGET-ID 114
     IMAGE-30 AT ROW 7.38 COL 36 WIDGET-ID 116
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
{utp/ut9000.i "YMOF0109" "1.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-item-ini c-item-fim c-fam-ini c-fam-fim c-ge-ini c-ge-fim 
          c-estab-ini c-estab-fim C-BEN-INI c-ben-fim C-NCM-INI c-ncm-fim 
          c-cfa-ini C-CFA-FIM 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-3 IMAGE-5 IMAGE-7 IMAGE-9 IMAGE-11 IMAGE-13 IMAGE-15 
         IMAGE-17 IMAGE-18 IMAGE-19 IMAGE-20 IMAGE-21 IMAGE-22 IMAGE-23 
         IMAGE-24 IMAGE-25 IMAGE-26 IMAGE-27 IMAGE-28 IMAGE-29 IMAGE-30 
         c-item-ini c-item-fim c-fam-ini c-fam-fim c-ge-ini c-ge-fim 
         c-estab-ini c-estab-fim C-BEN-INI c-ben-fim C-NCM-INI c-ncm-fim 
         c-cfa-ini C-CFA-FIM 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.c-fam-ini       = INPUT FRAME f-pg-sel c-fam-ini
           tt-param.c-fam-fim       = INPUT FRAME f-pg-sel c-fam-fim
           tt-param.c-ge-ini        = INPUT FRAME f-pg-sel c-ge-ini
           tt-param.c-ge-fim        = INPUT FRAME f-pg-sel c-ge-fim
           tt-param.c-estab-ini     = INPUT FRAME f-pg-sel c-estab-ini
           tt-param.c-estab-fim     = INPUT FRAME f-pg-sel c-estab-fim
           tt-param.c-ben-ini       = INPUT FRAME f-pg-sel C-BEN-INI
           tt-param.c-ben-fim       = INPUT FRAME f-pg-sel C-BEN-fim
           tt-param.c-ncm-ini       = INPUT FRAME f-pg-sel C-NCM-INI
           tt-param.c-ncm-fim       = INPUT FRAME f-pg-sel C-NCM-fim
           tt-param.c-cfa-ini       = INPUT FRAME f-pg-sel c-cfa-ini
           tt-param.c-cfa-fim       = INPUT FRAME f-pg-sel c-cfa-fim
    ...
    {include/i-rprun.i esp/ymof0109rp.p}
