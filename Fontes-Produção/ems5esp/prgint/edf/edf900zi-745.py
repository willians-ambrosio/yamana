        ...
        if v_cod_segto = '' then do:
            ...
            then do:    
                ...
                assign  v_cod_det = caps(v_cod_det + 
                                         ...
                                         fill('0',15) +                                                 /* Valor do Abatimento 151 a 165 132 Num */                                                                                              
                                         fill('0',15) +                                                 /* Valor do Desconto 166 a 180 132 Num */                                                                                                
                                         fill('0',15) +                                                 /* Valor da Mora 181 a 195 132 Num */                                                                                                    
                                         fill('0',15) +                                                 /* Valor da Multa 196 a 210 132 Num */                                                                                                   
            ...
            then do:
                ...
                assign v_cod_det = caps('J'                                                  /* C¢digo de Segmento no Reg. Detalhe 14 a 14 1-Alfa'J' */                             
                                        ...
                                        + fill('0',15)                                       /* Valor do Desconto + Abatimento 115 a 129 - 13,2 Num */                              
                                        + fill('0',15)                                       /* Valor da Mora + Multa130144132Num */                                                
