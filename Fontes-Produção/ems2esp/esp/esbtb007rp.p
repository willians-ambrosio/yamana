/*****************************************************************************
**       Programa: esbtb007rp.p
**       Data....: 22/02/11
**       Autor...: Daniel P. de Lima
**       Objetivo: Exporta Especie p Ilha
*******************************************************************************/

define variable c-prog-gerado as character no-undo initial "ESBTB007RP".
...
assign c-programa     = "ESBTB007RP"
       c-versao       = "2.06"
       c-revisao      = ".00.000"
       c-titulo-relat = "Exporta Especie p Ilha"
       c-sistema      = "".
...
/* gr9020a.p */
    ...
    FIND FIRST es_espec_ap NO-LOCK NO-ERROR. 
    IF  AVAIL es_espec_ap THEN DO:
        RUN esp/esidelete.i 'es_espec_ap'.
    END.
...
PROCEDURE pi-executa :
    FOR EACH espec_docto NO-LOCK:
        CREATE es_espec_ap NO-ERROR.
        ASSIGN  es_espec_ap.cod_esp   = espec_docto.cod_espec_docto
                es_espec_ap.descricao = espec_docto.des_espec_docto.
...
if  tt-param.parametro then do:
   ...
   disp stream str-rp "   Exporta Especie p Ilha"
