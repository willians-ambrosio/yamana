...
&Scoped-define INTERNAL-TABLES es_operac_financ

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es_operac_financ NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es_operac_financ NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main es_operac_financ
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es_operac_financ
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.es_operac_financ"
