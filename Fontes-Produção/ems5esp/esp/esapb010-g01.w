...
es-cat-code-conta.cod_plano_cta_ctbl 
...
DEFINE FRAME d-vapara
     es-cat-code-conta.cod_cta_ctbl AT ROW 1.75 COL 21 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 21.14 BY .88
     es-cat-code-conta.cod_plano_cta_ctbl AT ROW 2.75 COL 21 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 15.14 BY .88
     bt-ok AT ROW 5.54 COL 2.14
     bt-cancela AT ROW 5.54 COL 13
     bt-ajuda AT ROW 5.54 COL 58
     rt-button AT ROW 5.29 COL 1
...
DO:
  find es-cat-code-conta no-lock 
      where es-cat-code-conta.cod_cta_ctbl = input frame {&frame-name} es-cat-code-conta.cod_cta_ctbl 
      AND   es-cat-code-conta.cod_plano_cta_ctbl = input frame {&frame-name} es-cat-code-conta.cod_plano_cta_ctbl 
      no-error.
  if  not avail es-cat-code-conta then do:
      {utp/ut-table.i ESTMA es-cat-code-conta 1}
      run utp/ut-msgs.p (input "show",
                         input 2,
                         input RETURN-VALUE).
      return no-apply.
  end.
  assign p-row-tabela = rowid(es-cat-code-conta).
END.
...
------------------------------------------------------------------------------*/
  IF AVAILABLE es-cat-code-conta THEN 
    DISPLAY es-cat-code-conta.cod_cta_ctbl es-cat-code-conta.cod_plano_cta_ctbl 
      WITH FRAME d-vapara.
  ENABLE rt-button es-cat-code-conta.cod_cta_ctbl 
         es-cat-code-conta.cod_plano_cta_ctbl bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
