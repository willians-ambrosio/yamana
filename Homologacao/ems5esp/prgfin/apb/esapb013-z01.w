...
*******************************************************************************/
{include/i-prgvrs.i ESAPB013-Z01 12.01.23.000}
...
DEFINE VARIABLE h_esapb013-b01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apb/esapb013-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esapb013-b01 ).
       RUN set-position IN h_esapb013-b01 ( 2.33 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.83 , 80.00 ) */

       /* Links to SmartBrowser h_esapb013-b01. */
       RUN add-link IN adm-broker-hdl ( h_esapb013-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esapb013-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESAPB013-Z01" "12.01.23.000"}
