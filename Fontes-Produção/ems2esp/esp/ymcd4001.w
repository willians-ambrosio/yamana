...
*******************************************************************************/
{include/i-prgvrs.i ymcd4001 "TOTVS"}
...
DEFINE VARIABLE l-obsoleta AS LOGICAL INITIAL no 
     LABEL "Obsoletar" 
     VIEW-AS TOGGLE-BOX
     SIZE 17.72 BY 1.08 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     l-obsoleta AT ROW 1.29 COL 3.29 WIDGET-ID 6
     ...
     text-entrada AT ROW 8.83 COL 4.14 NO-LABEL WIDGET-ID 10
     RECT-10 AT ROW 9.17 COL 2 WIDGET-ID 8
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
/* SETTINGS FOR FRAME f-import
   FRAME-NAME                                                           */
/* SETTINGS FOR IMAGE im-pg-par IN FRAME f-import
   NO-ENABLE                                                            */
ASSIGN 
       im-pg-par:HIDDEN IN FRAME f-import           = TRUE.
...
ASSIGN 
       bt-arquivo-entrada22:HIDDEN IN FRAME f-pg-par           = TRUE.

ASSIGN 
       c-arquivo-entrada:HIDDEN IN FRAME f-pg-par           = TRUE.

ASSIGN 
       l-param-1:HIDDEN IN FRAME f-pg-par           = TRUE.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-arquivo-entrada22 C-Win
ON CHOOSE OF bt-arquivo-entrada22 IN FRAME f-pg-par
DO:
    DEFINE VARIABLE l-aux AS LOGICAL     NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY l-obsoleta c-arquivo-entrada 
      WITH FRAME f-pg-sel IN WINDOW C-Win.
  ENABLE RECT-10 l-obsoleta c-arquivo-entrada bt-arquivo-entrada 
      WITH FRAME f-pg-sel IN WINDOW C-Win.
  ...
  ENABLE l-param-1 c-arquivo-entrada bt-arquivo-entrada22 
      WITH FRAME f-pg-par IN WINDOW C-Win.
...
do  on error undo, return error
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.l-obsoletar     = INPUT FRAME f-pg-sel l-obsoleta.
    ...
    {include/i-imrun.i esp/ymcd4001rp.p}
