...
*******************************************************************************/
{include/i-prgvrs.i YG0008B 12.1.17.000}
...
DEFINE VARIABLE h_yg0008b-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_yg0008b-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 4.25 COL 2.57 HELP
          "Salva e sai"
     bt-save AT ROW 4.25 COL 13 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 4.25 COL 23.57 HELP
          "Cancela"
     bt-ajuda AT ROW 4.25 COL 70.72
     rt-button AT ROW 4.08 COL 1.57
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 94.72 BY 17 WIDGET-ID 100.
...
ON END-ERROR OF w-cadsim /* Inclui/Modifica Turnos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Inclui/Modifica Turnos */
DO:
...
DO:
{include/salvafil.i h_yg0008b-v01}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prghur/esp/yg0008b-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_yg0008b-v01 ).
       RUN set-position IN h_yg0008b-v01 ( 1.13 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 2.75 , 80.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prghur/esp/yg0008b-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_yg0008b-q01 ).
       RUN set-position IN h_yg0008b-q01 ( 3.67 , 53.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_yg0008b-v01. */
       RUN add-link IN adm-broker-hdl ( h_yg0008b-q01 , 'Record':U , h_yg0008b-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'tableio':U , h_yg0008b-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_yg0008b-v01 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "YG0008B" "12.1.17.000"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_yg0008b-v01 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_yg0008b-q01 (input v-row-table).
