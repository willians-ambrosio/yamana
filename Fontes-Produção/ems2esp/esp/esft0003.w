...
*******************************************************************************/
{include/i-prgvrs.i ESFT0003 2.06.00.000}
...
DEFINE VARIABLE h_esft0003-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esft0003-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 89.72 BY 6.71 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Manuten‡Æo CFOP x Conta de Terceiros"
         HEIGHT             = 6.71
         WIDTH              = 89.72
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 90.86
...
ON END-ERROR OF w-cadsim /* Manuten‡Æo CFOP x Conta de Terceiros */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manuten‡Æo CFOP x Conta de Terceiros */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esft0003-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esft0003-v01 ).
       RUN set-position IN h_esft0003-v01 ( 2.83 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 4.75 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esft0003-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/esft0003-z01.w,
                     ProgVaPara = esp/esft0003-g01.w':U ,
             OUTPUT h_esft0003-q01 ).
       RUN set-position IN h_esft0003-q01 ( 1.00 , 63.29 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_esft0003-v01. */
       RUN add-link IN adm-broker-hdl ( h_esft0003-q01 , 'Record':U , h_esft0003-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esft0003-v01 ).

       /* Links to SmartQuery h_esft0003-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_esft0003-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esft0003-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esft0003-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esft0003-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESFT0003" "2.06.00.000"}
