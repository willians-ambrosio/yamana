...
*****************************************************************************/
{include/i-prgvrs.i esfnd001a 5.06.00.000}
...
DEFINE FRAME f-cad
     bt-ok AT ROW 3.25 COL 3 HELP
          "Salva e sai"
     bt-save AT ROW 3.25 COL 14.14 HELP
          "Salva e cria novo registro"
     bt-cancela AT ROW 3.25 COL 25.14 HELP
          "Cancela"
     bt-ajuda AT ROW 3.25 COL 78.14
     rt-button AT ROW 3.08 COL 2
...
DO:
{include/okpai.i h_esfnd001-v01}
END.
...
DO:
{include/salvapai.i h_esfnd001-v01}
 END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_esfnd001-v01 ( 1.50 , 1.57 ) NO-ERROR.
       ...
       RUN set-position IN h_esfnd001-q01 ( 3.00 , 64.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_esfnd001-v01 ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esfnd001a" "5.06.00.000"}
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_esfnd001-q01 (INPUT v-row-table). 
