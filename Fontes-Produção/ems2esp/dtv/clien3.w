...
define variable c-prog-gerado as character no-undo initial "CLIEN3".
...
def var c-titulo           as char init "Listagem de Clientes" no-undo.        
def var v-cod-prog-gerado  as char init "clien3" no-undo.           
...
assign v-cod-prog-gerado = "clien3".
