...
*******************************************************************************/
{include/i-prgvrs.i ymof0122 1.00.00.000}
...
DEFINE FRAME f-import
     ...
     im-pg-par AT ROW 1.5 COL 1.86
     im-pg-log AT ROW 1.5 COL 17.57
...
DEFINE FRAME f-pg-par
     c-arquivo-entrada AT ROW 5.29 COL 15.29 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     bt-arquivo-entrada AT ROW 5.29 COL 55.14 HELP
          "Escolha do nome do arquivo"
     text-entrada AT ROW 4.25 COL 16.14 NO-LABEL
     RECT-8 AT ROW 4.58 COL 14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
...
{utp/ut9000.i "ymof0122" "1.00.00.000"}
...
do  on error undo, return error
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.arquivo         = session:TEMP-DIRECTORY + OS-GETENV("username")  + "\"   + c-programa-mg97 + ".tmp":U.
    ...
    if  tt-param.destino = 2 then 
        ...
        assign tt-param.arq-destino = session:TEMP-DIRECTORY + OS-GETENV("username") + "\"   + c-programa-mg97 + ".tmp":U.
    ...
    {include/i-imrun.i esp/ymof0122rp.p}
