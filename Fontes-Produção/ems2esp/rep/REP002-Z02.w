...
******************************************************************************************/
{include/i-prgvrs.i REP002-Z02 1.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i REP002-Z02 REP}
&ENDIF
...
DEFINE FRAME f-zoom
     ...
     bt-ajuda AT ROW 16.5 COL 39.57
...
ON END-ERROR OF w-pesquisa /* Pesquisa de estabelecimentos */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de estabelecimentos */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Estabelecimentos' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.17 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 13.67 , 49.43 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'rep/REP002-B02.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b-table-customer-2 ).
       RUN set-position IN h_b-table-customer-2 ( 3.25 , 3.29 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 45.57 ) */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "REP002-Z02" "1.00.00.000"}
