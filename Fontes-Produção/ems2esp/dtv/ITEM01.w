...
define variable c-prog-gerado as character no-undo initial "ITEM01".
...
def var c-titulo           as char init "CATµLOGO DE ITENS" no-undo.        
def var v-cod-prog-gerado  as char init "ITEM01" no-undo.           
...
assign v-cod-prog-gerado = "ITEM01".
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK 
   ON END-KEY UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK:
        ...
        assign c-lista = "ITEM" + "," + 
                         ...
                         "ITEM" + "," + 
                         "ITEM" + "," + 
                         "Por Conta e Centro de Custo" + "," + 
                         "Por Conta e OM" + "," + 
                         "Por Conta e Centro de Custo" + "," + 
                         "Por Conta e Centro de Custo" + "," + 
                         "ITEM".

        assign c-prog = "ITEM01AA.w" + "," + 
                        "ITEM01AB.w" + "," + 
                        "ITEM01AC.w" + "," + 
                        "ITEM01AD.w" + "," + 
                        "ITEM01AA.w" + "," + 
