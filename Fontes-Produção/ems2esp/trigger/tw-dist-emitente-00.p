...
*******************************************************************************/
/*{include/i-prgvrs.i TW-DIST-EMITENTE-00 2.00.00.001} /*** 010001 ***/*/
/*******************************************************************************
**  Programa: <name>
**  Objetivo: <comment>
...
DEF PARAM BUFFER b-dist-emitente-old FOR dist-emitente.
...
for each bco_empres no-lock
   where bco_empres.cod_bco_dados = "ems2cademp"
    ...
    if  not can-find(first tt-erro-conexao) then do:
        ...
        run trigger/tw-dist-emitente-01.p(buffer b-dist-emitente).
    end.
