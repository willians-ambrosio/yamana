...
*******************************************************************************/
{include/i-prgvrs.i escd0007-Z01 2.06.00.000}
...
DEFINE VARIABLE h_escd0007-b01 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Programa' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'cdp/escd0007-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escd0007-b01 ).
       RUN set-position IN h_escd0007-b01 ( 2.71 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.75 , 85.00 ) */

       /* Links to SmartBrowser h_escd0007-b01. */
       RUN add-link IN adm-broker-hdl ( h_escd0007-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_escd0007-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "escd0007-Z01" "2.06.00.000"}
