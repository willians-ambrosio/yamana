...
*******************************************************************************/
{include/i-prgvrs.i YG0001 12.1.13.003}   /*** 010002 ***/
...
DEFINE VARIABLE c-est-fim AS CHARACTER FORMAT "x(5)" INITIAL "zzzzz" 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.

DEFINE VARIABLE c-est-ini AS CHARACTER FORMAT "x(5)" 
     LABEL "Estab" 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88 NO-UNDO.
...
DEFINE VARIABLE i-cod-especialidade-fim AS INTEGER FORMAT ">>>>9" INITIAL 99999 
     VIEW-AS FILL-IN 
     SIZE 6.86 BY .88.

DEFINE VARIABLE i-cod-especialidade-ini AS INTEGER FORMAT ">>>>9" INITIAL 0 
     LABEL "Especialidade" 
     VIEW-AS FILL-IN 
     SIZE 6.86 BY .88.

DEFINE VARIABLE i-cod-sub-espec-fim AS INTEGER FORMAT ">>>>9" INITIAL 99999 
     VIEW-AS FILL-IN 
     SIZE 6.86 BY .88.

DEFINE VARIABLE i-cod-sub-espec-ini AS INTEGER FORMAT ">>>>9" INITIAL 0 
...
DEFINE VARIABLE i-num-ord-magnus-fim AS INTEGER FORMAT ">>>>>,>>>" INITIAL 99999999 
     VIEW-AS FILL-IN 
     SIZE 11.43 BY .88.

DEFINE VARIABLE i-num-ord-magnus-ini AS INTEGER FORMAT ">>>>>,>>>" INITIAL 0 
     LABEL "OI" 
     VIEW-AS FILL-IN 
     SIZE 11.43 BY .88.
...
DEFINE FRAME f-pg-sel
     i-emp-ini AT ROW 1.67 COL 25.29 COLON-ALIGNED HELP
          ""
     i-emp-fim AT ROW 1.67 COL 49 COLON-ALIGNED HELP
          "" NO-LABEL
     c-est-ini AT ROW 2.67 COL 25.29 COLON-ALIGNED
     c-est-fim AT ROW 2.67 COL 49 COLON-ALIGNED NO-LABEL
     i-proj-ini AT ROW 3.67 COL 25.29 COLON-ALIGNED
     i-proj-fim AT ROW 3.67 COL 49 COLON-ALIGNED NO-LABEL
     i-ordem-ini AT ROW 4.67 COL 25.29 COLON-ALIGNED
     i-ordem-fim AT ROW 4.67 COL 49 COLON-ALIGNED NO-LABEL
     d-data-ini AT ROW 5.67 COL 25.29 COLON-ALIGNED
     d-data-fim AT ROW 5.67 COL 49 COLON-ALIGNED NO-LABEL
     i-num-ord-magnus-ini AT ROW 6.67 COL 25.43 COLON-ALIGNED HELP
          "N£mero da ordem relacionada com o sistema Magnus." WIDGET-ID 6
     i-num-ord-magnus-fim AT ROW 6.67 COL 49 COLON-ALIGNED HELP
          "N£mero da ordem relacionada com o sistema Magnus." NO-LABEL WIDGET-ID 32
     i-cod-especialidade-ini AT ROW 7.67 COL 25.43 COLON-ALIGNED HELP
          "C¢digo da especialidade." WIDGET-ID 2
     i-cod-especialidade-fim AT ROW 7.67 COL 49 COLON-ALIGNED HELP
          "C¢digo da especialidade." NO-LABEL WIDGET-ID 28
     i-cod-sub-espec-ini AT ROW 8.67 COL 25.43 COLON-ALIGNED HELP
          "C¢digo da subdivisÆo da especialidade." WIDGET-ID 4
     i-cod-sub-espec-fim AT ROW 8.67 COL 49 COLON-ALIGNED HELP
          "C¢digo da subdivisÆo da especialidade." NO-LABEL WIDGET-ID 30
     IMAGE-1 AT ROW 1.67 COL 38.57
     IMAGE-2 AT ROW 1.67 COL 48
     IMAGE-9 AT ROW 2.67 COL 38.57
     IMAGE-10 AT ROW 2.67 COL 48
     IMAGE-7 AT ROW 3.67 COL 38.57
     IMAGE-8 AT ROW 3.67 COL 48
     IMAGE-5 AT ROW 4.67 COL 38.57
     IMAGE-6 AT ROW 4.67 COL 48
     IMAGE-13 AT ROW 5.67 COL 38.57
     IMAGE-14 AT ROW 5.67 COL 48
     IMAGE-15 AT ROW 6.67 COL 38.57 WIDGET-ID 10
     IMAGE-16 AT ROW 6.67 COL 48 WIDGET-ID 12
     IMAGE-17 AT ROW 7.67 COL 38.57 WIDGET-ID 14
     IMAGE-18 AT ROW 7.67 COL 48 WIDGET-ID 16
     IMAGE-19 AT ROW 8.67 COL 38.57 WIDGET-ID 18
     IMAGE-20 AT ROW 8.67 COL 48 WIDGET-ID 20
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Listagem de Controle de Verba Gerencial"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
/* SETTINGS FOR FRAME f-pg-par
                                                                        */
/* SETTINGS FOR BUTTON bt-excel IN FRAME f-pg-par
   NO-ENABLE                                                            */
ASSIGN 
       bt-excel:HIDDEN IN FRAME f-pg-par           = TRUE.
...
ON END-ERROR OF w-relat /* Listagem de Controle de Verba Gerencial */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Listagem de Controle de Verba Gerencial */
DO:
...
DO:
    ...
    RUN esp/yg0001a.w (input-output l-log-gera-excel,
...
{utp/ut9000.i "YG0001" "12.1.13.003"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY i-emp-ini i-emp-fim c-est-ini c-est-fim i-proj-ini i-proj-fim 
          i-ordem-ini i-ordem-fim d-data-ini d-data-fim i-num-ord-magnus-ini 
          i-num-ord-magnus-fim i-cod-especialidade-ini i-cod-especialidade-fim 
          i-cod-sub-espec-ini i-cod-sub-espec-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-9 IMAGE-10 IMAGE-7 IMAGE-8 IMAGE-5 IMAGE-6 
         IMAGE-13 IMAGE-14 IMAGE-15 IMAGE-16 IMAGE-17 IMAGE-18 IMAGE-19 
         IMAGE-20 i-emp-ini i-emp-fim c-est-ini c-est-fim i-proj-ini i-proj-fim 
         i-ordem-ini i-ordem-fim d-data-ini d-data-fim i-num-ord-magnus-ini 
         i-num-ord-magnus-fim i-cod-especialidade-ini i-cod-especialidade-fim 
         i-cod-sub-espec-ini i-cod-sub-espec-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  ENABLE RECT-16 rs-moeda l-atualiza c-moeda 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.cod-divisao-ini        = 0      
           tt-param.cod-divisao-fim        = 999999999      
           tt-param.cod-especialidade-ini  = input frame f-pg-sel i-cod-especialidade-ini
           tt-param.cod-especialidade-fim  = input frame f-pg-sel i-cod-especialidade-fim
           tt-param.cod-sub-espec-ini      = input frame f-pg-sel i-cod-sub-espec-ini    
           tt-param.cod-sub-espec-fim      = input frame f-pg-sel i-cod-sub-espec-fim    
           tt-param.num-ord-magnus-ini     = input frame f-pg-sel i-num-ord-magnus-ini   
           tt-param.num-ord-magnus-fim     = input frame f-pg-sel i-num-ord-magnus-fim   
           tt-param.i-moeda-par     = input frame f-pg-par rs-moeda
           tt-param.atualiza        = input frame f-pg-par l-atualiza
           tt-param.log-gera-excel  = YES 
           tt-param.caminho-excel   = SESSION:TEMP-DIRECTORY + "yg0001_" + REPLACE(STRING(TODAY,'99/99/9999'),'/','') +  REPLACE(STRING(TIME,'hh:mm:ss'),':','') + ".csv".
    ...
    {include/i-rprun.i esp/yg0001rp.p}
