...
*******************************************************************************/
{include/i-prgvrs.i esau001 2.06.00.000}
...
DEFINE VARIABLE d-data-fim AS DATE FORMAT "99/99/9999" INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 12.57 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE d-data-ini AS DATE FORMAT "99/99/9999" INITIAL 01/01/001 
     LABEL "Data":R15 
     VIEW-AS FILL-IN 
     SIZE 12.57 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     d-data-ini AT ROW 4 COL 18.57 COLON-ALIGNED WIDGET-ID 6
     d-data-fim AT ROW 4 COL 47.57 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     c-it-codigo-ini AT ROW 5 COL 14 COLON-ALIGNED WIDGET-ID 8
     c-it-codigo-fim AT ROW 5 COL 47.57 COLON-ALIGNED NO-LABEL WIDGET-ID 34
     c-fm-codigo-ini AT ROW 6 COL 19 COLON-ALIGNED HELP
          "C¢digo da Fam¡lia de Material" WIDGET-ID 44
     c-fm-codigo-fim AT ROW 6 COL 47.57 COLON-ALIGNED HELP
          "C¢digo da Fam¡lia de Material" NO-LABEL WIDGET-ID 50
     IMAGE-7 AT ROW 4 COL 33.29 WIDGET-ID 20
     IMAGE-8 AT ROW 4 COL 46 WIDGET-ID 22
     IMAGE-9 AT ROW 5 COL 33.29 WIDGET-ID 24
     IMAGE-10 AT ROW 5 COL 46 WIDGET-ID 26
     IMAGE-13 AT ROW 6 COL 33.29 WIDGET-ID 48
     IMAGE-14 AT ROW 6 COL 46 WIDGET-ID 46
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
{utp/ut9000.i "esau001" "2.06.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY d-data-ini d-data-fim c-it-codigo-ini c-it-codigo-fim c-fm-codigo-ini 
          c-fm-codigo-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-7 IMAGE-8 IMAGE-9 IMAGE-10 IMAGE-13 IMAGE-14 d-data-ini 
         d-data-fim c-it-codigo-ini c-it-codigo-fim c-fm-codigo-ini 
         c-fm-codigo-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    IF INPUT FRAME f-pg-sel d-data-ini > INPUT FRAME f-pg-sel d-data-fim THEN     
    DO:
        MESSAGE "Intervalo de Datas inv lido, verifique!"
            VIEW-AS ALERT-BOX INFO BUTTONS OK.
        APPLY "MOUSE-SELECT-CLICK":U TO im-pg-sel in frame f-relat.
        APPLY "entry" TO d-data-ini IN FRAME f-pg-sel.
        RETURN ERROR.
    END.
    IF INPUT FRAME f-pg-sel c-it-codigo-ini > INPUT FRAME f-pg-sel c-it-codigo-fim THEN     
    DO:
        MESSAGE "Intervalo de Itens inv lido, verifique!"
            VIEW-AS ALERT-BOX INFO BUTTONS OK.
        APPLY "MOUSE-SELECT-CLICK":U TO im-pg-sel in frame f-relat.
        APPLY "entry" TO c-it-codigo-ini IN FRAME f-pg-sel.
        RETURN ERROR.
    END.
    IF INPUT FRAME f-pg-sel c-fm-codigo-ini > INPUT FRAME f-pg-sel c-fm-codigo-fim THEN             
    DO:
        MESSAGE "Intervalo de Familias inv lido, verifique!"
            VIEW-AS ALERT-BOX INFO BUTTONS OK.
        APPLY "MOUSE-SELECT-CLICK":U TO im-pg-sel in frame f-relat.
    ...
    {include/i-rprun.i esp/esau001rp.p}
