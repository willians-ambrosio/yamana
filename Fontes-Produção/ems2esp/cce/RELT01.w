...
define variable c-prog-gerado as character no-undo initial "RELT01".
...
def var c-titulo           as char init "PEDIDOS POR COMPRADOR - CT" no-undo.        
def var v-cod-prog-gerado  as char init "RELT01" no-undo.           
...
assign v-cod-prog-gerado = "RELT01".
