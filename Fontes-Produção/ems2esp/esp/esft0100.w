...
ON END-ERROR OF w-relat /* Integraá∆o TOTVS x MES */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Integraá∆o TOTVS x MES */
DO:
...
ON VALUE-CHANGED OF mesCorrente IN FRAME f-pg-sel /* Considerar màs atual */
DO:
