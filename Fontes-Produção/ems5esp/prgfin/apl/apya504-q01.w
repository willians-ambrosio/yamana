...
&Scoped-define INTERNAL-TABLES es_produt_financ

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es_produt_financ NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es_produt_financ NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es_produt_financ
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es_produt_financ
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems5_esp.es_produt_financ"
     _Options          = "NO-LOCK"
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pi-retorna-rowid q-tables 
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
DEFINE OUTPUT PARAMETER v_row_parent AS ROWID       NO-UNDO.

GET CURRENT Query-Main.

ASSIGN v_row_parent = ROWID(es_produt_financ).
