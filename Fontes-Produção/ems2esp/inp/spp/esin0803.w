...
def var c-prg-vrs as char init "[[[2.00.00.015[[[" no-undo.
def var c-prg-obj as char no-undo.
assign c-prg-vrs = "2.00.00.015"
       c-prg-obj = "ESIN0803".
...
if  c-arquivo-log <> "" and c-arquivo-log <> ? then do:
    find prog_dtsul
        where prog_dtsul.cod_prog_dtsul = "ESIN0803"
        no-lock no-error.
   ...
   if not avail prog_dtsul then do:
    ...
    /*Alteraá∆o - 08/09/2006 - tech1007 - Alteraá∆o para exibir o nome do programa que executou o programa que ser† exibido no extrato de vers∆o
        ...
        PUT "ESIN0803" AT 1 "2.00.00.015" AT 69 STRING(TODAY,'99/99/99') AT 84 STRING(TIME,'HH:MM:SS':U) AT 94 SKIP.
        /*FO 1329.898 - tech1139 - 01/08/2006 */
...
DEFINE VARIABLE c-imob AS CHARACTER FORMAT "X(30)":U INITIAL "1-Imobilizado" 
     LABEL "÷ndice Imobilizaá∆o" 
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEMS "1-Imobilizado","2-N∆o","3-Ambos" 
     DROP-DOWN-LIST
     SIZE 26.86 BY 1 NO-UNDO.

DEFINE VARIABLE c-moeda AS CHARACTER FORMAT "X(30)":U INITIAL "1-Principal" 
     LABEL "Moeda" 
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEMS "1-Principal","2-Alternativa 1","3-Alternativa 2" 
     DROP-DOWN-LIST
     SIZE 27 BY 1 NO-UNDO.

DEFINE VARIABLE c-nivel AS CHARACTER FORMAT "X(30)":U INITIAL "1-Ordem" 
     LABEL "Nivel de Apresent." 
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEMS "1-Projeto","2-Ordem","3-Seá∆o","4-Especialidade","5-Sub-especial","6-Origem","7-Material","8-Geral Pedido","9-Geral Detalhado" 
     DROP-DOWN-LIST
     SIZE 27 BY 1 NO-UNDO.

DEFINE VARIABLE c-mesano-base AS CHARACTER FORMAT "99/9999":U INITIAL "000000" 
     LABEL "Realizado màs" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE c-est-fim AS CHARACTER FORMAT "X(15)":U INITIAL "ZZZ" 
     VIEW-AS FILL-IN 
     SIZE 5.72 BY .88 NO-UNDO.

DEFINE VARIABLE c-est-ini AS CHARACTER FORMAT "X(15)":U 
     LABEL "Estab Exec" 
     VIEW-AS FILL-IN 
     SIZE 5.72 BY .88 NO-UNDO.
...
DEFINE VARIABLE i-pro-fim AS INTEGER FORMAT ">>>>9":U INITIAL 99999 
     VIEW-AS FILL-IN 
     SIZE 7.43 BY .88 NO-UNDO.

DEFINE VARIABLE i-pro-ini AS INTEGER FORMAT ">>>>9":U INITIAL 0 
     LABEL "Projeto" 
     VIEW-AS FILL-IN 
     SIZE 7.43 BY .88 NO-UNDO.
...
DEFINE VARIABLE i-sig-fim AS CHARACTER FORMAT "X(15)":U INITIAL "ZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE i-sig-ini AS CHARACTER FORMAT "X(15)":U 
     LABEL "Sigla" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-relat
     i-ori-ini AT ROW 9.58 COL 23 COLON-ALIGNED
          LABEL "Origem" FORMAT "9":U
          VIEW-AS FILL-IN 
          SIZE 2.86 BY .88
     i-ori-fim AT ROW 9.58 COL 45.14 COLON-ALIGNED NO-LABEL FORMAT "9":U
          VIEW-AS FILL-IN 
          SIZE 2.86 BY .88
     ...
     IMAGE-31 AT ROW 9.58 COL 40.57
     IMAGE-32 AT ROW 9.58 COL 44.14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 81 BY 15
...
DEFINE FRAME f-pg-par
     c-nivel AT ROW 1.75 COL 29.86 COLON-ALIGNED
     c-imob AT ROW 3.75 COL 29.86 COLON-ALIGNED
     c-moeda AT ROW 5.75 COL 29.86 COLON-ALIGNED
     c-mesano-base AT ROW 7.75 COL 29.86 COLON-ALIGNED
     l-DivMil AT ROW 9.79 COL 31.57
     RECT-17 AT ROW 1.38 COL 12
     RECT-18 AT ROW 3.38 COL 12
     RECT-19 AT ROW 5.38 COL 12
     RECT-30 AT ROW 7.38 COL 12
     RECT-31 AT ROW 9.38 COL 12.14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.43 ROW 3
         SIZE 76.57 BY 10.33.
...
DEFINE FRAME f-pg-sel
     i-emp-ini AT ROW 1.54 COL 23 COLON-ALIGNED
     i-emp-fim AT ROW 1.54 COL 45.14 COLON-ALIGNED NO-LABEL
     c-est-ini AT ROW 2.54 COL 23 COLON-ALIGNED
     c-est-fim AT ROW 2.54 COL 45.29 COLON-ALIGNED NO-LABEL
     i-pro-ini AT ROW 3.54 COL 23 COLON-ALIGNED
     i-pro-fim AT ROW 3.54 COL 45.29 COLON-ALIGNED NO-LABEL
     i-sig-ini AT ROW 4.54 COL 23 COLON-ALIGNED
     i-sig-fim AT ROW 4.54 COL 45.29 COLON-ALIGNED NO-LABEL
     i-ord-ini AT ROW 5.54 COL 23 COLON-ALIGNED
     i-ord-fim AT ROW 5.54 COL 45.29 COLON-ALIGNED NO-LABEL
     i-sec-ini AT ROW 6.54 COL 23 COLON-ALIGNED
     i-sec-fim AT ROW 6.54 COL 45.29 COLON-ALIGNED NO-LABEL
     i-esp-ini AT ROW 7.54 COL 23 COLON-ALIGNED
     i-esp-fim AT ROW 7.54 COL 45.29 COLON-ALIGNED NO-LABEL
     i-sub-ini AT ROW 8.54 COL 23 COLON-ALIGNED
     i-sub-fim AT ROW 8.54 COL 45.29 COLON-ALIGNED NO-LABEL
     i-ori-ini AT ROW 9.54 COL 23 COLON-ALIGNED
     i-ori-fim AT ROW 9.54 COL 45.14 COLON-ALIGNED NO-LABEL
     d-data-ini AT ROW 10.54 COL 23 COLON-ALIGNED
     d-data-fim AT ROW 10.54 COL 45.14 COLON-ALIGNED NO-LABEL
     IMAGE-1 AT ROW 2.54 COL 40.43
     IMAGE-13 AT ROW 3.54 COL 40.57
     IMAGE-14 AT ROW 4.54 COL 44.14
     IMAGE-15 AT ROW 3.54 COL 44.14
     IMAGE-17 AT ROW 4.54 COL 40.57
     IMAGE-18 AT ROW 5.54 COL 40.57
     IMAGE-2 AT ROW 2.54 COL 44.14
     IMAGE-20 AT ROW 5.54 COL 44.14
     IMAGE-21 AT ROW 6.54 COL 44.14
     IMAGE-22 AT ROW 6.54 COL 40.57
     IMAGE-23 AT ROW 7.54 COL 40.57
     IMAGE-24 AT ROW 7.54 COL 44.14
     IMAGE-25 AT ROW 8.54 COL 44.14
     IMAGE-26 AT ROW 8.54 COL 40.57
     IMAGE-27 AT ROW 1.54 COL 40.57
     IMAGE-28 AT ROW 1.54 COL 44.14
     IMAGE-29 AT ROW 9.54 COL 40.57
     IMAGE-30 AT ROW 9.54 COL 44.14
     IMAGE-33 AT ROW 10.54 COL 40.57
     IMAGE-34 AT ROW 10.54 COL 44.14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = " Posicionamento Economico"
         HEIGHT             = 15
         WIDTH              = 81
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF C-Win /*  Posicionamento Economico */
...
ON WINDOW-CLOSE OF C-Win /*  Posicionamento Economico */
DO:
...
ON LEAVE OF c-mesano-base IN FRAME f-pg-par /* Realizado màs */
DO:

  define variable i-mes-base as integer.
  define variable i-ano-base as integer.

  if not ( substring(input frame f-pg-par c-mesano-base, 1, 2) <> ''
       and substring(input frame f-pg-par c-mesano-base, 3, 4) <> '' ) then do:
     apply 'entry' to self.
     return no-apply.
  end.

  assign i-mes-base = integer(substring(input frame f-pg-par c-mesano-base, 1, 2))
         i-ano-base = integer(substring(input frame f-pg-par c-mesano-base, 3, 4)).

  if not ( i-ano-base > 0 and i-ano-base <= 9999 ) then do:
     apply 'entry' to self.
     return no-apply.
  end.

  if not ( i-mes-base >= 1 and i-mes-base <= 12 ) then do:
     apply 'entry' to self.
     return no-apply.
  end.
...
ON U1 OF c-mesano-base IN FRAME f-pg-par /* Realizado màs */
DO:

  assign c-mesano-base:screen-value in frame f-pg-par = string(month(today), '99')
...
def var c_nom_razao_social as char no-undo.
    ...
    assign c-programa-mg97 = caps("ESIN0803")
           c-versao-mg97   = "2.00.00.015".
...
/* ut-liter.i */                    
    ...
    assign c-nivel:list-items in frame f-pg-par = c-lista-nivel
           c-nivel:screen-value in frame f-pg-par = entry(9,c-lista-nivel).
...
/* ut-liter.i */                    
    ...
    assign c-imob:list-items in frame f-pg-par = c-lista-imob
           c-imob:screen-value in frame f-pg-par = entry(3,c-lista-imob).
...
/* ut-liter.i */                    
    ...
    assign c-moeda:list-items in frame f-pg-par = c-lista-moeda
           c-moeda = entry(1,c-lista-moeda)
           c-moeda:screen-value in frame f-pg-par = entry(1,c-lista-moeda).
...
------------------------------------------------------------------------------*/
  DISPLAY i-ori-ini i-ori-fim 
      WITH FRAME f-relat IN WINDOW C-Win.
  ENABLE im-pg-imp im-pg-par im-pg-sel IMAGE-31 IMAGE-32 i-ori-ini i-ori-fim 
         bt-executar bt-cancelar bt-ajuda 
      WITH FRAME f-relat IN WINDOW C-Win.
  
  DISPLAY i-emp-ini i-emp-fim c-est-ini c-est-fim i-pro-ini i-pro-fim i-sig-ini 
          i-sig-fim i-ord-ini i-ord-fim i-sec-ini i-sec-fim i-esp-ini i-esp-fim 
          i-sub-ini i-sub-fim i-ori-ini i-ori-fim d-data-ini d-data-fim 
      WITH FRAME f-pg-sel IN WINDOW C-Win.
  ENABLE IMAGE-1 IMAGE-13 IMAGE-14 IMAGE-15 IMAGE-17 IMAGE-18 IMAGE-2 IMAGE-20 
         IMAGE-21 IMAGE-22 IMAGE-23 IMAGE-24 IMAGE-25 IMAGE-26 IMAGE-27 
         IMAGE-28 IMAGE-29 IMAGE-30 IMAGE-33 IMAGE-34 i-emp-ini i-emp-fim 
         c-est-ini c-est-fim i-pro-ini i-pro-fim i-sig-ini i-sig-fim i-ord-ini 
         i-ord-fim i-sec-ini i-sec-fim i-esp-ini i-esp-fim i-sub-ini i-sub-fim 
         i-ori-ini i-ori-fim d-data-ini d-data-fim 
      WITH FRAME f-pg-sel IN WINDOW C-Win.
  ...
  DISPLAY c-nivel c-imob c-moeda c-mesano-base l-DivMil 
      WITH FRAME f-pg-par IN WINDOW C-Win.
  ENABLE RECT-17 RECT-18 RECT-19 RECT-30 RECT-31 c-nivel c-imob c-moeda 
         c-mesano-base l-DivMil 
      WITH FRAME f-pg-par IN WINDOW C-Win.
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
     apply 'U1' to c-mesano-base in frame f-pg-par.
...
/* i-rpexa */
    ...
    create tt-param.
    assign tt-param.i-emp-ini    = input frame f-pg-sel i-emp-ini
           tt-param.i-emp-fim    = input frame f-pg-sel i-emp-fim
           tt-param.c-est-ini    = input frame f-pg-sel c-est-ini
           tt-param.c-est-fim    = input frame f-pg-sel c-est-fim
           tt-param.i-pro-ini    = input frame f-pg-sel i-pro-ini
           tt-param.i-pro-fim    = input frame f-pg-sel i-pro-fim
           tt-param.i-sig-ini    = input frame f-pg-sel i-sig-ini
           tt-param.i-sig-fim    = input frame f-pg-sel i-sig-fim
           ...
           tt-param.i-mes        = integer(substring(input frame f-pg-par c-mesano-base, 1, 2))
           tt-param.i-ano        = integer(substring(input frame f-pg-par c-mesano-base, 3, 4))
    ...
    do  i = 1 to 9: 
        if  entry(i,c-lista-nivel) = input frame f-pg-par c-nivel then
            assign tt-param.i-nivel = i.
    end.
    do  i = 1 to 3:
        if  entry(i,c-lista-imob) = input frame f-pg-par c-imob then
            assign tt-param.i-imob = i.
    end.
    do  i = 1 to 3:
        if  entry(i,c-lista-moeda) = input frame f-pg-par c-moeda then
            assign tt-param.i-moeda = i.
    end.
    
    find first base-mensal no-lock no-error.
    if  avail base-mensal then
        assign tt-param.da-data-base = base-mensal.dt-atualizacao.
    ...
    /* Coloque aqui a l¢gica de gravaá∆o dos parametros e seleá∆o na temp-table tt-param */ 
...
if rs-execucao:screen-value in frame f-pg-imp = "2" then do:
  ...
  run inp/spp/esin0803rp.p (input raw-param,
           input table tt-raw-digita).
end.
