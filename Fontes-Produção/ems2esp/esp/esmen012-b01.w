...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      fco-descricao() @ vc-descricao COLUMN-LABEL "Descri‡Æo" FORMAT "x(30)":U
      fco-nom-ext() @ vc-nom-ext COLUMN-LABEL "Nome Externo" FORMAT "x(30)":U
      ctrl-conflito-it.cod_prog_dtsul FORMAT "x(100)":U
      ctrl-conflito-it.observacao COLUMN-LABEL "Observa‡Æo" FORMAT "x(60)":U
...
"fco-descricao() @ vc-descricao" "Descri‡Æo" "x(30)" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"ctrl-conflito-it.observacao" "Observa‡Æo" "x(60)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
