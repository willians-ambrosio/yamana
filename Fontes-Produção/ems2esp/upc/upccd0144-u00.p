/* =========================================================================== 
   PROGRAMA      : UPCCD0144-U00.P
   DATA          : JUNHO/2010
   DESENVOLVEDOR : Augusto Guimar∆es (Kraft Consulting)
   VERSAO        : 1.00
   OBJETIVO      :  
   =========================================================================== */
{include/i-prgvrs.i upccd0144-u00 2.06.00.000} 
...
DO:
/*     RUN upc/upccd0144-u01.p  (INPUT p-ind-event,  */
/*                               INPUT p-ind-object, */
/*                               INPUT p-wgh-object, */
/*                               INPUT p-wgh-frame,  */
/*                               INPUT p-cod-table,  */
/*                               INPUT p-row-table). */
    ...
    RUN upc/upccd0144-u02.p  (INPUT p-ind-event,
                              INPUT p-ind-object,
                              INPUT p-wgh-object,
                              INPUT p-wgh-frame,
                              INPUT p-cod-table,
