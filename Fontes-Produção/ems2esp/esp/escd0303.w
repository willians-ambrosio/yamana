...
DEFINE FRAME f-pg-par
     ...
     "Atualiza‡Æo Regras CST" VIEW-AS TEXT
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Atualiza‡äes Cadastrais CST de PIS e COFINS"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.08
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF C-Win /* Atualiza‡äes Cadastrais CST de PIS e COFINS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Atualiza‡äes Cadastrais CST de PIS e COFINS */
DO:
