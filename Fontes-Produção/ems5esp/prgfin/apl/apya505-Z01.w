...
/****************************************************************************************** 
**         Programa: apya505-Z01.w
**            Autor: Felipe Vieira
**       Fornecedor: DKP
**       Data: 31/10/2018
** Change/Chamado: ------
**    Objetivo: Zoom da tabela Cota‡Æo de dolar para intercompany (contrato_cotac)
**
...
DEFINE VARIABLE h_apya505-b01 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Moeda' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.17 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 13.67 , 38.43 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apl/apya505-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_apya505-b01 ).
       RUN set-position IN h_apya505-b01 ( 3.13 , 6.57 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 27.00 ) */

       /* Links to SmartBrowser h_apya505-b01. */
       RUN add-link IN adm-broker-hdl ( h_apya505-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_apya505-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "apya505-z01" "Zoom de cota‡Æo de dolar para intercompany"}
