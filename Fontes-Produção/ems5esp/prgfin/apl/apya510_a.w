...
DEFINE FRAME FRAME-A
     ...
     cod_operac_financ_ini AT ROW 4.67 COL 34.43 RIGHT-ALIGNED HELP
          "C¢digo da Operaá∆o Financeira" WIDGET-ID 20
          LABEL "Operaá∆o Financeira" FORMAT "x(10)"
          VIEW-AS FILL-IN 
          SIZE 14.14 BY .88
     cod_operac_financ_fim AT ROW 4.67 COL 44 COLON-ALIGNED HELP
          "C¢digo da Operaá∆o Financeira" NO-LABEL WIDGET-ID 30 FORMAT "x(10)"
          VIEW-AS FILL-IN 
          SIZE 14.14 BY .88
     data_movimento_ini AT ROW 5.67 COL 34.43 RIGHT-ALIGNED WIDGET-ID 22
          LABEL "Data Movimentaá∆o" FORMAT "99/99/9999":U
          VIEW-AS FILL-IN 
          SIZE 14 BY .88
...
DEFINE FRAME f-pg-sel
     ...
     cod_operac_financ_ini AT ROW 4.67 COL 34.43 RIGHT-ALIGNED HELP
          "C¢digo da Operaá∆o Financeira" WIDGET-ID 20
     cod_operac_financ_fim AT ROW 4.67 COL 44 COLON-ALIGNED HELP
          "C¢digo da Operaá∆o Financeira" NO-LABEL WIDGET-ID 30
     data_movimento_ini AT ROW 5.67 COL 34.43 RIGHT-ALIGNED WIDGET-ID 22
