...
*******************************************************************************/
{include/i-prgvrs.i esin0519 2.00.00.002}  /*** 010002 ***/
...
DEFINE VARIABLE c-arquivo-2 AS CHARACTER INITIAL "D:/TEMP/julia/esin004.TXT" 
     VIEW-AS EDITOR MAX-CHARS 256
     SIZE 44 BY .88
     BGCOLOR 15  NO-UNDO.
...
ON END-ERROR OF w-relat /* <Monthly Commited Values> */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* <Monthly Commited Values> */
DO:
...
{utp/ut9000.i "esin004" "2.00.00.002"}
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i esp/esin004rp.p}
