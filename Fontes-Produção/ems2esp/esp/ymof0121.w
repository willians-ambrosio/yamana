...
*******************************************************************************/
{include/i-prgvrs.i YMOF0121 1.00.00.000}
...
DEFINE FRAME f-pg-par
     bt-arquivo-entrada AT ROW 5 COL 55.14 HELP
          "Escolha do nome do arquivo"
     c-arquivo-entrada AT ROW 5.04 COL 15.29 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     text-entrada AT ROW 4 COL 16.14 NO-LABEL
     RECT-8 AT ROW 4.33 COL 14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
...
DO:
    {include/i-imarq.i c-arquivo-entrada f-pg-par "'*.XLXS' '*.xl*','TODOS' '*.*'  " }
END.
...
{utp/ut9000.i "YMOF0121" "1.00.00.000"}
...
do  on error undo, return error
    ...
    {include/i-imrun.i esp/ymof0121rp.p}
