...
{include/i-prgvrs.i ESCE0001RP 12.1.13.000}
          ...
          FOR EACH saldo-estoq NO-LOCK
             ...
             IF NOT AVAIL tt_it-requisicao THEN DO:
                ...
                ASSIGN tt_it-requisicao.nr-requisicao  = requisicao.nr-requisicao
                       ...
                       tt_it-requisicao.preco-unit     = it-requisicao.val-item
...
PROCEDURE Mostra_Item:
   ...
   /* ini bisneto */
   FOR EACH tt-cabec: DELETE tt-cabec. END.
   CREATE tt-cabec.
   ASSIGN 
     tt-cabec.nr-requisicao = tt_requisicao.nr-requisicao
     tt-cabec.dt-requisicao = tt_requisicao.dt-requisicao
     tt-cabec.estado        = tt_requisicao.estado     
     tt-cabec.loc-entrega   = tt_requisicao.loc-entrega
     tt-cabec.nome-abrev    = tt_requisicao.nome-abrev  
     tt-cabec.nome-usuar    = tt_requisicao.nome-usuar.
   /* fim bisneto */
   ...
   FOR EACH tt_it-requisicao NO-LOCK
      ...
      IF FIRST-OF(tt_it-requisicao.it-codigo) THEN DO:
          ...
          ASSIGN 
            tt-corpo.sequencia      = tt_it-requisicao.sequencia         
            tt-corpo.it-codigo      = tt_it-requisicao.it-codigo         
            tt-corpo.un             = tt_it-requisicao.un                
            tt-corpo.qt-a-atender   = tt_it-requisicao.qt-a-atender      
            tt-corpo.preco-unit     = tt_it-requisicao.preco-unit        
            tt-corpo.dt-entrega     = tt_it-requisicao.dt-entrega        
            tt-corpo.descricao      = tt_it-requisicao.descricao         
            tt-corpo.conta-contabil = tt_it-requisicao.conta-contabil.   
...
/*          PUT "TOTAL............." AT 6 de-qt-a-atender TO 39 SKIP. */
      ...
      ASSIGN
        tt-corpo.conta-contabil = tt_it-requisicao.conta-contabil
        tt-corpo.cod-depos      = tt_it-requisicao.cod-depos     
        tt-corpo.cod-localiz    = tt_it-requisicao.cod-localiz   
        tt-corpo.qtidade-atu    = tt_it-requisicao.qtidade-atu.
   ...
   RUN cep\esce0001a.p(INPUT TABLE tt-cabec, INPUT TABLE tt-corpo).
      
   EMPTY TEMP-TABLE tt-cabec.
   EMPTY TEMP-TABLE tt-corpo.
