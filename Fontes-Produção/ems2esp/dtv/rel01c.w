...
define variable c-prog-gerado as character no-undo initial "REL01C".
...
def var c-titulo           as char init "CONTRATOS DE COMPRAS - VIGÒNCIA" no-undo.        
def var v-cod-prog-gerado  as char init "REL01C" no-undo.           
...
assign v-cod-prog-gerado = "REL01C".
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK 
   ON END-KEY UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK:
        ...
        assign c-lista = "CONTRATOS DE COMPRAS - VIGÒNCIA".

        assign c-prog = "REL01CC.w".
