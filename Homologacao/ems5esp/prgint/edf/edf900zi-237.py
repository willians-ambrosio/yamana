...
def var v_tot_vl_corr_monet    as dec  no-undo.
        ...
        if v_cod_segto = '' then do:
            ...
            then do:
                ...
                if avail tt_param_program_formul then
                 ...
                 /* =-=-=-=-=-=- Begins 13/05/2019 - Willians Ambrosio - Grupo DKP - Valor Nominal, Valor Total Pago =-=-=-=-=-=-=-=-=-*/  
                 assign v_val_titulo_aux = v_val_titulo.
                 ...
                 if avail tt_param_program_formul then
                 do:   
                      if entry(3,tt_param_program_formul.ttv_des_contdo,';') = "N" /*l_n*/ then 
                      do:
                          find first item_bord_ap no-lock
                          ...
                          if avail item_bord_ap then do:
                             assign v_val_titulo_aux = item_bord_ap.val_pagto.
                          end.   
                      end.
                      else 
                      do:
                 ...
                 if avail item_bord_ap then
                    assign v_val_titulo_aux = item_bord_ap.val_pagto.
                 /* =-=-=-=-=-=- End  13/05/2019 Valor Nominal, Valor Total Pago =-=-=-=-=-=-=-=-=-*/  
                ...
                assign  v_cod_det = caps(v_cod_det + 
                                         ...
                                         string(v_val_titulo_aux,'999999999999999') +                       /* Valor do Documento (Nominal) 136 a 150 132 Num */                                                                                     
    ...
    CASE v_cdn_forma_pagto:
        ...
        DO:
            ASSIGN v_inf_compl_trib = string(v_cod_receita,"X(06)")                 + /* "Codigo da Receita do Tributo          " */ 
                                      ...
                                      string(v_tot_vl_corr_monet,"999999999999999") + /* Atualiza‡Æo Monetÿria                  " */
...
PROCEDURE pi_processa_padrao:
    ...
    */
    ...
    if avail tt_param_program_formul then
    assign v_dec_aux            = dec(tt_param_program_formul.ttv_des_contdo)
           v_tot_vl_corr_monet  = v_tot_vl_corr_monet + v_dec_aux     
