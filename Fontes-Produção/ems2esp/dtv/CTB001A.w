...
/*------------------------------------------------------------------------
File.............: CTB001A.w
Description......: Recebimento Nota Fiscal OK
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 30/06/09 - 17:40 - 20100079
OBS..............: Este fonte foi gerado pelo Data Viewer
------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "CTB001A".
...
def new shared var c-cod-estabel-ini like docum-est.cod-estabel format "x(3)" initial "" no-undo.
def new shared var c-cod-estabel-fim like docum-est.cod-estabel format "x(3)" initial "ZZZ" no-undo.
...
DEFINE FRAME f-pg-sel
   ...
   da-dt-emissao-ini label "Data EmissÆo"
   ...
   IMAGE-7 AT ROW 04.00 COL 40
   IMAGE-8 AT ROW 04.00 COL 45
   IMAGE-9 AT ROW 05.00 COL 40
   IMAGE-10 AT ROW 05.00 COL 45
   IMAGE-11 AT ROW 06.00 COL 40
   IMAGE-12 AT ROW 06.00 COL 45
   WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY
   SIDE-LABELS NO-UNDERLINE THREE-D
   AT COL 3 ROW 2.85
   SIZE 76.86 BY 10.62.
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Recebimento Nota Fiscal OK - CTB001A"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "CTB001A".
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "CTB001A" + "." + v-cod-extens-arq.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "dtv/CTB0011.p".
