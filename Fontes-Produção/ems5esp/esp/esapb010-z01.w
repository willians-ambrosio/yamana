...
DEFINE VARIABLE h_esapb010-b01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-implantar AT ROW 16.88 COL 1.72
     bt-ok AT ROW 18.38 COL 3
     bt-cancela AT ROW 18.38 COL 14
     bt-ajuda AT ROW 18.38 COL 79
     rt-button AT ROW 18.13 COL 2
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Conta Cat Cod' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapb010-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esapb010-b01 ).
       RUN set-position IN h_esapb010-b01 ( 2.25 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 13.75 , 84.57 ) */

       /* Links to SmartBrowser h_esapb010-b01. */
       RUN add-link IN adm-broker-hdl ( h_esapb010-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esapb010-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
