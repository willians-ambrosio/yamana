...
*******************************************************************************/
{include/i-prgvrs.i esau0001 0.12.00.001}
...
&Scoped-define FIELDS-IN-QUERY-br-digita tt-digita.selec tt-digita.campo-1 tt-digita.campo-2   
...
&Scoped-Define ENABLED-OBJECTS br-digita RECT-15 IMAGE-15 IMAGE-16 ~
fl-usu-ini fl-usu-fim bt-inserir bt-recuperar 
&Scoped-Define DISPLAYED-OBJECTS fl-usu-ini fl-usu-fim 
...
DEFINE VARIABLE fl-usu-fim AS CHARACTER FORMAT "X(40)":U INITIAL "ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 18.72 BY .79 NO-UNDO.

DEFINE VARIABLE fl-usu-ini AS CHARACTER FORMAT "X(40)":U 
     LABEL "Usu†rio" 
     VIEW-AS FILL-IN 
     SIZE 18.72 BY .79 NO-UNDO.
...
DEFINE VARIABLE l-super AS LOGICAL INITIAL yes 
     LABEL "Apenas usuarios do tipo SUPER" 
     VIEW-AS TOGGLE-BOX
     SIZE 33.14 BY .83 NO-UNDO.
...
DEFINE VARIABLE dat-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 17 BY .88 NO-UNDO.

DEFINE VARIABLE dat-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/001 
     LABEL "Data" 
     VIEW-AS FILL-IN 
     SIZE 17 BY .88 NO-UNDO.
...
DEFINE VARIABLE rd-browse-tipo AS INTEGER 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Usu†rios", 1,
"Tabelas", 2
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-digita w-relat _FREEFORM
  QUERY br-digita DISPLAY
      tt-digita.selec 
tt-digita.campo-1
tt-digita.campo-2 WIDTH 47
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH SEPARATORS SIZE 76.57 BY 7.92
         BGCOLOR 15 FONT 1.
...
DEFINE FRAME f-relat
     ...
     bt-ajuda AT ROW 14.54 COL 70 HELP
          "Ajuda"
     rd-browse-tipo AT ROW 14.63 COL 28 NO-LABEL WIDGET-ID 2
...
DEFINE FRAME f-pg-dig
     ...
     fl-usu-ini AT ROW 9.04 COL 9 COLON-ALIGNED WIDGET-ID 4
     fl-usu-fim AT ROW 9.04 COL 47.43 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     bt-inserir AT ROW 10.17 COL 1.72
     bt-alterar AT ROW 10.17 COL 16.72
     bt-retirar AT ROW 10.17 COL 31.72
     bt-salvar AT ROW 10.17 COL 46.72
     bt-recuperar AT ROW 10.17 COL 61.72
     RECT-15 AT ROW 9.96 COL 1 WIDGET-ID 2
     IMAGE-15 AT ROW 9.04 COL 30.43 WIDGET-ID 6
     IMAGE-16 AT ROW 9.04 COL 45.86 WIDGET-ID 8
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.88
         SIZE 76.86 BY 10.83
...
DEFINE FRAME f-pg-sel
     dat-ini AT ROW 2 COL 16.57 COLON-ALIGNED WIDGET-ID 4
     dat-fim AT ROW 2 COL 46 COLON-ALIGNED NO-LABEL WIDGET-ID 2
...
DEFINE FRAME f-pg-par
     ...
     l-super AT ROW 5.83 COL 7.86 WIDGET-ID 16
     "Usuarios:" VIEW-AS TEXT
          SIZE 6.72 BY .67 AT ROW 4.83 COL 7.29 WIDGET-ID 14
     "Eventos:" VIEW-AS TEXT
          SIZE 6.72 BY .67 AT ROW 2.17 COL 7.29 WIDGET-ID 10
     RECT-10 AT ROW 2.5 COL 5.57 WIDGET-ID 8
     RECT-11 AT ROW 5.17 COL 5.57 WIDGET-ID 12
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 75 BY 10
...
/* SETTINGS FOR FRAME f-relat
                                                                        */
ASSIGN 
       rd-browse-tipo:HIDDEN IN FRAME f-relat           = TRUE.
...
/*    apply 'entry':U to tt-digita.ordem in browse br-digita. */
  IF AVAIL tt-digita THEN
    ASSIGN 
      ...
      tt-digita.selec = NO.
  APPLY "VALUE-CHANGED" TO rd-browse-tipo IN FRAME f-relat.
END.
...
/*     {include/i-rprcd.i} */
  OPEN QUERY br-digita 
    FOR EACH tt-digita
    WHERE tt-digita.tipo       =  INPUT FRAME f-relat  rd-browse-tipo
    AND   tt-digita.campo-1    >= INPUT FRAME f-pg-dig fl-usu-ini   
    AND   tt-digita.campo-1    <= INPUT FRAME f-pg-dig fl-usu-fim.
  FIND FIRST b-tt-digita
    NO-LOCK
    WHERE ROWID(b-tt-digita) = r-tt-digita
    AND   b-tt-digita.tipo    = INPUT FRAME f-relat rd-browse-tipo
    NO-ERROR.
  IF AVAIL b-tt-digita THEN
...
DO:
  run pi-troca-pagina.
  ASSIGN 
    bt-inserir  :SENSITIVE IN FRAME f-pg-dig = YES
    bt-alterar  :SENSITIVE IN FRAME f-pg-dig = YES
    bt-retirar  :SENSITIVE IN FRAME f-pg-dig = YES
    bt-salvar   :SENSITIVE IN FRAME f-pg-dig = YES
    bt-recuperar:SENSITIVE IN FRAME f-pg-dig = YES.
  ASSIGN 
    bt-inserir  :LABEL IN FRAME f-pg-dig = "Marca"
    bt-alterar  :LABEL IN FRAME f-pg-dig = "Desmarca"
    bt-retirar  :LABEL IN FRAME f-pg-dig = "Todos"
    bt-salvar   :LABEL IN FRAME f-pg-dig = "Nenhum"
    bt-recuperar:LABEL IN FRAME f-pg-dig = "Refaz".
  ASSIGN
    rd-browse-tipo:HIDDEN IN FRAME f-relat = NO.
END.
...
DO:
    run pi-troca-pagina.
    ASSIGN rd-browse-tipo:HIDDEN IN FRAME f-relat = YES.
END.
...
&Scoped-define SELF-NAME l-super
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL l-super w-relat
ON VALUE-CHANGED OF l-super IN FRAME f-pg-par /* Apenas usuarios do tipo SUPER */
DO:
  RUN pi-tt-digita.
END.
...
&Scoped-define FRAME-NAME f-relat
&Scoped-define SELF-NAME rd-browse-tipo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL rd-browse-tipo w-relat
ON VALUE-CHANGED OF rd-browse-tipo IN FRAME f-relat
DO:
  IF INPUT FRAME f-relat rd-browse-tipo = 1 THEN
    ASSIGN 
      tt-digita.campo-1:LABEL IN BROWSE br-digita   = "Usu†rio"
      tt-digita.campo-2:LABEL IN BROWSE br-digita   = "Nome"
      fl-usu-ini       :SENSITIVE IN FRAME f-pg-dig = YES
      fl-usu-fim       :SENSITIVE IN FRAME f-pg-dig = YES.
  ELSE
    ASSIGN 
      tt-digita.campo-1:LABEL IN BROWSE br-digita      = "DB"
      tt-digita.campo-2:LABEL IN BROWSE br-digita      = "Tabela"
      fl-usu-ini       :SENSITIVE IN FRAME f-pg-dig    = NO
      fl-usu-fim       :SENSITIVE IN FRAME f-pg-dig    = NO
      fl-usu-ini       :SCREEN-VALUE IN FRAME f-pg-dig = ""
      fl-usu-fim       :SCREEN-VALUE IN FRAME f-pg-dig = "ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ".
  OPEN QUERY br-digita 
    FOR EACH tt-digita
    WHERE tt-digita.tipo       =  INPUT FRAME f-relat  rd-browse-tipo
    AND   tt-digita.campo-1    >= INPUT FRAME f-pg-dig fl-usu-ini   
...
{utp/ut9000.i "esau0001" "0.12.00.001"}
...
------------------------------------------------------------------------------*/
  DISPLAY rd-browse-tipo 
      WITH FRAME f-relat IN WINDOW w-relat.
  ENABLE im-pg-dig im-pg-imp im-pg-par im-pg-sel bt-executar bt-cancelar 
         bt-ajuda rd-browse-tipo 
      WITH FRAME f-relat IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-relat}
  DISPLAY dat-ini dat-fim c-base-ini c-base-fim c-atr-ini c-atr-fim c-prog-ini 
          c-prog-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-9 IMAGE-10 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 IMAGE-13 IMAGE-14 
         dat-ini dat-fim c-base-ini c-base-fim c-atr-ini c-atr-fim c-prog-ini 
         c-prog-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-sel}
  DISPLAY fl-usu-ini fl-usu-fim 
      WITH FRAME f-pg-dig IN WINDOW w-relat.
  ENABLE br-digita RECT-15 IMAGE-15 IMAGE-16 fl-usu-ini fl-usu-fim bt-inserir 
         bt-recuperar 
      WITH FRAME f-pg-dig IN WINDOW w-relat.
  ...
  DISPLAY l-create l-write l-delete l-super 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE RECT-10 RECT-11 l-create l-write l-delete l-super 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
/*                                             rs-classif:radio-buttons in frame f-pg-cla) */
           ...
           .
    ASSIGN 
      tt-param.tt-dat-ini       = input frame f-pg-sel dat-ini    
      tt-param.tt-dat-fim       = input frame f-pg-sel dat-fim    
      tt-param.tt-c-base-ini    = input frame f-pg-sel c-base-ini 
      tt-param.tt-c-base-fim    = input frame f-pg-sel c-base-fim 
      tt-param.tt-c-atr-ini     = input frame f-pg-sel c-atr-ini  
      tt-param.tt-c-atr-fim     = input frame f-pg-sel c-atr-fim  
      tt-param.tt-c-prog-ini    = input frame f-pg-sel c-prog-ini 
      tt-param.tt-c-prog-fim    = input frame f-pg-sel c-prog-fim 
      tt-param.tt-l-create      = input frame f-pg-par l-create   
      tt-param.tt-l-write       = input frame f-pg-par l-write    
      tt-param.tt-l-delete      = input frame f-pg-par l-delete
      tt-param.tt-l-super       = INPUT FRAME f-pg-par l-super
    ...
    {include/i-rprun.i esp/esau0001rp.p}
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pi-tt-digita w-relat 
PROCEDURE pi-tt-digita :
/*pi-tt-digita*/
  ...
  FOR EACH usuar_mestre
    NO-LOCK:
      ...
      */
      ...
      IF l-super:CHECKED IN FRAME f-pg-par AND usuar_mestre.ind_tip_usuar <> "Super" THEN
          NEXT blk.
      ...
      ASSIGN 
        tt-digita.selec   = YES
        tt-digita.tipo    = 1 /* Usuario */ 
        tt-digita.campo-1 = usuar_mestre.cod_usuario
        tt-digita.campo-2 = usuar_mestre.nom_usuario.
  ...
  FOR EACH tabela_monitor
    NO-LOCK:
      ...
      */
      ...
      ASSIGN 
        tt-digita.selec   = YES
        tt-digita.tipo    = 2 /* Tabelas */           
        tt-digita.campo-1 = tabela_monitor.cod_base_dados    
        tt-digita.campo-2 = tabela_monitor.cod_tabela.
    END. /* FOR EACH usuar_mestre */
  OPEN QUERY br-digita 
    FOR EACH tt-digita
    WHERE tt-digita.tipo    = 1 /* Usuario */.
  ASSIGN 
    tt-digita.campo-1:LABEL IN BROWSE br-digita = "Usu†rio"
    tt-digita.campo-2:LABEL IN BROWSE br-digita = "Nome".
END PROCEDURE.
