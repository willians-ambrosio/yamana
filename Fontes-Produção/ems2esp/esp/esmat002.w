...
*******************************************************************************/
{include/i-prgvrs.i ESMAT002 12.1.17.001}
...
DEFINE VARIABLE text-modo-2 AS CHARACTER FORMAT "X(256)":U INITIAL "Tipo Cont Item" 
      VIEW-AS TEXT 
     SIZE 10.86 BY .63 NO-UNDO.

DEFINE VARIABLE rs-tp-contr AS INTEGER 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Fisico", 1,
"Total", 2,
...
DEFINE VARIABLE tg-coluna AS LOGICAL INITIAL yes 
     LABEL "Imprime coluna 'Tipo de Controle do Item'" 
     VIEW-AS TOGGLE-BOX
...
DEFINE VARIABLE dt-corte AS DATE FORMAT "99/99/9999":U INITIAL 01/01/1900 
     LABEL "Data" 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88 NO-UNDO.

DEFINE VARIABLE dt-corte-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/2999 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88 NO-UNDO.

DEFINE VARIABLE fi-cc-fim AS CHARACTER FORMAT "X(08)":U INITIAL "9999999999999999999999" 
     VIEW-AS FILL-IN 
     SIZE 12 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-par
     rs-tp-contr AT ROW 1.96 COL 4 NO-LABEL WIDGET-ID 4
     tg-coluna AT ROW 2.92 COL 4 WIDGET-ID 26
     tg-excel AT ROW 5.21 COL 4 WIDGET-ID 24
     text-modo-2 AT ROW 1.21 COL 1.14 COLON-ALIGNED NO-LABEL WIDGET-ID 22
     text-modo AT ROW 4.42 COL 1.14 COLON-ALIGNED NO-LABEL WIDGET-ID 18 FORMAT "X(256)":U
           VIEW-AS TEXT 
          SIZE 6.86 BY .63
     RECT-11 AT ROW 4.63 COL 2 WIDGET-ID 12
     RECT-12 AT ROW 1.42 COL 2 WIDGET-ID 20
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
...
DEFINE FRAME f-pg-sel
     dt-corte AT ROW 1.75 COL 33 RIGHT-ALIGNED WIDGET-ID 2
     dt-corte-fim AT ROW 1.75 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     fi-cc-ini AT ROW 2.75 COL 33 RIGHT-ALIGNED WIDGET-ID 8
     fi-cc-fim AT ROW 2.75 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     fi-item-ini AT ROW 3.75 COL 33 RIGHT-ALIGNED WIDGET-ID 16
     fi-item-fim AT ROW 3.75 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     fi-est-ini AT ROW 4.75 COL 33 RIGHT-ALIGNED WIDGET-ID 12
     fi-est-fim AT ROW 4.75 COL 48 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     IMAGE-13 AT ROW 1.75 COL 35 WIDGET-ID 18
     IMAGE-14 AT ROW 1.75 COL 46 WIDGET-ID 20
     IMAGE-15 AT ROW 2.75 COL 46 WIDGET-ID 22
     IMAGE-16 AT ROW 3.75 COL 46 WIDGET-ID 24
     IMAGE-17 AT ROW 2.75 COL 35 WIDGET-ID 26
     IMAGE-18 AT ROW 3.75 COL 35 WIDGET-ID 28
     IMAGE-19 AT ROW 4.75 COL 35 WIDGET-ID 30
     IMAGE-20 AT ROW 4.75 COL 46 WIDGET-ID 32
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Relat¢rio de Custo Total e DÇbito Direto"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
/* SETTINGS FOR FRAME f-pg-par
                                                                        */
/* SETTINGS FOR FILL-IN text-modo IN FRAME f-pg-par
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       text-modo:PRIVATE-DATA IN FRAME f-pg-par     = 
                "Sa°da".

/* SETTINGS FOR FILL-IN text-modo-2 IN FRAME f-pg-par
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       text-modo-2:PRIVATE-DATA IN FRAME f-pg-par     = 
                "Tipo de Controle do Item".

/* SETTINGS FOR TOGGLE-BOX tg-excel IN FRAME f-pg-par
   NO-ENABLE                                                            */
/* SETTINGS FOR FRAME f-pg-sel
                                                                        */
/* SETTINGS FOR FILL-IN dt-corte IN FRAME f-pg-sel
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN fi-cc-ini IN FRAME f-pg-sel
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN fi-est-ini IN FRAME f-pg-sel
   ALIGN-R                                                              */
/* SETTINGS FOR FILL-IN fi-item-ini IN FRAME f-pg-sel
   ALIGN-R                                                              */
...
ON END-ERROR OF w-relat /* Relat¢rio de Custo Total e DÇbito Direto */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Relat¢rio de Custo Total e DÇbito Direto */
DO:
...
{utp/ut9000.i "ESMAT002" "12.1.17.001"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    FOR EACH estabelec
        ...
        IF FIRST(estabelec.cod-estabel) THEN
           ASSIGN fi-est-ini:SCREEN-VALUE IN FRAME f-pg-sel = estabelec.cod-estabel.

        IF LAST(estabelec.cod-estabel) THEN 
           ASSIGN fi-est-fim:SCREEN-VALUE IN FRAME f-pg-sel = estabelec.cod-estabel.
    END.
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY dt-corte dt-corte-fim fi-cc-ini fi-cc-fim fi-item-ini fi-item-fim 
          fi-est-ini fi-est-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-13 IMAGE-14 IMAGE-15 IMAGE-16 IMAGE-17 IMAGE-18 IMAGE-19 
         IMAGE-20 dt-corte dt-corte-fim fi-cc-ini fi-cc-fim fi-item-ini 
         fi-item-fim fi-est-ini fi-est-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  DISPLAY rs-tp-contr tg-coluna tg-excel 
      WITH FRAME f-pg-par IN WINDOW w-relat.
  ENABLE RECT-11 RECT-12 rs-tp-contr tg-coluna 
      WITH FRAME f-pg-par IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN tt-param.rs-tp-contr  = INPUT FRAME f-pg-par rs-tp-contr
           tt-param.l-excel      = INPUT FRAME f-pg-par tg-excel
           tt-param.l-coluna     = INPUT FRAME f-pg-par tg-coluna.
        .

    ASSIGN tt-param.dt-base      = INPUT FRAME f-pg-sel dt-corte
           tt-param.dt-base-fim  = INPUT FRAME f-pg-sel dt-corte-fim
    ...
    {include/i-rprun.i esp/esmat002rp.p}
