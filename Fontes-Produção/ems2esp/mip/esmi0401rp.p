...
{include/i-prgvrs.i ESMI0401RP 2.06.00.000}  /*** 010004 ***/
{include/i_fnctrad.i}
/********************************************************************************
**
**       PROGRAMA: esmi0401rp.p
**
...
/* ***************************  Main Block  *************************** */
{mip/esmi0401.i2}   /* pi-ordem       */
{mip/esmi0401.i3}   /* pi-empresa     */
{mip/esmi0401.i4}   /* pi-dt-abertura */
/*{mip/esmi0401.i5}   /* pi-oficina     */*/
...
if  tt-param.l-param then do:
   ...
   /* PUT unformatted skip(1) return-value format "x(30)" AT 23 skip.
    ...
    disp i-ordem-ini          colon 33  "|< >|"  at 57 i-ordem-fim           no-label
         ...
         dt-manut-ini         colon 33  "|< >|"  at 57  dt-manut-fim         no-label
         dt-ini-cedo-ini      colon 33  "|< >|"  at 57 dt-ini-cedo-fim       no-label   
         i-tipo-manut-ini     colon 33  "|< >|"  at 57 i-tipo-manut-fim      no-label
         i-planejador-ini     colon 33  "|< >|"  at 57 i-planejador-fim      no-label   
         dt-ini-tarde-ini     colon 33  "|< >|"  at 57 dt-ini-tarde-fim      no-label
...
ASSIGN i-ordem-ini         =  tt-param.i-ordem-ini      
       ...
       dt-manut-ini        =  tt-param.dt-manut-ini  
       dt-manut-fim        =  tt-param.dt-manut-fim  
       dt-ini-cedo-ini     =  tt-param.dt-ini-cedo-ini   
       dt-ini-cedo-fim     =  tt-param.dt-ini-cedo-fim   
       ...
       dt-ini-tarde-ini     =  tt-param.dt-ini-tarde-ini    
       dt-ini-tarde-fim     =  tt-param.dt-ini-tarde-fim    
