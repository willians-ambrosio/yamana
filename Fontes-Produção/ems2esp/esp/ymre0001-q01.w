...
*******************************************************************************/
{include/i-prgvrs.i YMRE0001-q01 11.5.11.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ymre0001-q01 MUT}
&ENDIF
...
&Scoped-define INTERNAL-TABLES es-natoper-rec

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-natoper-rec ~
      WHERE es-natoper-rec.ep-codigo = i-ep-codigo-usuario ~
 NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-natoper-rec ~
      WHERE es-natoper-rec.ep-codigo = i-ep-codigo-usuario ~
 NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main es-natoper-rec
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-natoper-rec
...
<FOREIGN-KEYS>
ep-codigo||y|ems5_esp.es-natoper-rec.ep-codigo
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems5_esp.es-natoper-rec"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _Where[1]         = "ems5_esp.es-natoper-rec.ep-codigo = i-ep-codigo-usuario
"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "ep-codigo" "es-natoper-rec" "ep-codigo"}
