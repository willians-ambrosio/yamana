...
*******************************************************************************/
{include/i-prgvrs.i ESIN0518 2.00.00.002}  /*** 010002 ***/
...
DEFINE VARIABLE c-arquivo-2 AS CHARACTER INITIAL "D:/TEMP/20000047/ESIN0518.TXT" 
     VIEW-AS EDITOR MAX-CHARS 256
     SIZE 44 BY .88
     BGCOLOR 15  NO-UNDO.
...
DEFINE FRAME f-pg-sel
     i-emp-ini AT ROW 1.92 COL 19.57 COLON-ALIGNED
     c-est-ini AT ROW 2.96 COL 19.57 COLON-ALIGNED
     c-est-fim AT ROW 2.96 COL 48.86 COLON-ALIGNED NO-LABEL
     i-proj-ini AT ROW 3.96 COL 19.57 COLON-ALIGNED
     i-proj-fim AT ROW 3.96 COL 48.86 COLON-ALIGNED NO-LABEL
     i-ordem-ini AT ROW 4.96 COL 19.57 COLON-ALIGNED
     i-ordem-fim AT ROW 4.96 COL 48.86 COLON-ALIGNED NO-LABEL
     i-data-ini AT ROW 5.92 COL 19.57 COLON-ALIGNED
     i-data-fim AT ROW 6 COL 48.86 COLON-ALIGNED NO-LABEL
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN c-est-ini:LABEL IN FRAME f-pg-sel = TRIM(RETURN-VALUE).

    &IF "{&mguni_version}" >= "2.071" &THEN
    ASSIGN c-est-fim:SCREEN-VALUE IN FRAME f-pg-sel = "ZZZZZ"
           i-emp-ini:SCREEN-VALUE IN FRAME f-pg-sel = "".
    &ELSE
    ASSIGN c-est-fim:SCREEN-VALUE IN FRAME f-pg-sel = "ZZZ"
           i-emp-ini:SCREEN-VALUE IN FRAME f-pg-sel = "0".                
    &ENDIF
...
------------------------------------------------------------------------------*/
  ENABLE im-pg-sel im-pg-imp bt-executar bt-cancelar 
         bt-ajuda 
      WITH FRAME f-relat IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-relat}
  DISPLAY i-emp-ini c-est-ini c-est-fim i-proj-ini i-proj-fim 
          i-ordem-ini i-ordem-fim i-data-ini i-data-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-9 IMAGE-10 IMAGE-7 IMAGE-8 IMAGE-5 IMAGE-6 
i-emp-ini c-est-ini c-est-fim i-proj-ini i-proj-fim 
         i-ordem-ini i-ordem-fim i-data-ini i-data-fim 
         IMAGE-11 IMAGE-12 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ...
  ENABLE RECT-7 RECT-9 rs-destino bt-arquivo bt-config-impr c-arquivo 
         rs-execucao c-arquivo-2 RECT-10 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.arquivo-destino = input frame f-pg-imp c-arquivo-2.
    ...
    {include/i-rprun.i esp/esin0518rp.p}
