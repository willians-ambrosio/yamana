...
*******************************************************************************/
{include/i-prgvrs.i YMSA0005-G01 1.00.00.000}
...
&Scoped-Define ENABLED-OBJECTS rt-button d_dat_referencia bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS d_dat_referencia 
...
DEFINE VARIABLE d_dat_referencia AS DATE FORMAT "99/99/9999":U 
     LABEL "Data" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     d_dat_referencia AT ROW 1.17 COL 24 COLON-ALIGNED WIDGET-ID 2
...
DO:
FIND func_revista NO-LOCK
    WHERE func_revista.dat_referencia EQ INPUT FRAME {&FRAME-NAME} d_dat_referencia NO-ERROR.

IF NOT AVAILABLE func_revista THEN DO:
    {utp/ut-table.i dthresp func_revista 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(func_revista).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY d_dat_referencia 
      WITH FRAME d-vapara.
  ENABLE rt-button d_dat_referencia bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "YMSA0005-G01" "1.00.00.000"}
