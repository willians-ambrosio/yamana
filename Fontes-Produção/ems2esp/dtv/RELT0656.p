...
**       Data....: 09/12/10
**       Autor...: DATASUL S.A.
**       Objetivo: SEGURADORA COM IPI
**       VersÆo..: 1.00.000 - adm
**       OBS.....: Este fonte foi gerado pelo Data Viewer 3.00
*******************************************************************************/

define variable c-prog-gerado as character no-undo initial "RELT0656".
...
assign c-programa     = "RELT0656"
       c-versao       = "2.06"
       c-revisao      = ".00.000"
       c-titulo-relat = "SEGURADORA COM IPI"
       c-sistema      = "EMS".
...
for each doc-fiscal no-lock
         where doc-fiscal.dt-docto >= da-dt-docto-ini and 
...
if  tt-param.parametro then do:
   ...
   disp stream str-rp 
      da-dt-docto-ini colon 17 "|< >|"   at 41 da-dt-docto-fim no-label
