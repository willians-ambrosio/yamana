...
&Scoped-define INTERNAL-TABLES es_param_apl

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es_param_apl NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es_param_apl NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es_param_apl
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es_param_apl
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems5_esp.es_param_apl"
     _Options          = "NO-LOCK"
