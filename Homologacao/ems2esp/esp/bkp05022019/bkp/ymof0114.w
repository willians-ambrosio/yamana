...
DEFINE FRAME f-pg-imp
     ...
     bt-config-impr AT ROW 2.75 COL 43.72 HELP
...
ON MOUSE-SELECT-DBLCLICK OF c-class-i IN FRAME f-pg-sel /* Classificaá∆o Fiscal */
DO:
  {include/zoomvar.i &prog-zoom=inzoom\z01in046.r
                        &campo=c-class-i
                        &campozoom=class-fiscal
...
/* ASSIGN c-arquivo:SCREEN-VALUE IN FRAME f-pg-imp = REPLACE(c-arquivo:SCREEN-VALUE IN FRAME f-pg-imp, ".LST", ".xlsx"). */
...
------------------------------------------------------------------------------*/
  ...
  ENABLE rect-rtf RECT-7 RECT-9 rs-destino bt-arquivo c-arquivo bt-config-impr 
...
/*     end.                                                                */
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.rpw             = IF input frame f-pg-imp rs-execucao = 2 THEN YES ELSE NO
