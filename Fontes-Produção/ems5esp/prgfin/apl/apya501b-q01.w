...
&Scoped-define QUERY-STRING-Query-Main FOR EACH aditivo_contrat_apf NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH aditivo_contrat_apf NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main aditivo_contrat_apf
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main aditivo_contrat_apf
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems5_esp.aditivo_contrat_apf"
     _Options          = "NO-LOCK"
