...
&Scoped-define INTERNAL-TABLES es_categ_ptoelet_sit

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es_categ_ptoelet_sit NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es_categ_ptoelet_sit NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es_categ_ptoelet_sit
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es_categ_ptoelet_sit
...
DEFINE QUERY Query-Main FOR 
      es_categ_ptoelet_sit SCROLLING.
&ANALYZE-RESUME
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "hresp.es_categ_ptoelet_sit"
     _Options          = "NO-LOCK"
