...
/*------------------------------------------------------------------------
File.............: POC004A.w
Description......: Notas Fiscais Recebidas - Laurence _ colocar em pr
Input Parameters : 
Output Parameters: 
Author...........: DATASUL S.A.
Created..........: 05/02/10 - 14:09 - 20100079
OBS..............: Este fonte foi gerado pelo Data Viewer
------------------------------------------------------------------------*/

define variable c-prog-gerado as character no-undo initial "POC004A".
...
DEFINE FRAME f-pg-sel
   ...
   c-nat-operacao-ini label "Nat Operaá∆o"
     at row 3 col 20 colon-aligned
     view-as fill-in 
     size 7 by .88
     font 1

   c-nat-operacao-fim no-label
   ...
   da-dt-trans-050-ini label "Data Transaá∆o"
     at row 5 col 20 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

   da-dt-trans-050-fim no-label
     at row 5 col 47 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

   da-dt-emissao-060-ini label "Data Emiss∆o"
     at row 6 col 20 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

   da-dt-emissao-060-fim no-label
     at row 6 col 47 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

   da-dt-trans-ini label "Data Transaá∆o"
   ...
   da-dt-vencim-ini label "Data Vencimento"
     at row 8 col 20 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

   da-dt-vencim-fim no-label
     at row 8 col 47 colon-aligned
     view-as fill-in 
     size 11 by .88
     font 1

    IMAGE-1 AT ROW 01.00 COL 39
    IMAGE-2 AT ROW 01.00 COL 43
    IMAGE-3 AT ROW 02.00 COL 39
    IMAGE-4 AT ROW 02.00 COL 43
    IMAGE-5 AT ROW 03.00 COL 39
    IMAGE-6 AT ROW 03.00 COL 43
    IMAGE-7 AT ROW 04.00 COL 39
    IMAGE-8 AT ROW 04.00 COL 43
    IMAGE-9 AT ROW 05.00 COL 39
    IMAGE-10 AT ROW 05.00 COL 43
    IMAGE-11 AT ROW 06.00 COL 39
    IMAGE-12 AT ROW 06.00 COL 43
    IMAGE-13 AT ROW 07.00 COL 39
    IMAGE-14 AT ROW 07.00 COL 43
    IMAGE-15 AT ROW 08.00 COL 39
    IMAGE-16 AT ROW 08.00 COL 43
   WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY
   SIDE-LABELS NO-UNDERLINE THREE-D
   AT COL 3 ROW 2.85
   SIZE 76.86 BY 10.62.
...
CREATE WINDOW C-Win ASSIGN
   HIDDEN             = YES
   TITLE              = "Notas Fiscais Recebidas - Laurence _ colocar em pr - POC004A"
   HEIGHT             = 15
   WIDTH              = 81.14
   MAX-HEIGHT         = 22.35
   MAX-WIDTH          = 114.29
...
assign v-cod-prog-gerado = "POC004A".
...
&ENDIF
  ...
  assign wh-label-imp:format       = "x(10)".
  assign wh-label-imp:screen-value = "Exportaá∆o".
PAUSE 0 BEFORE-HIDE.
...
PROCEDURE enable_UI :
   ...
   c-nat-operacao-ini c-nat-operacao-fim
   da-dt-emissao-ini da-dt-emissao-fim
   da-dt-trans-050-ini da-dt-trans-050-fim
   da-dt-emissao-060-ini da-dt-emissao-060-fim
   da-dt-trans-ini da-dt-trans-fim
   da-dt-vencim-ini da-dt-vencim-fim
...
if return-value = "NOK" then do:
  ...
  return error.
   ...
   if  tt-param.destino = 2 then
       ...
       assign tt-param.arquivo = session:temp-directory + "POC004A" + "." + v-cod-extens-arq.
    ...
    assign tt-param.i-cod-emitente-ini = input frame f-pg-sel i-cod-emitente-ini
           ...
           tt-param.da-dt-trans-050-ini = input frame f-pg-sel da-dt-trans-050-ini
           tt-param.da-dt-trans-050-fim = input frame f-pg-sel da-dt-trans-050-fim
           tt-param.da-dt-emissao-060-ini = input frame f-pg-sel da-dt-emissao-060-ini
           tt-param.da-dt-emissao-060-fim = input frame f-pg-sel da-dt-emissao-060-fim
           ...
           tt-param.da-dt-vencim-ini = input frame f-pg-sel da-dt-vencim-ini
           tt-param.da-dt-vencim-fim = input frame f-pg-sel da-dt-vencim-fim
.
...
if return-value = "NOK" then return error.
   ...
   if  session:set-wait-state("general") then.
    assign v-cod-prog-i-rprun = "dtv/POC0041.p".
