    ...
    where controle-verba.ep-codigo    >= tt-param.i-ep-ini
      ...
      if l-imprimiu = yes then do:
         ...
         if tt-param.atualiza then do:
            find b-controle-verba where
                 b-controle-verba.ep-codigo = controle-verba.ep-codigo and
                 b-controle-verba.cod-est-exec = controle-verba.cod-est-exec and
                 b-controle-verba.num-projeto = controle-verba.num-projeto and
                 b-controle-verba.num-ordem = controle-verba.num-ordem exclusive-lock.
