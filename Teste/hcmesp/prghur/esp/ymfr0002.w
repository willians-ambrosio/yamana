...
*******************************************************************************/
{include/i-prgvrs.i YMFR0002 1.02.00.003 } /*** 010003 ***/
/*------------------------------------------------------------------------
...
{utp/ut9000.i "YMFR0002" "1.02.00.000"}
...
do  on error undo, return error
    ...
    if input frame f-pg-par v_dat_lancto = ? then do:
       {utp/ut-liter.i Data_do_D‚bito MFP C}
        run utp/ut-msgs.p (input "show",
                           input 54,
                           input return-value).                               
        apply 'mouse-select-click' to im-pg-par in frame f-relat.
   ...
   assign  tt-param.c-arq-lqd       = input frame f-pg-par c-arq-lqd
    ...
    {include/i-rprun.i prghur/esp/ymfr0002rp.p}
