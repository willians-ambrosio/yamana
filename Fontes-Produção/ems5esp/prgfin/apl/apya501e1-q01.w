...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es_operac_financ_rof NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es_operac_financ_rof NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es_operac_financ_rof
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es_operac_financ_rof
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "ems5_esp.es_operac_financ_rof"
     _Options          = "NO-LOCK"
