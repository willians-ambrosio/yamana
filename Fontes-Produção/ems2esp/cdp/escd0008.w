...
*******************************************************************************/
{include/i-prgvrs.i escd0008 2.12.00.000}
...
DEFINE VARIABLE h_escd0008-q01-2 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escd0008-v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'cdp/escd0008-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escd0008-v01 ).
       RUN set-position IN h_escd0008-v01 ( 2.75 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 8.00 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'cdp/escd0008-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = cdp\escd0008-z01.w,
                     ProgVaPara = cdp\escd0008-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_escd0008-q01-2 ).
       RUN set-position IN h_escd0008-q01-2 ( 1.00 , 63.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_escd0008-v01. */
       RUN add-link IN adm-broker-hdl ( h_escd0008-q01-2 , 'Record':U , h_escd0008-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_escd0008-v01 ).

       /* Links to SmartQuery h_escd0008-q01-2. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_escd0008-q01-2 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_escd0008-q01-2 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_escd0008-q01-2 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_escd0008-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "escd0008" "2.12.00.000"}
