...
*******************************************************************************/
{include/i-prgvrs.i VAN001-W03 5.06.99.999}
...
DEFINE VARIABLE h_van001-b05 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_van001-q02 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_van001-v02 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 98.72 BY 19.08 WIDGET-ID 100.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-exihel ).
       RUN set-position IN h_p-exihel ( 1.29 , 82.29 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'van/van001-v02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_van001-v02 ).
       RUN set-position IN h_van001-v02 ( 2.92 , 2.14 ) NO-ERROR.
       /* Size in UIB:  ( 8.50 , 96.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'van/van001-b05.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_van001-b05 ).
       RUN set-position IN h_van001-b05 ( 11.75 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 8.00 , 97.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'van/van001-q02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_van001-q02 ).
       RUN set-position IN h_van001-q02 ( 3.75 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_van001-v02. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_van001-v02 ).
       RUN add-link IN adm-broker-hdl ( h_van001-q02 , 'Record':U , h_van001-v02 ).

       /* Links to SmartBrowser h_van001-b05. */
       RUN add-link IN adm-broker-hdl ( h_van001-q02 , 'Record':U , h_van001-b05 ).
       RUN add-link IN adm-broker-hdl ( h_van001-v02 , 'hab':U , h_van001-b05 ).

       /* Links to SmartQuery h_van001-q02. */
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_van001-q02 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-cadsim ,
             h_p-navega , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_van001-v02 ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_van001-b05 ,
             h_van001-v02 , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "VAN001-W03" "5.06.99.999"}
