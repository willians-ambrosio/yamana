...
*******************************************************************************/
{include/i-prgvrs.i APYA501 12.1.17.000}
...
DEFINE VARIABLE h_apya501-b01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_apya501-b03 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_apya501-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_apya501-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 90.14 BY 23.17 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadpaifilho-ambos ASSIGN
         HIDDEN             = YES
         TITLE              = "Manuten‡Æo Contratos Intercompany"
         HEIGHT             = 23
         WIDTH              = 90.43
         MAX-HEIGHT         = 23.63
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-cadpaifilho-ambos /* Manuten‡Æo Contratos Intercompany */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadpaifilho-ambos w-cadpaifilho-ambos
ON WINDOW-CLOSE OF w-cadpaifilho-ambos /* Manuten‡Æo Contratos Intercompany */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apl/apya501-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_apya501-v01 ).
       RUN set-position IN h_apya501-v01 ( 2.71 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 13.29 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Opera‡äes|Aditivos' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 16.13 , 1.43 ) NO-ERROR.
       RUN set-size IN h_folder ( 7.63 , 89.29 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apl/apya501-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = prgfin/apl/apya501-z01.w,
                     ProgVaPara = prgfin/apl/apya501-g01.w,
                     ProgIncMod = prgfin/apl/apya501a.w,
                     Implantar = no':U ,
             OUTPUT h_apya501-q01 ).
       RUN set-position IN h_apya501-q01 ( 1.00 , 60.00 ) NO-ERROR.
       ...
       /* Links to SmartViewer h_apya501-v01. */
       RUN add-link IN adm-broker-hdl ( h_apya501-b01 , 'handle':U , h_apya501-v01 ).
       RUN add-link IN adm-broker-hdl ( h_apya501-b03 , 'handle':U , h_apya501-v01 ).
       RUN add-link IN adm-broker-hdl ( h_apya501-q01 , 'Record':U , h_apya501-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadpai , 'TableIO':U , h_apya501-v01 ).

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to SmartQuery h_apya501-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-cadpai , 'State':U , h_apya501-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_apya501-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_apya501-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_apya501-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadpai , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_apya501-v01 ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_apya501-v01 , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apl/apya501-b03.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?,
                     ProgAtributo = ,
                     ProgIncMod = prgfin/apl/apya501f.w,
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_apya501-b03 ).
       RUN set-position IN h_apya501-b03 ( 17.63 , 3.14 ) NO-ERROR.
       /* Size in UIB:  ( 6.00 , 86.29 ) */

       /* Links to BrowserCadastro2 h_apya501-b03. */
       RUN add-link IN adm-broker-hdl ( h_apya501-q01 , 'Record':U , h_apya501-b03 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_apya501-b03 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'prgfin/apl/apya501-b01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     Hide-on-Init = no,
                     Disable-on-Init = no,
                     ...
                     Create-On-Add = ?,
                     ProgAtributo = ,
                     ProgIncMod = prgfin/apl/apya501b.w,
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_apya501-b01 ).
       RUN set-position IN h_apya501-b01 ( 17.63 , 2.72 ) NO-ERROR.
       /* Size in UIB:  ( 5.88 , 87.00 ) */

       /* Links to BrowserCadastro2 h_apya501-b01. */
       RUN add-link IN adm-broker-hdl ( h_apya501-q01 , 'Record':U , h_apya501-b01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_apya501-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 2 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "APYA501" "12.1.17.000"}
  
  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  /* Code placed here will execute AFTER standard behavior.    */
  ASSIGN h-viewer = h_apya501-v01.
