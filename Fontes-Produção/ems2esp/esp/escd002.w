...
DEFINE VARIABLE h_escd002-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_escd002-v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/escd002-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_escd002-v01 ).
       RUN set-position IN h_escd002-v01 ( 2.75 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.38 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/escd002-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_escd002-q01 ).
       RUN set-position IN h_escd002-q01 ( 1.25 , 61.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.50 , 6.00 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_escd002-v01. */
       RUN add-link IN adm-broker-hdl ( h_escd002-q01 , 'Record':U , h_escd002-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_escd002-v01 ).

       /* Links to SmartQuery h_escd002-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_escd002-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_escd002-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESCD002" "2.06.00.000"}
